...
- (void)session:(void *)arg1 didReceiveCertificate:(void *)arg2 fromPeer:(void *)arg3 certificateHandler:(void *)arg4; // needs 4 arg types, found 9: MCSession *, NSArray *, MCPeerID *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
