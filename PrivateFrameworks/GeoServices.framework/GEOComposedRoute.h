...
@interface GEOComposedRoute : NSObject <GEOMapAccessRestrictions> {
    ...
    <GEOServerFormattedString> *_fareErrorMessageFormatString;
...
@property (nonatomic, readonly) <GEOServerFormattedString> *fareErrorMessageFormatString;
...
- (id)fareErrorMessageFormatString;
