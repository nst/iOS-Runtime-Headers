...
@property (nonatomic, readonly) double debugFramesPerSecond;
...
- (double)distanceFromPoint:(struct CGPoint { double x1; double x2; })arg1 toPoint:(struct CGPoint { double x1; double x2; })arg2 fromLayer:(id)arg3 withPrecision:(int)arg4;
...
- (BOOL)gridDisabled;
- (id)hostDisplay;
- (id)iconForStyleAttributes:(id)arg1 contentScale:(float)arg2 size:(int)arg3 customIconID:(unsigned int)arg4 transparent:(BOOL)arg5;
...
- (void)startFlyoverTourAnimation:(unsigned int)arg1 animateToStart:(BOOL)arg2 completion:(id /* block */)arg3;
