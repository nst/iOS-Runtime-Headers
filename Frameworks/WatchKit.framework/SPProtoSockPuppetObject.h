...
@property (nonatomic) double nfloat;
@property (nonatomic) int nint32;
@property (nonatomic) int nint64;
@property (nonatomic) unsigned int nuint32;
@property (nonatomic) unsigned int nuint64;
...
- (void)setNint64:(int)arg1;
- (void)setNuint32:(unsigned int)arg1;
- (void)setNuint64:(unsigned int)arg1;
