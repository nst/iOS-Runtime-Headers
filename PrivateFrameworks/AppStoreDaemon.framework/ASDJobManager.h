...
- (void).cxx_destruct;
- (void)_applyUpdates:(id)arg1 usingBlock:(id)arg2;
- (void)_connectToDaemon;
- (void)_finishJobsWithIDs:(id)arg1;
- (void)_getJobsUsingBlock:(id)arg1;
- (void)_getJobsWithIDs:(id)arg1 usingBlock:(id)arg2;
...
- (void)cancelJobsWithIDs:(id)arg1 completionBlock:(id)arg2;
- (void)dealloc;
...
- (void)getJobsUsingBlock:(id)arg1;
- (void)getJobsWithIDs:(id)arg1 usingBlock:(id)arg2;
- (id)init;
- (id)initWithOptions:(id)arg1;
- (void)invalidate;
- (bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;
- (void)pauseJobsWithIDs:(id)arg1 completionBlock:(id)arg2;
- (void)removeObserver:(id)arg1;
- (void)resumeJobsWithIDs:(id)arg1 completionBlock:(id)arg2;
