...
@class CADisplayLink, EAGLContext, GMMStreetViewReportRequest, MKPanorama, MKPanoramaAnnotationGeometry, MKPanoramaLoader, MKPanoramaPlaceholderGeometry, MKPanoramaSkyGeometry, MKPanoramaTextures, MKSearchResult, MKStreetView, MKStreetViewGeometry, MKStreetViewLabelCache, MKStreetViewMinimapGeometry, MKStreetViewTexture, MKStreetViewTileDecoder, NSMutableDictionary, NSString, NSTimer, UIImageView;
