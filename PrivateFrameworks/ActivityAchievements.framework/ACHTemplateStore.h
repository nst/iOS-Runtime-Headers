...
- (void)_queue_addTemplates:(id)arg1 provenance:(long long)arg2 triggerSync:(bool)arg3;
- (bool)_queue_addTemplatesToDatabase:(id)arg1 provenance:(long long)arg2 error:(id*)arg3;
