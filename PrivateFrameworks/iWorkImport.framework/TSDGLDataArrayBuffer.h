...
@property(readonly) unsigned long long GLDataBufferEntrySize;
@property(readonly) unsigned long long bufferCount;
@property unsigned long long currentBufferIndex;
