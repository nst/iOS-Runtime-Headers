...
- (void)p_setupContextForRendering:(struct CGContext { }*)arg1 layerRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg2 modelCache:(id)arg3 shadow:(id)arg4;
