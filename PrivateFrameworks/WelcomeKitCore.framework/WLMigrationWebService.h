...
- (void).cxx_destruct;
- (void)_downloadFileInMultipleSegmentsForSummary:(id)arg1 account:(id)arg2 segmentCompletion:(id)arg3 completion:(id)arg4;
- (void)_downloadFileInSingleSegmentForSummary:(id)arg1 account:(id)arg2 completion:(id)arg3;
- (void)_downloadSegmentsStartingAtByteLocation:(unsigned long long)arg1 ofSummary:(id)arg2 account:(id)arg3 toFileHandle:(id)arg4 segmentCompletion:(id)arg5 completion:(id)arg6;
- (void)_fetchSummariesForAccount:(id)arg1 statistics:(id)arg2 completion:(id)arg3;
- (unsigned long long)_newNumberOfRetriesAllowed:(unsigned long long)arg1 startDate:(id)arg2;
- (void)_performDownloadRequest:(id)arg1 toDestination:(id)arg2 numberOfRetriesAllowed:(unsigned long long)arg3 startDate:(id)arg4 logString:(id)arg5 completionHandler:(id)arg6;
- (void)_performRequest:(id)arg1 numberOfRetriesAllowed:(unsigned long long)arg2 startDate:(id)arg3 logString:(id)arg4 completionHandler:(id)arg5;
- (bool)_shouldDelayBetweenRequests;
- (id)contentType;
- (id)dataType;
- (id)delegate;
- (id)device;
- (void)didReceiveData:(id)arg1 response:(id)arg2 error:(id)arg3 forSummary:(id)arg4 completion:(id)arg5;
- (void)downloadDataForSummary:(id)arg1 account:(id)arg2 completion:(id)arg3;
- (void)downloadFileForSummary:(id)arg1 account:(id)arg2 segmentCompletion:(id)arg3 completion:(id)arg4;
- (void)estimateItemSizeForSummary:(id)arg1 account:(id)arg2;
- (unsigned long long)expectedRecordCount;
- (void)fetchAccountsAndSummariesWithStatistics:(id)arg1 completion:(id)arg2;
