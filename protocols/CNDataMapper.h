...
- (void)requestAccessForEntityType:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 8: long long, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
...
- (<CNCancelable> *)executeFetchRequest:(void *)arg1 progressiveResults:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 14: CNContactFetchRequest *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSArray *, NSDictionary *, void*, id, void*, void, id, NSError *, void*
