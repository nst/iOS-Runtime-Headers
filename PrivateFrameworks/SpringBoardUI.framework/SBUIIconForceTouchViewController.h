...
- (void)_peekAnimated:(bool)arg1 withRelativeTouchForce:(double)arg2 allowSmoothing:(bool)arg3 completionHandler:(id)arg4;
...
- (void)dealloc;
- (id)delegate;
- (bool)dismissAnimated:(bool)arg1 withCompletionHandler:(id)arg2;
...
- (bool)presentAnimated:(bool)arg1 withCompletionHandler:(id)arg2;
