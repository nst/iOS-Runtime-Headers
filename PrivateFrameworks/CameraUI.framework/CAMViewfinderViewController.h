...
- (struct CAMShutterButtonSpec { double x1; double x2; double x3; double x4; double x5; })_shutterButtonSpecForLayoutStyle:(int)arg1;
...
- (BOOL)zoomControl:(id)arg1 shouldReceiveTouchAtPoint:(struct CGPoint { double x1; double x2; })arg2;
