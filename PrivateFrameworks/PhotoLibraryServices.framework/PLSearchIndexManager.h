...
- (void)_inqResetSearchIndexWithReason:(long long)arg1 dropCompletion:(id)arg2;
...
- (void)_onQueueAsyncWithDelay:(double)arg1 perform:(id)arg2;
...
- (void)resetSearchIndexWithReason:(long long)arg1 dropCompletion:(id)arg2;
