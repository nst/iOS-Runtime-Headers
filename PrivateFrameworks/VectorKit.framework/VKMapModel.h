...
@interface VKMapModel : VKModelObject <GEOExperimentConfigurationObserver, GEOResourceManifestTileGroupObserver, VKLabelModelDelegate, VKOverlayContainerDelegate, VKPolylineGroupOverlayObserver, VKPolylineOverlayRouteRibbonObserver, VKTileProviderClient> {
    ...
    double  _navMapModeTransitionZ;
    VKPolygonMapModel * _navPolygonModel;
    double  _navigationPuckSize;
...
@property (nonatomic, readonly) double currentRoadSignOffset;
...
@property (nonatomic) double navMapModeTransitionZ;
@property (nonatomic) double navigationPuckSize;
...
- (struct Matrix<float, 4, 1> { double x1[4]; })clearColor;
- (void)clearScene;
...
- (float)contentScale;
- (id)createSourceForLayer:(unsigned int)arg1 tileSet:(id)arg2 useAdditionalManifest:(BOOL)arg3;
- (id)createSourceForLayer:(unsigned int)arg1 useAdditionalManifest:(BOOL)arg2;
...
- (void)setClearColor:(struct Matrix<float, 4, 1> { double x1[4]; })arg1;
...
- (id)tileProvider;
- (id)tileProviderForMapLayer:(unsigned int)arg1;
- (void)tileProviderNeedsUpdate:(id)arg1;
- (id)tileSetForMapLayer:(unsigned int)arg1 tileGroup:(id)arg2;
- (int)tileSize;
