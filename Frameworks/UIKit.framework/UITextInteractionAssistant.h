...
- (float)distanceBetweenPoint:(struct CGPoint { double x1; double x2; })arg1 andRange:(id)arg2;
- (id)doubleTapGesture;
...
- (void)loupeMagnifierWithState:(int)arg1 atPoint:(struct CGPoint { double x1; double x2; })arg2;
...
- (BOOL)swallowsDoubleTapWithScale:(float)arg1 atPoint:(struct CGPoint { double x1; double x2; })arg2;
