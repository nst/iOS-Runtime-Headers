...
@interface CVAFilterGuided : NSObject {
...
- (void)encodePostProcessAlphaToCommandBuffer:(id)arg1 source:(id)arg2 destination:(id)arg3 alphaMaxLaplacian:(float)arg4 infConvOrientation:(float)arg5 infConvMajorRadius:(float)arg6 infConvMinorRadius:(float)arg7 isBgColorLutBlack:(bool)arg8 gammaExponent:(float)arg9 enableInfConvolution:(bool)arg10;
- (void)encodeReconstructToCommandBuffer:(id)arg1 inGuidancePixelBuffer:(struct __CVBuffer { }*)arg2 inCoeffTexture:(id)arg3 outAlphaPixelBuffer:(struct __CVBuffer { }*)arg4 alphaMaxLaplacian:(float)arg5 gravity:(const struct array<float, 3> { float x1[3]; }*)arg6 isBgColorLutBlack:(bool)arg7 gammaExponent:(float)arg8 enableInfConvolution:(bool)arg9;
...
- (id)initWithDevice:(id)arg1 library:(id)arg2 commandQueue:(id)arg3 textureSize:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg4 alphaSize:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg5 kernelSize:(int)arg6;
- (id)label;
