...
@class <PLCloudSharedCreateAlbumViewControllerDelegate>, NSArray, NSString, PLCloudSharedAlbum, PLComposeRecipientViewController, UILabel, UINavigationItem, UISwitch, UITableView, UITextField;
