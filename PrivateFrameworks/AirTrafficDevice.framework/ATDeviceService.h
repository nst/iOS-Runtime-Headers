...
- (void)requestKeybagSyncToPairedDeviceWithCompletion:(id)arg1;
...
- (void)restoreFromDeviceWithIdentifier:(id)arg1 completion:(id)arg2;
- (bool)run;
- (bool)stop;
