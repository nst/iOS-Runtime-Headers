...
- (void)applyScale:(void *)arg1 withTransitionOptions:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: float, ISPlayerOutputTransitionOptions *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, BOOL, void*
