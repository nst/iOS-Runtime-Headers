...
- (void)_getPairingInfoWithCompletion:(id)arg1;
...
- (void)_setNewAuthRandomIfNecessaryReturningPairingState:(id)arg1;
- (void)_setNewAuthRandomReturningPairingState:(id)arg1;
...
- (void)enableServiceModeForPassWithUniqueIdentifier:(id)arg1 completion:(id)arg2;
...
- (void)handlePreferredAID:(id)arg1 forPassWithUniqueID:(id)arg2 completion:(id)arg3;
...
- (void)paymentWebService:(id)arg1 signData:(id)arg2 withCompletionHandler:(id)arg3;
...
- (void)setDefaultExpressFelicaTransitPassIdentifier:(id)arg1 applicationIdentifier:(id)arg2 requestAuthorization:(bool)arg3 completion:(id)arg4;
