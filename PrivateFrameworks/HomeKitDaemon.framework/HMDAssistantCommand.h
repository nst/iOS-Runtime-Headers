...
- (void)executeActionSet:(id)arg1 action:(id)arg2 withCompletionHandler:(id)arg3;
...
- (void)handleCommandWithCompletionHandler:(id)arg1;
- (void)handleGetActionTypes:(id)arg1 serviceType:(id)arg2 forObjects:(id)arg3 completionHandler:(id)arg4;
- (void)handleGetColor:(id)arg1 forObjects:(id)arg2 serviceType:(id)arg3 completionHandler:(id)arg4;
- (void)handleGetMetadataActionTypes:(id)arg1 serviceType:(id)arg2 forObjects:(id)arg3 completionHandler:(id)arg4;
...
- (void)handleSetActionTypes:(id)arg1 serviceType:(id)arg2 forObjects:(id)arg3 completionHandler:(id)arg4;
- (void)handleSetColor:(id)arg1 forObjects:(id)arg2 service:(id)arg3 completionHandler:(id)arg4;
- (void)handleUpdateActionTypes:(id)arg1 serviceType:(id)arg2 forObjects:(id)arg3 completionHandler:(id)arg4;
- (id)homeKitObjects;
...
- (void)performWithGather:(id)arg1 queue:(id)arg2 msgDispatcher:(id)arg3 completion:(id)arg4;
...
- (id)primaryHomeUUID;
- (id)queue;
- (void)reportOutcome:(id)arg1 results:(id)arg2 handler:(id)arg3;
- (void)reportResults:(id)arg1 handler:(id)arg2;
- (void)reportUnlockRequired:(id)arg1;
- (void)returnResults:(id)arg1 serviceType:(id)arg2 forAction:(id)arg3 completionHandler:(id)arg4;
