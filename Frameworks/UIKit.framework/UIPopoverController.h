...
@class <UIPopoverControllerDelegate>, NSArray, UIBarButtonItem, UIDimmingView, UIPanGestureRecognizer, UIView, UIViewController, _UIPopoverLayoutInfo, _UIPopoverView;
