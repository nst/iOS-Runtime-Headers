...
@property int assetUpdatedNotification;
...
@property int newAssetInstalledNotification;
...
@property BOOL receivedAccountChangedNotification;
...
@property(retain) NSMutableArray * uuidsOfRemovedHomes;
