...
@interface UIScrollView : UIView <DebugHierarchyObject_Fallback, NSCoding, UIGestureRecognizerDelegate, UIIndexBarAccessoryViewDelegate, UIScrollViewDelayedTouchesBeganGestureRecognizerClient, _UIScrollToTopView> {
