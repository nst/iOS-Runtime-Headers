...
- (void)_requestThumbnailsWithFilters:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 singleCompletion:(id /* block */)arg3 fullCompletion:(id /* block */)arg4;
...
- (id)inputImage;
- (void)requestThumbnailsWithFilters:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 fullCompletion:(id /* block */)arg3;
- (void)requestThumbnailsWithFilters:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 singleCompletion:(id /* block */)arg3;
