...
- (void)set_bytesPerSecondLimit:(int)arg1;
...
- (void)set_priority:(int)arg1;
- (void)set_priorityValue:(int)arg1;
...
- (void)set_suspensionThreshhold:(int)arg1;
