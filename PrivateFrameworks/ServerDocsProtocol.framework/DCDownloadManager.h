...
- (bool)_needsToStartDownloadingItemAtSubpath:(id)arg1 completionHandler:(id)arg2;
- (void)cancelAllDownloadTasks;
- (id)downloadTaskForItemAtPath:(id)arg1;
- (bool)isDownloadingDirectory:(id)arg1;
- (bool)isDownloadingFile:(id)arg1;
- (void)startDownloadingDirectory:(id)arg1 usingRemoteFileManager:(id)arg2 activityInfo:(id)arg3 completionHandler:(id)arg4;
- (void)startDownloadingFile:(id)arg1 usingRemoteFileManager:(id)arg2 activityInfo:(id)arg3 completionHandler:(id)arg4;
