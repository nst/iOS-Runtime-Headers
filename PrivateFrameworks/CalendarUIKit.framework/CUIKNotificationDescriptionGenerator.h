...
- (id)conflictStringForConflictDetails:(id)arg1 maxTitleLength:(unsigned int)arg2;
- (id)descriptionForNotification:(id)arg1 withOptions:(unsigned int)arg2;
- (id)descriptionStringsForNotification:(id)arg1 withOptions:(unsigned int)arg2;
- (id)timePeriodForTimeInterval:(id)arg1;
- (id)titleStringForNotification:(id)arg1 withOptions:(unsigned int)arg2;
