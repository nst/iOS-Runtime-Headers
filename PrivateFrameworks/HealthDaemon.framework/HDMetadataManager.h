...
- (bool)_insertExternalSyncMetadata:(id)arg1 forObjectID:(id)arg2 localSourceID:(id)arg3 externalSyncObjectCode:(long long)arg4 objectDeleted:(bool)arg5 error:(id*)arg6;
...
- (bool)insertMetadata:(id)arg1 forObjectID:(id)arg2 localSourceID:(id)arg3 externalSyncObjectCode:(long long)arg4 objectDeleted:(bool)arg5 error:(id*)arg6;
