...
@class CNFAlertView, CNFAudioDeviceView, CNFHUDView, NSObject<CNFDisplayControllerDelegate>, NSTimer, TPBottomButtonBar, TPBottomDualButtonBar, TPLCDView, UIControl, UIImageView, UIView;
