...
- (void).cxx_destruct;
- (void)_addScheduledLocalNotifications:(id)arg1 withCompletion:(id)arg2;
- (void)_cancelScheduledLocalNotifications:(id)arg1 withCompletion:(id)arg2;
...
- (void)snoozeScheduledLocalNotifications:(id)arg1 withCompletion:(id)arg2;
