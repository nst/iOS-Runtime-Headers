...
+ (void)deleteSamplesWithPredicate:(id)arg1 limit:(unsigned long long)arg2 generateDeletedObjects:(bool)arg3 database:(id)arg4 profile:(id)arg5 recursiveDeleteAuthorizationBlock:(id)arg6 completionHandler:(id)arg7;
+ (void)deleteSamplesWithPredicate:(id)arg1 limit:(unsigned long long)arg2 generateDeletedObjects:(bool)arg3 profile:(id)arg4 recursiveDeleteAuthorizationBlock:(id)arg5 completionHandler:(id)arg6;
+ (void)deleteSamplesWithTypes:(id)arg1 sourceIdentifier:(id)arg2 profile:(id)arg3 recursiveDeleteAuthorizationBlock:(id)arg4 completionHandler:(id)arg5;
...
+ (id)timePeriodForSamplesOfType:(id)arg1 database:(id)arg2 matchingPredicate:(id)arg3 error:(id*)arg4 cancellationBlock:(id)arg5;
