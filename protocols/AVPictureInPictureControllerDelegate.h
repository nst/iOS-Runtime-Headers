...
- (void)pictureInPictureController:(void *)arg1 restoreUserInterfaceForPictureInPictureStopWithCompletionHandler:(void *)arg2; // needs 2 arg types, found 7: AVPictureInPictureController *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
