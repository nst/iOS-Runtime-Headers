...
- (id)checkRecordsExistenceTaskForRecords:(id)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (id)engineLibrary;
- (id)getAssetCountsTaskAndLibraryState:(BOOL)arg1 withCompletionHandler:(id /* block */)arg2;
