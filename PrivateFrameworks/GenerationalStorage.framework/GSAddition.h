...
- (unsigned int)hash;
- (id)init;
- (BOOL)internalStat:(struct stat { int x1; unsigned short x2; unsigned short x3; unsigned int x4; unsigned int x5; unsigned int x6; int x7; struct timespec { int x_8_1_1; long x_8_1_2; } x8; struct timespec { int x_9_1_1; long x_9_1_2; } x9; struct timespec { int x_10_1_1; long x_10_1_2; } x10; struct timespec { int x_11_1_1; long x_11_1_2; } x11; int x12; int x13; int x14; unsigned int x15; unsigned int x16; int x17; int x18[2]; }*)arg1;
...
- (BOOL)setOptions:(unsigned int)arg1 error:(id*)arg2;
- (id)size;
