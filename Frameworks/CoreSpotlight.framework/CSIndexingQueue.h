...
- (id)initWithIdleTime:(double)arg1 idleTimeLeeway:(double)arg2 maximumBatchSize:(unsigned long long)arg3 mode:(long long)arg4 notifyBlock:(id)arg5;
- (id)initWithMode:(long long)arg1 notifyBlock:(id)arg2;
- (double)lastPush;
- (id)lastPushedItem;
