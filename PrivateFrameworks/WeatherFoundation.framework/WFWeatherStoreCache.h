...
- (void)_concurrentQueue_barrier_deleteOldDataFromCache:(id)arg1 allowedStaleness:(unsigned int)arg2;
...
- (id)cachedObjectWithinDomain:(id)arg1 forKey:(id)arg2 staleness:(unsigned int)arg3;
- (void)deleteOldDataFromCache:(id)arg1 allowedStaleness:(unsigned int)arg2;
