...
+ (void)requestForcedCleanupWithOptions:(id)arg1 completion:(id)arg2;

- (void).cxx_destruct;
- (id)_asyncProcessingDispatchQueue:(id*)arg1;
- (void)_asynchronouslyDispatchRequests:(id)arg1 onDispatchQueue:(id)arg2 completion:(id)arg3;
