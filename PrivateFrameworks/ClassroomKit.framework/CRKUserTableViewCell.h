...
@property (nonatomic) bool isPresentingFullScreenView;
...
@property (nonatomic, retain) UIImageView *screenObservationImageView;
...
- (void)setScreenObservationImageView:(id)arg1;
