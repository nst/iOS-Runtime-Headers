...
@property (setter=_setAllPairedDevicesAreCurrentVersion:, nonatomic) bool allPairedDevicesAreCurrentVersion;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property bool enablePeriodicSyncTimer;
@property (readonly) unsigned long long hash;
@property (readonly) bool isMaster;
@property (setter=_setPairingActivated:) bool isPairingActivated;
...
- (void)_handleIncomingRequest:(id)arg1 usingBlock:(id)arg2;
- (void)_handleIncomingResponse:(id)arg1 usingBlock:(id)arg2;
- (void)_handleOutgoingMessageError:(id)arg1 usingBlock:(id)arg2;
- (void)_invalidate;
...
- (void)_queue_beginProactiveSyncWithCompletion:(id)arg1;
- (void)_queue_beginRestoreWithStore:(id)arg1 completion:(id)arg2;
...
- (void)_queue_pairedSyncDidBeginForDevice:(id)arg1 messagesSentHandler:(id)arg2 completion:(id)arg3;
- (void)_queue_performNextProactiveSyncWithRemainingDevices:(id)arg1 completion:(id)arg2;
...
- (void)_queue_requestAuthorizationForRequestRecord:(id)arg1 syncStore:(id)arg2 requestSentHandler:(id)arg3 completion:(id)arg4;
- (void)_queue_resetPairingWithCompletion:(id)arg1;
- (void)_queue_routineRequestDidFailToSendWithError:(id)arg1 syncStore:(id)arg2;
- (void)_queue_sendChangeSet:(id)arg1 status:(id)arg2 session:(id)arg3 completion:(id)arg4;
...
- (void)_queue_sendRoutineRequest:(id)arg1 syncStore:(id)arg2 completion:(id)arg3;
- (void)_queue_sendSpeculativeChangeSet:(id)arg1 syncStore:(id)arg2 completion:(id)arg3;
- (void)_queue_sendStartWorkoutAppRequest:(id)arg1 syncStore:(id)arg2 completion:(id)arg3;
...
- (void)_queue_syncImmediatelyWithReason:(id)arg1 options:(unsigned long long)arg2 completion:(id)arg3;
...
- (void)_queue_synchronizeWithOptions:(unsigned long long)arg1 restoreMessagesSentHandler:(id)arg2 targetSyncStore:(id)arg3 reason:(id)arg4 completion:(id)arg5;
...
- (void)_queue_updateSyncStoresWithCompletion:(id)arg1;
- (void)_queue_waitForLastChanceSyncWithPairingID:(id)arg1 timeout:(double)arg2 completion:(id)arg3;
...
- (id)messageCenter;
- (void)messageCenter:(id)arg1 activeDeviceDidChange:(id)arg2 acknowledgementHandler:(id)arg3;
...
- (void)pairedSyncDidBeginForDevice:(id)arg1 messagesSentHandler:(id)arg2 completion:(id)arg3;
...
- (void)requestAuthorizationForRequestRecord:(id)arg1 requestSentHandler:(id)arg2 completion:(id)arg3;
- (void)resetPairingWithCompletion:(id)arg1;
- (void)restoreTimedOutWithSyncStore:(id)arg1;
- (double)restoreTimeout;
- (void)samplesAdded:(id)arg1 anchor:(id)arg2;
- (void)sendRoutineRequest:(id)arg1 completion:(id)arg2;
- (void)sendStartWorkoutAppRequest:(id)arg1 completion:(id)arg2;
...
- (void)syncHealthDataWithOptions:(unsigned long long)arg1 completion:(id)arg2;
- (void)syncHealthDataWithOptions:(unsigned long long)arg1 reason:(id)arg2 completion:(id)arg3;
- (id)syncQueue;
- (void)syncSession:(id)arg1 didFinishSuccessfully:(bool)arg2 error:(id)arg3;
- (void)syncSession:(id)arg1 sendChanges:(id)arg2 completion:(id)arg3;
- (void)syncSessionWillBegin:(id)arg1;
- (id)syncStoresByDeviceIdentifier;
- (void)updatePairedDevicesWithCompletion:(id)arg1;
