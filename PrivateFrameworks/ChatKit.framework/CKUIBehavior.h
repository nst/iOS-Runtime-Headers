...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })balloonMaskCapInsetsWithBalloonDescriptor:(struct CKBalloonDescriptor_t { BOOL x1; BOOL x2; BOOL x3; BOOL x4; unsigned int x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; })arg1;
...
- (struct CGSize { double x1; double x2; })balloonMaskSizeWithBalloonDescriptor:(struct CKBalloonDescriptor_t { BOOL x1; BOOL x2; BOOL x3; BOOL x4; unsigned int x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; })arg1;
...
- (struct CGSize { double x1; double x2; })locationOfferMapThumbnailFillSizeForWidth:(float)arg1;
...
- (struct CGSize { double x1; double x2; })locationShareBalloonSizeForWidth:(float)arg1 offerState:(int)arg2;
...
- (struct CGSize { double x1; double x2; })stickerSizeScaledWithInitialSize:(struct CGSize { double x1; double x2; })arg1 imageScale:(float)arg2 userScale:(float)arg3 rectifiedScreenScale:(float)arg4;
...
- (float)transcriptDrawerOverlapForMarginInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
- (float)transcriptDrawerSpace;
- (float)transcriptDrawerWidthForMarginInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
