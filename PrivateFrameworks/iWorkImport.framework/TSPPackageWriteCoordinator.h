...
- (void)addDelayedObject:(id)arg1 forComponentRootObject:(id)arg2 claimingComponent:(id)arg3 isDelayedObjectReferencedByObjectContainer:(bool)arg4 completion:(id)arg5;
...
- (void)enqueueRootObject:(id)arg1 forceArchive:(bool)arg2 isAddingDelayedObjectReferencedByObjectContainer:(bool)arg3 completion:(id)arg4;
- (void)enqueueRootObjectImpl:(id)arg1 forceArchive:(bool)arg2 isAddingDelayedObjectReferencedByObjectContainer:(bool)arg3 completion:(id)arg4;
