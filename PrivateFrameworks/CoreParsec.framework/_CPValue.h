...
@property (nonatomic, readonly) bool hasBool_value;
@property (nonatomic, readonly) bool hasBytes_value;
@property (nonatomic, readonly) bool hasList_value;
@property (nonatomic, readonly) bool hasNull_value;
@property (nonatomic, readonly) bool hasNumber_value;
@property (nonatomic, readonly) bool hasString_value;
@property (nonatomic, readonly) bool hasStruct_value;
