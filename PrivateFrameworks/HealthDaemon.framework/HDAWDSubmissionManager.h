...
- (void).cxx_destruct;
- (int)_CDACountWithDatabase:(id)arg1 error:(id*)arg2;
- (id)_actions;
- (BOOL)_activitySummaryForActivitySummaryIndex:(int)arg1 activitySummaryOut:(id*)arg2 error:(id*)arg3;
...
- (int)_countOfObjectsWithSQLQuery:(id)arg1 database:(id)arg2 error:(id*)arg3;
- (int)_deletedRowCountWithDatabase:(id)arg1 error:(id*)arg2;
...
- (int)_manuallyEnteredTypesCountWithDatabase:(id)arg1 error:(id*)arg2;
- (id)_newActivitySummaryQueryHelperWithFilter:(id)arg1 initialResultsHandler:(id /* block */)arg2;
- (int)_nonAppleSourcesCountWithDatabase:(id)arg1 error:(id*)arg2;
- (int)_nonAppleSourcesWithDataSince:(id)arg1 database:(id)arg2 error:(id*)arg3;
- (int)_objectRowCountWithDatabase:(id)arg1 error:(id*)arg2;
- (void)_queue_start;
