...
@interface BWZoomDelayBuffer : NSObject {
    ...
    int  _operatingMode;
    struct { double x1; int x2; BOOL x3; } * _zoomRequestBuffer;
...
- (void)addZoomRequest:(struct { double x1; int x2; BOOL x3; })arg1;
- (void)dealloc;
...
- (struct { double x1; int x2; BOOL x3; })zoomRequestForISPAppliedZoomFactor:(float)arg1;
