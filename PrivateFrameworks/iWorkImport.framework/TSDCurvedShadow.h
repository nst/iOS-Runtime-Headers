...
- (id)initWithOffset:(float)arg1 angle:(float)arg2 radius:(float)arg3 curve:(float)arg4 opacity:(float)arg5 color:(id)arg6 enabled:(BOOL)arg7;
...
- (float)paddingForCurveWithSize:(struct CGSize { double x1; double x2; })arg1;
