...
@class <ABPersonLinkingUIDelegate>, <ABPersonTableViewDataSourceDelegate>, <ABStyleProvider>, ABActionsController, ABLabelViewWithVariablePositioning, ABMultiCellContentView, ABNamePropertyGroup, ABPersonCellLayoutManager, ABPersonImageView, ABPersonTableActionDataSource, ABPersonTableFooterView, ABPersonTableHeaderView, ABPersonTableTinyActionCell, AccountsManager, NSArray, NSDictionary, NSIndexPath, NSMutableArray, NSMutableDictionary, NSString, UIDatePicker, UIFont, UILabel, UIResponder, UITableView, UITableViewCell, UIView;
