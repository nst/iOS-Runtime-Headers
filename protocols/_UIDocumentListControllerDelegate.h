...
- (void)documentListController:(void *)arg1 performAction:(void *)arg2 URL:(void *)arg3 originatingView:(void *)arg4 completion:(void *)arg5; // needs 5 arg types, found 9: _UIDocumentListController *, int, NSURL *, UIView *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
