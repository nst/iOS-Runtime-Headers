...
- (void).cxx_destruct;
- (void)_accessPotentiallyActiveConnections:(id)arg1;
- (id)_activeOrAnyPendingConnection;
- (id)_connectionInfoForRoute:(id)arg1;
- (void)_handleLastEventFromBackgroundConnection:(id)arg1 pendingConnectionExhaustionHandler:(id)arg2;
...
- (void)_waitForActiveConnection:(id)arg1;
- (id)aceHost;
- (id)analysisInfo;
- (id)assistantIdentifier;
- (void)barrier:(id)arg1;
- (void)cancelSynchronously:(bool)arg1 completion:(id)arg2;
- (id)connectionId;
- (id)connectionPolicy;
- (void)dealloc;
- (id)delegate;
- (bool)deviceIsInWalkaboutExperimentGroup;
- (void)getAnalysisInfo:(id)arg1;
- (void)getConnectionMetrics:(id)arg1;
