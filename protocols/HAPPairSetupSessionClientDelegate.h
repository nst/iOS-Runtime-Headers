...
- (void)pairSetupSession:(void *)arg1 didReceiveSetupCodeRequestWithCompletionHandler:(void *)arg2; // needs 2 arg types, found 8: HAPPairSetupSession *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSString *, NSError *, void*
