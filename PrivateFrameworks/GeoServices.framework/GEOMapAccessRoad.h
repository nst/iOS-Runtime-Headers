...
- (id)findRoadsFromNextIntersection:(id)arg1 completionHandler:(id)arg2;
- (id)findRoadsFromPreviousIntersection:(id)arg1 completionHandler:(id)arg2;
- (id)findRoadsToNextIntersection:(id)arg1 completionHandler:(id)arg2;
- (id)findRoadsToPreviousIntersection:(id)arg1 completionHandler:(id)arg2;
- (int)formOfWay;
...
- (int)rampType;
- (int)roadClass;
- (void)roadEdgesWithHandler:(id)arg1;
- (void)roadFeaturesWithHandler:(id)arg1;
