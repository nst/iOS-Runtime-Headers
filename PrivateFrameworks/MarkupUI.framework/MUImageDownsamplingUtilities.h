...
+ (float)_maxDimensionOfSize:(struct CGSize { double x1; double x2; })arg1 fittingToArea:(float)arg2;
...
+ (struct CGSize { double x1; double x2; })_sizeFittingArea:(float)arg1 withSize:(struct CGSize { double x1; double x2; })arg2;
