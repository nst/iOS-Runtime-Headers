...
@property (setter=_associatedMessageRange:, nonatomic) struct _NSRange { unsigned int x1; unsigned int x2; } associatedMessageRange;
@property (nonatomic, readonly) int associatedMessageType;
@property (setter=_associatedMessageType:, nonatomic) int associatedMessageType;
...
@property (setter=_updateFlags:, nonatomic) unsigned int flags;
...
@property (setter=_updateMessageID:, nonatomic) int messageID;
...
+ (id)defaultInvitationMessageFromSender:(id)arg1 flags:(unsigned int)arg2;
...
+ (id)instantMessageWithAssociatedMessageContent:(id)arg1 flags:(unsigned int)arg2 associatedMessageGUID:(id)arg3 associatedMessageType:(int)arg4 associatedMessageRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg5 messageSummaryInfo:(id)arg6;
+ (id)instantMessageWithText:(id)arg1 flags:(unsigned int)arg2;
+ (id)instantMessageWithText:(id)arg1 messageSubject:(id)arg2 fileTransferGUIDs:(id)arg3 flags:(unsigned int)arg4;
+ (id)instantMessageWithText:(id)arg1 messageSubject:(id)arg2 fileTransferGUIDs:(id)arg3 flags:(unsigned int)arg4 balloonBundleID:(id)arg5 payloadData:(id)arg6 expressiveSendStyleID:(id)arg7;
+ (id)instantMessageWithText:(id)arg1 messageSubject:(id)arg2 flags:(unsigned int)arg3;
...
+ (id)messageWithLocation:(id)arg1 flags:(unsigned int)arg2 error:(id)arg3 guid:(id)arg4;

- (void).cxx_destruct;
- (void)_associatedMessageGUID:(id)arg1;
- (void)_associatedMessageRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1;
- (void)_associatedMessageType:(int)arg1;
- (id)_copyWithFlags:(unsigned int)arg1;
- (id)_imMessageItem;
- (id)_initWithSender:(id)arg1 time:(id)arg2 timeRead:(id)arg3 timeDelivered:(id)arg4 timePlayed:(id)arg5 plainText:(id)arg6 text:(id)arg7 messageSubject:(id)arg8 fileTransferGUIDs:(id)arg9 flags:(unsigned int)arg10 error:(id)arg11 guid:(id)arg12 messageID:(int)arg13 subject:(id)arg14 balloonBundleID:(id)arg15 payloadData:(id)arg16 expressiveSendStyleID:(id)arg17 timeExpressiveSendPlayed:(id)arg18 associatedMessageGUID:(id)arg19 associatedMessageType:(int)arg20 associatedMessageRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg21 messageSummaryInfo:(id)arg22;
...
- (void)_updateMessageID:(int)arg1;
...
- (id)initWithSender:(id)arg1 time:(id)arg2 text:(id)arg3 messageSubject:(id)arg4 fileTransferGUIDs:(id)arg5 flags:(unsigned int)arg6 error:(id)arg7 guid:(id)arg8 subject:(id)arg9;
- (id)initWithSender:(id)arg1 time:(id)arg2 text:(id)arg3 messageSubject:(id)arg4 fileTransferGUIDs:(id)arg5 flags:(unsigned int)arg6 error:(id)arg7 guid:(id)arg8 subject:(id)arg9 associatedMessageGUID:(id)arg10 associatedMessageType:(int)arg11 associatedMessageRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg12 associatedMessageInfo:(id)arg13;
- (id)initWithSender:(id)arg1 time:(id)arg2 text:(id)arg3 messageSubject:(id)arg4 fileTransferGUIDs:(id)arg5 flags:(unsigned int)arg6 error:(id)arg7 guid:(id)arg8 subject:(id)arg9 associatedMessageGUID:(id)arg10 associatedMessageType:(int)arg11 associatedMessageRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg12 messageSummaryInfo:(id)arg13;
- (id)initWithSender:(id)arg1 time:(id)arg2 text:(id)arg3 messageSubject:(id)arg4 fileTransferGUIDs:(id)arg5 flags:(unsigned int)arg6 error:(id)arg7 guid:(id)arg8 subject:(id)arg9 balloonBundleID:(id)arg10 payloadData:(id)arg11 expressiveSendStyleID:(id)arg12;
...
- (id)__ck_attachmentPreviewTextForAttachmentAtIndex:(int)arg1;
