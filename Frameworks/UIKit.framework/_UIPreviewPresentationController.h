...
- (float)_leadingQuickActionOffsetForCenterPosition:(struct CGPoint { double x1; double x2; })arg1 swipeView:(id)arg2;
...
- (float)_trailingQuickActionOffsetForCenterPosition:(struct CGPoint { double x1; double x2; })arg1 swipeView:(id)arg2;
