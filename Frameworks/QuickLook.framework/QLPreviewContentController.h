...
@class <QLPreviewContentDataSource>, <QLPreviewContentDelegate>, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSString, UILongPressGestureRecognizer, UIPageViewController, UISegmentedControl, UITapGestureRecognizer;
