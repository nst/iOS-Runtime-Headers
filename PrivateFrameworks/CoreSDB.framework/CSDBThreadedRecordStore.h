...
- (void)setupDatabaseWithAllowLocalMigration:(bool)arg1 pathBlock:(id)arg2 setupStoreHandler:(int (*)arg3 connectionInitializer:(int (*)arg4 versionChecker:(int (*)arg5 migrationHandler:(int (*)arg6 schemaVersion:(int)arg7 dataProtectionClass:(unsigned int)arg8 registerBlock:(id)arg9;
- (void)setupDatabaseWithAllowLocalMigration:(bool)arg1 pathBlock:(id)arg2 setupStoreHandler:(int (*)arg3 connectionInitializer:(int (*)arg4 versionChecker:(int (*)arg5 migrationHandler:(int (*)arg6 schemaVersion:(int)arg7 dataProtectionClass:(unsigned int)arg8 registerBlock:(id)arg9 exclusiveOwnership:(bool)arg10;
