...
@property (setter=_setBreakBeforeMakeTimeoutTimer:, nonatomic, retain) NSTimer *breakBeforeMakeTimeoutTimer;
@property (getter=isCallUpgrade, setter=_setCallUpgrade:, nonatomic) BOOL callUpgrade;
...
- (void)beginChat;
- (id)breakBeforeMakeTimeoutTimer;
- (id)callerProperties;
- (unsigned int)cameraOrientation;
- (unsigned int)cameraType;
- (void)cancelInvitation;
- (void)conferenceAVConferenceCallID:(int)arg1 didConnect:(BOOL)arg2;
- (void)conferenceDidPauseAudioWithCallID:(int)arg1 didPauseAudio:(BOOL)arg2;
