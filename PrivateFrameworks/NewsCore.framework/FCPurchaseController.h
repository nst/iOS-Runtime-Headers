...
- (void)checkIntegrityOfPurchaseWithID:(id)arg1 callbackQueue:(id)arg2 completion:(id)arg3;
...
- (void)feldsparEntitlementCheckWithCallbackQueue:(id)arg1 ignoreCache:(bool)arg2 completion:(id)arg3;
- (void)fetchChannelIDsForPurchaseIDs:(id)arg1 callbackQueue:(id)arg2 completion:(id)arg3;
...
- (void)performHTTPRequestForVerifyAccessTokenWithURL:(id)arg1 accessToken:(id)arg2 completion:(id)arg3;
...
- (id)readWriteQueue;
- (void)removeFromAppStorePurchasesDiscoveredList:(id)arg1 completion:(id)arg2;
...
- (void)shouldShowSignedInWithDifferentiTunesAccountAlertWithCompletion:(id)arg1;
- (void)shouldShowiTunesSignedOutAlertWithCompletion:(id)arg1;
...
- (void)startPurchaseWithTagID:(id)arg1 productIdentifier:(id)arg2 purchaseID:(id)arg3 appAdamID:(id)arg4 storeExternalVersion:(id)arg5 price:(id)arg6 webAccessOptIn:(bool)arg7 payment:(id)arg8 completion:(id)arg9;
- (void)submitWebAccessWithTagID:(id)arg1 purchaseID:(id)arg2 emailAddress:(id)arg3 purchaseReceipt:(id)arg4 serialCompletion:(id)arg5 completion:(id)arg6;
...
- (void)verifyAccessTokenWithTagID:(id)arg1 accessToken:(id)arg2 serialCompletion:(id)arg3 callbackQueue:(id)arg4 completion:(id)arg5;
