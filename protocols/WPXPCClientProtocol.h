...
- (void)updateAdvertisingRequest:(void *)arg1 withUpdate:(void *)arg2; // needs 2 arg types, found 7: WPAdvertisingRequest *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, WPAdvertisingRequest *, void*
- (void)updateScanningRequest:(void *)arg1 withUpdate:(void *)arg2; // needs 2 arg types, found 7: WPScanRequest *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, WPScanRequest *, void*
