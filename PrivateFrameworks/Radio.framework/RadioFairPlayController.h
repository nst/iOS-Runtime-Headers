...
- (void)_loadSAPContextWithBag:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_verifyWithURL:(id)arg1 data:(id)arg2 headerFields:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)dealloc;
- (id)init;
