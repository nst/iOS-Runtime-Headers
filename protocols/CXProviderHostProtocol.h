...
- (oneway void)reportNewIncomingCallWithUUID:(void *)arg1 update:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 8: NSUUID *, CXCallUpdate *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSError *, void*
