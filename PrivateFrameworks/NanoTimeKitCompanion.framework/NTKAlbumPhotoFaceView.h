...
- (void)_displayAtom:(id)arg1 animated:(bool)arg2 withAnalysis:(id)arg3 completion:(id)arg4;
...
- (void)_nextPhotoAnimated:(bool)arg1 random:(bool)arg2 loadSynchronous:(bool)arg3 completion:(id)arg4;
