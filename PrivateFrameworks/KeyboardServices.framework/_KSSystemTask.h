...
- (id)handler;
- (id)init;
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 handler:(id)arg3;
- (id)initWithName:(id)arg1 isPeriodic:(bool)arg2 period:(unsigned long long)arg3 handler:(id)arg4;
- (id)name;
