...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct HDActivityCacheActiveSource { double x1; int x2; struct vector<int, std::__1::allocator<int> > { int *x_3_1_1; int *x_3_1_2; struct __compressed_pair<int *, std::__1::allocator<int> > { int *x_3_2_1; } x_3_1_3; } x3; })_baseActiveSource;
- (struct _HDActivityCacheActiveSourceCalculatorSourceEvent { double x1; int x2; int x3; })_baseSourceEvent;
