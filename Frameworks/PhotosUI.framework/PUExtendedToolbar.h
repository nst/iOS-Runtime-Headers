...
- (void)_performChanges:(id)arg1 withAnimatorBlock:(id)arg2;
...
- (void)_updateIfNeededWithAnimatorBlock:(id)arg1;
- (void)_updateToolbarItemsIfNeeded;
- (void)_updateViewsIfNeededWithAnimatorBlock:(id)arg1;
...
- (void)setToolbarViewModel:(id)arg1 withAnimatorBlock:(id)arg2;
