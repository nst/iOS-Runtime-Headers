...
- (id)didReceiveResponse:(void *)arg1; // needs 1 arg types, found 6: id, NSDictionary *, NSError *, void*, id, SEL
...
- (void)setDidReceiveResponse:(void *)arg1; // needs 1 arg types, found 7: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSDictionary *, NSError *, void*
