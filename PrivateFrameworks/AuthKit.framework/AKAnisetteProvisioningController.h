...
- (void)anisetteDataForURLRequest:(id)arg1 completion:(id)arg2;
- (void)anisetteDataWithCompletion:(id)arg1;
- (id)anisetteDataWithError:(id*)arg1;
- (void)dealloc;
- (void)eraseWithCompletion:(id)arg1;
...
- (void)provisionWithCompletion:(id)arg1;
- (void)syncWithSIMData:(id)arg1 completion:(id)arg2;
