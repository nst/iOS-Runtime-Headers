...
- (void)_writeDataFromInputStream:(id)arg1 length:(int)arg2 toPath:(id)arg3;
- (id)addDataFromInputStream:(id)arg1 length:(int)arg2 filenameHint:(id)arg3;
...
- (void)setDataFromInputStream:(id)arg1 length:(int)arg2 forIdentifier:(id)arg3;
