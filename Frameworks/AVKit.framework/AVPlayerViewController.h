...
@interface AVPlayerViewController : UIViewController <AVPictureInPictureControllerDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate> {
    ...
    unsigned int _allowsPictureInPicturePlayback;
    ...
    unsigned int _isHidingPlaybackControlsViewForPictureInPicturePlayback;
    ...
    unsigned int _playbackControlsViewControllerPictureInPictureButtonEnabled;
    ...
    unsigned int _transitionFromFullScreenOrDismissViewControllerWhenEnteringBackgroundAfterPictureInPictureStart;
    AVUnsupportedContentIndicatorView *_unsupportedContentIndicatorView;
    int _videoGravity;
    unsigned int _viewIsFullScreen;
}
