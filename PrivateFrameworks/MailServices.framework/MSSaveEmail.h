...
+ (void)placeholderAttachmentForFileName:(id)arg1 fileSize:(int)arg2 mimeType:(id)arg3 contentID:(id)arg4 completionBlock:(id /* block */)arg5;
...
+ (void)securityScopeForURL:(id)arg1 completionBlock:(id /* block */)arg2;
