...
- (void)_reallyExchangeData:(id)arg1 serverVersion:(int)arg2 qualityOfService:(long long)arg3 withCompletionHandler:(id)arg4;
- (void)_reallyProcessSignedData:(id)arg1 signature:(id)arg2 qualityOfService:(long long)arg3 withCompletionHandler:(id)arg4;
- (void)_reallySignData:(id)arg1 qualityOfService:(long long)arg2 withCompletionHandler:(id)arg3;
- (void)_renewMescalSessionForRequestLocked:(id)arg1 withCallback:(id)arg2;
- (void)_setUpWithCompletionHandler:(id)arg1;
- (void)_teardown;
- (void)_teardownLocked;
- (id)context;
- (void)dealloc;
- (void)exchangeData:(id)arg1 serverVersion:(int)arg2 qualityOfService:(long long)arg3 withCompletionHandler:(id)arg4;
- (id)init;
