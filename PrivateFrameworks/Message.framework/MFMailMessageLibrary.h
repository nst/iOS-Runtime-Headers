...
@class <MFMailMessageLibraryDelegate>, <MFMailboxPathProvider>, MFDbJournal, MFMailMessageLibraryMigrator, MFSQLiteConnectionPool, NSMutableSet, NSObject<OS_dispatch_queue>, NSString;
