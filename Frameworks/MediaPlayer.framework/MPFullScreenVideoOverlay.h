...
@class <MPVideoOverlayDelegate>, MPAVController, MPAVItem, MPCenteringNavigationBar, MPDetailSlider, MPNowPlayingItemQueueInfoButton, MPTransportControls, MPVideoViewController, UIImageView, UILabel, UINavigationBar, UINavigationButton, UINavigationItem, UIView;
