...
@property (readonly) int persistentID;

// Image: /System/Library/PrivateFrameworks/MusicLibrary.framework/MusicLibrary

+ (id)URLForEntityWithPersistentID:(int)arg1 libraryUID:(id)arg2;
+ (BOOL)_deleteRowForPersistentIDs:(const int*)arg1 count:(unsigned int)arg2 library:(id)arg3 table:(id)arg4 usingColumn:(id)arg5 usingConnection:(id)arg6;
+ (void)_didChangeValueForProperties:(id)arg1 inLibrary:(id)arg2;
+ (BOOL)_shouldIncrementRevisionForType:(int)arg1 persistentID:(int)arg2 usingConnection:(id)arg3;
...
+ (id)anyInLibrary:(id)arg1 predicate:(id)arg2 options:(int)arg3;
...
+ (BOOL)deleteFromLibrary:(id)arg1 deletionType:(int)arg2 persistentIDs:(const int*)arg3 count:(unsigned int)arg4 usingConnection:(id)arg5;
...
+ (id)entityURLScheme;
+ (void)enumeratePersistentIDsInLibrary:(id)arg1 afterRevision:(int)arg2 usingBlock:(id /* block */)arg3;
+ (void)enumeratePersistentIDsInLibrary:(id)arg1 matchingPredicate:(id)arg2 orderingTerms:(id)arg3 persistentIDs:(const int*)arg4 count:(unsigned int)arg5 options:(int)arg6 usingBlock:(id /* block */)arg7;
...
+ (BOOL)incrementRevisionForRevisionTypeContentWithConnection:(id)arg1 deletionType:(int)arg2 persistentIDs:(const int*)arg3 count:(unsigned int)arg4;
+ (BOOL)incrementRevisionForRevisionTypeContentWithLibrary:(id)arg1 deletionType:(int)arg2 persistentIDs:(id)arg3;
+ (BOOL)incrementRevisionWithLibrary:(id)arg1 persistentID:(int)arg2 deletionType:(int)arg3 revisionType:(int)arg4;
+ (BOOL)incrementRevisionWithLibrary:(id)arg1 persistentID:(int)arg2 deletionType:(int)arg3 revisionType:(int)arg4 usingConnection:(id)arg5;
+ (id)indexableSQLForProperties:(id)arg1;
+ (BOOL)insertValues:(id)arg1 intoTable:(id)arg2 persistentID:(int)arg3 connection:(id)arg4;
+ (BOOL)insertValues:(id)arg1 intoTable:(id)arg2 persistentID:(int)arg3 library:(id)arg4;
...
+ (id)newWithPersistentID:(int)arg1 inLibrary:(id)arg2;
...
+ (id)predicateIncludingSystemwidePredicatesWithPredicate:(id)arg1 library:(id)arg2 options:(int)arg3;
...
+ (id)queryWithLibrary:(id)arg1 predicate:(id)arg2 options:(int)arg3;
...
+ (id)queryWithLibrary:(id)arg1 predicate:(id)arg2 orderingTerms:(id)arg3 propertyToCount:(id)arg4 options:(int)arg5;
+ (id)queryWithLibrary:(id)arg1 predicate:(id)arg2 orderingTerms:(id)arg3 usingSections:(BOOL)arg4;
+ (id)queryWithLibrary:(id)arg1 predicate:(id)arg2 orderingTerms:(id)arg3 usingSections:(BOOL)arg4 options:(int)arg5;
+ (id)queryWithLibrary:(id)arg1 predicate:(id)arg2 usingSections:(BOOL)arg3;
+ (BOOL)removeFromMyLibrary:(id)arg1 deletionType:(int)arg2 persistentIDs:(const int*)arg3 count:(unsigned int)arg4;
...
- (id)initWithPersistentID:(int)arg1 inLibrary:(id)arg2;
