...
- (void)_alertForDownloadConstraintsWithCompletion:(id)arg1;
...
- (void)_reallyDownloadAndInstallAcceptingCellularFees:(bool)arg1 completion:(id)arg2;
...
- (void)presentTermsIfNecessaryCompletion:(id)arg1;
- (id)prettyNameForUpdate:(id)arg1;
- (id)prettyUpdateName;
- (id)progressString;
- (void)promptForDevicePasscodeCompletion:(id)arg1;
...
- (void)scanForUpdateCompletion:(id)arg1;
- (id)serverFlowStyle;
...
- (void)startDownloadWithHandler:(id)arg1;
- (void)startInstallWithHandler:(id)arg1;
- (int)state;
- (id)update;
