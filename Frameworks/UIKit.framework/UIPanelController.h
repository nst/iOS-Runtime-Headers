...
@property (setter=_setSnapshotView:, nonatomic, retain) UIView *_sourceSnapshotView;
...
- (void)_performWrappedUpdate:(id)arg1;
...
- (void)addWrapperBlockForNextUpdate:(id)arg1;
...
- (id)view;
- (void)viewWillTransitionToSize:(struct CGSize { double x1; double x2; })arg1 withTransitionCoordinator:(id)arg2 superBlock:(id)arg3;
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2 superBlock:(id)arg3;
