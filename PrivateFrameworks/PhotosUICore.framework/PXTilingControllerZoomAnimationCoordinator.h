...
- (void).cxx_destruct;
- (void)_animateTilesPassingTest:(id)arg1 forEndPointType:(long long)arg2 withZoomTransitionContext:(id)arg3 tileGeometryTransformer:(id)arg4;
- (void)_animateTilesPassingTest:(id)arg1 fromEndPointType:(long long)arg2 toEndPointType:(long long)arg3 alpha:(double)arg4 transform:(id)arg5 withOptions:(id)arg6 tileGeometryTransformer:(id)arg7 completionHandler:(id)arg8;
...
- (void)moveTile:(id)arg1 toView:(struct NSObject { Class x1; }*)arg2 restorationBlock:(out id*)arg3;
