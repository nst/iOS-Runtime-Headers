...
- (void).cxx_destruct;
- (id)_grayArtworkPlaceholderImageForSize:(struct CGSize { double x1; double x2; })arg1 scale:(float)arg2;
...
- (id)artworkPlaceholderImageForSize:(struct CGSize { double x1; double x2; })arg1 scale:(float)arg2;
