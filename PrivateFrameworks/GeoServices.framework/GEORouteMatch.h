...
@property (nonatomic, readonly) struct PolylineCoordinate { unsigned int x1; double x2; } routeCoordinate;
...
- (id)initWithRoute:(id)arg1 routeCoordinate:(struct PolylineCoordinate { unsigned int x1; double x2; })arg2 locationCoordinate:(struct { double x1; double x2; })arg3 stepIndex:(unsigned int)arg4 matchedCourse:(double)arg5 timestamp:(id)arg6;
...
- (void)updateWithMinRouteCoordinate:(struct PolylineCoordinate { unsigned int x1; double x2; })arg1;
