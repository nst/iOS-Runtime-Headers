...
+ (BOOL)_enumerateAssociationsWithPredicate:(id)arg1 excludedSyncStore:(id)arg2 syncAnchorRange:(struct HDSyncAnchorRange { int x1; int x2; })arg3 lastSyncAnchor:(int*)arg4 healthDatabase:(id)arg5 error:(id*)arg6 block:(id /* block */)arg7;
+ (id)_insertAssociationEntryWithAssociation:(id)arg1 object:(id)arg2 provenance:(int)arg3 database:(id)arg4 error:(id*)arg5;
+ (BOOL)_insertEntriesWithAssociationUUID:(id)arg1 objectUUIDsData:(id)arg2 provenance:(int)arg3 profile:(id)arg4 error:(id*)arg5;
...
+ (id)objectIDsForAssociationEntityWithPersistentID:(int)arg1 profile:(id)arg2 error:(id*)arg3;
