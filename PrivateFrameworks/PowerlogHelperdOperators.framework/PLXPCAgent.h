...
@interface PLXPCAgent : PLAgent {
    ...
    int  _peekpopProcessID;
    int  _popCount;
    PLXPCListenerOperatorComposition * _siriFalseAlarm;
    int  _spotlightAgentIndexOperationCount;
...
- (void)setSpotlightAgentIndexOperationCount:(int)arg1;
...
- (id)siriFalseAlarm;
- (int)spotlightAgentIndexOperationCount;
