...
+ (void)addPasses:(id)arg1 completion:(id /* block */)arg2;
+ (id)cacheIdentifier;
...
+ (void)sendData:(id)arg1 reply:(id /* block */)arg2;
...
- (void)receiveNativeComplicationRequest:(id)arg1 completion:(id /* block */)arg2;
