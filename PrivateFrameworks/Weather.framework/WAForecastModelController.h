...
- (id)_queue_executeFetchForCity:(id)arg1 completion:(id)arg2;
- (void)cancelAllFetchRequests;
- (id)completionHandlerQueue;
- (id)completionHandlersForCity;
- (bool)fetchForecastForCities:(id)arg1 completion:(id)arg2;
- (bool)fetchForecastForCity:(id)arg1 completion:(id)arg2;
