...
@interface UIToolbar : UIView <DebugHierarchyObject_Fallback, UIAccessibilityHUDGestureHosting, UIBarPositioning, UIGestureRecognizerDelegatePrivate, _UIBarPositioningInternal> {
