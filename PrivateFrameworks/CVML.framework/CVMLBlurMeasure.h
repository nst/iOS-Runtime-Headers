...
+ (BOOL)computeBlurScore:(float*)arg1 onGrayscaleImage:(struct __CVBuffer { }*)arg2 andWithRegionOfInterestInImageCoordinates:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg3 andRegionOfInterestInsetFactor:(float)arg4 error:(id*)arg5;
+ (BOOL)computeBlurScore:(float*)arg1 onGrayscaleImage:(struct __CVBuffer { }*)arg2 insetFactor:(float)arg3 error:(id*)arg4;
+ (BOOL)computeBlurScore:(float*)arg1 usingBlurSignature:(id)arg2 insetFactor:(float)arg3 imageROI:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg4 error:(id*)arg5;
