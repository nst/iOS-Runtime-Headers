...
@class <CNFDisplayControllerDelegate>, CNFAlertView, CNFHUDView, CNFInterfaceOverlayView, IMAVChat, IMAVChatParticipant, NSObject<CNFDisplayControllerDelegate>, NSString, NSTimer, TPAudioDeviceView, TPBottomBar, TPBottomDoubleButtonBar, TPBottomLockBar, TPBottomSingleButtonBar, TPLCDView, UIControl, UIImage, UIImageView, UILabel, UIView;
