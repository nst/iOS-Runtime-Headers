...
- (void)presentAddPassesControllerWithPasses:(id)arg1 completion:(id)arg2;
- (void)presentAudioRecorderControllerWithOutputURL:(id)arg1 preset:(long long)arg2 options:(id)arg3 completion:(id)arg4;
- (void)presentControllerWithName:(id)arg1 context:(id)arg2;
- (void)presentControllerWithNames:(id)arg1 contexts:(id)arg2;
- (void)presentMediaPlayerControllerWithURL:(id)arg1 options:(id)arg2 completion:(id)arg3;
- (void)presentTextInputControllerWithSuggestions:(id)arg1 allowedInputMode:(long long)arg2 completion:(id)arg3;
- (void)presentTextInputControllerWithSuggestionsForLanguage:(id)arg1 allowedInputMode:(long long)arg2 completion:(id)arg3;
- (id)properties;
