...
@property BOOL avoidRenderFeedback;
...
@property (nonatomic) BOOL disabledUpdates;
...
@property int lastRenderUpdateSequenceNumber;
...
- (id)recognizer;
- (id)replicatorView;
- (id)replicatorViewHeightConstraint;
...
- (void)setReplicatorViewHeightConstraint:(id)arg1;
...
- (id)visibleResultsInSection:(int)arg1;
