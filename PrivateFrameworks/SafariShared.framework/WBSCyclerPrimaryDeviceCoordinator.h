...
@interface WBSCyclerPrimaryDeviceCoordinator : NSObject {
    ...
    unsigned int  _expectedNumberOfSecondaryDevices;
...
- (void)_didReceiveData:(id)arg1 fromSecondaryDevice:(unsigned int)arg2;
...
- (id)delegate;
- (id)init;
- (void)sendData:(id)arg1 toSecondaryDevice:(unsigned int)arg2;
- (void)sendDataToAllSecondaryDevices:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)startCoordinatingWithExpectedNumberOfSecondaryDevices:(unsigned int)arg1 timeout:(double)arg2;
