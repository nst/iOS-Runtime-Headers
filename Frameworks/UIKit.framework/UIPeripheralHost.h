...
@class UIPeripheralHostView, UIKeyboardRotationState, UIResponder, UIPeripheralHostState, NSMutableArray, UIKeyboardAutomatic, UIInputViewSet, NSMutableSet, UIInputViewPostPinningReloadState, UIInputViewTransition;
