...
@class <AdSheetSessionDelegate>, ADDistributedMessagingCenter, ADLayerHostWindow, ADSRVBannerView, ADServerAccessCoordinator, ADStoryboardController, ADStoryboardTransitionWindow, CPDistributedMessagingCenter, NSMutableArray, NSString, NSTimer;
