...
- (int)_indexOfCellAtContentOffset:(struct CGPoint { double x1; double x2; })arg1 ofScrollView:(id)arg2;
...
- (struct CGPoint { double x1; double x2; })contentOffsetForIndexOfTickMark:(int)arg1 ofScrollView:(id)arg2;
- (id)dataSource;
- (void)dealloc;
