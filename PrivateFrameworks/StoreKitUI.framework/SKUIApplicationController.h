...
- (void)_setManifestURLOnUpdatableAssetController:(id)arg1 completion:(id)arg2;
...
- (void)showErrorViewWithTitle:(id)arg1 message:(id)arg2 buttonTitle:(id)arg3 buttonAction:(id)arg4;
...
- (void)updateTabBarWithItems:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
- (id)vendorIdentifier;
- (id)vendorStorage;
