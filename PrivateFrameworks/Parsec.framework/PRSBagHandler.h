...
@class <PRSSessionController>, CLInUseAssertion, CLLocation, CLLocationManager, NSArray, NSDictionary, NSError, NSMutableArray, NSMutableData, NSObject<OS_dispatch_queue>, NSSet, NSString, NSTimer, NSURL, NSURLSessionConfiguration, NSURLSessionDataTask, PRSFairPlaySAPSession, PRSSharedParsecSession;
...
@property(retain) NSTimer * guidTimer;
...
@property(readonly) NSArray * lookupEnabledDomains;
@property(readonly) NSString * lookupFirstUseDescription1;
@property(readonly) NSString * lookupFirstUseDescription2;
@property(readonly) NSString * lookupFirstUseLearnMore;
@property(readonly) int lookupMaximumQueryLength;
@property(readonly) int lookupMinimumQueryLength;
@property(readonly) int lookupSearchRenderTimeout;
@property(readonly) int maximumCachedQueryCount;
@property(readonly) int maximumCachedResultCount;
@property(retain) NSDictionary * mescalDict;
...
@property(readonly) int useSprite;
