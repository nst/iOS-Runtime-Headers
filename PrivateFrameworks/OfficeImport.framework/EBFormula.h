...
+ (void)readFormulaFromXlCell:(struct XlCell { int (**x1)(); unsigned short x2; short x3; short x4; int x5; double x6; struct XlString {} *x7; int x8; struct XlFormulaInfo {} *x9; boolx10; boolx11; boolx12; }*)arg1 edCell:(struct EDCellHeader { unsigned short x1; unsigned int x2; }*)arg2 edRowBlocks:(id)arg3 state:(id)arg4;
