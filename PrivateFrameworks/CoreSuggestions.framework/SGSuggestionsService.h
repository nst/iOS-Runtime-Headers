...
- (void).cxx_destruct;
- (void)_addSearchableItemMetadata:(id)arg1 htmlData:(id)arg2 completion:(id)arg3;
- (id)_remoteSuggestionManager;
- (bool)addInteractions:(id)arg1 bundleId:(id)arg2 error:(id*)arg3;
- (void)addInteractions:(id)arg1 bundleId:(id)arg2 withCompletion:(id)arg3;
- (bool)addSearchableItems:(id)arg1 error:(id*)arg2;
- (void)addSearchableItems:(id)arg1 withCompletion:(id)arg2;
...
- (void)confirmContactDetailRecord:(id)arg1 withCompletion:(id)arg2;
...
- (void)confirmEventByRecordId:(id)arg1 withCompletion:(id)arg2;
- (bool)confirmRecord:(id)arg1 error:(id*)arg2;
- (void)confirmRecord:(id)arg1 withCompletion:(id)arg2;
...
- (void)eventFromUniqueId:(id)arg1 withCompletion:(id)arg2;
- (void)eventsForSchemas:(id)arg1 usingStore:(id)arg2 completion:(id)arg3;
...
- (void)keysForSchemas:(id)arg1 completion:(id)arg2;
...
- (void)originFromRecordId:(id)arg1 withCompletion:(id)arg2;
...
- (id)registerContactsChangeObserver:(id)arg1;
- (id)registerEventsChangeObserver:(id)arg1;
...
- (void)rejectContactDetailRecord:(id)arg1 withCompletion:(id)arg2;
...
- (void)rejectEventByRecordId:(id)arg1 withCompletion:(id)arg2;
- (bool)rejectRecord:(id)arg1 error:(id*)arg2;
- (void)rejectRecord:(id)arg1 withCompletion:(id)arg2;
...
- (void)waitForEventWithIdentifier:(id)arg1 toAppearInEventStoreWithCompletion:(id)arg2;
