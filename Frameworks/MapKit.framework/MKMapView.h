...
@interface MKMapView : UIView <GEOLogContextDelegate, GEOResourceManifestTileGroupObserver, MKAnnotationContainerViewDelegate, MKAnnotationManagerDelegate, MKAnnotationMarkerContainer, MKMapGestureControllerDelegate, MKOverlayContainerViewDelegate, MKVariableDelayTapRecognizerDelegate, NSCoding, UIGestureRecognizerDelegate, VKMapViewDelegate> {
    ...
    UIView * _contentView;
    unsigned int  _currentFlyoverAnimationID;
...
@property (getter=_currentFlyoverAnimationID, setter=_setCurrentFlyoverAnimationID:, nonatomic) unsigned int currentFlyoverAnimationID;
...
+ (struct { struct CLLocationCoordinate2D { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })_regionThatFitsMapType:(unsigned int)arg1 viewSize:(struct CGSize { double x1; double x2; })arg2 viewInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg3 edgePadding:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg4 region:(struct { struct CLLocationCoordinate2D { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg5 minZoomLevel:(float)arg6 maxZoomLevel:(float)arg7 snapToZoomLevel:(BOOL)arg8;
+ (unsigned int)minZoomLevelForMapType:(unsigned int)arg1 viewSize:(struct CGSize { double x1; double x2; })arg2;
+ (struct { struct CLLocationCoordinate2D { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })regionThatFitsMapType:(unsigned int)arg1 viewSize:(struct CGSize { double x1; double x2; })arg2 edgeInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg3 region:(struct { struct CLLocationCoordinate2D { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg4;
...
- (double)_distanceFromPoint:(struct CGPoint { double x1; double x2; })arg1 toPoint:(struct CGPoint { double x1; double x2; })arg2 fromView:(id)arg3 withPrecision:(int)arg4;
...
- (void)_selectTransitLineMarkerWithFeatureID:(unsigned int)arg1;
...
- (void)_setCurrentFlyoverAnimationID:(unsigned int)arg1;
...
- (void)_startFlyoverTourAnimation:(unsigned int)arg1 duration:(double)arg2 completion:(id /* block */)arg3;
...
- (id)_transitLineMarkerForFeatureID:(unsigned int)arg1;
...
- (struct { double x1; struct CLLocationCoordinate2D { double x_2_1_1; double x_2_1_2; } x2; })_zoomRegionForMapRect:(struct { struct { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg1 edgePadding:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2 maxZoomLevel:(int)arg3 minZoomLevel:(int)arg4;
- (float)_zoomScale;
...
- (struct CGPoint { double x1; double x2; })gestureController:(id)arg1 focusPointForPoint:(struct CGPoint { double x1; double x2; })arg2 gestureKind:(int)arg3;
