...
- (void).cxx_destruct;
- (void)_composeReviewViewControllerDidFinish:(id)arg1 result:(unsigned int)arg2;
- (void)_finishWithResult:(unsigned int)arg1 error:(id)arg2;
...
- (void)_submitRating:(int)arg1 completion:(id /* block */)arg2;
- (id /* block */)completion;
