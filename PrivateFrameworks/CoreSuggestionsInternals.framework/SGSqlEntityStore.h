...
- (int)_popQueuedSerializedContactId;
...
- (void)_selectAuthoritativeDetailsForContactWithId:(int)arg1;
- (BOOL)_shouldContinueReindex:(int)arg1;
- (void)_slowCopyFromTable:(id)arg1 toTable:(id)arg2 startingAtEntityId:(unsigned int)arg3;
...
- (void)_writeEntityParentageFor:(id)arg1 entityId:(int)arg2;
- (void)_writeEntityToSnippetsDb:(id)arg1;
- (void)_writeEventEntityToJournal:(id)arg1;
- (void)_writeFTSTermsForEntity:(id)arg1 entityId:(int)arg2;
- (int)_writeGenericExtractionEntityToDb:(id)arg1;
- (void)_writeLabeledBlobs:(id)arg1 isDelete:(BOOL)arg2;
- (void)_writeMergeBlobSnapshotForAnalysis:(id)arg1;
- (int)_writeMessageEntityToDb:(id)arg1;
- (void)_writeMessageEntityToSnippetsDb:(id)arg1;
- (int)_writeOneEntityToDb:(id)arg1;
...
- (void)deleteAllCNContactMatchesForEntityID:(int)arg1;
...
- (void)deleteSerializedContactForId:(int)arg1;
...
- (id)loadCNContactMatchesForContact:(id)arg1 andGetMaxEntityId:(int*)arg2;
...
- (id)loadEntitiesByEntityKey:(id)arg1 entityType:(int)arg2 resolveDuplicates:(id /* block */)arg3;
...
- (void)pruneLostMessagesWithSource:(id)arg1 count:(unsigned int)arg2;
...
- (id)suggestContactByMasterEntityId:(int)arg1;
...
- (void)writeCNContactMatchAndUpdateSetForContact:(id)arg1 withMatches:(id)arg2 andMaxEntityID:(int)arg3;
- (void)writeCNContactMatchForContact:(id)arg1 withMatches:(id)arg2 andMaxEntityID:(int)arg3;
- (int)writeEntity:(id)arg1;
- (int)writeEntity:(id)arg1 withSpotlightReferenceForBundleIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 domainIdentifier:(id)arg4;
...
- (void)writeSerializedContactPlaceholder:(int)arg1;
