...
- (void)_saveVisits:(id)arg1 tombstones:(id)arg2 toCloudHistoryBypassingThrottler:(bool)arg3 longLivedOperationPersistenceCompletion:(id)arg4 withCallback:(id)arg5;
...
- (id)initWithConfiguration:(id)arg1 completionBlock:(id)arg2;
