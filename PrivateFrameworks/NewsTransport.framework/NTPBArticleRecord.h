...
- (void)addTopicFlags:(unsigned int)arg1;
...
- (void)setThumbnailFocalFrame:(int)arg1;
- (void)setThumbnailHQMetadata:(int)arg1;
- (void)setThumbnailHQURL:(id)arg1;
- (void)setThumbnailLQMetadata:(int)arg1;
- (void)setThumbnailLQURL:(id)arg1;
- (void)setThumbnailMediumMetadata:(int)arg1;
- (void)setThumbnailMediumURL:(id)arg1;
- (void)setThumbnailMetadata:(int)arg1;
- (void)setThumbnailURL:(id)arg1;
- (void)setThumbnailUltraHQMetadata:(int)arg1;
- (void)setThumbnailUltraHQURL:(id)arg1;
- (void)setThumbnailWidgetHQMetadata:(int)arg1;
- (void)setThumbnailWidgetHQTaggedURL:(id)arg1;
- (void)setThumbnailWidgetHQURL:(id)arg1;
- (void)setThumbnailWidgetLQMetadata:(int)arg1;
- (void)setThumbnailWidgetLQTaggedURL:(id)arg1;
- (void)setThumbnailWidgetLQURL:(id)arg1;
- (void)setThumbnailWidgetMetadata:(int)arg1;
- (void)setThumbnailWidgetTaggedURL:(id)arg1;
- (void)setThumbnailWidgetURL:(id)arg1;
- (void)setTitle:(id)arg1;
- (void)setTopicFlags:(unsigned int*)arg1 count:(unsigned int)arg2;
...
- (int)storyType;
- (id)subtitle;
- (int)thumbnailFocalFrame;
- (int)thumbnailHQMetadata;
- (id)thumbnailHQURL;
- (int)thumbnailLQMetadata;
- (id)thumbnailLQURL;
- (int)thumbnailMediumMetadata;
- (id)thumbnailMediumURL;
- (int)thumbnailMetadata;
- (id)thumbnailURL;
- (int)thumbnailUltraHQMetadata;
- (id)thumbnailUltraHQURL;
- (int)thumbnailWidgetHQMetadata;
- (id)thumbnailWidgetHQTaggedURL;
- (id)thumbnailWidgetHQURL;
- (int)thumbnailWidgetLQMetadata;
- (id)thumbnailWidgetLQTaggedURL;
- (id)thumbnailWidgetLQURL;
- (int)thumbnailWidgetMetadata;
- (id)thumbnailWidgetTaggedURL;
- (id)thumbnailWidgetURL;
- (id)title;
- (unsigned int*)topicFlags;
- (unsigned int)topicFlagsAtIndex:(unsigned int)arg1;
