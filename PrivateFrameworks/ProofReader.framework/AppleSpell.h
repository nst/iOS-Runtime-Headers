...
- (unsigned long long)_contextLengthForRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 language:(id)arg2 tagger:(id)arg3 taggerIndex:(unsigned long long)arg4 languageModel:(void*)arg5 maxContextLength:(unsigned long long)arg6 context:(unsigned int*)arg7 cleanOffset:(unsigned long long*)arg8;
...
- (bool)_findMatchingRangesForRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 inString:(id)arg2 keyEventArray:(id)arg3 endingAtIndex:(unsigned long long)arg4 matchingStringRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg5 correctableStringRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg6 matchingKeyEventRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg7 lastMisspelledKeyEventIndex:(unsigned long long*)arg8 previousBackspaceCount:(unsigned long long*)arg9;
...
- (id)spellServer:(id)arg1 suggestCompletionsForKoreanPartialWordRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 inString:(id)arg3 options:(id)arg4;
