...
- (void)populateFeaturesWithEvaluator:(id)arg1 updatingBundleFeatures:(float*)arg2 withContext:(struct prs_feature_population_ctx_t { struct __CFArray {} *x1; struct __CFArray {} *x2; struct __CFArray {} *x3; unsigned char x4; double x5[28]; double x6; double x7; double x8; double x9; unsigned int x10; unsigned long long x11; unsigned long long x12; long long x13; unsigned long long x14; }*)arg3 fuzzyEvaluator:(id)arg4;
- (void)populateMailFeatures;
- (void)populateOtherFeatures;
- (void)populateTextFeatureValuesForProperty:(id)arg1 updatingBundleFeatureValues:(id)arg2 withEvaluator:(id)arg3 withContext:(struct prs_feature_population_ctx_t { struct __CFArray {} *x1; struct __CFArray {} *x2; struct __CFArray {} *x3; unsigned char x4; double x5[28]; double x6; double x7; double x8; double x9; unsigned int x10; unsigned long long x11; unsigned long long x12; long long x13; unsigned long long x14; }*)arg4 fuzzyEvaluator:(id)arg5 propertyCanFuzzyMatch:(bool)arg6;
- (float)quality_score;
- (float)rawScore;
- (float)score;
