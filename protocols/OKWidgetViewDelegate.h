...
- (void)evaluateScript:(void *)arg1 withInfoDictionary:(void *)arg2 andCompletionBlock:(void *)arg3 forWidgetView:(void *)arg4; // needs 4 arg types, found 8: NSString *, NSDictionary *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, id, OKWidgetView *
