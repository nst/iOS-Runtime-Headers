...
+ (id)_databaseTable;
+ (struct _HDDeleteObjectDataDefn { BOOL x1; int x2; int x3; int x4; })_deleteInfoForObjectWithUUID:(id)arg1 database:(id)arg2 error:(id*)arg3;
...
+ (id)_primitiveInsertDataObject:(id)arg1 entityClass:(Class)arg2 provenanceEntityID:(int)arg3 profile:(id)arg4 database:(id)arg5 error:(id*)arg6;
+ (BOOL)_removeObjectWithPersistentID:(int)arg1 database:(id)arg2 error:(id*)arg3;
