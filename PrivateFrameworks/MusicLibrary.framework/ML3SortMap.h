...
@interface ML3SortMap : NSObject {
    ...
    BOOL  _preloadNames;
    int  _smallestNameDelta;
}

- (void).cxx_destruct;
- (BOOL)_insertSortedNameEntriesIntoSortMap:(id)arg1;
- (int)_maxNameOrderForSortMapEntry:(id)arg1 iPhoneSortKeyBuilder:(struct iPhoneSortKeyBuilder { }*)arg2;
- (id)_maxSortKeyForEntry:(id)arg1 iPhoneSortKeyBuilder:(struct iPhoneSortKeyBuilder { }*)arg2;
- (int)_minNameOrderForSortMapEntry:(id)arg1 iPhoneSortKeyBuilder:(struct iPhoneSortKeyBuilder { }*)arg2;
- (id)_minSortKeyForEntry:(id)arg1 iPhoneSortKeyBuilder:(struct iPhoneSortKeyBuilder { }*)arg2;
- (int)_sortKeyDistance:(id)arg1 sortKey2:(id)arg2 offset:(unsigned int)arg3;
