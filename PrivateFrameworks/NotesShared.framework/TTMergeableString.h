...
- (void)moveRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1 toIndex:(unsigned int)arg2;
...
- (void)updateTimestampsInRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1;
