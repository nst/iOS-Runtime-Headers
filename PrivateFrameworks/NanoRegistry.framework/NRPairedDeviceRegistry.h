...
- (void)_getActiveDeviceAssertionsWithInlineBlock:(id)arg1;
- (id)_getChangeHistory;
- (id)_getClientInfo;
- (id)_getLocalDeviceCollection;
- (id)_getSecureProperties:(id)arg1;
- (void)_getSwitchEventsFromIndex:(unsigned int)arg1 toIndex:(unsigned int)arg2 inlineCallback:(id)arg3;
- (void)_invalidateActiveDeviceAssertionWithIdentifier:(id)arg1;
- (void)_pairingStorePathPairingID:(id)arg1;
- (void)_pingActiveGizmoWithPriority:(long long)arg1 withMessageSize:(unsigned long long)arg2 withBlock:(id)arg3;
...
- (id)clientQueue;
- (void)companionOOBDiscoverAndPairWithName:(id)arg1 withOutOfBandPairingKey:(id)arg2 withOptions:(id)arg3 operationHasBegun:(id)arg4;
- (void)companionPasscodePairWithDevice:(id)arg1 withOptions:(id)arg2 operationHasBegun:(id)arg3;
...
- (id)getAllDevices;
- (id)getDevices;
- (id)getDevicesMatching:(id)arg1;
- (void)getDevicesWithBlock:(id)arg1;
- (id)getPairedDevices;
- (void)getSwitchEventsFromIndex:(unsigned int)arg1 inlineCallback:(id)arg2;
...
- (void)pairWithSimulator:(id)arg1 withQueue:(id)arg2 withCompletion:(id)arg3;
...
- (int)registerNotifyTokenWithName:(id)arg1 withBlock:(id)arg2;
- (int)registerNotifyTokenWithName:(id)arg1 withQueue:(id)arg2 withBlock:(id)arg3;
...
- (void)setActivePairedDevice:(id)arg1 isMagicSwitch:(bool)arg2 operationHasCompleted:(id)arg3;
- (void)setActivePairedDevice:(id)arg1 operationHasCompleted:(id)arg2;
- (void)setActivePairedDevice:(id)arg1 withActiveDeviceAssertionHandler:(id)arg2;
...
- (void)switchToSimulator:(id)arg1 withQueue:(id)arg2 withCompletion:(id)arg3;
- (void)syncDevicesWithDevice:(id)arg1;
- (void)transitionToCompatibilityState:(long long)arg1 withBlock:(id)arg2;
- (void)unpairWithDevice:(id)arg1 shouldObliterate:(bool)arg2 operationHasBegun:(id)arg3;
- (void)unpairWithDevice:(id)arg1 withOptions:(id)arg2 operationHasBegun:(id)arg3;
- (void)unpairWithSimulator:(id)arg1 withQueue:(id)arg2 withCompletion:(id)arg3;
- (void)updateDeviceCollectionWithQueue:(id)arg1 withCompletion:(id)arg2;
- (void)updateSecurePropertiesWithQueue:(id)arg1 withCompletion:(id)arg2;
