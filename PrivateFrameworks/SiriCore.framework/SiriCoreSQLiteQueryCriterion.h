...
+ (id)andQueryCriterionWithSubcriteriaProvider:(id)arg1;
...
+ (id)orQueryCriterionWithSubcriteriaProvider:(id)arg1;
...
- (id)initWithColumnName:(id)arg1 comparisonOperator:(long long)arg2 logicalOperator:(long long)arg3 value:(id)arg4 values:(id)arg5 subcriteriaProvider:(id)arg6;
