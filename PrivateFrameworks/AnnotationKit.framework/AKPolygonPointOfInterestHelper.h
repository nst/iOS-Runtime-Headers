...
+ (struct CGPoint { double x1; double x2; })_pointForPointsControlOfPolygonWithNumberOfPoints:(unsigned int)arg1 inAnnotation:(id)arg2 onPageController:(id)arg3;
+ (unsigned int)maxPolygonPoints;
+ (unsigned int)minPolygonPoints;
+ (unsigned int)numberOfPolygonPointsForControlPoint:(struct CGPoint { double x1; double x2; })arg1 inAnnotation:(id)arg2 onPageController:(id)arg3;
