...
- (void)_enableNotification:(bool)arg1 completionHandler:(id)arg2;
- (bool)_mergeWithNewObject:(id)arg1 operations:(id)arg2;
- (void)_readValueWithCompletionHandler:(id)arg1;
- (void)_updateAuthorizationData:(id)arg1 completionHandler:(id)arg2;
- (void)_updateValue:(id)arg1 updateTime:(id)arg2;
- (void)_writeValue:(id)arg1 completionHandler:(id)arg2;
