...
- (void)drawText:(id)arg1 atPoint:(struct CGPoint { double x1; double x2; })arg2 horizontalAlignment:(int)arg3 verticalAlignment:(int)arg4 textColor:(id)arg5 font:(id)arg6 clipToAxis:(BOOL)arg7;
