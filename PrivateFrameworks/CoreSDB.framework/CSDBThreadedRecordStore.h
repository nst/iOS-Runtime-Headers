...
- (void)setupDatabaseWithAllowLocalMigration:(BOOL)arg1 pathBlock:(id)arg2 setupStoreHandler:(int (*)())arg3 connectionInitializer:(int (*)())arg4 versionChecker:(int (*)())arg5 migrationHandler:(int (*)())arg6 schemaVersion:(int)arg7 registerBlock:(id)arg8;
