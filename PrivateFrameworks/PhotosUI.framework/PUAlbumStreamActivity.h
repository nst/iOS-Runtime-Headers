...
@class <PUAlbumStreamActivityDelegate>, NSObject<PLUserEditableAlbumProtocol>, PUActivityItemSourceController, PUPhotoStreamComposeServiceViewController, PUVideoTrimQueueController, UIViewController;
