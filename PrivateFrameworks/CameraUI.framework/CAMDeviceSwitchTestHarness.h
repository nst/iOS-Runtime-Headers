...
@interface CAMDeviceSwitchTestHarness : CAMModeAndDeviceConfigurationTestHarness {
    ...
    long long  _intermediateCaptureMode;
...
@property (nonatomic, readonly) long long intermediateCaptureMode;
...
- (id)initWithTestName:(id)arg1 viewfinderViewController:(id)arg2 devicePosition:(long long)arg3 testingAnimation:(bool)arg4 intermediateCaptureMode:(long long)arg5;
- (long long)intermediateCaptureMode;
