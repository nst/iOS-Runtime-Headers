...
@interface TSCECalculationEngine : TSPObject {
    ...
    boolmBlockingUntilRecalcIsComplete;
    boolmDirtyAllFormulasInDocumentDidLoad;
    boolmDirtyRandomVolatileFunctionsAtEndOfDirtyBatching;
    boolmShouldCancelRecalculationTask;
    boolmShouldRefillRecalcQueue;
