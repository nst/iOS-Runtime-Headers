...
- (struct ColorResult { BOOL x1; struct Color { double x_2_1_1; double x_2_1_2; double x_2_1_3; double x_2_1_4; } x2; })colorFromRedKey:(id)arg1 greenKey:(id)arg2 blueKey:(id)arg3;
- (struct Color { double x1; double x2; double x3; double x4; })colorFromRedKey:(id)arg1 greenKey:(id)arg2 blueKey:(id)arg3 defaultGray:(float)arg4;
- (void)dealloc;
...
- (struct Color { double x1; double x2; double x3; double x4; })makeGray:(float)arg1;
