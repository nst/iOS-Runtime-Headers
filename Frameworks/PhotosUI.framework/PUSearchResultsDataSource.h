...
- (void)setSearchString:(id)arg1 withCompletion:(id)arg2;
- (void)setSearchString:(id)arg1 withWildcardSearch:(bool)arg2 andEarlyNotifyOfResults:(id)arg3 andCompletion:(id)arg4;
