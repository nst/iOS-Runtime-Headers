...
- (void)drawAtPoint:(struct CGPoint { double x1; double x2; })arg1 withStyle:(id)arg2;
- (void)drawInRect:(struct CGRect { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withStyle:(id)arg2;
- (struct CGSize { double x1; double x2; })sizeWithStyle:(id)arg1 forWidth:(double)arg2;
- (id)wb$themedPath;
...
- (bool)_containsEmoji;
- (void)_enumerateEmojiTokensInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 block:(id)arg2;
- (bool)_isSingleEmoji;
...
+ (void)_lp_reverseEnumerateComponents:(id)arg1 usingBlock:(id)arg2;
...
- (void)enumerateContentLineRangesInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 usingBlock:(id)arg2;
- (void)enumerateParagraphsInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 usingBlock:(id)arg2;
...
- (void)_reverseEnumerateLongCharactersInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 usingBlock:(id)arg2;
- (bool)_shouldBePaddedWithSpaces;
- (id)_stringByApplyingTransform:(id)arg1;
- (id)_stringByComposingDiacriticsLogicalOrder:(bool)arg1 allowedCharacters:(id)arg2;
