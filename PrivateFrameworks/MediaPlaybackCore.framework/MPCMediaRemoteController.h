...
- (void)_sendLocalCommand:(unsigned int)arg1 options:(id)arg2 completion:(id /* block */)arg3;
- (void)_sendRemoteCommand:(unsigned int)arg1 options:(id)arg2 completion:(id /* block */)arg3;
