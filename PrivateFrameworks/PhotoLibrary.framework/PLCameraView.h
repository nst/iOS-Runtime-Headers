...
@class AVCaptureVideoPreviewLayer, CADisplayLink, CALayer, NSData, NSDictionary, NSMutableArray, NSString, NSTimer, PLCameraController, PLCameraElapsedTimeView, PLCameraFlashButton, PLCameraFloatingShutterButton, PLCameraFloatingShutterButtonView, PLCameraGuideView, PLCameraIrisAnimationView, PLCameraOptionsButton, PLCameraOverlayTextLabelView, PLCameraPanoramaView, PLCameraPreviewView, PLCameraProgressView, PLCameraSettingsView, PLCameraToggleButton, PLCameraVideoStillCaptureButton, PLCameraZoomSlider, PLCropOverlay, PLCropOverlayBottomBarButton, PLLowDiskSpaceAlertView, PLPhotoLibrary, PLPhotoTileViewController, PLPreviewOverlayView, PLVideoView, UIAlertView, UIImage, UIImageView, UILongPressGestureRecognizer, UITapGestureRecognizer, UIToolbar, UIView;
