...
- (id)handleFlowClosed:(unsigned int)arg1 withFallbackReason:(int)arg2 withFrameError:(unsigned int)arg3;
- (void)handleFlowUsedTunnel;
- (void)increaseWindowSizeForFlow:(unsigned int)arg1 byBytes:(unsigned int)arg2;
...
- (void)sendData:(id)arg1 toClientFlow:(unsigned int)arg2;
- (void)setConnectionInfo:(id)arg1;
- (void)setConnectionStartDate:(id)arg1;
- (void)setFlowFallbackReason:(int)arg1;
- (void)setFlowFallbackReason:(unsigned int)arg1 withReason:(int)arg2;
