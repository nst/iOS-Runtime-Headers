...
- (void).cxx_destruct;
- (id)ATR;
- (void)connectToEndpoint:(id)arg1 synchronous:(bool)arg2 reply:(id)arg3;
- (void)control:(id)arg1 data:(id)arg2 expectedLength:(unsigned int)arg3 reply:(id)arg4;
- (void)dealloc;
- (id)description;
...
- (long long)state;
- (id)synchronous:(bool)arg1 remoteSlotWithErrorHandler:(id)arg2;
