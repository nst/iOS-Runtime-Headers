...
- (unsigned int)_playbackIndexForDelta:(int)arg1 fromIndex:(unsigned int)arg2 ignoreElapsedTime:(BOOL)arg3 totalItemCount:(unsigned int)arg4 didReachEnd:(BOOL*)arg5;
...
- (void)_updateMaximumQueueDepthForItemIndex:(int)arg1 inQueueFeeder:(id)arg2;
