...
- (void)_checkForCanSendMailWithContinuation:(id)arg1;
...
- (void)_promptForMailDropIfNecessaryWithContinuation:(id)arg1;
...
- (void)handleMarkupURL:(id)arg1 attachment:(id)arg2 completion:(id)arg3;
...
- (void)securityScopeForURL:(id)arg1 withHandler:(id)arg2;
...
- (void)serializedPlaceholderForData:(id)arg1 fileName:(id)arg2 mimeType:(id)arg3 contentID:(id)arg4 withHandler:(id)arg5;
- (void)serializedPlaceholderForFileName:(id)arg1 fileSize:(long long)arg2 mimeType:(id)arg3 contentID:(id)arg4 withHandler:(id)arg5;
- (void)serializedPlaceholderForURL:(id)arg1 mimeType:(id)arg2 contentID:(id)arg3 withHandler:(id)arg4;
