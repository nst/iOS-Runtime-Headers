...
@interface UISearchController : UIViewController <DebugHierarchyObject_Fallback, NSCoding, UIViewControllerAnimatedTransitioning, UIViewControllerPresenting, UIViewControllerTransitioningDelegate, _UIScrollViewScrollObserver_Internal> {
