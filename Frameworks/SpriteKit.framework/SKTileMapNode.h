...
@interface SKTileMapNode : SKNode <NSCoding, NSCopying> {
    ...
    double  _isoColumnWidth;
    double  _isoHeightScalar;
    void _isoOrigin;
    double  _isoRowHeight;
    void _isoRowVector;
...
+ (id)tileMapNodeWithTileSet:(id)arg1 columns:(unsigned int)arg2 rows:(unsigned int)arg3 tileSize:(struct CGSize { double x1; double x2; })arg4;
+ (id)tileMapNodeWithTileSet:(id)arg1 columns:(unsigned int)arg2 rows:(unsigned int)arg3 tileSize:(struct CGSize { double x1; double x2; })arg4 fillWithTileGroup:(id)arg5;
+ (id)tileMapNodeWithTileSet:(id)arg1 columns:(unsigned int)arg2 rows:(unsigned int)arg3 tileSize:(struct CGSize { double x1; double x2; })arg4 tileGroupLayout:(id)arg5;
...
- (int)blendMode;
- (void)calculateSize;
- (struct CGPoint { double x1; double x2; })centerOfTileAtColumn:(unsigned int)arg1 row:(unsigned int)arg2;
...
- (id)initWithTileSet:(id)arg1 columns:(unsigned int)arg2 rows:(unsigned int)arg3 tileSize:(struct CGSize { double x1; double x2; })arg4;
- (id)initWithTileSet:(id)arg1 columns:(unsigned int)arg2 rows:(unsigned int)arg3 tileSize:(struct CGSize { double x1; double x2; })arg4 fillWithTileGroup:(id)arg5;
- (id)initWithTileSet:(id)arg1 columns:(unsigned int)arg2 rows:(unsigned int)arg3 tileSize:(struct CGSize { double x1; double x2; })arg4 tileGroupLayout:(id)arg5;
...
- (void)setStartData:(unsigned int)arg1 rows:(unsigned int)arg2 tileSize:(struct CGSize { double x1; double x2; })arg3 tileSet:(id)arg4;
...
- (unsigned int)tileColumnIndexFromPosition:(struct CGPoint { double x1; double x2; })arg1;
...
- (unsigned int)tileRowIndexFromPosition:(struct CGPoint { double x1; double x2; })arg1;
- (id)tileSet;
- (id)tileSetName;
...
+ (id)tileMapNodesWithTileSet:(id)arg1 columns:(unsigned int)arg2 rows:(unsigned int)arg3 tileSize:(struct CGSize { double x1; double x2; })arg4 fromNoiseMap:(id)arg5 tileTypeNoiseMapThresholds:(id)arg6;
