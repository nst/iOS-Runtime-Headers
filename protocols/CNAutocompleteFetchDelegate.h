...
- (bool)autocompleteFetch:(void *)arg1 shouldExpectSupplementalResultsForRequest:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 9: <CNCancelable> *, CNAutocompleteFetchRequest *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSArray *, NSError *, void*
...
- (id)resultComparatorForAutocompleteFetch:(void *)arg1; // needs 1 arg types, found 6: id, id, void*, id, SEL, <CNCancelable> *
