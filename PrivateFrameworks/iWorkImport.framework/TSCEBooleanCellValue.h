...
@interface TSCEBooleanCellValue : TSCECellValue {
    struct TSCEBooleanValue { int (**x1)(); bool x2; } *mBooleanValue;
}
...
- (void)dealloc;
- (id)displayString;
- (void)encodeToArchive:(struct BooleanCellValueArchive { int (**x1)(); struct UnknownFieldSet { struct vector<google::protobuf::UnknownField, std::__1::allocator<google::protobuf::UnknownField> > {} *x_2_1_1; } x2; bool x3; int x4; unsigned int x5[1]; }*)arg1;
...
- (id)initWithArchive:(const struct BooleanCellValueArchive { int (**x1)(); struct UnknownFieldSet { struct vector<google::protobuf::UnknownField, std::__1::allocator<google::protobuf::UnknownField> > {} *x_2_1_1; } x2; bool x3; int x4; unsigned int x5[1]; }*)arg1;
- (id)initWithBoolean:(BOOL)arg1;
- (id)initWithBooleanValue:(struct TSCEBooleanValue { int (**x1)(); bool x2; }*)arg1;
