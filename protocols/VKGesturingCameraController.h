...
- (void)zoom:(void *)arg1 withFocusPoint:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 7: double, struct CGPoint { double x1; double x2; }, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
