...
@property (setter=_setOnReadyToDisplayBlock:, nonatomic, copy) id _onReadyToDisplayBlock;
...
- (void)_setOnReadyToDisplayBlock:(id)arg1;
...
- (id)loadView;
- (id)loadedView;
- (void)notifyWhenReadyForDisplayWithTimeOut:(double)arg1 completionHandler:(id)arg2;
