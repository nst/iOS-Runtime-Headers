...
@interface BRCLocalItem : NSObject <BRCItem, BRCSyncThrottleItemProtocol> {
    ...
    unsigned int  _localDiffs;
    NSNumber * _minimumSupportedOSRowID;
    unsigned int  _notifsRank;
    BRCLocalItem * _orig;
    NSNumber * _ownerKey;
...
@property (nonatomic, readonly) unsigned int dbRowID;
...
@property (nonatomic, readonly) unsigned int localDiffs;
...
@property (nonatomic, readonly) unsigned int notifsRank;
...
- (id)_initWithServerItem:(id)arg1 dbRowID:(unsigned int)arg2;
- (BOOL)_insertInDB:(id)arg1 dbRowID:(unsigned int)arg2;
- (BOOL)_isInterestingUpdateForNotifs;
- (BOOL)_isInterestingUpdateForNotifsWithDiffs:(unsigned int)arg1;
...
- (void)_sendNotificationIfNeededWithDiffs:(unsigned int)arg1 regather:(BOOL)arg2;
...
- (id)appLibrary;
- (id)appLibraryID;
- (void)applyMetadataOnFileID:(unsigned int)arg1 liveFD:(unsigned int)arg2;
- (id)asBRAlias;
- (id)asDirectory;
- (id)asDocument;
- (id)asFSRoot;
...
- (unsigned int)dbRowID;
- (id)debugDescription;
- (id)description;
- (id)descriptionWithContext:(id)arg1;
- (unsigned int)diffAgainstLocalItem:(id)arg1;
- (unsigned int)diffAgainstOriginalItem;
...
- (void)markReserved;
- (void)markStagedWithFileID:(unsigned int)arg1 generationID:(unsigned int)arg2;
- (void)markStagedWithFileID:(unsigned int)arg1 generationID:(unsigned int)arg2 documentID:(unsigned int)arg3;
