...
- (void)_removeAllRecentContactsWithCompletion:(id)arg1;
...
- (void)_searchRecentsUsingQuery:(id)arg1 completion:(id)arg2;
...
- (void)performRecentsSearch:(id)arg1 operationQueue:(id)arg2 completion:(id)arg3;
