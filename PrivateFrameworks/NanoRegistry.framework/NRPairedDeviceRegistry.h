...
@property (nonatomic) BOOL shouldRestartDaemon;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *shouldRestartDaemonQueue;
...
- (void)_pingActiveGizmoWithPriority:(int)arg1 withBlock:(id /* block */)arg2;
...
- (void)setShouldRestartDaemonQueue:(id)arg1;
