...
- (void)fakeSetCECBusLinkStateAsync:(void *)arg1 linkState:(void *)arg2 physicalAddress:(void *)arg3 reply:(void *)arg4; // needs 4 arg types, found 9: CoreCECBus *, BOOL, unsigned int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
