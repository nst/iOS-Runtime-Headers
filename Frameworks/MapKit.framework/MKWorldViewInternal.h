...
@class <MKWorldViewDelegate>, MKUserLocation, MKUserLocationMarker, MKWorldAnnotationManager, MKWorldGestureController, NSTimer, UIGestureRecognizer, UIImageView, UILabel, UILongPressGestureRecognizer, UITapGestureRecognizer, UIView, VKAnnotationMarker, VKMapView, VKPuckAnimator;
