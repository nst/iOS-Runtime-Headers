...
@property(readonly) TSDDynamicOperationController * dynamicOperationController;
...
@property(readonly) TSDGuideStorage * guideStorage;
...
@property(readonly) TSDTrackerManipulatorCoordinator * tmCoordinator;
