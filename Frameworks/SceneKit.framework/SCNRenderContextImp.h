...
- (void)renderLight:(struct __C3DNode { }*)arg1 lightType:(long)arg2 lightData:(struct __C3DLightRuntimeData { unsigned int x1; float x2; union C3DMatrix4x4 { float x_3_1_1[16]; /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x_3_1_2[4]; } x3; }*)arg3;
