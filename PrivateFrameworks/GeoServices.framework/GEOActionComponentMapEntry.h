...
@property int actionComponent;
@property BOOL hasActionComponent;
@property(readonly) int* placeDataComponents;
@property(readonly) unsigned int placeDataComponentsCount;
