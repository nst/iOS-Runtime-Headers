...
@property (nonatomic) struct CGSize { double x1; double x2; } loadingIndicatorSize;
...
- (id)_displayTileTransformForItemAtIndexPath:(id)arg1 pageSize:(struct CGSize { double x1; double x2; })arg2 secondaryDisplayTransform:(id)arg3 options:(unsigned int)arg4;
- (void)_getLayoutRect:(out struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg1 transform:(out struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; }*)arg2 parallaxOffset:(out struct CGPoint { double x1; double x2; }*)arg3 forContentOfItemAtIndexPath:(id)arg4 options:(unsigned int)arg5;
...
- (struct CGSize { double x1; double x2; })loadingIndicatorSize;
- (id)parallaxComputer;
...
- (void)setLoadingIndicatorSize:(struct CGSize { double x1; double x2; })arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })visibleRectForItemAtIndexPath:(id)arg1 transitionProgress:(float)arg2;
