...
- (void)_inq_stashLocationValue:(int)arg1 forOrderedObjectWithID:(id)arg2 inSourceObjectID:(id)arg3 relationship:(id)arg4 atIndex:(unsigned int)arg5 usingStashDictionary:(id)arg6;
- (id)_locationsCache;
...
- (void)dealloc;
- (unsigned int)findIndexForAlbumWithID:(id)arg1 newOrderValue:(int)arg2 inFolderWithID:(id)arg3 hasOrderValueConflictWithAlbumID:(id*)arg4;
- (unsigned int)findIndexForAssetWithID:(id)arg1 newOrderValue:(int)arg2 inAlbumWithID:(id)arg3 hasOrderValueConflictWithAssetID:(id*)arg4;
- (void)getConflictResolutionOrderValuesForRelationship:(id)arg1 onObjectWithID:(id)arg2 atIndex:(unsigned int)arg3 intoLower:(int*)arg4 higher:(int*)arg5;
...
- (void)stashAlbumAssetsLocationValue:(int)arg1 forAssetWithID:(id)arg2 inAlbumWithID:(id)arg3 atIndex:(unsigned int)arg4;
- (void)stashFolderAlbumsLocationValue:(int)arg1 forAlbumWithID:(id)arg2 inFolderWithID:(id)arg3 atIndex:(unsigned int)arg4;
