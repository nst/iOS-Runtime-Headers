...
@interface EKCalendarChooser : UIViewController {
    ...
    bool_disableCalendarEditing;
    bool_showDetailAccessories;
    bool_showsDeclinedEventsSetting;
}
