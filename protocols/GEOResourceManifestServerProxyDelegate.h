...
- (oneway void)serverProxy:(void *)arg1 didChangeActiveTileGroup:(void *)arg2 finishedCallback:(void *)arg3; // needs 3 arg types, found 7: <GEOResourceManifestServerProxy> *, GEOActiveTileGroup *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
