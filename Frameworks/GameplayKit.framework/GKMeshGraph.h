...
- (void)setTriangulationMode:(unsigned int)arg1;
- (struct GKTriangle { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })triangleAtIndex:(unsigned int)arg1;
- (unsigned int)triangleCount;
- (void)triangulate;
- (unsigned int)triangulationMode;
