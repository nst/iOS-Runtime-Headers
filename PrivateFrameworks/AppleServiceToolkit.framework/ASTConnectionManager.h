...
- (void)dealloc;
- (id)delegate;
- (void)downloadAsset:(id)arg1 destinationFileURL:(id)arg2 sessionId:(id)arg3 completion:(id)arg4;
- (id)init;
- (id)networking;
- (id)postEnrollWithSerialNumber:(id)arg1;
- (void)postFileURL:(id)arg1 fileSequence:(id)arg2 totalFiles:(id)arg3 testId:(id)arg4 dataId:(id)arg5 sessionId:(id)arg6 completion:(id)arg7;
- (bool)postProfile:(id)arg1 sessionId:(id)arg2;
- (id)postRequest:(id)arg1 sessionId:(id)arg2;
- (void)postSessionExistsForSerialNumbers:(id)arg1 ticket:(id)arg2 timeout:(double)arg3 completion:(id)arg4;
- (void)postTestResult:(id)arg1 sessionId:(id)arg2 completion:(id)arg3;
