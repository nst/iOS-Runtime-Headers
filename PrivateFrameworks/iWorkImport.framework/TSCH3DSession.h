...
- (struct SessionLoadResourceResult { boolx1; boolx2; boolx3; id x4; id x5; })loadResource:(id)arg1 reload:(bool)arg2 withLoader:(id)arg3 config:(void*)arg4;
