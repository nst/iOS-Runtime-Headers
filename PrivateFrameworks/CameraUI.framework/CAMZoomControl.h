...
- (void).cxx_destruct;
- (float)_accelerationForMovementFromPointFromPoint:(struct CGPoint { double x1; double x2; })arg1 toPoint:(struct CGPoint { double x1; double x2; })arg2 elapsedTime:(double)arg3;
- (float)_additionalAccelerationForMovementFromPoint:(struct CGPoint { double x1; double x2; })arg1 toPoint:(struct CGPoint { double x1; double x2; })arg2 deltaX:(double)arg3;
- (id)_buttonMaskView;
- (void)_cancelDelayedZoomDialVisibilityChange;
- (float)_dampingFactorForDistanceFromDialForPoint:(struct CGPoint { double x1; double x2; })arg1;
- (float)_dampingFactorForMovementFromPoint:(struct CGPoint { double x1; double x2; })arg1 toPoint:(struct CGPoint { double x1; double x2; })arg2;
- (float)_dampingFactorForPerpendicularityFromPoint:(struct CGPoint { double x1; double x2; })arg1 toPoint:(struct CGPoint { double x1; double x2; })arg2;
- (id)_dialClippingView;
- (float)_distanceFromDialClippingViewToPoint:(struct CGPoint { double x1; double x2; })arg1;
