...
- (struct CGPoint { double x1; double x2; })gestureController:(MKMapGestureController *)arg1 focusPointForPoint:(struct CGPoint { double x1; double x2; })arg2 gestureKind:(int)arg3;
