...
- (void)setReadHandler:(id)arg1 maxDatagrams:(unsigned long long)arg2;
...
- (void)writeDatagram:(id)arg1 completionHandler:(id)arg2;
- (void)writeMultipleDatagrams:(id)arg1 completionHandler:(id)arg2;
