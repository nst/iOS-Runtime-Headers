...
- (id)initWithAttachment:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 scale:(float)arg3 cache:(id)arg4 cacheKey:(id)arg5 processingBlock:(id /* block */)arg6 completionBlock:(id /* block */)arg7 fallbackBlock:(id /* block */)arg8;
- (BOOL)isMovie;
- (void)main;
- (id)mediaURL;
