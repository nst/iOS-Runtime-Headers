...
@property (copy) id dnsResolverCompletionHandler;
...
@property (copy) id startTunnelCompletionHandler;
...
- (void)resolveServerAddressIfNeeded:(id)arg1;
- (id)resolver;
...
- (void)setTunnelNetworkSettings:(id)arg1 completionHandler:(id)arg2;
- (void)setVirtualInterface:(struct NEVirtualInterface_s { }*)arg1;
- (void)startCompleteOrCancelTunnelWithError:(id)arg1;
- (void)startIKEv2TunnelWithOptions:(id)arg1 completionHandler:(id)arg2;
- (void)startRekeyTimer:(bool)arg1;
- (id)startTunnelCompletionHandler;
- (void)startTunnelWithOptions:(id)arg1 completionHandler:(id)arg2;
- (void)stopIKEv2TunnelWithReason:(long long)arg1 completionHandler:(id)arg2;
- (void)stopTunnelWithReason:(long long)arg1 completionHandler:(id)arg2;
- (bool)stopped;
