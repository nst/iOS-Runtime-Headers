...
+ (id)resourceForType:(int)arg1 fromAsset:(id)arg2 usingLibrary:(id)arg3;
...
- (id)description;
- (id)fileReservation;
- (id)initWithResourceType:(int)arg1 fromAsset:(id)arg2 managedAsset:(id)arg3 usingLibrary:(id)arg4;
