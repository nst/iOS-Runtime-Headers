...
+ (bool)_insertDataObject:(id)arg1 provenance:(id)arg2 creationDateSetter:(id)arg3 profile:(id)arg4 database:(id)arg5 insertedEntityID:(id*)arg6 error:(id*)arg7;
...
+ (id)databaseTable;
+ (void)deleteDataObjects:(id)arg1 restrictedSourceEntity:(id)arg2 failIfNotFound:(bool)arg3 profile:(id)arg4 recursiveDeleteAuthorizationBlock:(id)arg5 completionHandler:(id)arg6;
...
+ (bool)enumerateAssociatedObjectsForIdentifier:(long long)arg1 inDatabase:(id)arg2 error:(id*)arg3 associatedObjectHandler:(id)arg4;
+ (bool)generateSyncObjectsForStore:(id)arg1 predicate:(id)arg2 syncAnchorRange:(struct HDSyncAnchorRange { long long x1; long long x2; })arg3 maxEncodedBytesPerMessage:(long long)arg4 profile:(id)arg5 error:(id*)arg6 handler:(id)arg7;
...
+ (void)insertDataObjects:(id)arg1 withProvenance:(id)arg2 creationDate:(double)arg3 profile:(id)arg4 skipInsertionFilter:(bool)arg5 completionHandler:(id)arg6;
+ (bool)isBackedByTable;
+ (id)joinClausesForProperty:(id)arg1;
+ (bool)journalObjects:(id)arg1 withProvenance:(id)arg2 creationDate:(double)arg3 profile:(id)arg4 error:(id*)arg5;
+ (id)mergeDataObject:(id)arg1 provenance:(id)arg2 database:(id)arg3 error:(id*)arg4 insertHandler:(id)arg5;
