...
- (void)cameraControllerRemoteShutter:(CMKCaptureController *)arg1 setFlashMode:(int)arg2;
...
- (void)cameraControllerRemoteShutterPressed:(CMKCaptureController *)arg1 countdown:(unsigned int)arg2;
