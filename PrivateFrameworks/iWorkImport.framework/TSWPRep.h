...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })caretRectForCharIndex:(unsigned int)arg1 caretAffinity:(int)arg2;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })caretRectForCharIndex:(unsigned int)arg1 leadingEdge:(BOOL)arg2 caretAffinity:(int)arg3;
...
- (unsigned int)charIndexForPointWithPinning:(struct CGPoint { double x1; double x2; })arg1;
- (unsigned int)charIndexForPointWithPinning:(struct CGPoint { double x1; double x2; })arg1 isTail:(BOOL)arg2 selectionType:(int)arg3;
- (unsigned int)charIndexFromPoint:(struct CGPoint { double x1; double x2; })arg1 allowPastBreak:(BOOL)arg2 allowNotFound:(BOOL)arg3 isAtEndOfLine:(BOOL*)arg4 leadingEdge:(BOOL*)arg5;
- (unsigned int)charIndexFromPoint:(struct CGPoint { double x1; double x2; })arg1 allowPastBreak:(BOOL)arg2 allowNotFound:(BOOL)arg3 pastCenterGoesToNextChar:(BOOL)arg4 isAtEndOfLine:(BOOL*)arg5 leadingEdge:(BOOL*)arg6;
- (unsigned int)charIndexFromPoint:(struct CGPoint { double x1; double x2; })arg1 allowPastBreak:(BOOL)arg2 isAtEndOfLine:(BOOL*)arg3;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })labelRectForCharIndex:(unsigned int)arg1;
- (id)lastSelection;
- (Class)layerClass;
- (id)layout;
- (struct { struct CGRect { struct CGPoint { double x_1_2_1; double x_1_2_2; } x_1_1_1; struct CGSize { double x_2_2_1; double x_2_2_2; } x_1_1_2; } x1; double x2; double x3; double x4; double x5; })lineMetricsAtCharIndex:(unsigned int)arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })p_convertNaturalRectToRotated:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 repAngle:(float)arg2;
...
- (void)willBeRemoved;
- (struct { struct CGRect { struct CGPoint { double x_1_2_1; double x_1_2_2; } x_1_1_1; struct CGSize { double x_2_2_1; double x_2_2_2; } x_1_1_2; } x1; double x2; double x3; double x4; double x5; BOOL x6; })wordMetricsAtCharIndex:(unsigned int)arg1;
