...
- (void)_handleUnlockDeviceCommand:(id)arg1 completion:(id)arg2;
...
- (void)resultDidChangeForAceCommand:(id)arg1 completion:(id)arg2;
- (void)rollbackClearContext;
- (id)safeWrapResponseCompletion:(id)arg1;
