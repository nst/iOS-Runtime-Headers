...
- (void).cxx_destruct;
- (void)_authenticateForNote:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(struct UIWindow { Class x1; }*)arg3 completionHandler:(id)arg4;
- (void)_recursivelyAuthenticateForNotes:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(struct UIWindow { Class x1; }*)arg3 completionHandler:(id)arg4;
- (void)authenticateForDeletingNotes:(id)arg1 displayWindow:(struct UIWindow { Class x1; }*)arg2 completionHandler:(id)arg3;
- (void)authenticateForNote:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(struct UIWindow { Class x1; }*)arg3 completionHandler:(id)arg4;
- (void)authenticateForNotes:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(struct UIWindow { Class x1; }*)arg3 completionHandler:(id)arg4;
- (void)authenticateIfNecessaryForDeletingNotes:(id)arg1 displayWindow:(struct UIWindow { Class x1; }*)arg2 completionHandler:(id)arg3;
- (void)authenticatePasswordForDeletingNotes:(id)arg1 displayWindow:(struct UIWindow { Class x1; }*)arg2 completionHandler:(id)arg3;
...
- (void)showPasswordEntrySheetWithIntent:(unsigned long long)arg1 note:(id)arg2 displayWindow:(struct UIWindow { Class x1; }*)arg3 completionHandler:(id)arg4;
- (void)showPasswordSetUpSheetForAccount:(id)arg1 displayWindow:(struct UIWindow { Class x1; }*)arg2 completionHandler:(id)arg3;
