...
- (void)createGridViewControllerWithAssets:(id)arg1 withTitle:(id)arg2 hideTabBar:(bool)arg3 hideSearch:(bool)arg4 containerViewController:(id)arg5 navigationItemDelegate:(id)arg6 andCompletion:(id)arg7;
