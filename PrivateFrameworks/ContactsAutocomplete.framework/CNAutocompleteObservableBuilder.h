...
@interface CNAutocompleteObservableBuilder : NSObject <CNAutocompleteObservableBuilder> {
    ...
    id  _networkActivityDidStartHandler;
    id  _networkActivityDidStopHandler;
...
@property (nonatomic, copy) id networkActivityDidStartHandler;
@property (nonatomic, copy) id networkActivityDidStopHandler;
...
- (void)addDuetObservable:(id)arg1 doOnTimeout:(id)arg2;
...
- (id)probeObservable:(id)arg1 forPerformanceWithBlock:(id)arg2;
- (id)probeProvider;
- (id)scheduler;
