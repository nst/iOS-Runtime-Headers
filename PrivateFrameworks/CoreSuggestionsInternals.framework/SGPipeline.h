...
- (id)storeOperation:(id)arg1 spotlightBundleIdentifier:(id)arg2 spotlightUniqueIdentifier:(id)arg3 spotlightDomainIdentifier:(id)arg4 withStore:(id)arg5 dependencies:(id)arg6 isReprocessing:(BOOL)arg7 originalEnrichmentCount:(unsigned int)arg8;
- (id)storeOperation:(id)arg1 withStore:(id)arg2 dependencies:(id)arg3;
- (id)storeOperation:(id)arg1 withStore:(id)arg2 dependencies:(id)arg3 isReprocessing:(BOOL)arg4 originalEnrichmentCount:(unsigned int)arg5;
