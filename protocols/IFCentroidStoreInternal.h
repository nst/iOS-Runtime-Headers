...
- (void)enumerateStateWithBlock:(void *)arg1; // needs 1 arg types, found 10: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, IFFeature *, unsigned long long, NSDictionary *, id*, bool, void*
