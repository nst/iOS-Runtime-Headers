...
- (id)payloads;
- (id)peerDevice;
- (bool)requestPayloadWithCompletionHandler:(id)arg1;
- (bool)requestPayloadWithCompletionHandlerEvenIfClean:(bool)arg1 withCompletionHandler:(id)arg2;
...
- (id)uuid;
- (id)wasContinuedInfo;
- (bool)wasResumedOnAnotherDeviceWithCompletionHandler:(id)arg1;
- (id)webpageURL;
- (id)when;
