...
@class <MKPlaceHeaderViewDelegate>, MKDistanceDetailProvider, MKMapItem, MKPlaceHeaderBackgroundView, MKStarRatingView, NSArray, NSLayoutConstraint, NSMutableArray, NSString, UIFont, UIImageView, UIView;
...
@property(readonly) UIFont * subtitleFont;
