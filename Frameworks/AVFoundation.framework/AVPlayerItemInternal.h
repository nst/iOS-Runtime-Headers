...
@class AVAsset, AVAudioMix, AVPlayerConnection, AVPlayerItem, AVPropertyStorage, AVVideoComposition, AVWeakReference, NSArray, NSDictionary, NSError, NSMutableArray, NSURL;
