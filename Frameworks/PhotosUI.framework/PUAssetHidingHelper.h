...
- (id)alertControllerForTogglingAssetsVisibilityWithCompletionHandler:(id)arg1;
- (void)applyHiddenState:(bool)arg1 completionHandler:(id)arg2;
- (id)assets;
- (id)attemptTogglingAssetsVisibilityFromViewController:(id)arg1 sourceView:(id)arg2 sourceRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 completionHandler:(id)arg4;
