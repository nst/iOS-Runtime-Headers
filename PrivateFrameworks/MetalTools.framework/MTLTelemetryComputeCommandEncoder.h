...
- (void).cxx_destruct;
- (void)accumDispatchDistribution:(unsigned int)arg1 threadgroupsPerGrid:(struct { unsigned int x1; unsigned int x2; unsigned int x3; })arg2 threadsPerThreadgroup:(struct { unsigned int x1; unsigned int x2; unsigned int x3; })arg3 threadsPerGrid:(struct { unsigned int x1; unsigned int x2; unsigned int x3; })arg4;
