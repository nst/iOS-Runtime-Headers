...
- (bool)wb$boolForKey:(id)arg1;
- (id)wb$colorForKey:(id)arg1;
...
- (void)encodeKeysAndValuesWithCSCoder:(id)arg1 filterBlock:(id)arg2;
- (void)encodeWithCSCoder:(id)arg1;

// Image: /System/Library/Frameworks/EventKit.framework/EventKit

- (id)dictionaryByMergingWithDictionary:(id)arg1;
- (id)objectForKey:(id)arg1 withDefaultValueBlock:(id)arg2;
...
- (id)fm_dictionaryByMappingValues:(id)arg1;
...
- (id)na_dictionaryByMappingValues:(id)arg1;
- (id)na_filter:(id)arg1;

// Image: /System/Library/PrivateFrameworks/NewsCore.framework/NewsCore

+ (id)fc_dictionary:(id)arg1;
+ (id)fc_dictionaryByAddingEntriesFromDictionary:(id)arg1 toDictionary:(id)arg2;
+ (id)fc_dictionaryFromArray:(id)arg1 keyBlock:(id)arg2 valueBlock:(id)arg3;
+ (id)fc_dictionaryFromJSON:(id)arg1;
+ (id)fc_dictionaryWithKeys:(id)arg1 valueBlock:(id)arg2;
+ (id)fc_dictionaryWithKeys:(id)arg1 valueWithIndexBlock:(id)arg2;
+ (id)fc_dictionaryWithObjects:(id)arg1 keyBlock:(id)arg2;

- (id)fc_actionTypes;
- (id)fc_deepCopy;
- (id)fc_dictionaryByRemovingObjectForKey:(id)arg1;
- (id)fc_dictionaryBySwappingValuesAndKeys;
- (id)fc_dictionaryByTransformingKeysWithBlock:(id)arg1;
- (id)fc_dictionaryByTransformingKeysWithKeyAndValueBlock:(id)arg1;
- (id)fc_dictionaryByTransformingValuesWithBlock:(id)arg1;
- (id)fc_dictionaryByTransformingValuesWithKeyAndValueBlock:(id)arg1;
...
- (id)fr_descriptionWithKeyComparator:(id)arg1;
- (id)jsonString;
...
- (id)safari_mapAndFilterKeysAndObjectsUsingBlock:(id)arg1;
