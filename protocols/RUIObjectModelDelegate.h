...
- (void)objectModel:(void *)arg1 pressedLink:(void *)arg2 httpMethod:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 10: RUIObjectModel *, NSURL *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
