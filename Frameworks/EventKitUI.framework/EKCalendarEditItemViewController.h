...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 store:(id)arg2 styleProvider:(id)arg3 entityType:(unsigned int)arg4;
- (BOOL)limitToSource;
- (void)loadView;
