...
- (void)enumerateEdgesWithLabel:(id)arg1 usingBlock:(id)arg2;
- (void)enumerateNodesWithBlock:(id)arg1;
- (void)enumerateNodesWithLabel:(id)arg1 usingBlock:(id)arg2;
- (id)init;
...
- (void)traverseGraphBreadthFirstFromNode:(id)arg1 directed:(bool)arg2 usingBlock:(id)arg3;
- (void)traverseGraphDepthFirstFromNode:(id)arg1 directed:(bool)arg2 usingBlock:(id)arg3;
