...
- (void)_dismissAnimated:(bool)arg1 completion:(id)arg2;
...
- (void)showColorWheel;
- (void)transformPickerCircleToSelectionMarkerWithCompletion:(id)arg1;
- (void)transformSelectionMarkerToPickerCircleWithCompletion:(id)arg1;
