...
+ (struct CGSize { double x1; double x2; })_scaledDownSize:(struct CGSize { double x1; double x2; })arg1 maxWidth:(float)arg2;
...
- (void)_appendImageWithContentId:(id)arg1 imageSize:(struct CGSize { double x1; double x2; })arg2;
