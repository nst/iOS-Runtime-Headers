...
+ (id)_applyAnimationSettings:(id)arg1 withApplier:(id)arg2 completion:(id)arg3 applyDynamically:(bool)arg4;
+ (id)applyAnimationSettings:(id)arg1 withDynamicApplier:(id)arg2 completion:(id)arg3;
+ (id)applyAnimationSettings:(id)arg1 withStaticApplier:(id)arg2 completion:(id)arg3;
...
- (bool)notifyUponEffectiveProgress:(double)arg1 withBlock:(id)arg2;
