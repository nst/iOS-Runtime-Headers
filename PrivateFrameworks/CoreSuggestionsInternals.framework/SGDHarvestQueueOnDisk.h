...
- (void)_popWithStringAfterWhereClause:(id)arg1 binder:(id)arg2 callback:(id)arg3;
- (void)_read:(struct { int x1; int x2; unsigned int x3; })arg1 fileId:(int)arg2 callback:(id)arg3;
