...
@property (nonatomic) struct { int x1; int x2; unsigned int x3; int x4; } minIntervalBetweenFrames;
@property (nonatomic) struct OpaqueFigVirtualDisplaySession { }*session;
@property (nonatomic) struct CGSize { double x1; double x2; } size;

+ (id)screenCaptureControllerWithSize:(struct CGSize { double x1; double x2; })arg1 minIntervalBetweenFrames:(struct { int x1; int x2; unsigned int x3; int x4; })arg2;
...
- (id)initWithSize:(struct CGSize { double x1; double x2; })arg1 minIntervalBetweenFrames:(struct { int x1; int x2; unsigned int x3; int x4; })arg2;
- (struct { int x1; int x2; unsigned int x3; int x4; })minIntervalBetweenFrames;
- (struct OpaqueFigVirtualDisplaySession { }*)session;
- (void)setDelegate:(id)arg1;
- (void)setMinIntervalBetweenFrames:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
