...
- (void)_batchSaveRecords:(id)arg1 useLongLivedOperation:(bool)arg2 longLivedOperationPersistenceCompletion:(id)arg3 completion:(id)arg4;
...
- (void)_saveCloudHistoryVisits:(id)arg1 tombstones:(id)arg2 longLivedOperationPersistenceCompletion:(id)arg3 completion:(id)arg4;
...
- (void)replayPersistedLongLivedSaveOperationWithID:(id)arg1 completion:(id)arg2;
- (void)saveCloudHistoryVisits:(id)arg1 tombstones:(id)arg2 longLivedOperationPersistenceCompletion:(id)arg3 completion:(id)arg4;
