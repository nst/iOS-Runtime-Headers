...
- (void)_gkDeleteCredential:(id)arg1 completionHandler:(id)arg2;
- (id)_gkMapAccountsWithBlock:(id)arg1;
- (id)_gkPrimaryCredentialForEnvironment:(long long)arg1;
- (void)_gkSaveCredential:(id)arg1 completionHandler:(id)arg2;
- (void)_gkSetScope:(unsigned int)arg1 forCredential:(id)arg2 completionHandler:(id)arg3;
