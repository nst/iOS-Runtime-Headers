...
- (struct CGPoint { double x1; double x2; })applyOffsetInDirectionOfHandle:(float)arg1 toPoint:(struct CGPoint { double x1; double x2; })arg2;
...
- (float)offsetInDirectionOfHandleFromFirstPoint:(struct CGPoint { double x1; double x2; })arg1 toSecondPoint:(struct CGPoint { double x1; double x2; })arg2;
