...
- (void)_queue_deliverBackgroundContentAvailablePushForNotificationRequest:(id)arg1 bundleIdentifier:(id)arg2 message:(id)arg3 withCompletionHandler:(id)arg4;
...
- (void)allowsRemoteNotificationsForBundleIdentifier:(id)arg1 withResult:(id)arg2;
