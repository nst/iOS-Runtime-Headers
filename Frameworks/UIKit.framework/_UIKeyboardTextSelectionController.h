...
- (void)beginSelectionWithBasePositionAtBoundary:(int)arg1 inDirection:(int)arg2 withInitialExtentPoint:(struct CGPoint { double x1; double x2; })arg3 executionContext:(id)arg4;
