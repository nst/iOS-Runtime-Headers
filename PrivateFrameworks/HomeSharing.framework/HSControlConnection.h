...
- (id)_newDataForControlTouchEventMessage_v1_1:(struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; double x8; double x9; unsigned int *x10; })arg1;
- (void)_sendTouchEvent:(int)arg1 locations:(const unsigned int*)arg2 count:(unsigned int)arg3 velocity:(struct { double x1; double x2; })arg4;
- (void)close;
- (void)dealloc;
- (id)delegate;
...
- (void)sendTouchesMoved:(const unsigned int*)arg1 count:(unsigned int)arg2 velocity:(struct { double x1; double x2; })arg3;
