...
- (struct CGPoint { double x1; double x2; })constrainedPoint:(struct CGPoint { double x1; double x2; })arg1 withInset:(float)arg2;
...
- (void)setSelectionWithPoint:(struct CGPoint { double x1; double x2; })arg1 inset:(float)arg2;
