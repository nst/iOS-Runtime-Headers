...
+ (struct CGPoint { float x1; float x2; })_arrowHeadInnerControlPoint:(id)arg1;
+ (struct CGPoint { float x1; float x2; })_arrowHeadOuterControlPoint:(id)arg1;
+ (struct CGPoint { float x1; float x2; })_centeredBaseControlPoint:(id)arg1;
...
+ (struct CGPoint { float x1; float x2; })_normalizedDirectionVector:(id)arg1;
