...
- (void).cxx_destruct;
- (void)_closeViewfinder:(bool)arg1 animated:(bool)arg2 withCompletionHandler:(id)arg3;
- (id)_existingSnapshotViewCreateIfNecessary:(bool)arg1 removedOnCompletion:(bool)arg2;
- (void)_setSnapshotView:(id)arg1;
- (id)_snapshotView;
- (id)_viewfinderView;
- (void)closeAnimated:(bool)arg1 withCompletionHandler:(id)arg2;
- (id)initWithViewfinderView:(id)arg1;
- (void)openAnimated:(bool)arg1 withCompletionHandler:(id)arg2;
