...
- (void)_inSearchQueueAsync:(id)arg1;
...
- (id)_inqNewGroupsWithMatchingGroupIds:(const void**)arg1 count:(long long)arg2 matchingPredicateBlock:(id)arg3;
...
- (long long)options;
- (id)path;
- (void)query:(id)arg1 searchString:(id)arg2 earlyResultsHandler:(id)arg3 resultsHandler:(id)arg4;
