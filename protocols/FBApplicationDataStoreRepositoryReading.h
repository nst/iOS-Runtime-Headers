...
- (void)objectForKey:(void *)arg1 forApplication:(void *)arg2 withResult:(void *)arg3; // needs 3 arg types, found 7: NSString *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, id
- (void)objectForKeys:(void *)arg1 forAllApplicationsWithResult:(void *)arg2; // needs 2 arg types, found 6: NSArray *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, id
