...
- (void)dealloc;
- (void)exportToMovieFileURL:(id)arg1 fileType:(id)arg2 completionHandler:(id)arg3;
- (id)init;
...
- (void)p_finishWithSuccess:(bool)arg1 error:(id)arg2 completionHandler:(id)arg3;
