...
- (void)setTableViewCellHook:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, UITableViewCell *, id, unsigned long long, void*
