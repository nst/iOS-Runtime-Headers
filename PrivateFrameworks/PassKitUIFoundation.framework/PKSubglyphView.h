...
@interface PKSubglyphView : UIView <PKMicaResizableView> {
    ...
    <PKSubglyphViewDelegate> * _delegate;
...
@property (nonatomic) <PKSubglyphViewDelegate> *delegate;
...
- (void)_showMicaContentWithTransitionIndex:(unsigned int)arg1 animated:(BOOL)arg2;
