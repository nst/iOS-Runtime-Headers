...
- (void)_getCookieStoragePartitionsCompletionHandler:(id)arg1;
- (void)_getCookiesForPartition:(id)arg1 completionHandler:(id)arg2;
- (void)_getCookiesForURL:(id)arg1 mainDocumentURL:(id)arg2 partition:(id)arg3 completionHandler:(id)arg4;
