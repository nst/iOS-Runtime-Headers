...
- (void)_mediaRemoteCommunicationWithIndexPath:(id)arg1 work:(id)arg2;
- (void)_nowPlayingDidChangeNotification:(id)arg1;
- (void)_performMediaRemoteAccess:(id)arg1 onQueue:(id)arg2;
...
- (id)containerForRoot;
- (void)dealloc;
- (void)getChildrenAtIndexPath:(id)arg1 inRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 completion:(id)arg3;
- (void)getChildrenSupportsPlaybackProgressForIndexPath:(id)arg1 withCompletion:(id)arg2;
- (void)getCountOfChildrenAtIndexPath:(id)arg1 withCompletion:(id)arg2;
- (void)getItemAtIndexPath:(id)arg1 completion:(id)arg2;
- (void)getNowPlayingIdentifiersWithCompletion:(id)arg1;
- (void)getRemoteAppIsPlaying:(id)arg1;
- (id)imageForIdentifier:(id)arg1;
- (struct CGSize { double x1; double x2; })imageSize;
- (id)initWithBundleID:(id)arg1;
- (void)initiatePlaybackAtIndexPath:(id)arg1 completion:(id)arg2;
