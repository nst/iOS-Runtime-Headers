...
+ (id)logCategory;
+ (void)twoFactorAuthenticationEnabledForAccount:(id)arg1 altDSID:(id)arg2 completionHandler:(id)arg3;
...
- (void)_stopBrowser;
- (void)_tryPairingWithAccessories:(id)arg1 completionHandler:(id)arg2;
- (id)atHomeRetryTimer;
- (id)bonjourKeys;
- (void)dealloc;
