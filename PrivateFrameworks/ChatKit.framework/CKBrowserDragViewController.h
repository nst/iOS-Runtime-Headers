...
- (void)animateBackToSourceCompletionBlock:(id)arg1;
- (void)animatePeelWithCompletion:(id)arg1;
- (void)animatePlacementAtPoint:(struct CGPoint { double x1; double x2; })arg1 completionBlock:(id)arg2;
...
- (void)reversePeelAnimationToPoint:(struct CGPoint { double x1; double x2; })arg1 forPlacement:(bool)arg2 completionBlock:(id)arg3;
