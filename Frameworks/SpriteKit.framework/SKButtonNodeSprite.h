...
- (void)touchBegan:(unsigned int)arg1 location:(struct CGPoint { double x1; double x2; })arg2;
- (void)touchEnded:(unsigned int)arg1 location:(struct CGPoint { double x1; double x2; })arg2;
- (void)touchMoved:(unsigned int)arg1 location:(struct CGPoint { double x1; double x2; })arg2;
