...
+ (id)touchStateForTouchUUID:(id)arg1 withTimestamp:(double)arg2 phase:(int)arg3 location:(struct CGPoint { double x1; double x2; })arg4 pathIndex:(unsigned char)arg5 inView:(id)arg6;
