...
@interface WKCustomProtocolLoader : NSObject <NSURLConnectionDelegate> {
    ...
    struct CustomProtocolManagerProxy { int (**x1)(); struct ChildProcessProxy {} *x2; struct WebProcessPool {} *x3; struct HashMap<unsigned int, WTF::RetainPtr<WKCustomProtocolLoader>, WTF::IntHash<unsigned int>, WTF::HashTraits<unsigned int>, WTF::HashTraits<WTF::RetainPtr<WKCustomProtocolLoader> > > { struct HashTable<unsigned int, WTF::KeyValuePair<unsigned int, WTF::RetainPtr<WKCustomProtocolLoader> >, WTF::KeyValuePairKeyExtractor<WTF::KeyValuePair<unsigned int, WTF::RetainPtr<WKCustomProtocolLoader> > >, WTF::IntHash<unsigned int>, WTF::HashMap<unsigned int, WTF::RetainPtr<WKCustomProtocolLoader>, WTF::IntHash<unsigned int>, WTF::HashTraits<unsigned int>, WTF::HashTraits<WTF::RetainPtr<WKCustomProtocolLoader> > >::KeyValuePairTraits, WTF::HashTraits<unsigned int> > { struct KeyValuePair<unsigned int, WTF::RetainPtr<WKCustomProtocolLoader> > {} *x_1_2_1; unsigned int x_1_2_2; unsigned int x_1_2_3; unsigned int x_1_2_4; unsigned int x_1_2_5; } x_4_1_1; } x4; } * _customProtocolManagerProxy;
