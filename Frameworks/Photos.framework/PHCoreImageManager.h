...
+ (void)_chooseFormatsForSize:(struct CGSize { double x1; double x2; })arg1 contentMode:(long long)arg2 srcAspectRatio:(double)arg3 options:(id)arg4 hasAdjustmentsHandler:(id)arg5 desiredImagePixelSize:(struct CGSize { double x1; double x2; }*)arg6 bestFormat:(id*)arg7 degradedFormat:(id*)arg8;
+ (id)_debugFilenameForAsset:(id)arg1;
+ (id)_degradedFormatWithPolicy:(long long)arg1 request:(id)arg2 hasAdjustmentsHandler:(id)arg3;
+ (id)_descriptionForDomain:(id)arg1;
+ (id)_dictionaryBySettingObject:(id)arg1 forKey:(id)arg2 inDictionary:(id)arg3;
+ (id)_fastestDegradedFormatForRequest:(id)arg1 hasAdjustmentsHandler:(id)arg2;
...
- (void)asyncEnumeratePendingCPLDownloadRequestsWithBlock:(id)arg1 completionHandler:(id)arg2;
- (void)asyncEnumeratePendingRequestsWithBlock:(id)arg1 completionHandler:(id)arg2;
