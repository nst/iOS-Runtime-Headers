...
- (struct Point3D { double x1; double x2; double x3; })_pointForEntry:(struct Entry { double x1; double x2; })arg1 andPrimaryReferenceMetric:(float)arg2 usingFallbackSecondaryReferenceMetric:(float)arg3;
