...
- (void)_transformAttachmentsForBundleIdentifier:(id)arg1 usingTransformBlock:(id)arg2;
- (unsigned long long)_transformNotificationIdentifiersForRepositoryURL:(id)arg1 bundleIdentifier:(id)arg2 usingTransformBlock:(id)arg3;
