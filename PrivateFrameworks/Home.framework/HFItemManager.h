...
- (id)_reloadItemProviders:(id)arg1 updateItems:(id)arg2 shouldUpdateExistingItems:(bool)arg3 senderSelector:(SEL)arg4 readValidator:(id)arg5;
...
- (id)_updateResultsForItems:(id)arg1 removedItems:(id)arg2 senderSelector:(SEL)arg3 logger:(id)arg4 options:(id)arg5 readValidator:(id)arg6;
- (id)_updateResultsForItems:(id)arg1 senderSelector:(SEL)arg2 readValidator:(id)arg3;
