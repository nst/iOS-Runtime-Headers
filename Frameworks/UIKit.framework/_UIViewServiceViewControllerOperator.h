...
- (void)__hostViewWillAppear:(BOOL)arg1 inInterfaceOrientation:(int)arg2 traitCollection:(id)arg3 statusBarHeight:(float)arg4 underlapsStatusBar:(BOOL)arg5 completionHandler:(id /* block */)arg6;
- (void)__hostViewWillDisappear:(BOOL)arg1;
- (void)__hostViewWillTransitionToSize:(struct CGSize { double x1; double x2; })arg1 withContextDescription:(id)arg2 statusBarHeight:(float)arg3 underlapsStatusBar:(BOOL)arg4 whenDone:(id /* block */)arg5;
