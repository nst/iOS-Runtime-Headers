...
@property(retain) TSTColumnRowUIDMap * columnRowUIDMap;
...
@property(retain,readonly) TSTStrokeSidecar * strokeSidecar;
...
@property(retain) TSTTableStylePreset * tableStylePreset;
