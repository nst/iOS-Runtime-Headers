...
- (void)_attachServerWithClientQueue:(id)arg1 lifecycleDelegate:(id)arg2 healthStore:(id)arg3 completion:(id)arg4;
...
- (void)_nukeWithCompletion:(id)arg1;
...
- (void)clientRemote_serverPausedWithDate:(id)arg1 completion:(id)arg2;
...
- (id)metadata;
- (void)pauseWorkoutWithDate:(id)arg1 userInitiated:(bool)arg2 completion:(id)arg3;
- (id)resumeDataByType;
- (void)resumeWorkoutFromDate:(id)arg1 userInitiated:(bool)arg2 completion:(id)arg3;
