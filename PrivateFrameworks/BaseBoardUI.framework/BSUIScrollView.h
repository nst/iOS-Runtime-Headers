...
- (void)_setContentOffset:(struct CGPoint { double x1; double x2; })arg1 withBlock:(id)arg2;
- (void)_setScrollCompletion:(id)arg1;
...
- (bool)setContentOffset:(struct CGPoint { double x1; double x2; })arg1 animated:(bool)arg2 completion:(id)arg3;
