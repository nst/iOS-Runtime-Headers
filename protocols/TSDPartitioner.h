...
- (<TSDHint> *)nextHintForSize:(struct CGSize { double x1; double x2; })arg1 parentLayout:(TSDLayout *)arg2 previousHint:(id <TSDHint>)arg3 horizontally:(bool)arg4 outFinished:(out bool*)arg5;
