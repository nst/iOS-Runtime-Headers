...
@interface TSCHChartInfo : NSObject <TSCHStyleOwning, TSCHUnretainedParent, TSDMixing, NSCopying> {
    ...
    struct CGPoint { 
        double x; 
        double y; 
    boolmDisplayMessageOnRepCreation;
    boolmNeedsCalcEngineDependentImport;
    boolmNeedsCalcEngineDependentUpgrade;
...
@property struct { boolx1; boolx2; boolx3; boolx4; boolx5; boolx6; unsigned long long x7; } defaultLayoutSettings;
...
@property(readonly) struct CGSize { double x1; double x2; } minimumChartBodySize;
@property(retain) TSCHChartModel * model;
@property(readonly) TSCHChartStylePreset * preset;
@property struct CGPoint { double x1; double x2; } previewOrigin;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })chartBodyBoundsForSageImportWithSageChartType:(bool)arg1;
...
- (id)create3DSceneWithLayoutSettings:(const struct { boolx1; boolx2; boolx3; boolx4; boolx5; boolx6; unsigned long long x7; }*)arg1;
- (void)dealloc;
- (void)debugLayoutCache;
- (struct { boolx1; boolx2; boolx3; boolx4; boolx5; boolx6; unsigned long long x7; })defaultLayoutSettings;
...
- (void)performUpgradeForPersistentChartInfo:(id)arg1 archiveVersion:(unsigned long long)arg2 innerChartFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 isFromPasteboard:(bool)arg4;
- (id)preset;
...
- (void)setDefaultLayoutSettings:(struct { boolx1; boolx2; boolx3; boolx4; boolx5; boolx6; unsigned long long x7; })arg1;
