...
- (void)beginPulsing;
- (void)endPulsing;
- (void)setVisibleMapRect:(struct { struct { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg1 zoomScale:(float)arg2 zoomLevel:(NSInteger)arg3 tileType:(unsigned char)arg4;
