...
@class <VKInteractiveMapDelegate>, <VKRouteMatchedAnnotationPresentation>, <VKTrackableAnnotation>, AltMapView, GEOMapRegion, NSArray, NSObject<OS_dispatch_queue>, NSSet, UIView, VKAnchorContext, VKAnnotationModel, VKCalloutController, VKCamera, VKGlobeAdapter, VKGlobeCameraController, VKGlobeLineContainer, VKGlobePointCache, VKGlobeViewWrapperImp, VKTrafficIncident, VKViewTransform, VKWorld;
