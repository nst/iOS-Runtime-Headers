...
- (void)autoInstallOperationIsReadyToInstall:(void *)arg1 withResult:(void *)arg2; // needs 2 arg types, found 8: NSUUID *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
