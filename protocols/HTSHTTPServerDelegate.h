...
- (void)httpServer:(void *)arg1 dataForRequest:(void *)arg2 resolvedPath:(void *)arg3 handler:(void *)arg4; // needs 4 arg types, found 10: HTSHTTPServer *, HTSHTTPMessageRequest *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSData *, NSString *, void*
