...
@property (nonatomic, copy) id scrollBlock;
...
- (void)fullScreenBalloonViewController:(id)arg1 verticallyScrollTranscriptByAmount:(double)arg2 animated:(bool)arg3 completion:(id)arg4;
...
- (void)hideMediaPickerAnimated:(bool)arg1 completion:(id)arg2;
