...
@class <UIKeyInput>, <UIKeyboardCandidateList>, <UIKeyboardImplGeometryDelegate>, <UIKeyboardRivenCenterView>, NSArray, NSMutableArray, NSMutableDictionary, NSObject<UIKeyboardRecording><UIApplicationEventRecording>, NSString, NSTimer, UIAutocorrectInlinePrompt, UIDelayedAction, UIKeyboardCandidate, UIKeyboardInputManager, UIKeyboardLayout, UITextInputArrowKeyHistory, UITextInputTraits, UIView;
