...
- (void)_startLeaseIfNeededForCurrentPlayerItemsFromUserAction:(bool)arg1 withCompletionHandler:(id)arg2;
- (void)_startLeaseIfNeededForPlaybackResumptionWithCompletionHandler:(id)arg1;
...
- (void)acquireShouldStartLeaseForAssetCreationWithCompletionHandler:(id)arg1;
- (void)dealloc;
- (void)getFinalSubscriptionStatusWithCompletionHandler:(id)arg1;
- (void)handleLeaseForErrorResolutionWithCompletionHandler:(id)arg1;
- (id)init;
- (void)registerPlayer:(id)arg1;
- (void)startLeaseIfNeededForPlaybackResumptionWithCompletionHandler:(id)arg1;
