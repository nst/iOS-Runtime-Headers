...
- (void)drawText:(id)arg1 inContext:(struct CGContext { }*)arg2 minSize:(struct CGSize { double x1; double x2; })arg3 maxSize:(struct CGSize { double x1; double x2; })arg4 anchor:(struct CGPoint { double x1; double x2; })arg5 flags:(int)arg6 viewScale:(float)arg7;
...
- (id)layoutTextStorage:(id)arg1 minSize:(struct CGSize { double x1; double x2; })arg2 maxSize:(struct CGSize { double x1; double x2; })arg3 anchor:(struct CGPoint { double x1; double x2; })arg4 pageNumber:(unsigned int)arg5 pageCount:(unsigned int)arg6 flags:(int)arg7;
- (id)locale;
- (float)maxAnchorY;
