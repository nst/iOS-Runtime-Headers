...
- (id)plainTextContent;
- (void)prepareDataForDocumentAtURLForInsertion:(id)arg1 withCompletion:(id)arg2;
...
- (void)replaceAttachment:(id)arg1 withDocumentAtURL:(id)arg2 completion:(id)arg3;
