...
- (BOOL)vcVideoStreamReceiver:(VCVideoStreamReceiver *)arg1 didReceiveRemoteFrame:(struct __CVBuffer { }*)arg2 atTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg3 newVideoAttributes:(VideoAttributes *)arg4 isFirstFrame:(BOOL)arg5;
