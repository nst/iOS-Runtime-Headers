...
- (BOOL)_initializeSetupSession:(unsigned int)arg1;
...
- (id)initWithRole:(unsigned int)arg1 resumeSessionID:(unsigned int)arg2 delegate:(id)arg3;
- (id)inputKey;
- (id)inputNonce;
- (void)open;
- (id)outputKey;
...
- (void)setResumeSessionID:(unsigned int)arg1;
