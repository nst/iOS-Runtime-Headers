...
- (void)fetchMetadataForTextField:(id)arg1 inFrame:(id)arg2 withCompletion:(id)arg3;
...
- (void)willSubmitForm:(id)arg1 inFrame:(id)arg2 submissionHandler:(id)arg3;
- (void)willSubmitFormValues:(id)arg1 userObject:(id)arg2 submissionHandler:(id)arg3;
