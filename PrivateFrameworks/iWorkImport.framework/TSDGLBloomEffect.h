...
- (void)dealloc;
- (void)drawBloomEffectWithMVPMatrix:(struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; })arg1 bloomAmount:(float)arg2 currentGLFramebuffer:(int)arg3 GLState:(id)arg4;
- (id)initWithEffectSize:(struct CGSize { double x1; double x2; })arg1 blurScale:(float)arg2;
