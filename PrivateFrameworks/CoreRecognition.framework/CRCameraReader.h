...
@property BOOL foundNumberFixedLandscape;
@property BOOL foundNumberFixedPortrait;
...
+ (id)findCCExpDateInImage:(struct vImage_Buffer { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; })arg1 useCombinedEngine:(BOOL)arg2 usingTextFeatures:(id)arg3 invert:(BOOL)arg4;
+ (id)findCCExpDateInImage:(struct vImage_Buffer { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; })arg1 usingTextFeatures:(id)arg2 invert:(BOOL)arg3;
...
+ (id)findCCNameInImage:(struct vImage_Buffer { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; })arg1 useCombinedEngine:(BOOL)arg2 usingTextFeatures:(id)arg3 invert:(BOOL)arg4;
+ (id)findCCNameInImage:(struct vImage_Buffer { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; })arg1 usingTextFeatures:(id)arg2 invert:(BOOL)arg3;
...
+ (id)findCCNumberInImage:(struct vImage_Buffer { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; })arg1 useCombinedEngine:(BOOL)arg2 usingTextFeatures:(id)arg3 invert:(BOOL)arg4;
+ (id)findCCNumberInImage:(struct vImage_Buffer { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; })arg1 usingTextFeatures:(id)arg2 invert:(BOOL)arg3;
+ (id)findCCObject:(id)arg1 inImage:(struct vImage_Buffer { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; })arg2 forRect:(id)arg3 rotateRectImage:(BOOL)arg4 useFlatEngine:(BOOL)arg5 numberRecognizedInverted:(BOOL)arg6;
