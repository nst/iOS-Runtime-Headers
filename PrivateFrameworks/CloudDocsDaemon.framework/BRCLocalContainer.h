...
@property(readonly) BOOL hasHighPriorityWatchers;
...
@property(readonly) long long lastInsertedRank;
...
@property(readonly) NSMutableIndexSet * pendingCoordinatedIOs;
...
@property(readonly) BRCDeadlineToken * syncDeadlineToken;
