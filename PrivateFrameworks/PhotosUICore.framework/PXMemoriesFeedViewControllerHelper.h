...
@interface PXMemoriesFeedViewControllerHelper : PXObservable <PXMemoriesFeedScrollFilterDelegate, PXMemoriesFeedTilingLayoutDelegate, PXSectionedDataSourceManagerObserver, PXSectionedLayoutEngineDelegate, PXTilingControllerScrollDelegate, PXTilingControllerTransitionDelegate> {
    ...
    id  __newMemoriesRequestCompletion;
...
@property (setter=_setNewMemoriesRequestCompletion:, nonatomic, copy) id _newMemoriesRequestCompletion;
...
- (void)_enumerateInsertedItemsInChangeDetails:(id)arg1 withDataSource:(id)arg2 usingBlock:(id)arg3;
...
- (void)_setNewMemoriesRequestCompletion:(id)arg1;
...
- (id)initWithScrollViewController:(id)arg1 photoLibrary:(id)arg2 traitCollection:(id)arg3 tilingControllerConfigurationBlock:(id)arg4;
...
- (id)photoLibrary;
- (void)prepare;
- (void)requestNewMemoriesForReason:(unsigned long long)arg1 withCompletion:(id)arg2;
- (void)requestNewMemoriesWithCompletion:(id)arg1;
