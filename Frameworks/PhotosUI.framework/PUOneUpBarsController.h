...
@property (setter=_setShouldAnimateNextChromeVisibilityUpdate:, nonatomic) BOOL _shouldAnimateNextChromeVisibilityUpdate;
...
@property (nonatomic, readonly) PUPhotoBrowserTitleView *_titleView;
...
@property (nonatomic) BOOL isShowingPlayPauseButton;
...
- (id)_newBarButtonItemWithIdentifier:(int)arg1;
...
- (void)_setShouldAnimateNextChromeVisibilityUpdate:(BOOL)arg1;
...
- (BOOL)_shouldAnimateNextChromeVisibilityUpdate;
