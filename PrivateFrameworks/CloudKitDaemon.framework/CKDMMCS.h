...
- (id)_contextToGetItemGroup:(id)arg1 operation:(id)arg2 options:(id)arg3 progress:(id)arg4 command:(id)arg5 completionHandler:(id)arg6;
- (id)_contextToGetSectionItem:(id)arg1 operation:(id)arg2 options:(id)arg3 progress:(id)arg4 completionHandler:(id)arg5;
- (id)_contextToPutItemGroup:(id)arg1 operation:(id)arg2 options:(id)arg3 progress:(id)arg4 completionHandler:(id)arg5;
- (id)_contextToPutSectionItem:(id)arg1 operation:(id)arg2 options:(id)arg3 progress:(id)arg4 completionHandler:(id)arg5;
- (id)_contextToRegisterItemGroup:(id)arg1 operation:(id)arg2 fetchOnly:(bool)arg3 options:(id)arg4 completionHandler:(id)arg5;
...
- (id)assetCache;
- (void)dealloc;
- (id)getItemGroupSet:(id)arg1 operation:(id)arg2 shouldFetchAssetContentInMemory:(bool)arg3 options:(id)arg4 progress:(id)arg5 command:(id)arg6 completionHandler:(id)arg7;
- (struct _mmcs_engine { }*)getMMCSEngine;
- (unsigned int)getMaxChunkCountForSection;
- (id)getSectionItem:(id)arg1 operation:(id)arg2 options:(id)arg3 progress:(id)arg4 completionHandler:(id)arg5;
- (id)initWithMMCSEngineContext:(id)arg1 path:(id)arg2;
- (id)path;
- (void)performOnRunLoop:(id)arg1;
- (id)putItemGroupSet:(id)arg1 operation:(id)arg2 options:(id)arg3 progress:(id)arg4 completionHandler:(id)arg5;
- (id)putSectionItem:(id)arg1 operation:(id)arg2 options:(id)arg3 progress:(id)arg4 completionHandler:(id)arg5;
- (id)registerItemGroupSet:(id)arg1 operation:(id)arg2 completionHandler:(id)arg3;
- (id)registerItemGroupSet:(id)arg1 operation:(id)arg2 shouldChunk:(bool)arg3 completionHandler:(id)arg4;
- (id)registerItemGroupSet:(id)arg1 operation:(id)arg2 shouldChunk:(bool)arg3 fetchOnly:(bool)arg4 completionHandler:(id)arg5;
...
- (void)unregisterItemIDs:(id)arg1 completionBlock:(id)arg2;
