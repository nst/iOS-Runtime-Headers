...
- (void)activityContinuationManager:(void *)arg1 displayProgressUI:(void *)arg2 dismissalHandler:(void *)arg3; // needs 3 arg types, found 7: UIActivityContinuationManager *, NSProgress *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
- (void)activityContinuationManager:(void *)arg1 hideProgressUIWithCompletion:(void *)arg2; // needs 2 arg types, found 6: UIActivityContinuationManager *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
