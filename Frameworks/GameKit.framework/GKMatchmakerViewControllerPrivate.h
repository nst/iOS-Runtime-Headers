...
@class UILabel, GKMatchRequest, UIAlertView, UIActivityIndicatorView, UITableView, UIButton, GKUITheme, UIView, <GKMatchmakerViewControllerDelegate>, NSArray, GKMatch, GKInvite, NSMutableDictionary, NSMutableArray, GKFriendPickerViewController;
