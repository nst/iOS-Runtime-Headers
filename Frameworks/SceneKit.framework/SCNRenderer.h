...
- (struct SCNVector3 { double x1; double x2; double x3; })_projectPoint:(struct SCNVector3 { double x1; double x2; double x3; })arg1 viewport:(struct CGSize { double x1; double x2; })arg2;
- (void)_projectPoints:(struct SCNVector3 { double x1; double x2; double x3; }*)arg1 count:(unsigned int)arg2 viewport:(struct CGSize { double x1; double x2; })arg3;
...
- (void)_stop;
- (double)_systemTime;
- (struct SCNVector3 { double x1; double x2; double x3; })_unprojectPoint:(struct SCNVector3 { double x1; double x2; double x3; })arg1 viewport:(struct CGSize { double x1; double x2; })arg2;
...
- (struct SCNVector4 { double x1; double x2; double x3; double x4; })_viewport;
...
- (void)set_viewport:(struct SCNVector4 { double x1; double x2; double x3; double x4; })arg1;
- (BOOL)showsStatistics;
- (id)snapshotAtTime:(double)arg1;
- (id)snapshotAtTime:(double)arg1 withSize:(struct CGSize { double x1; double x2; })arg2 antialiasingMode:(unsigned int)arg3;
