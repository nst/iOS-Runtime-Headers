...
- (void)_prepareSnapshotViewWithPass:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 suppressedContent:(unsigned long long)arg3 cacheKey:(id)arg4 completion:(id)arg5;
- (void)_snapshotWithPass:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 suppressedContent:(unsigned long long)arg3 withCache:(bool)arg4 completion:(id)arg5;
- (void)dealloc;
- (id)init;
- (id)passLibrary;
...
- (void)snapshotWithPass:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 suppressedContent:(unsigned long long)arg3 completion:(id)arg4;
