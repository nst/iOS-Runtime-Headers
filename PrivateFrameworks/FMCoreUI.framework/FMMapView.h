...
- (id)displayLink;
- (double)distanceBetweenOrigin:(struct { double x1; double x2; })arg1 andDestination:(struct { double x1; double x2; })arg2;
...
- (BOOL)isUserSwiping;
- (BOOL)isValidLocation:(struct { double x1; double x2; })arg1;
...
- (float)maxZoomLevel;
- (void)moveCenterByOffset:(struct CGPoint { float x1; float x2; })arg1 from:(struct { double x1; double x2; })arg2;
...
- (void)refreshOverlayForAnnotation:(id)arg1 andCoordinate:(struct { double x1; double x2; })arg2;
...
- (void)updateCameraPositionWithLocation:(struct { double x1; double x2; })arg1 andAltitude:(double)arg2;
