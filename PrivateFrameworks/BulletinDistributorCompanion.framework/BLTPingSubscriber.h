...
- (void)pingWithRecordID:(id)arg1 forSectionID:(id)arg2 ack:(id)arg3;
- (id)sectionIDs;
...
- (void)subscribeToSectionID:(id)arg1 withBulletinAckHandler:(id)arg2;
- (void)subscribeToSectionID:(id)arg1 withBulletinHandler:(id)arg2;
- (void)subscribeToSectionID:(id)arg1 withPingAckHandler:(id)arg2;
