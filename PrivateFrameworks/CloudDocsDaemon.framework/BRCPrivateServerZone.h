...
@property(readonly) BRCPrivateLocalContainer * container;
@property(readonly) BRCZonePurgeOperation * deleteAllContentsOperation;
@property(readonly) NSError * deleteAllContentsOperationLastError;
