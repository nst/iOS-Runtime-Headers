...
@interface StockChartData : NSObject {
    ...
    struct { double x1; double x2; unsigned int x3; } * _maxValue;
    struct { double x1; double x2; unsigned int x3; } * _minValue;
    double  _previousClosePrice;
    Stock * _stock;
    unsigned int  _stockValueCount;
    struct { double x1; double x2; unsigned int x3; } * _stockValues;
...
@property (nonatomic) struct { double x1; double x2; unsigned int x3; }*maxValue;
@property (nonatomic) struct { double x1; double x2; unsigned int x3; }*minValue;
@property (nonatomic) double previousClosePrice;
@property (nonatomic) Stock *stock;
@property (readonly) unsigned int stockValueCount;
@property (readonly) struct { double x1; double x2; unsigned int x3; }*stockValues;
@property (nonatomic) int yAxisFractionDigits;

- (void).cxx_destruct;
- (struct { double x1; double x2; unsigned int x3; }*)allocateStockValuesWithCount:(unsigned int)arg1;
- (int)chartInterval;
...
- (id)marketOpenDate;
- (id)marketTimeZone;
- (struct { double x1; double x2; unsigned int x3; }*)maxValue;
- (struct { double x1; double x2; unsigned int x3; }*)minValue;
...
- (void)setMaxValue:(struct { double x1; double x2; unsigned int x3; }*)arg1;
- (void)setMinValue:(struct { double x1; double x2; unsigned int x3; }*)arg1;
...
- (struct { double x1; double x2; unsigned int x3; }*)stockValues;
