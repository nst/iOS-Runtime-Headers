...
- (id)CIImage;
- (id)UIImage;
- (void)_drawImagePatchListInContext:(struct CGContext { }*)arg1 imagePatchList:(id)arg2 size:(struct CGSize { double x1; double x2; })arg3 drawScaleX:(float)arg4 drawScaleY:(float)arg5 totalPadding:(float)arg6;
