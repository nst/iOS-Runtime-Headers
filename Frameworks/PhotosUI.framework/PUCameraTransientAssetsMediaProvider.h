...
- (void)_handleLivePhotoPairedVideoRequestResultURL:(id)arg1 filterName:(id)arg2 stillDisplayTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg3 error:(id)arg4 requestID:(int)arg5;
...
- (int)_requestLivePhotoForTransientAsset:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 contentMode:(int)arg3 options:(id)arg4 resultHandler:(id /* block */)arg5;
- (BOOL)_requestLivePhotoWithSupplementaryImageSourceIfPossibleWithAsset:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 contentMode:(int)arg3 options:(id)arg4 resultHandler:(id /* block */)arg5;
