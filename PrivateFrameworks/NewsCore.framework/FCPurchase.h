...
- (void).cxx_destruct;
- (id)appAdamID;
- (void)appLookupForBundleIDWithAppAdamID:(id)arg1 completion:(id)arg2;
- (void)appLookupWithAppAdamID:(id)arg1 completion:(id)arg2;
- (id)bundleID;
- (id)cloudContext;
...
- (id)price;
- (id)product;
- (void)productLookupWithcompletion:(id)arg1;
- (id)productRequestGroup;
- (void)productsRequest:(id)arg1 didReceiveResponse:(id)arg2;
- (id)purchaseID;
- (void)purchaseLookUp:(id)arg1;
...
- (void)startPurchaseWithTagID:(id)arg1 webAccessOptIn:(bool)arg2 completion:(id)arg3;
