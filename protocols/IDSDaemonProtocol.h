...
- (void)continuityStartScanningForType:(int)arg1 withData:(NSData *)arg2 mask:(NSData *)arg3;
- (void)continuityStartScanningForType:(int)arg1 withData:(NSData *)arg2 mask:(NSData *)arg3 boostedScan:(BOOL)arg4 duplicates:(BOOL)arg5;
- (void)continuityStartScanningForType:(int)arg1 withData:(NSData *)arg2 mask:(NSData *)arg3 peers:(NSArray *)arg4;
- (void)continuityStartScanningForType:(int)arg1 withData:(NSData *)arg2 mask:(NSData *)arg3 peers:(NSArray *)arg4 boostedScan:(BOOL)arg5 duplicates:(BOOL)arg6;
...
- (void)registrationControlGetRegistrationStateForRegistrationType:(int)arg1 requestID:(NSString *)arg2;
