...
@class AVCaptureVideoPreviewLayer, CADisplayLink, NSData, NSDictionary, NSMutableArray, NSString, PLCameraController, PLCameraElapsedTimeView, PLCameraFlashButton, PLCameraHDRButton, PLCameraPreviewView, PLCameraProgressView, PLCameraZoomSlider, PLCropOverlay, PLPhotoLibrary, PLPhotoTileViewController, PLPreviewOverlayView, PLReorientingButton, PLSyncProgressView, PLVideoView, UIAlertView, UIImage, UIImageView, UIToolbar, UIView;
