...
@interface RCAVWaveformViewController : UIViewController <RCGLWaveformViewDelegate, RCPreviewControllerObserver, RCCaptureSessionObserver> {
    ...
    bool_autocenterCurrentTimeIndicatorAlways;
    bool_clipsTimeMarkersToDuration;
    bool_currentTimeTracksCapturedEndPoint;
    bool_needsUpdateDisplayableTime;
    bool_screenUpdatesDisabled;
    bool_selectionOverlayVisible;
    bool_showingSelectionOverlayEnabled;
    bool_userInteractionEnabled;
}
...
@property(readonly) double waveformBottomLineInset;
