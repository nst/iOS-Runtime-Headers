...
- (id)initWithIdentifier:(int)arg1 archiveInfo:(struct shared_ptr<TSP::ArchiveInfo> { struct ArchiveInfo {} *x1; struct __shared_weak_count {} *x2; })arg2 messagesData:(id)arg3 packageLocator:(id)arg4 objectDelegate:(id)arg5 lazyReferenceDelegate:(id)arg6 delegate:(id)arg7;
