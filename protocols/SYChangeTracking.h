...
- (void)addObject:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: <SYObject> *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
...
- (void)deleteObject:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: <SYObject> *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
...
- (void)updateObject:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: <SYObject> *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
