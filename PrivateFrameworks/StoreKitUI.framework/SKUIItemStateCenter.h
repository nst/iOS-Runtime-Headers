...
- (void)_performPurchases:(id)arg1 hasBundlePurchase:(bool)arg2 withClientContext:(id)arg3 completionBlock:(id)arg4;
...
- (void)downloadRentalForItem:(id)arg1 withCompletionBlock:(id)arg2;
...
- (void)getSoftwareUpdatesWithCompletionBlock:(id)arg1;
...
- (void)reloadSoftwareUpdatesFromServerWithCompletionBlock:(id)arg1;
