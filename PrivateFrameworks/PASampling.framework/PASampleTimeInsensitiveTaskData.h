...
- (id)_initWithSerializedTimeInsensitiveTaskData:(const struct { unsigned int x1; int x2; int x3; int x4; unsigned int x5; int x6; int x7; unsigned int x8; int x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; double x14; unsigned int x15; unsigned int x16; struct _CSArchitecture { int x_17_1_1; int x_17_1_2; } x17; double x18; BOOL x19; }*)arg1;
...
- (BOOL)correspondsToUniquePid:(unsigned int)arg1 withName:(const char *)arg2 withLoadInfos:(const struct dyld_uuid_info_64 { unsigned int x1; unsigned char x2[16]; }*)arg3 numLoadInfos:(unsigned int)arg4;
- (id)debugDescription;
- (BOOL)didExec;
- (void)guessArchitectureGivenMachineArchitecture:(struct _CSArchitecture { int x1; int x2; })arg1;
- (id)imageInfos;
- (id)initWithKCDataStackshotDeltaTask:(const struct task_delta_snapshot_v2 { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; }*)arg1 withLoadInfos:(const struct dyld_uuid_info_64 { unsigned int x1; unsigned char x2[16]; }*)arg2 numLoadInfos:(unsigned int)arg3 pid:(int)arg4 andMachineArchitecture:(struct _CSArchitecture { int x1; int x2; })arg5;
...
- (id)initWithPid:(int)arg1 andUniqueID:(unsigned int)arg2 andName:(const char *)arg3;
