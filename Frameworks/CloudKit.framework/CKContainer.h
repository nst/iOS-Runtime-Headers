...
- (void)_discoverUserIdentityWithLookupInfo:(id)arg1 completionHandler:(id)arg2;
- (void)_fetchLongLivedOperationsWithIDs:(id)arg1 completionHandler:(id)arg2;
...
- (void)acceptShareMetadata:(id)arg1 completionHandler:(id)arg2;
...
- (void)dataclassEnabled:(id)arg1 completionHandler:(id)arg2;
- (void)dealloc;
- (void)decryptPersonalInfoOnShare:(id)arg1 completionHandler:(id)arg2;
- (id)description;
- (void)discoverAllContactUserInfosWithCompletionHandler:(id)arg1;
- (void)discoverAllIdentitiesWithCompletionHandler:(id)arg1;
- (void)discoverUserIdentityWithEmailAddress:(id)arg1 completionHandler:(id)arg2;
- (void)discoverUserIdentityWithPhoneNumber:(id)arg1 completionHandler:(id)arg2;
- (void)discoverUserIdentityWithUserRecordID:(id)arg1 completionHandler:(id)arg2;
...
- (id)fakeEntitlements;
- (void)fetchAllLongLivedOperationIDsWithCompletionHandler:(id)arg1;
- (void)fetchCurrentDeviceIDWithCompletionHandler:(id)arg1;
- (void)fetchFullNameAndPrimaryEmailOnAccountWithCompletionHandler:(id)arg1;
- (void)fetchLongLivedOperationWithID:(id)arg1 completionHandler:(id)arg2;
- (void)fetchLongLivedOperationsWithIDs:(id)arg1 completionHandler:(id)arg2;
- (void)fetchShareMetadataWithURL:(id)arg1 completionHandler:(id)arg2;
- (void)fetchShareParticipantWithEmailAddress:(id)arg1 completionHandler:(id)arg2;
- (void)fetchShareParticipantWithLookupInfo:(id)arg1 completionHandler:(id)arg2;
- (void)fetchShareParticipantWithPhoneNumber:(id)arg1 completionHandler:(id)arg2;
- (void)fetchShareParticipantWithUserRecordID:(id)arg1 completionHandler:(id)arg2;
...
- (void)openFileWithOpenInfo:(id)arg1 reply:(id)arg2;
