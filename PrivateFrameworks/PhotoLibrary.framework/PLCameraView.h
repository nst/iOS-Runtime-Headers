...
@class PLCameraZoomSlider, NSDictionary, NSMutableArray, PLCameraController, NSString, PLCameraElapsedTimeView, UIAlertView, PLCropOverlay, PLPhotoLibrary, NSData, PLPhotoTileViewController, PLPreviewView, PLCameraFlashButton, UIToolbar, CADisplayLink, PLVideoView, PLReorientingButton, UIImage, UIImageView, UIView;
