...
- (void)_bumpThrottleID:(int)arg1 zone:(id)arg2 throttle:(id)arg3;
- (void)_cancelThrottleID:(int)arg1;
- (void)_cancelThrottles:(id)arg1 state:(int)arg2;
- (void)_computeRecordForThrottleID:(int)arg1 item:(id)arg2;
- (void)_deleteThrottleID:(int)arg1;
- (id)_documentItemForThrottleID:(int)arg1 operationID:(id)arg2;
- (id)_documentItemForThrottleID:(int)arg1 stageID:(id)arg2;
...
- (void)_finishedUploadingItem:(id)arg1 record:(id)arg2 throttleID:(int)arg3 stageID:(id)arg4 error:(id)arg5;
...
- (void)_rescheduleThrottlesOutOfQuotaForDefaultOwnerWithAvailableSize:(int)arg1;
- (void)_resumeGlobalProgressForZones:(id)arg1 queue:(id)arg2;
- (void)_scheduleQuotaFetchForDefaultOwner;
- (void)_scheduleRetries;
- (void)_setQuotaAvailableForDefaultOwner:(unsigned int)arg1;
...
- (void)_updateRecord:(id)arg1 throttleID:(int)arg2 thumbnailOperation:(id)arg3 stageID:(id)arg4;
- (void)_updateThrottleID:(int)arg1 setStageID:(id)arg2 operationID:(id)arg3;
- (void)_willTryThrottleID:(int)arg1 zone:(id)arg2 throttle:(id)arg3 operationID:(id)arg4;
