...
- (int)_authenticateConnection:(id)arg1 forEntitlement:(id)arg2 error:(out id*)arg3 withResult:(id)arg4;
- (int)_authenticateProcessHandle:(id)arg1 entitlement:(id)arg2 error:(out id*)arg3 withResult:(id)arg4;
...
- (int)authenticateClient:(id)arg1 withResult:(id)arg2;
