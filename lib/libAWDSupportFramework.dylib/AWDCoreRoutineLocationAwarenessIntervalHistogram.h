...
- (id)anyPositiveIntervalHistogramAtIndex:(unsigned int)arg1;
- (id)anyPositiveIntervalHistograms;
- (unsigned int)anyPositiveIntervalHistogramsCount;
...
- (id)lessThan10mIntervalHistogramAtIndex:(unsigned int)arg1;
- (id)lessThan10mIntervalHistograms;
- (unsigned int)lessThan10mIntervalHistogramsCount;
- (id)lessThan200mIntervalHistogramAtIndex:(unsigned int)arg1;
- (id)lessThan200mIntervalHistograms;
- (unsigned int)lessThan200mIntervalHistogramsCount;
- (id)lessThan25mIntervalHistogramAtIndex:(unsigned int)arg1;
- (id)lessThan25mIntervalHistograms;
- (unsigned int)lessThan25mIntervalHistogramsCount;
- (id)lessThan55mIntervalHistogramAtIndex:(unsigned int)arg1;
- (id)lessThan55mIntervalHistograms;
- (unsigned int)lessThan55mIntervalHistogramsCount;
