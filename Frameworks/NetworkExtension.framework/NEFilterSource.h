...
- (id)filterOptions;
- (void)finishedLoadingWithDecisionHandler:(id)arg1;
- (id)flowUUID;
...
- (void)prepareAgentForRequest:(id)arg1 handler:(id)arg2;
- (void)prepareAgentForResponse:(id)arg1 handler:(id)arg2;
- (void)prepareAgentForURL:(id)arg1 urlRequest:(id)arg2 urlResponse:(id)arg3 parentURL:(id)arg4 direction:(long long)arg5 flowUUID:(id)arg6 handler:(id)arg7;
- (void)prepareAgentWithHandler:(id)arg1;
- (id)queue;
- (void)receivedData:(id)arg1 decisionHandler:(id)arg2;
- (void)receivedResponse:(id)arg1 decisionHandler:(id)arg2;
- (bool)registered;
- (void)remediateWithDecisionHandler:(id)arg1;
...
- (id)url;
- (id)urlAppendString;
- (void)willSendRequest:(id)arg1 decisionHandler:(id)arg2;
