...
- (void)dealloc;
- (void)getCurrentWellnessEntryWithHandler:(id)arg1;
- (void)getWellnessEntriesAfterDate:(id)arg1 limit:(unsigned long long)arg2 handler:(id)arg3;
- (void)getWellnessEntriesBeforeDate:(id)arg1 limit:(unsigned long long)arg2 handler:(id)arg3;
- (id)init;
