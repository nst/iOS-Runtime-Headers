...
- (id)coredataStorage;
- (void)deleteRecords:(id)arg1 withCompletion:(id)arg2;
- (bool)deleteStorageWithObliterationOption:(bool)arg1;
- (void)fetchKeynamesFor:(id)arg1 predicate:(id)arg2 fetchLimit:(unsigned long long)arg3 fetchOffset:(unsigned long long)arg4 withCompletion:(id)arg5;
- (void)fetchRecordsFor:(id)arg1 predicate:(id)arg2 fetchLimit:(unsigned long long)arg3 fetchOffset:(unsigned long long)arg4 withCompletion:(id)arg5;
- (void)flush;
- (void)handleEmptyArrayError:(long long)arg1 completion:(id)arg2;
- (id)init;
- (id)initWithDirectory:(id)arg1 readOnly:(bool)arg2;
- (id)queue;
- (bool)readOnly;
- (id)removeBadObjects:(id)arg1;
- (void)saveRecords:(id)arg1 andFlush:(bool)arg2 withCompletion:(id)arg3;
- (void)saveRecords:(id)arg1 withCompletion:(id)arg2;
- (void)scheduleMaintenance;
- (void)scheduleMaintenanceWithName:(id)arg1;
- (void)scheduleStorageCullingWithName:(id)arg1;
- (void)updateRecords:(id)arg1 withCompletion:(id)arg2;
