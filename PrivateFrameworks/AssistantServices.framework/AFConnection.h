...
- (void)_tellSpeechDelegateToPerformTwoShotPromptWithType:(int)arg1 reply:(id /* block */)arg2;
...
- (void)_willStartRequestForSpeech:(BOOL)arg1 analyticsEventProvider:(id /* block */)arg2;
- (unsigned int)audioSessionID;
- (float)averagePower;
- (void)boostedPreheatWithStyle:(int)arg1 completion:(id /* block */)arg2;
- (void)cancelRequest;
- (void)cancelSpeech;
...
- (void)preheatWithStyle:(int)arg1 forOptions:(id)arg2;
