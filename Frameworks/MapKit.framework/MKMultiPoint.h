...
- (void)_setCoordinates:(const struct CLLocationCoordinate2D { double x1; double x2; }*)arg1 count:(unsigned int)arg2;
- (void)_setPoints:(const struct { double x1; double x2; }*)arg1 count:(unsigned int)arg2;
- (void)_wrapAroundTheDateline:(const struct CLLocationCoordinate2D { double x1; double x2; }*)arg1 count:(unsigned int)arg2;
- (struct { struct { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })boundingMapRect;
- (struct CLLocationCoordinate2D { double x1; double x2; })coordinate;
- (void)dealloc;
- (void)getCoordinates:(struct CLLocationCoordinate2D { double x1; double x2; }*)arg1 range:(struct _NSRange { unsigned int x1; unsigned int x2; })arg2;
