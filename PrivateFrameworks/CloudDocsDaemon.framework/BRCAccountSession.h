...
@interface BRCAccountSession : NSObject <BRCCloudDocsAppsObserver, BRCIndexingArbiter, BRCPQLDBCorruptionHandler> {
    ...
    unsigned int  _availableDiskSpace;
    ...
    BOOL  _isDBOpened;
    BOOL  _isGreedy;
    unsigned int  _lastDiskSpaceCheckTime;
...
@property (nonatomic, readonly) unsigned int availableDiskSpace;
...
- (BOOL)_setupBackupDetector:(struct backup_detector { unsigned int x1; unsigned int x2; unsigned int x3; }*)arg1 error:(id*)arg2;
...
- (void)_startWatcher;
- (BOOL)_stepBackupDetector:(struct backup_detector { unsigned int x1; unsigned int x2; unsigned int x3; })arg1 newState:(struct backup_detector { unsigned int x1; unsigned int x2; unsigned int x3; }*)arg2 error:(id*)arg3;
...
- (unsigned int)availableDiskSpace;
- (void)availableDiskSpaceDidChange;
- (unsigned int)availableDiskSpaceUsingCache:(BOOL)arg1;
- (unsigned int)availableDiskSpaceUsingCache:(BOOL)arg1 schedulingPendingDiskItemsIfNeeded:(BOOL)arg2;
...
- (BOOL)createAppLibraryOnDisk:(id)arg1 createdRoot:(BOOL*)arg2 createdDocuments:(BOOL*)arg3 rootFileID:(unsigned int*)arg4;
...
- (BOOL)createSharedAppLibraryOnDiskWithMangledID:(id)arg1 createdRoot:(BOOL*)arg2 rootFileID:(unsigned int*)arg3;
...
- (id)directoryItemIDByFileID:(unsigned int)arg1;
- (id)directoryItemIDByFileID:(unsigned int)arg1 db:(id)arg2;
...
- (id)itemByFileID:(unsigned int)arg1;
- (id)itemByFileID:(unsigned int)arg1 db:(id)arg2;
- (id)itemByRowID:(unsigned int)arg1;
- (id)itemByRowID:(unsigned int)arg1 db:(id)arg2;
- (id)itemIDByRowID:(unsigned int)arg1;
- (id)itemIDByRowID:(unsigned int)arg1 db:(id)arg2;
- (struct PQLResultSet { Class x1; }*)itemsNeedingIndexingEnumeratorWithMinNotifRank:(unsigned int)arg1 maxNotifRank:(unsigned int)arg2;
...
- (unsigned int)totalEvictableSizeWithAccessTimeDelta:(double)arg1;
