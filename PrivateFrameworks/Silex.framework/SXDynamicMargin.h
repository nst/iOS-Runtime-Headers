...
- (id)initWithTop:(struct _SXConvertibleValue { double x1; unsigned long long x2; })arg1 andBottom:(struct _SXConvertibleValue { double x1; unsigned long long x2; })arg2;
