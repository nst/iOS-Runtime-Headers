...
@property (nonatomic, copy) id commandBlock;
...
- (id)initWithMMCS:(id)arg1 itemGroup:(id)arg2 operation:(id)arg3 progress:(id)arg4 command:(id)arg5 start:(id)arg6 completionHandler:(id)arg7;
- (id)itemGroup;
