...
- (void)connection:(VSSpeechConnection *)arg1 speechRequest:(VSSpeechRequest *)arg2 willSpeakMark:(long)arg3 inRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg4;
