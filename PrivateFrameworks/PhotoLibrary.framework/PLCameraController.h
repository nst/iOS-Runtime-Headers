...
@class <PLCameraControllerDelegate>, AVCaptureDevice, AVCaptureDeviceInput, AVCaptureInput, AVCaptureMovieFileOutput, AVCaptureOutput, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoPreviewLayer, NSString, NSTimer, SBSAccelerometer;
