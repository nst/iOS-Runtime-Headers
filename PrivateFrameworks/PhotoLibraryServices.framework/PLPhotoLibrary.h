...
+ (id)dcimDirectory;
+ (id)dcimDirectoryURL;
+ (unsigned int)defaultUnverifiedFaceCountThreshold;
...
- (void)addSidecarFileInfo:(id)arg1 toAsset:(id)arg2 atIndex:(unsigned int)arg3;
- (BOOL)addSidecarFileToAsset:(id)arg1 atIndex:(unsigned int)arg2 sidecarURL:(id)arg3 withFilename:(id)arg4 originalFilename:(id)arg5 compressedSize:(id)arg6 captureDate:(id)arg7 modificationDate:(id)arg8 uniformTypeIdentifier:(id)arg9;
...
- (void)performBlock:(id /* block */)arg1 completionHandler:(id /* block */)arg2 withPriority:(int)arg3;
