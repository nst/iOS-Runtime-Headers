...
- (bool)onQueue:(id)arg1 forGlobalProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 addListener:(id)arg4;
- (bool)onQueue:(id)arg1 forGlobalProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 removeListener:(id)arg4;
- (bool)onQueue:(id)arg1 forInputProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 addListener:(id)arg4;
- (bool)onQueue:(id)arg1 forInputProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 removeListener:(id)arg4;
- (bool)onQueue:(id)arg1 forMasterGlobalProperty:(unsigned int)arg2 addListener:(id)arg3;
- (bool)onQueue:(id)arg1 forMasterGlobalProperty:(unsigned int)arg2 removeListener:(id)arg3;
- (bool)onQueue:(id)arg1 forMasterInputProperty:(unsigned int)arg2 addListener:(id)arg3;
- (bool)onQueue:(id)arg1 forMasterInputProperty:(unsigned int)arg2 removeListener:(id)arg3;
- (bool)onQueue:(id)arg1 forMasterOutputProperty:(unsigned int)arg2 addListener:(id)arg3;
- (bool)onQueue:(id)arg1 forMasterOutputProperty:(unsigned int)arg2 removeListener:(id)arg3;
- (bool)onQueue:(id)arg1 forOutputProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 addListener:(id)arg4;
- (bool)onQueue:(id)arg1 forOutputProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 removeListener:(id)arg4;
- (bool)onQueue:(id)arg1 forProperty:(unsigned int)arg2 scope:(unsigned int)arg3 ofElement:(unsigned int)arg4 addListener:(id)arg5;
- (bool)onQueue:(id)arg1 forProperty:(unsigned int)arg2 scope:(unsigned int)arg3 ofElement:(unsigned int)arg4 removeListener:(id)arg5;
- (id)ownedObjectIDs;
