...
@interface CLIndoorSettings : NSObject {
    ...
    struct duration<int, std::__1::ratio<1, 1000000000> > { 
        int __rep_; 
    ...
    struct duration<int, std::__1::ratio<1, 1> > { 
        int __rep_; 
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{duration<int' */ struct  errorBackoffDuration; /* unknown property attribute:  1000000000> >=q} */
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{duration<int' */ struct  tilePrefetchActivityInterval; /* unknown property attribute:  1> >=q} */
@property (nonatomic) struct optional<unsigned long> { bool x1; struct aligned_storage<unsigned long> { union dummy_u { BOOL x_1_2_1[4]; struct a4 { } x_1_2_2; } x_2_1_1; } x2; } tilePrefetchMaxCount;
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{duration<int' */ struct  tilePrefetchRelevancyWindow; /* unknown property attribute:  1> >=q} */
...
- (id)disabledVenues;
- (struct duration<int, std::__1::ratio<1, 1000000000> > { int x1; })errorBackoffDuration;
- (id)fakeLastFix;
- (id)forcedVenues;
...
- (void)setErrorBackoffDuration:(struct duration<int, std::__1::ratio<1, 1000000000> > { int x1; })arg1;
...
- (void)setTilePrefetchActivityInterval:(struct duration<int, std::__1::ratio<1, 1> > { int x1; })arg1;
- (void)setTilePrefetchMaxCount:(struct optional<unsigned long> { bool x1; struct aligned_storage<unsigned long> { union dummy_u { BOOL x_1_2_1[4]; struct a4 { } x_1_2_2; } x_2_1_1; } x2; })arg1;
...
- (void)setTilePrefetchRelevancyWindow:(struct duration<int, std::__1::ratio<1, 1> > { int x1; })arg1;
- (void)setVenueGroupDistance:(double)arg1;
- (struct duration<int, std::__1::ratio<1, 1> > { int x1; })tilePrefetchActivityInterval;
- (const struct optional<unsigned long> { bool x1; struct aligned_storage<unsigned long> { union dummy_u { BOOL x_1_2_1[4]; struct a4 { } x_1_2_2; } x_2_1_1; } x2; }*)tilePrefetchMaxCount;
...
- (struct duration<int, std::__1::ratio<1, 1> > { int x1; })tilePrefetchRelevancyWindow;
