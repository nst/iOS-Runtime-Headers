...
- (id)delegate;
- (id)description;
- (void)fetchChangesWithChangeToken:(id)arg1 desiredKeys:(id)arg2 fetchAllChanges:(bool)arg3 qualityOfService:(long long)arg4 completion:(id)arg5;
- (id)initWithDatabase:(id)arg1 delegate:(id)arg2 recordZoneID:(id)arg3;
- (bool)isZoneReady;
- (void)performActionWithRecordZone:(id)arg1;
- (id)recordZoneID;
