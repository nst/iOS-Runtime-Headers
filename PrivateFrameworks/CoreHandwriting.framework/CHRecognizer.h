...
@interface CHRecognizer : NSObject {
    ...
    struct CHNeuralNetwork { int (**x1)(); int x2; char *x3; unsigned int x4; unsigned int *x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; } * _engine;
    ...
    struct CHNeuralNetwork { int (**x1)(); int x2; char *x3; unsigned int x4; unsigned int *x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; } * _freeformEngine;
    ...
    struct VariantMap { int *x1; int *x2; int *x3; int x4; int *x5; unsigned int x6; } * _scVariantMap;
    struct VariantMap { int *x1; int *x2; int *x3; int x4; int *x5; unsigned int x6; } * _tcVariantMap;
}

@property (nonatomic, retain) NSCharacterSet *activeCharacterSet;
@property (nonatomic, copy) CHDrawing *cachedDrawing;
@property (nonatomic) /* Warning: unhandled struct encoding: '{map<std::__1::set<unsigned long' */ struct  cachedResults; /* unknown property attribute:  true> >=L}}} */
@property (nonatomic) struct CHNeuralNetwork { int (**x1)(); int x2; char *x3; unsigned int x4; unsigned int *x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; }*engine;
@property (nonatomic) /* Warning: unhandled struct encoding: '{Network=II{basic_string<char' */ struct *formatGrammarFST; /* unknown property attribute:  std::__1::less<uint128> >=L}}}} */
@property (nonatomic) struct CHNeuralNetwork { int (**x1)(); int x2; char *x3; unsigned int x4; unsigned int *x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; }*freeformEngine;
@property (nonatomic) void**icuTransliterator;
@property (nonatomic) void*languageModel;
@property (nonatomic) unsigned int lastCharacterStrokeCount;
@property (nonatomic) NSMutableIndexSet *lastCharacterStrokeIndexes;
@property (nonatomic, retain) NSURL *learningDictionaryURL;
@property (nonatomic) unsigned int maxRecognitionResultCount;
...
@property (nonatomic) struct VariantMap { int *x1; int *x2; int *x3; int x4; int *x5; unsigned int x6; }*scVariantMap;
@property (nonatomic) struct VariantMap { int *x1; int *x2; int *x3; int x4; int *x5; unsigned int x6; }*tcVariantMap;
...
- (id)recognitionResultsForMultipleCharacterDrawing:(id)arg1 sortedStrokeIndices:(struct vector<unsigned long, std::__1::allocator<unsigned long> > { unsigned long *x1; unsigned long *x2; struct __compressed_pair<unsigned long *, std::__1::allocator<unsigned long> > { unsigned long *x_3_1_1; } x3; }*)arg2 network:(struct Network { unsigned int x1; unsigned int x2; struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > { struct __compressed_pair<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >::__rep, std::__1::allocator<char> > { struct __rep { union { struct __long { unsigned int x_1_5_1; unsigned int x_1_5_2; char *x_1_5_3; } x_1_4_1; struct __short { union { unsigned char x_1_6_1; BOOL x_1_6_2; } x_2_5_1; BOOL x_2_5_2[11]; } x_1_4_2; struct __raw { unsigned long x_3_5_1[3]; } x_1_4_3; } x_1_3_1; } x_1_2_1; } x_3_1_1; } x3; unsigned int x4; struct vector<NetworkNode, std::__1::allocator<NetworkNode> > { struct NetworkNode {} *x_5_1_1; struct NetworkNode {} *x_5_1_2; struct __compressed_pair<NetworkNode *, std::__1::allocator<NetworkNode> > { struct NetworkNode {} *x_3_2_1; } x_5_1_3; } x5; struct vector<NetworkEdge, std::__1::allocator<NetworkEdge> > { struct NetworkEdge {} *x_6_1_1; struct NetworkEdge {} *x_6_1_2; struct __compressed_pair<NetworkEdge *, std::__1::allocator<NetworkEdge> > { struct NetworkEdge {} *x_3_2_1; } x_6_1_3; } x6; }*)arg3 options:(id)arg4 ch:(struct Hanzi { struct vector<std::__1::vector<Coord, std::__1::allocator<Coord> >, std::__1::allocator<std::__1::vector<Coord, std::__1::allocator<Coord> > > > { struct vector<Coord, std::__1::allocator<Coord> > {} *x_1_1_1; struct vector<Coord, std::__1::allocator<Coord> > {} *x_1_1_2; struct __compressed_pair<std::__1::vector<Coord, std::__1::allocator<Coord> > *, std::__1::allocator<std::__1::vector<Coord, std::__1::allocator<Coord> > > > { struct vector<Coord, std::__1::allocator<Coord> > {} *x_3_2_1; } x_1_1_3; } x1; }*)arg5 shouldCancel:(id /* block */)arg6;
...
- (struct VariantMap { int *x1; int *x2; int *x3; int x4; int *x5; unsigned int x6; }*)scVariantMap;
- (void)setActiveCharacterSet:(id)arg1;
- (void)setCachedDrawing:(id)arg1;
- (void)setCachedResults:(struct map<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> >, std::__1::vector<CHCandidateResult, std::__1::allocator<CHCandidateResult> >, std::__1::less<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> > >, std::__1::allocator<std::__1::pair<const std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> >, std::__1::vector<CHCandidateResult, std::__1::allocator<CHCandidateResult> > > > > { struct __tree<std::__1::__value_type<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> >, std::__1::vector<CHCandidateResult, std::__1::allocator<CHCandidateResult> > >, std::__1::__map_value_compare<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> >, std::__1::__value_type<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> >, std::__1::vector<CHCandidateResult, std::__1::allocator<CHCandidateResult> > >, std::__1::less<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> > >, true>, std::__1::allocator<std::__1::__value_type<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> >, std::__1::vector<CHCandidateResult, std::__1::allocator<CHCandidateResult> > > > > { struct __tree_end_node<std::__1::__tree_node_base<void *> *> {} *x_1_1_1; struct __compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *> *>, std::__1::allocator<std::__1::__tree_node<std::__1::__value_type<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> >, std::__1::vector<CHCandidateResult, std::__1::allocator<CHCandidateResult> > >, void *> > > { struct __tree_end_node<std::__1::__tree_node_base<void *> *> { struct __tree_node_base<void *> {} *x_1_3_1; } x_2_2_1; } x_1_1_2; struct __compressed_pair<unsigned long, std::__1::__map_value_compare<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> >, std::__1::__value_type<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> >, std::__1::vector<CHCandidateResult, std::__1::allocator<CHCandidateResult> > >, std::__1::less<std::__1::set<unsigned long, std::__1::less<unsigned long>, std::__1::allocator<unsigned long> > >, true> > { unsigned long x_3_2_1; } x_1_1_3; } x1; })arg1;
- (void)setEngine:(struct CHNeuralNetwork { int (**x1)(); int x2; char *x3; unsigned int x4; unsigned int *x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; }*)arg1;
...
- (void)setFreeformEngine:(struct CHNeuralNetwork { int (**x1)(); int x2; char *x3; unsigned int x4; unsigned int *x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; }*)arg1;
- (void)setIcuTransliterator:(void**)arg1;
- (void)setLanguageModel:(void*)arg1;
- (void)setLastCharacterStrokeCount:(unsigned int)arg1;
- (void)setLastCharacterStrokeIndexes:(id)arg1;
- (void)setLearningDictionaryURL:(id)arg1;
- (void)setMaxRecognitionResultCount:(unsigned int)arg1;
...
- (void)setScVariantMap:(struct VariantMap { int *x1; int *x2; int *x3; int x4; int *x5; unsigned int x6; }*)arg1;
