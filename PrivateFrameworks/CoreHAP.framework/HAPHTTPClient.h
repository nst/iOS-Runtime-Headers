...
- (void)sendGETRequestToURL:(id)arg1 timeout:(double)arg2 completionHandler:(id)arg3;
...
- (void)sendPUTRequestToURL:(id)arg1 withRequestObject:(id)arg2 serializationType:(unsigned long long)arg3 timeout:(double)arg4 completionHandler:(id)arg5;
