...
- (void)_renderContent;
- (void)_renderSynchronouslyForTime:(double)arg1 preRender:(id)arg2 postRender:(id)arg3;
- (void)_renderToIOSurfaceID:(unsigned int)arg1 scaleFactor:(float)arg2 asynchronous:(bool)arg3 preRender:(id)arg4 postRender:(id)arg5;
- (void)_reshape;
...
- (void)_vsyncRenderForTime:(double)arg1 preRender:(id)arg2 postRender:(id)arg3;
...
- (void)setDynamicRenderBlock:(id)arg1;
