...
@interface PHQuery : NSObject <NSCopying, NSPredicateVisitor> {
    ...
    unsigned int  _containerSortingAttributesIndexValue;
    unsigned int  _containerToObjectRelationshipIndexValue;
    PHFetchOptions * _fetchOptions;
    NSFetchRequest * _fetchRequest;
    NSString * _fetchType;
    NSPredicate * _filterPredicate;
    unsigned int  _filteringAttributesIndexValue;
    NSMutableSet * _filteringKeys;
    NSMutableSet * _filteringObjectKeyPaths;
    NSMutableSet * _filteringOids;
    unsigned int  _filteringRelationshipsIndexValue;
    NSMutableDictionary * _filteringRelationshipsIndexValueByBaseEntityName;
    unsigned int  _objectToContainerRelationshipIndexValue;
...
+ (id)queryForAssetCollectionsContainingAssets:(id)arg1 withType:(int)arg2;
...
+ (id)queryForAssetCollectionsWithType:(int)arg1 localIdentifiers:(id)arg2;
...
+ (id)queryForCollectionListsWithType:(int)arg1 localIdentifiers:(id)arg2;
...
- (void)_setCollectionFetchType:(int)arg1;
...
- (unsigned int)containerSortingAttributesIndexValue;
- (unsigned int)containerToObjectRelationshipIndexValue;
...
- (id)fetchType;
- (id)filterPredicate;
- (unsigned int)filteringAttributesIndexValue;
- (id)filteringOids;
- (unsigned int)filteringRelationshipsIndexValue;
...
- (unsigned int)objectToContainerRelationshipIndexValue;
- (id)photoLibrary;
- (id)seedOIDs;
