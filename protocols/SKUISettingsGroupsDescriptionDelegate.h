...
- (void)settingsGroupsDescription:(void *)arg1 dismissViewController:(void *)arg2 animated:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 8: SKUISettingsGroupsDescription *, UIViewController *, bool, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
- (void)settingsGroupsDescription:(void *)arg1 presentViewController:(void *)arg2 animated:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 8: SKUISettingsGroupsDescription *, UIViewController *, bool, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
