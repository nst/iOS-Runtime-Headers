...
- (void)migrateCheckingNecessity:(void *)arg1 lastRelevantPlugin:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: BOOL, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, void*
