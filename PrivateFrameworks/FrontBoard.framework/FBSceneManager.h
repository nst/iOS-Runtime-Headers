...
- (void)_applyMutableSettings:(id)arg1 toScene:(id)arg2 asUpdate:(bool)arg3 withTransitionContext:(id)arg4 completion:(id)arg5;
...
- (void)_enqueueInternalObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 withBlock:(id)arg3;
- (void)_enqueueObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 preferInternal:(bool)arg3 withBlock:(id)arg4;
- (void)_enqueueObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 withBlock:(id)arg3;
- (id)_eventForScene:(id)arg1 withName:(id)arg2 block:(id)arg3;
...
- (void)_updateScene:(id)arg1 withSettings:(id)arg2 transitionContext:(id)arg3 completion:(id)arg4;
...
- (void)scene:(id)arg1 handleUpdateToSettings:(id)arg2 withTransitionContext:(id)arg3 completion:(id)arg4;
