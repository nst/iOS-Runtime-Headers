...
+ (BOOL)getDPDAttributesForMode:(int)arg1 isWakeUp:(BOOL)arg2 isNAT:(BOOL)arg3 retry:(unsigned int*)arg4 timeout:(unsigned int*)arg5 frequency:(unsigned int*)arg6;
