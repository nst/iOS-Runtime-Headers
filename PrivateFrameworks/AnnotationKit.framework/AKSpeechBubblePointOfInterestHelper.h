...
+ (struct CGPoint { float x1; float x2; })_endPointOfBoundingLineSegmentFromPointyPointThroughtPoint:(struct CGPoint { float x1; float x2; })arg1 forAnnotation:(id)arg2;
+ (float)maxOutset;
+ (float)minOutset;
