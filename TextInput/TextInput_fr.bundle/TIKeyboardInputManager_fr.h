/* Generated by RuntimeBrowser.
   Image: /System/Library/TextInput/TextInput_fr.bundle/TextInput_fr
 */
...
@interface TIKeyboardInputManager_fr : TIKeyboardInputManagerZephyr <UIKeyboardKeyDelegate> {
}
...
- (BOOL)willEnterTouchPhase:(int)arg1 forKey:(id)arg2;
- (id)displayStringOverrideForKey:(id)arg1;
- (int)overrideState:(int)arg1 forKey:(id)arg2;
