...
- (void).cxx_destruct;
- (void)_checkContactlessValidity:(unsigned long long)arg1 authorizationValidity:(unsigned long long)arg2 performWork:(id)arg3;
- (void)_checkContactlessValidity:(unsigned long long)arg1 performWork:(id)arg2;
- (void)_handleConventionalTransactionWithContext:(id)arg1;
- (void)_handleFelicaTransitTransactionWithContext:(id)arg1;
- (void)_internalQueue_deactivateSessionWithCompletion:(id)arg1;
- (void)_internalQueue_getContactlessAndAuthorizationValidityAndPerformWork:(id)arg1;
...
- (void)_internalQueue_updateContactlessValidityAndPerformWork:(id)arg1;
...
- (bool)_sessionQueue_startContactlessSessionWithSuccessfulCompletionOnInternalQueue:(id)arg1;
...
- (id)credential;
- (id)currentPass;
- (void)deactivateSessionWithCompletion:(id)arg1;
- (id)deactivationCompletionBlocks;
- (void)dealloc;
- (bool)deferAuthorization;
- (id)delegate;
- (id)fieldDetector;
- (void)getAllVASPasses:(id)arg1;
- (bool)inServiceMode;
