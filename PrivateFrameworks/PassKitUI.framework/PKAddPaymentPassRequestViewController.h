...
- (void)_displayTermsForEligibilityResponse:(id)arg1 withCompletion:(id)arg2;
...
- (void)_setupTermsControllerHandlerWithNavigationController:(id)arg1 forCompletion:(id)arg2;
- (void)_showEligibilityIssueForStatus:(long long)arg1 learnMoreURL:(id)arg2 completion:(id)arg3;
- (void)dealloc;
- (id)delegate;
- (bool)hidePrivacy;
