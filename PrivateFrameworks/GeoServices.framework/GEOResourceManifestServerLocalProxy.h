...
@class <GEOResourceManifestServerProxyDelegate>, GEOActiveTileGroup, GEORegionalResourcesInfo, GEORegionalResourcesLoader, GEOResourceLoader, GEOResourceManifestDownload, NSError, NSLock, NSMutableData, NSMutableDictionary, NSString, NSTimer, NSURLConnection;
