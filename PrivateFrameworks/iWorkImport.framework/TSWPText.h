...
- (id)layoutMargins;
- (id)layoutText:(id)arg1 context:(id)arg2 kind:(int)arg3 minSize:(struct CGSize { float x1; float x2; })arg4 maxSize:(struct CGSize { float x1; float x2; })arg5 anchor:(struct CGPoint { float x1; float x2; })arg6 flags:(int)arg7;
