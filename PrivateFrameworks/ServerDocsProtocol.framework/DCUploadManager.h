...
- (void).cxx_destruct;
- (unsigned long long)_addHandlerToCallForItemAtSubpath:(id)arg1 completionHandler:(id)arg2;
...
- (bool)_needsToStartUploadingItemAtSubpath:(id)arg1 completionHandler:(id)arg2;
- (void)_removePendingCompletionHandlersForCompletedUploads;
- (void)cancelAllUploadTasks;
- (bool)isUploadingFile:(id)arg1;
- (void)uploadFile:(id)arg1 usingRemoteFileManager:(id)arg2 activityInfo:(id)arg3 completionHandler:(id)arg4;
