...
@property (nonatomic) struct CGPoint { float x1; float x2; } holdPoint;
...
- (id)gesture;
- (struct CGPoint { float x1; float x2; })holdPoint;
- (id)init;
- (BOOL)isOptional;
- (id)longPressAction;
- (id)longPressGesture;
...
- (void)setHoldPoint:(struct CGPoint { float x1; float x2; })arg1;
