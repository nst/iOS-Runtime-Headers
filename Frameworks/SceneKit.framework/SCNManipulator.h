...
- (BOOL)_applyWithEvent:(struct { id x1; unsigned char x2; /* Warning: Unrecognized filer type: 'G' using 'void*' */ void*x3; void*x4; out int x5; in void*x6; void*x7; float x8; float x9; })arg1;
...
- (void)_snapPositionToAlign:(void *)arg1 original:(void *)arg2 unit:(void *)arg3 axisMove:(void *)arg4 rayStart:(void *)arg5 rayDir:(void *)arg6 didSnap:(void *)arg7 snapIndexes:(void *)arg8; // needs 8 arg types, found 5: struct SCNVector3 { float x1; float x2; float x3; }, float, bool, bool*, int*
- (void)_updateCloneStateWithEvent:(struct { id x1; unsigned char x2; /* Warning: Unrecognized filer type: 'G' using 'void*' */ void*x3; void*x4; out int x5; in void*x6; void*x7; float x8; float x9; })arg1;
...
- (const struct { float x1; struct __C3DNode {} *x2; float x3; }*)snapInfoAtIndex:(unsigned int)arg1 axis:(int)arg2;
- (id)target;
- (id)targets;
...
- (void)updateItemsRotation:(struct __C3DQuaternion { float x1; float x2; float x3; float x4; })arg1;
- (void)validateClones;
- (int)xAlignment;
- (int)yAlignment;
- (int)zAlignment;
