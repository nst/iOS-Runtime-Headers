...
+ (struct __CFNumberFormatter { }*)createHarmonizedCFNumberFormatterWithLocale:(struct __CFLocale { }*)arg1 style:(long)arg2;
...
+ (unsigned int)groupingSizeForLocale:(struct __CFLocale { }*)arg1;
+ (void)initialize;
...
- (id)p_arrayOfString:(id)arg1 ofCount:(unsigned int)arg2;
- (id)p_createDictionaryOfCurrencyFormattersForCurrencies:(struct __CFArray { }*)arg1;
- (struct __CFNumberFormatter { }*)p_createHarmonizedCFNumberFormatterOfStyle:(long)arg1;
