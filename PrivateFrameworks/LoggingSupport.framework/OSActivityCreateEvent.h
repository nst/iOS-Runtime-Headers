...
@interface OSActivityCreateEvent : OSActivityEvent {
    unsigned int  _creatorActivityID;
    unsigned int  _creatorProcessUniqueID;
    unsigned int  _senderProgramCounter;
}

@property (readonly) unsigned int creatorActivityID;
@property (readonly) unsigned int creatorProcessUniqueID;
@property (readonly) unsigned int senderProgramCounter;

- (void)_addProperties:(id)arg1;
- (unsigned int)creatorActivityID;
- (unsigned int)creatorProcessUniqueID;
