...
- (id)_createSnapshotWithGroupID:(id)arg1 newSnapshotCreator:(id)arg2;
...
- (void)_noteDirtied;
- (void)_queue_accessSnapshotsWithBlock:(id)arg1 completion:(id)arg2;
...
- (void)_scheduleArchivingIfNecessaryWithCompletion:(id)arg1;
- (void)_synchronizeDataStoreWithCompletion:(id)arg1;
- (void)beginSnapshotAccessTransaction:(id)arg1 completion:(id)arg2;
- (id)bundleIdentifier;
...
- (void)deleteSnapshotsForGroupID:(id)arg1 predicateBuilder:(id)arg2;
- (void)deleteSnapshotsMatchingPredicate:(id)arg1;
- (void)deleteSnapshotsUsingPredicateBuilder:(id)arg1;
- (id)description;
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;
- (id)descriptionWithMultilinePrefix:(id)arg1;
- (void)encodeWithCoder:(id)arg1;
- (void)generateImageForSnapshot:(id)arg1 dataProvider:(id)arg2 writeToFile:(bool)arg3 didGenerateImage:(id)arg4 didSaveImage:(id)arg5;
- (id)identity;
- (id)init;
