...
@property (nonatomic, readonly) struct { int x1; int x2; unsigned int x3; int x4; } compositionTime;
...
- (id)initUsingSession:(id)arg1 withRenderContext:(id)arg2 compositionFrame:(struct OpaqueFigVideoCompositorFrame { }*)arg3 atTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg4 usingSources:(id)arg5 instruction:(id)arg6;
- (id)renderContext;
