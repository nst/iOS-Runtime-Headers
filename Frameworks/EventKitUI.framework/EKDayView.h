...
@class <EKDayViewDelegate>, CalendarModel, EKDayTimeView, UIImageView, UIScrollAnimation, EKDayViewContent, UIView, <EKDayViewDataSource>, UIScrollView, NSDate, EKDayOccurrenceView;
