...
- (void)_handleAudioStreamSettingUpdate:(unsigned long long)arg1 completionHandler:(id)arg2 error:(id)arg3;
- (void)_issueUpdateAudioStreamSettingRequest:(unsigned long long)arg1 completionHandler:(id)arg2;
- (void)_updateAudioStreamSetting:(unsigned long long)arg1 completionHandler:(id)arg2;
...
- (void)updateAudioStreamSetting:(unsigned long long)arg1 completionHandler:(id)arg2;
