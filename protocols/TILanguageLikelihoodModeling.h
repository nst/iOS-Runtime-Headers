...
- (void)priorProbabilityForLanguages:(void *)arg1 recipient:(void *)arg2 handler:(void *)arg3; // needs 3 arg types, found 10: NSArray *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSString *, float, bool*, void*
