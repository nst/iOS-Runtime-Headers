...
@interface NNMKHTMLParser : NSObject {
    ...
    bool_cancelled;
    bool_containsBlacklistedElements;
    bool_isLastCharAddedLineBreak;
    bool*_partiallyParsed;
}

@property bool cancelled;
@property bool containsBlacklistedElements;
@property unsigned long long currentListLevel;
@property unsigned long long currentQuoteLevel;
