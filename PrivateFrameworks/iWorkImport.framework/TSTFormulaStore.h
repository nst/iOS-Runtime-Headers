...
+ (struct TSUCellCoord { unsigned short x1; unsigned char x2; unsigned char x3; })coordFromIndex:(unsigned int)arg1;
+ (unsigned int)indexFromCoord:(const struct TSUCellCoord { unsigned short x1; unsigned char x2; unsigned char x3; }*)arg1;
