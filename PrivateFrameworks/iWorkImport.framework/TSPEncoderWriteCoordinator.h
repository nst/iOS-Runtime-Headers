...
@class <TSPEncoder>, <TSPEncoderWriteCoordinatorDelegate>, NSHashTable, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, NSURL, TSPArchiverManager, TSPObjectContext, TSURetainedPointerKeyDictionary;
...
- (void)writeRootObject:(id)arg1 completion:(id)arg2;
