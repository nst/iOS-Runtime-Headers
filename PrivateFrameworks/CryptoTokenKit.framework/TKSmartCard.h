...
- (void)beginSessionWithReply:(id)arg1;
...
- (void)endSession;
- (void)endSessionWithReply:(id)arg1;
- (void)handleApduResponse:(id)arg1 body:(id)arg2 le:(unsigned long long)arg3 isCase4:(bool)arg4 error:(id)arg5 reply:(id)arg6;
- (bool)inSessionWithError:(id*)arg1 executeBlock:(id)arg2;
- (id)initWithSlot:(id)arg1;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void*)arg4;
- (void)releaseSessionWithReply:(id)arg1;
- (id)remoteSessionWithErrorHandler:(id)arg1;
- (void)reserveExclusive:(bool)arg1 reply:(id)arg2;
- (bool)revalidate;
- (bool)selectApplication:(id)arg1 error:(id*)arg2;
- (void)sendIns:(unsigned char)arg1 p1:(unsigned char)arg2 p2:(unsigned char)arg3 data:(id)arg4 le:(id)arg5 reply:(id)arg6;
...
- (id)slot;
- (bool)synchronous;
- (void)transmitChunkedIns:(unsigned char)arg1 p1:(unsigned char)arg2 p2:(unsigned char)arg3 data:(id)arg4 fromOffset:(unsigned long long)arg5 realLe:(unsigned long long)arg6 chained:(bool)arg7 isCase4:(bool)arg8 reply:(id)arg9;
- (void)transmitRequest:(id)arg1 reply:(id)arg2;
- (void)unreserve;
