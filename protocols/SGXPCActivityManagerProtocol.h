...
- (void)registerForActivity:(void *)arg1 handler:(void *)arg2; // needs 2 arg types, found 7: int, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSObject<OS_xpc_object> *, void*
