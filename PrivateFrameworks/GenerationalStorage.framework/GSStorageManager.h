...
+ (BOOL)_isPermanentStorageSupportedForStatFSInfo:(struct statfs { unsigned int x1; int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; struct fsid { int x_8_1_1[2]; } x8; unsigned int x9; unsigned int x10; unsigned int x11; unsigned int x12; BOOL x13[16]; BOOL x14[1024]; BOOL x15[1024]; unsigned int x16[8]; }*)arg1 error:(id*)arg2;
+ (void)initialize;
+ (id)manager;
