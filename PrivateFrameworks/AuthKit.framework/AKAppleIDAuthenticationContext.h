...
- (void)cdpContext:(id)arg1 performSilentRecoveryTokenRenewal:(id)arg2;
- (id)cdpUiProvider;
- (id)clientInfo;
- (id)companionDevice;
...
- (void)dismissICSCRecoveryUIWithCompletion:(id)arg1;
...
- (void)presentICSCRecoveryUIWithInfo:(id)arg1 completion:(id)arg2;
