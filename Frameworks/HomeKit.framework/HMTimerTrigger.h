...
- (id)_serializeForAdd;
- (void)_updateFireDate:(id)arg1 completionHandler:(id)arg2;
- (void)_updateRecurrence:(id)arg1 completionHandler:(id)arg2;
- (void)_updateRecurrences:(id)arg1 completionHandler:(id)arg2;
- (void)_updateSignificantEvent:(id)arg1 completionHandler:(id)arg2;
- (void)_updateSignificantEventOffset:(id)arg1 completionHandler:(id)arg2;
- (void)_updateTimeZone:(id)arg1 completionHandler:(id)arg2;
- (void)dealloc;
...
- (void)updateSignificantEvent:(id)arg1 completionHandler:(id)arg2;
- (void)updateSignificantEventOffset:(id)arg1 completionHandler:(id)arg2;
