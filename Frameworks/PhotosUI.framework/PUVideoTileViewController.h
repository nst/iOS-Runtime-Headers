...
@interface PUVideoTileViewController : PUTileViewController <PUAssetViewModelChangeObserver, PUBrowsingVideoPlayerChangeObserver, PUVideoPlayerViewDelegate> {
    ...
    id  __readyForDisplayCompletionHandler;
    struct CGSize { 
        double width; 
        double height; 
    }  __targetSize;
...
@property (setter=_setReadyForDisplayCompletionHandler:, nonatomic, copy) id _readyForDisplayCompletionHandler;
...
- (void)_setReadyForDisplayCompletionHandler:(id)arg1;
