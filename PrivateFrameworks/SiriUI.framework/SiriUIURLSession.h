...
- (id)imageTaskWithHTTPGetRequest:(id)arg1 client:(id)arg2 fitToSize:(struct CGSize { double x1; double x2; })arg3 fillColor:(id)arg4 userAgent:(id)arg5 completionHandler:(id)arg6;
...
- (id)imageTaskWithHTTPGetRequest:(id)arg1 client:(id)arg2 fitToSize:(struct CGSize { double x1; double x2; })arg3 incremental:(bool)arg4 progressHandler:(id)arg5 fillColor:(id)arg6 userAgent:(id)arg7;
- (id)init;
