...
@property (nonatomic) int clientConnectionCount;
...
@property (nonatomic, readonly) int*connectionReadyTimes;
...
- (void)addConnectionReadyTimes:(int)arg1;
- (void)addResumptionFailureErrors:(int)arg1;
- (void)addResumptionFailureTimes:(int)arg1;
- (void)addResumptionSuccessTimes:(int)arg1;
- (int)bytesReceived;
- (int)bytesSent;
...
- (int*)connectionReadyTimes;
- (int)connectionReadyTimesAtIndex:(unsigned int)arg1;
...
- (int*)resumptionFailureTimes;
- (int)resumptionFailureTimesAtIndex:(unsigned int)arg1;
- (unsigned int)resumptionFailureTimesCount;
- (int)resumptionSuccessCount;
- (int*)resumptionSuccessTimes;
- (int)resumptionSuccessTimesAtIndex:(unsigned int)arg1;
- (unsigned int)resumptionSuccessTimesCount;
- (void)setBytesReceived:(int)arg1;
- (void)setBytesSent:(int)arg1;
- (void)setClientConnectionCount:(int)arg1;
...
- (void)setConnectionReadyTimes:(int*)arg1 count:(unsigned int)arg2;
...
- (void)setResumptionFailureTimes:(int*)arg1 count:(unsigned int)arg2;
- (void)setResumptionSuccessCount:(int)arg1;
- (void)setResumptionSuccessTimes:(int*)arg1 count:(unsigned int)arg2;
