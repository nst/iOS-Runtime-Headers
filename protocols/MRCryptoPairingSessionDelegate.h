...
- (void)pairingSession:(void *)arg1 promptForSetupCodeWithCompletion:(void *)arg2; // needs 2 arg types, found 7: MRCryptoPairingSession *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, void*
