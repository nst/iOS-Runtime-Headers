...
- (void)canOfferToHandles:(id)arg1 completion:(id)arg2;
...
- (id)connection;
- (void)contactForPayload:(id)arg1 completion:(id)arg2;
- (void)crashDaemon;
- (void)dataForPayload:(id)arg1 completion:(id)arg2;
- (void)dealloc;
- (void)declineFriendshipRequest:(id)arg1 completion:(id)arg2;
- (void)decryptPayload:(id)arg1 withToken:(id)arg2 completion:(id)arg3;
- (id)delegate;
- (id)delegateQueue;
...
- (void)dumpStateWithCompletion:(id)arg1;
- (void)encryptPayload:(id)arg1 completion:(id)arg2;
...
- (void)favoritesForMaxCount:(id)arg1 completion:(id)arg2;
- (void)forceRefresh;
...
- (void)getDataForPerformanceRequest:(id)arg1;
...
- (void)handleAndLocationForPayload:(id)arg1 completion:(id)arg2;
- (void)handleIncomingAirDropURL:(id)arg1 completion:(id)arg2;
- (id)handles;
- (bool)hasModelInitialized;
- (oneway void)iCloudAccountNameWithCompletion:(id)arg1;
- (id)init;
...
- (void)isIn5XXGracePeriodWithCompletion:(id)arg1;
...
- (void)nearbyLocationsWithCompletion:(id)arg1;
...
- (id)serverProxy;
- (void)sessionHandleReport:(id)arg1;
