...
@interface APSAWDAirPlayDiscoveryDetailedModeStats : PBCodable <NSCopying> {
    ...
    unsigned int  _firstAWDLDeviceFoundMs;
    unsigned int  _firstSrcPresenceBeaconSentMs;
    struct { 
...
@property (nonatomic) unsigned int firstAWDLDeviceFoundMs;
@property (nonatomic) unsigned int firstSrcPresenceBeaconSentMs;
...
- (unsigned int)firstAWDLDeviceFoundMs;
- (unsigned int)firstSrcPresenceBeaconSentMs;
- (BOOL)hasApRSSI;
...
- (void)setFirstAWDLDeviceFoundMs:(unsigned int)arg1;
- (void)setFirstSrcPresenceBeaconSentMs:(unsigned int)arg1;
