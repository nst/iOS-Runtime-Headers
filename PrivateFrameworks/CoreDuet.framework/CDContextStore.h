...
- (void)enableHandlerForPredicateId:(unsigned long long)arg1 withOptions:(id)arg2 usingBlock:(id)arg3;
- (id)init;
- (void)initConnection;
- (long long)integerValueForKey:(id)arg1;
- (void)registerHandlerForPredicateString:(id)arg1 withOptions:(id)arg2 usingBlock:(id)arg3;
...
- (void)waitForeverForPredicateString:(id)arg1 withOptions:(id)arg2 handlerQueue:(id)arg3 handler:(id)arg4;
- (void)waitForeverForPredicteString:(id)arg1 withOptions:(id)arg2 handlerQueue:(id)arg3 handler:(id)arg4;
