...
- (oneway void)reportCallWithUUID:(NSUUID *)arg1 changedFrequencyData:(NSData *)arg2 forDirection:(int)arg3;
- (oneway void)reportCallWithUUID:(NSUUID *)arg1 crossDeviceIdentifier:(NSString *)arg2 changedBytesOfDataUsed:(int)arg3;
- (oneway void)reportCallWithUUID:(NSUUID *)arg1 endedAtDate:(NSDate *)arg2 privateReason:(int)arg3 failureContext:(CXCallFailureContext *)arg4;
