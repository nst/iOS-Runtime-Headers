...
+ (id)_readyDocumentPaperListForPrinter:(id)arg1 withDuplexMode:(int)arg2 contentSize:(struct CGSize { double x1; double x2; })arg3 scaleUpForRoll:(BOOL)arg4;
+ (id)_readyPaperListForPrinter:(id)arg1 withDuplexMode:(int)arg2 forContentType:(int)arg3 contentSize:(struct CGSize { double x1; double x2; })arg4;
+ (id)bestPaperForPageSize:(struct CGSize { double x1; double x2; })arg1 andContentType:(int)arg2 withPapersFromArray:(id)arg3;
