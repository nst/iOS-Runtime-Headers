...
@interface UINavigationBar : UIView <DebugHierarchyObject_Fallback, NSCoding, UIAccessibilityHUDGestureHosting, UIBarPositioning, UIGestureRecognizerDelegate, UIStatusBarTinting, _UIBarPositioningInternal> {
