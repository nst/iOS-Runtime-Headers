...
@property (setter=_setRadiusDelta:, nonatomic) double _radiusDelta;
...
- (struct CGPoint { double x1; double x2; })_dotCenterForOffsetAngle:(float)arg1 assumeExpanded:(BOOL)arg2;
- (struct CGPoint { double x1; double x2; })_dotCenterForZoomFactor:(float)arg1 assumeExpanded:(BOOL)arg2 relativeToCurrentZoomFactor:(BOOL)arg3;
- (id)_dotsFrom2x;
...
- (struct CGPoint { double x1; double x2; })dotCenterForZoomFactor:(float)arg1 assumeExpanded:(BOOL)arg2;
...
- (float)offsetAngleForPoint:(struct CGPoint { double x1; double x2; })arg1;
