...
- (id)_imageNamed:(id)arg1 forControlState:(unsigned int)arg2;
- (void)_itemChanged:(id)arg1;
- (void)_itemReadyToPlay:(id)arg1;
- (id)_newFrostedGlassBackdropView;
- (void)_notifyDelegateOfUserEvent:(unsigned int)arg1;
- (void)_notifyDelegateOfUserEventBegin:(unsigned int)arg1;
- (void)_notifyDelegateOfUserEventCancel:(unsigned int)arg1;
- (void)_notifyDelegateOfUserEventEnd:(unsigned int)arg1;
