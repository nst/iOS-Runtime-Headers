...
- (long long)_purgeableDatabaseFileSizeWithUrgency:(unsigned int)arg1;
...
- (long long)_purgeableTracksTotalSizeWithUrgency:(unsigned int)arg1 includeAutoFilledTracks:(BOOL)arg2;
...
- (long long)purgeableStorageSizeWithUrgency:(unsigned int)arg1 includeAutoFilledTracks:(BOOL)arg2;
