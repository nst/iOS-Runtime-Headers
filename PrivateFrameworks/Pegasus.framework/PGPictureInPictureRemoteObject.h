...
- (oneway void)activateApplicationIfNeededWithCompletionHandler:(id)arg1;
- (void)cancel;
- (oneway void)cleanupWithCompletionHandler:(id)arg1;
- (id)connection;
- (void)dealloc;
- (id)delegate;
- (id)init;
- (id)initWithConnection:(id)arg1;
- (oneway void)initializePictureInPictureWithControlsStyle:(long long)arg1 completionHandler:(id)arg2;
- (void)invalidate;
...
- (id)queue;
- (void)resume;
- (oneway void)rotateContentContainer:(long long)arg1 withCompletionHandler:(id)arg2;
- (void)setDelegate:(id)arg1;
- (oneway void)setLoadedTimeRanges:(id)arg1 completionHandler:(id)arg2;
- (void)setPictureInPicturePossible:(bool)arg1;
- (oneway void)setPictureInPictureShouldStartWhenEnteringBackground:(bool)arg1 completionHandler:(id)arg2;
- (oneway void)setPlaybackProgress:(id)arg1 completionHandler:(id)arg2;
- (oneway void)setShouldShowAlternateActionButtonImage:(bool)arg1 completionHandler:(id)arg2;
- (oneway void)setShouldShowLoadingIndicator:(bool)arg1 completionHandler:(id)arg2;
- (oneway void)setupAnimated:(bool)arg1 withHostedWindowHostingHandle:(id)arg2 preferredContentSize:(struct CGSize { double x1; double x2; })arg3 initialLayerFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 completionHandler:(id)arg5;
- (bool)shouldStartPictureInPictureEnteringBackground;
- (oneway void)startPictureInPictureAnimated:(bool)arg1 completionHandler:(id)arg2;
- (void)startPictureInPictureEnteringBackgroundAnimated:(bool)arg1 withCompletionHandler:(id)arg2;
- (oneway void)stopPictureInPictureAnimated:(bool)arg1 withFinalLayerFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 completionHandler:(id)arg3;
- (void)suspend;
- (oneway void)updatePreferredContentSize:(struct CGSize { double x1; double x2; })arg1 withCompletionHandler:(id)arg2;
