...
- (id)_trigger;
- (id)initWithNotification:(id)arg1 deliverable:(bool)arg2 timeout:(double)arg3 withHandler:(id)arg4;
- (id)initWithNotification:(id)arg1 timeout:(double)arg2 withHandler:(id)arg3;
