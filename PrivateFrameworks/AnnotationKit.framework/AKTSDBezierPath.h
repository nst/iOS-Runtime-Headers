...
- (unsigned int)elementAtIndex:(int)arg1 allPoints:(struct CGPoint { double x1; double x2; }*)arg2;
- (unsigned int)elementAtIndex:(int)arg1 associatedPoints:(struct CGPoint { double x1; double x2; }*)arg2;
- (int)elementCount;
