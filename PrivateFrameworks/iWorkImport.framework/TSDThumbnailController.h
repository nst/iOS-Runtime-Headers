...
@class <TSDThumbnailControllerDelegate>, <TSDThumbnailProducer>, NSDate, NSMutableSet, NSObject<OS_dispatch_queue>, NSSet, TSDThumbnailGenerator, TSKDocumentRoot, TSULRUCache;
