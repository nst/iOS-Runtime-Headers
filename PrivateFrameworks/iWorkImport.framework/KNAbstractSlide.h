...
@interface KNAbstractSlide : TSPObject <TSSPropertySource, TSSStyleClient, TSKDocumentObject, TSDDrawableContainerInfo, TSKTransformableObject> {
    boolmInDocument;
    boolmNeedsSlideNodeEventCountUpdate;
    boolmShouldConsiderAllChunksActive;
...
@property(readonly) unsigned long long deliveryGroupCount;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })p_rangeForChunksInBuild:(id)arg1;
