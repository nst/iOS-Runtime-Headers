...
- (void)assetsAnalyzedSinceDate:(id)arg1 completionHandler:(id)arg2;
...
- (int)requestAnalysesForAssets:(id)arg1 analysisTypes:(unsigned long long)arg2 allowOndemand:(bool)arg3 progressHandler:(id)arg4 completionHandler:(id)arg5;
- (id)requestAnalysisForAsset:(id)arg1 analysisTypes:(unsigned long long)arg2 allowOndemand:(bool)arg3;
- (int)requestAnalysisForAsset:(id)arg1 analysisTypes:(unsigned long long)arg2 progressHandler:(id)arg3 completionHandler:(id)arg4;
