...
- (void)queryStateOntoQueue:(id)arg1 andMonitorFor:(double)arg2 withTimeout:(double)arg3 andHandler:(id)arg4;
- (void)queryStateOntoQueue:(id)arg1 withTimeout:(double)arg2 andHandler:(id)arg3;
