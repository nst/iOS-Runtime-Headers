...
@interface HMDAccessory : NSObject <HAPAccessoryServerForBridgeDelegate, HAPRelayAccessoryDelegate, HAPTimerDelegate, HMDTimeInformationMonitorDelegate, HMMessageReceiver, NSSecureCoding> {
...
@property (nonatomic, retain) HAPTimer *systemTimeInformationTimer;
@property (nonatomic) BOOL systemTimeNeedsUpdate;
@property (nonatomic, readonly) BOOL timeInformationServiceExists;
@property (nonatomic, retain) HAPTimer *timeInformationTimer;
