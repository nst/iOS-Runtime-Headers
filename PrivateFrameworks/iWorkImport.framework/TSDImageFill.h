...
+ (void)makeCompatibleImageFillDataFromURL:(id)arg1 withContext:(id)arg2 modalOperationPresenter:(id)arg3 compatibilityAlertPresenter:(id)arg4 completionHandler:(id /* block */)arg5;
+ (id)presetKinds;
