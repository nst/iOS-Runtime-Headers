...
- (void)_popDocument:(bool)arg1 completion:(id)arg2;
- (void)_popDocumentSkippingUserInterfaceUpdates;
- (void)_popOverlayStackItem:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
- (void)_popPopoverStackItem:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
