...
- (void)getAspectRatioForAttachmentUUID:(void *)arg1 recordID:(void *)arg2 withCompletionHandler:(void *)arg3; // needs 3 arg types, found 8: NSUUID *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, float, void*
- (void)getDataForAttachmentUUID:(void *)arg1 recordID:(void *)arg2 withCompletionHandler:(void *)arg3; // needs 3 arg types, found 8: NSUUID *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSData *, void*
- (void)getPNGDataForAttachmentUUID:(void *)arg1 recordID:(void *)arg2 sizeConstraints:(void *)arg3 withCompletionHandler:(void *)arg4; // needs 4 arg types, found 9: NSUUID *, NSString *, BBThumbnailSizeConstraints *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSData *, void*
- (void)handleBulletinActionResponse:(BBActionResponse *)arg1;
- (void)handleBulletinActionResponse:(void *)arg1 withCompletion:(void *)arg2; // needs 2 arg types, found 7: BBActionResponse *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
