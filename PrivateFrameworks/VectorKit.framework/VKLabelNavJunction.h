...
@interface VKLabelNavJunction : NSObject <VKLabelNavFeature> {
    ...
    double  _distanceFromPreviousShieldLabel;
    BOOL  _foundRoads;
...
@property (nonatomic) double distanceFromPreviousShieldLabel;
...
- (void)addRouteEdge:(const struct VKLabelNavRouteRoadEdge { struct PolylineCoordinate { unsigned int x_1_1_1; double x_1_1_2; } x1; struct PolylineCoordinate { unsigned int x_2_1_1; double x_2_1_2; } x2; struct { /* ? */ } *x3; }*)arg1 atA:(BOOL)arg2;
...
- (id)incomingRoad;
- (id)initWithGEOJunction:(struct { unsigned int x1; unsigned int x2; struct { /* ? */ } *x3; }*)arg1 routeOffset:(struct PolylineCoordinate { unsigned int x1; double x2; })arg2 tile:(id)arg3;
- (id)initWithRoadEdge:(const struct { struct { /* ? */ } *x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; struct { /* ? */ } *x6; struct { /* ? */ } *x7; }*)arg1 atA:(BOOL)arg2 routeOffset:(struct PolylineCoordinate { unsigned int x1; double x2; })arg3 tile:(id)arg4;
...
- (void)setSharedRouteDirection:(struct Matrix<float, 2, 1> { double x1[2]; })arg1;
- (struct Matrix<float, 2, 1> { double x1[2]; })sharedRouteDirection;
- (id)shieldDisplayGroup;
- (id)tile;
- (struct Matrix<float, 2, 1> { double x1[2]; })tileCoordinate;
