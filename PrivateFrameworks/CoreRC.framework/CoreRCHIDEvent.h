...
- (id)init;
- (id)initKeyboardEventWithUsagePage:(unsigned int)arg1 usageID:(unsigned int)arg2 pressed:(BOOL)arg3 timestamp:(unsigned int)arg4;
...
- (id)initWithCommand:(unsigned int)arg1 pressed:(BOOL)arg2 timestamp:(unsigned int)arg3;
