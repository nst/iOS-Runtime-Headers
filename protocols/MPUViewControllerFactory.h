...
+ (void)registerViewControllerIdentifier:(void *)arg1 withConfigurationBlock:(void *)arg2; // needs 2 arg types, found 6: NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, MPUViewControllerConfiguration *, id, void*
