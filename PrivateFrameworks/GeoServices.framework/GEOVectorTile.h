...
@property(readonly) struct { unsigned char x1; struct { /* ? */ } *x2; unsigned int x3; float *x4; struct _NSRange {} *x5; unsigned int x6; unsigned int x7; struct { /* ? */ } *x8; struct _NSRange {} *x9; }* lineVertices;
