...
@interface AVItem : NSObject 
{
  ...
  /* Error parsing encoded ivar type info: ^{AVItemPrivate=@@"NSString"dfffIcc@"NSDictionary"iqqc@"NSDictionary"@"NSDictionary"@"NSURL"@"NSDictionary"^{OpaqueMD5CheckProgress}^{OpaqueFigThread}^{OpaqueFigByteStream}i} */
