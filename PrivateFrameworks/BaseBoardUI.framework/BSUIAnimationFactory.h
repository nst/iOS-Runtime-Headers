...
+ (void)addAlongsideAnimations:(id)arg1 completion:(id)arg2;
...
+ (void)animateWithSettings:(id)arg1 actions:(id)arg2;
+ (void)animateWithSettings:(id)arg1 actions:(id)arg2 completion:(id)arg3;
+ (void)animateWithSettings:(id)arg1 options:(unsigned long long)arg2 actions:(id)arg3;
+ (void)animateWithSettings:(id)arg1 options:(unsigned long long)arg2 actions:(id)arg3 completion:(id)arg4;
