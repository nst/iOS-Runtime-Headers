...
- (void)getScreenshotImageForDebugController:(void *)arg1 withCompletion:(void *)arg2; // needs 2 arg types, found 7: <AFUIDebugControlling> *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, UIImage *, void*
