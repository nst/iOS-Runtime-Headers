...
+ (bool)_enumerateMergedKeyValueEntitiesInCategory:(long long)arg1 withPredicate:(id)arg2 healthDatabase:(id)arg3 error:(id*)arg4 usingBlock:(id)arg5;
...
+ (bool)_readRawValuesInCategory:(long long)arg1 withPredicate:(id)arg2 withDatabase:(id)arg3 error:(id*)arg4 usingBlock:(id)arg5;
...
+ (id)_valuesForKeys:(id)arg1 domain:(id)arg2 category:(long long)arg3 healthDaemon:(id)arg4 error:(id*)arg5 handler:(id)arg6;
