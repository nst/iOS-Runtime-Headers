...
@property (nonatomic) int currentUserInterfaceIdiom;
...
- (void)reloadPrecomposedCharacterSetWithIdiom:(int)arg1;
- (id)replacementForDoubleSpace;
- (void)setCurrentUserInterfaceIdiom:(int)arg1;
