...
- (id)initWithString:(id)arg1 score:(double)arg2 rotation:(float)arg3 vertex1:(struct CGPoint { double x1; double x2; })arg4 vertex2:(struct CGPoint { double x1; double x2; })arg5 vertex3:(struct CGPoint { double x1; double x2; })arg6;
