...
- (void)_prepareForPlaybackWithTargetSize:(struct CGSize { double x1; double x2; })arg1 options:(id)arg2 completionHandler:(id)arg3;
- (id)_processImage:(id)arg1 scale:(double)arg2 error:(id*)arg3;
- (void)_renderImageToURL:(id)arg1 fileType:(id)arg2 targetSize:(struct CGSize { double x1; double x2; })arg3 completionHandler:(id)arg4;
- (void)_renderImageWithTargetSize:(struct CGSize { double x1; double x2; })arg1 completionHandler:(id)arg2;
- (void)_renderVideoToURL:(id)arg1 fileType:(id)arg2 targetSize:(struct CGSize { double x1; double x2; })arg3 volume:(float)arg4 completionHandler:(id)arg5;
...
- (void)exportToDestination:(id)arg1 options:(id)arg2 completionHandler:(id)arg3;
- (id)frameProcessor;
- (id)imageProperties;
- (id)init;
...
- (void)prepareForPlaybackWithTargetSize:(struct CGSize { double x1; double x2; })arg1 options:(id)arg2 completionHandler:(id)arg3;
