...
@property (nonatomic) int containerAdamID;
...
@property (nonatomic) unsigned int itemCloudID;
...
- (void)setContainerAdamID:(int)arg1;
...
- (void)setItemCloudID:(unsigned int)arg1;
