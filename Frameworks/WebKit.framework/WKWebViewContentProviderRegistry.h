...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct Vector<WTF::String, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> { struct String {} *x1; unsigned int x2; unsigned int x3; unsigned int x4; })_mimeTypesWithCustomContentProviders;
