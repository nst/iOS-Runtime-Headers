...
+ (int)indexOfPointNear:(struct CGPoint { double x1; double x2; })arg1 inEyePoints:(id)arg2 andMaskSize:(struct CGSize { double x1; double x2; })arg3;
...
- (int)indexOfPointNear:(struct CGPoint { double x1; double x2; })arg1;
- (id)layerData;
