...
+ (void)_alertTitleAndMessageForAsset:(id)arg1 type:(int)arg2 title:(id*)arg3 message:(id*)arg4;
...
+ (void)checkIsSupportedAndPresentAlertForAsset:(id)arg1 type:(int)arg2 alertControllerPresenter:(id /* block */)arg3 completionHandler:(id /* block */)arg4;
+ (void)checkIsSupportedAsset:(id)arg1 completionHandler:(id /* block */)arg2;
+ (void)presentAlertForAsset:(id)arg1 type:(int)arg2 alertControllerPresenter:(id /* block */)arg3 completionHandler:(id /* block */)arg4;
