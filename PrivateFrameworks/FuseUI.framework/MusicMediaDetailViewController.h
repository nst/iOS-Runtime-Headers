...
- (float)_effectiveHeaderHeightForContentOffset:(struct CGPoint { double x1; double x2; })arg1 externalScrollViewContentInset:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2;
