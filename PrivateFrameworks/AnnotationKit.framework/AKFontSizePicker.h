...
@interface AKFontSizePicker : UIControl <UICollectionViewDataSource, UICollectionViewDelegate> {
    ...
    long long  _style;
    double  _value;
    id  _willBeginTrackingUpdates;
}

@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (nonatomic, copy) id didEndTrackingUpdates;
...
@property (nonatomic, copy) id willBeginTrackingUpdates;
