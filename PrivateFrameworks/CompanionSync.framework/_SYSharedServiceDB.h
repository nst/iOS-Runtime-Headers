...
- (void)_LOCKED_runSchemaUpdate:(id)arg1 forClientNamed:(id)arg2;
...
- (bool)_runTransactionBlock:(id)arg1 exclusive:(bool)arg2;
- (void)dealloc;
- (bool)inExclusiveTransaction:(id)arg1;
- (bool)inTransaction:(id)arg1;
- (id)initWithServiceName:(id)arg1;
- (long long)schemaVersionForClient:(id)arg1;
- (void)setSchemaVersion:(long long)arg1 forClient:(id)arg2;
- (void)updateSchemaForClient:(id)arg1 usingBlock:(id)arg2;
- (void)withDBRef:(id)arg1;
