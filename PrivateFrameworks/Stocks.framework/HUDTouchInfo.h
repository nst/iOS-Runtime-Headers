...
@property (nonatomic) struct { double x1; double x2; unsigned int x3; } stockValue;
...
- (void)setStockValue:(struct { double x1; double x2; unsigned int x3; })arg1;
- (void)setTouch:(id)arg1;
- (struct { double x1; double x2; unsigned int x3; })stockValue;
- (id)touch;
