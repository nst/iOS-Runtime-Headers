...
- (unsigned int)_getInt64ValueInTable:(id)arg1 column:(id)arg2 where:(id)arg3 limit:(unsigned int)arg4;
- (BOOL)_hasAnySongs;
- (BOOL)_hasRowsInTable:(id)arg1;
- (BOOL)_readBlobForRowID:(unsigned int)arg1 intoData:(id)arg2 table:(const char *)arg3 blobColumn:(const char *)arg4;
- (BOOL)_readBlobIntoData:(id)arg1 table:(id)arg2 blobColumn:(id)arg3 where:(id)arg4;
- (id)copyGeniusConfigrationDataAndBytes;
- (id)copyGeniusMetadataDataAndBytesForGlobalID:(unsigned int)arg1;
- (id)copyGeniusSimilaritiesDataAndBytesForGlobalID:(unsigned int)arg1;
...
- (BOOL)getGeniusMetadataDataAndBytesForGlobalID:(unsigned int)arg1 intoData:(id)arg2;
- (BOOL)getGeniusSimilaritiesDataAndBytesForGlobalID:(unsigned int)arg1 intoData:(id)arg2;
