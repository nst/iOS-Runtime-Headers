...
- (void)_filterExtensionsWithBlock:(id)arg1;
- (void)_notifyForLoadedExtensions;
- (void)_performJob:(id)arg1 extensions:(id)arg2 count:(unsigned long long)arg3 throttle:(id)arg4 perExtensionCompletionHandler:(id)arg5;
- (void)_performJob:(id)arg1 extensions:(id)arg2 perExtensionCompletionHandler:(id)arg3 completionHandler:(id)arg4;
- (void)_willRunJobWithBundleID:(id)arg1;
- (id)allExtensionsWithBlock:(id)arg1;
- (id)anyExtensionWithBlock:(id)arg1;
- (void)dealloc;
- (id)extensionLoader;
- (id)extensions;
...
- (void)indexRequestsPerformJob:(id)arg1 extensions:(id)arg2 perExtensionCompletionHandler:(id)arg3 completionHandler:(id)arg4;
- (void)indexRequestsPerformJob:(id)arg1 forBundle:(id)arg2 completionHandler:(id)arg3;
- (void)indexRequestsPerformJob:(id)arg1 perExtensionCompletionHandler:(id)arg2 completionHandler:(id)arg3;
- (id)init;
