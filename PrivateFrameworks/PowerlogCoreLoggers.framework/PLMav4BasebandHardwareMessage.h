...
@interface PLMav4BasebandHardwareMessage : PLBasebandHardwareMessage {
    ...
    struct _PLMav4BasebandHWStatsARMPerf { unsigned int x1[3]; } *_mav4_armPerf;
...
@property struct _PLMav4BasebandHWStatsARMPerf { unsigned int x1[3]; }* armPerf;
...
- (struct _PLMav4BasebandHWStatsARMPerf { unsigned int x1[3]; }*)armPerf;
...
- (void)setArmPerf:(struct _PLMav4BasebandHWStatsARMPerf { unsigned int x1[3]; }*)arg1;
