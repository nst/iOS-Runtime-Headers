...
@property (nonatomic) double zeroValue;
...
- (struct tvec2<float> { union { double x_1_1_1; double x_1_1_2; double x_1_1_3; } x1; union { double x_2_1_1; double x_2_1_2; double x_2_1_3; } x2; })bottomTopAtPosition:(float)arg1;
- (int)capCount;
