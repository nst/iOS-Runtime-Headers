...
- (void)devicePINController:(void *)arg1 shouldAcceptPIN:(void *)arg2 withCompletion:(void *)arg3; // needs 3 arg types, found 8: DevicePINController *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
