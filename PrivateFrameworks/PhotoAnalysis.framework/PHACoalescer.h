...
@property int state;
@property unsigned int stateCaptureHandlerHandle;
@property id target;
...
- (id)context;
- (void)dealloc;
- (void)dispatch_after:(unsigned int)arg1 queue:(id)arg2 block:(id /* block */)arg3;
- (id)init;
...
- (void)setStateCaptureHandlerHandle:(unsigned int)arg1;
...
- (id)sourceQueue;
- (int)state;
- (unsigned int)stateCaptureHandlerHandle;
- (id)stateInformation;
- (id)target;
- (id)targetQueue;
- (id)transaction;
