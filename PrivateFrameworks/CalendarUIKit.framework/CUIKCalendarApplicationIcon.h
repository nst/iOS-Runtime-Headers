...
+ (void)_drawIconInContext:(struct CGContext { }*)arg1 imageSize:(struct CGSize { double x1; double x2; })arg2 iconBase:(id)arg3 calendar:(id)arg4 dayNumberString:(id)arg5 dateNameBlock:(id /* block */)arg6 dateNameFormatType:(int)arg7 format:(int)arg8 showGrid:(BOOL)arg9;
+ (void)_fillContextWithWhiteBackgroundIfNeededForFormat:(int)arg1 context:(struct CGContext { }*)arg2 frame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3;
...
+ (void)drawIconInContext:(struct CGContext { }*)arg1 imageSize:(struct CGSize { double x1; double x2; })arg2 iconBase:(id)arg3 dateComponents:(id)arg4 dateNameFormatType:(int)arg5 format:(int)arg6 showGrid:(BOOL)arg7;
