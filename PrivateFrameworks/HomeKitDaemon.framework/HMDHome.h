...
- (void)_removeAllAccessoriesAndPairings:(bool)arg1 queue:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)removeAllAccessoriesAndPairings:(bool)arg1 queue:(id)arg2 completionHandler:(id /* block */)arg3;
