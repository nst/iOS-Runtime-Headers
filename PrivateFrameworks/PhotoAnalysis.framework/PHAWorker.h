...
- (id)currentOperation;
- (id)dataLoader;
- (void)dispatchAsyncToExecutiveStateQueue:(id)arg1;
- (void)dispatchAsyncToUserInitiatedRequestQueue:(id)arg1;
- (void)dispatchSyncToUserInitiatedRequestQueue:(id)arg1;
