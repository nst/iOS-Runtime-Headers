...
- (bool)open:(id)arg1;
- (id)path;
- (bool)readDatabaseVersion:(id)arg1;
- (bool)readRowCountForTable:(id)arg1 resultBlock:(id)arg2;
- (bool)revertTransaction:(id)arg1;
- (bool)runArrayOfQueries:(id)arg1 resultBlock:(id)arg2;
- (bool)runSimpleQuery:(id)arg1 resultBlock:(id)arg2;
...
- (id)tableNames;
- (bool)writeDatabaseVersion:(long long)arg1 resultBlock:(id)arg2;
