...
- (void)enumerateStatesForLibraryItems:(void *)arg1 usingBlock:(void *)arg2; // needs 2 arg types, found 9: NSSet *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, SKUILibraryItem *, SKUILibraryItemState *, bool*, void*
