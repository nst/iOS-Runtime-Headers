...
- (void)enumerateEdgesBetweenNode:(id)arg1 usingBlock:(id)arg2;
- (void)enumerateEdgesFromNode:(id)arg1 usingBlock:(id)arg2;
- (void)enumerateEdgesTowardNode:(id)arg1 usingBlock:(id)arg2;
- (void)enumerateNeighborNodesUsingBlock:(id)arg1;
