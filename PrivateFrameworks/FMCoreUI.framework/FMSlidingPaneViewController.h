...
- (void)_crossDissolveOldPaneState:(id)arg1 newPaneState:(id)arg2 animated:(bool)arg3 completion:(id)arg4;
- (void)_dismissPaneState:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
...
- (void)_presentPaneState:(id)arg1 animated:(bool)arg2 interactive:(bool)arg3 completion:(id)arg4;
...
- (void)dismissPaneViewControllerAnimated:(bool)arg1 completion:(id)arg2;
...
- (id)paneVisualEffect;
- (void)presentPaneViewController:(id)arg1 fromEdge:(unsigned long long)arg2 animated:(bool)arg3 completion:(id)arg4;
- (void)presentPaneViewController:(id)arg1 fromEdge:(unsigned long long)arg2 withPercent:(double)arg3 completion:(id)arg4;
