...
- (void)capturePlaceCardUserAction:(int)arg1 onTarget:(int)arg2 eventValue:(id)arg3 mapItem:(id)arg4 timestamp:(double)arg5 resultIndex:(int)arg6 targetID:(unsigned int)arg7 providerID:(id)arg8 animationID:(unsigned int)arg9 actionURL:(id)arg10 photoID:(id)arg11 traits:(id)arg12 placeCardType:(int)arg13 localizedMapItemCategory:(id)arg14 availableActions:(id)arg15 unactionableUIElements:(id)arg16;
- (void)captureTransitPlaceCardUserAction:(int)arg1 onTarget:(int)arg2 eventValue:(id)arg3 mapItem:(id)arg4 timestamp:(double)arg5 resultIndex:(int)arg6 targetID:(unsigned int)arg7 providerID:(id)arg8 animationID:(unsigned int)arg9 transitCardCategory:(int)arg10 transitSystem:(id)arg11 transitDepartureSequence:(id)arg12 transitIncident:(id)arg13 traits:(id)arg14;
...
- (void)incrementAGGDInteractedWithPlaceCardKeyWithType:(unsigned int)arg1 incrementValue:(int)arg2;
- (void)incrementAGGDOpenPlaceCardKeyWithType:(unsigned int)arg1 incrementValue:(int)arg2;
...
- (void)submitUsageForTraits:(id)arg1 mapItem:(id)arg2 timestamp:(double)arg3 resultIndex:(int)arg4 targetID:(unsigned int)arg5;
...
- (void)submitUsageForTraitsWithAction:(int)arg1 flyoverAnimationID:(unsigned int)arg2;
...
- (void)submitUsageForTraitsWithAction:(int)arg1 mapItem:(id)arg2 providerID:(id)arg3 resultIndex:(int)arg4 targetID:(unsigned int)arg5 transitCardCategory:(int)arg6;
- (void)submitUsageForTraitsWithAction:(int)arg1 mapItem:(id)arg2 providerID:(id)arg3 resultIndex:(int)arg4 targetID:(unsigned int)arg5 transitCardCategory:(int)arg6 transitSystem:(id)arg7;
- (void)submitUsageForTraitsWithAction:(int)arg1 mapItem:(id)arg2 providerID:(id)arg3 resultIndex:(int)arg4 targetID:(unsigned int)arg5 transitCardCategory:(int)arg6 transitSystem:(id)arg7 transitDepartureSequence:(id)arg8;
- (void)submitUsageForTraitsWithAction:(int)arg1 mapItem:(id)arg2 providerID:(id)arg3 resultIndex:(int)arg4 targetID:(unsigned int)arg5 transitCardCategory:(int)arg6 transitSystem:(id)arg7 transitIncident:(id)arg8;
- (void)submitUsageForTraitsWithAction:(int)arg1 mapItem:(id)arg2 providerID:(id)arg3 targetID:(unsigned int)arg4;
- (void)submitUsageForTraitsWithAction:(int)arg1 mapItem:(id)arg2 targetID:(unsigned int)arg3;
...
- (id)ticketForNearestTransitStation:(unsigned int)arg1 coordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg2 includeETA:(BOOL)arg3 traits:(id)arg4;
...
- (id)ticketForURLQuery:(id)arg1 coordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg2 muid:(unsigned int)arg3 resultProviderId:(int)arg4 contentProvider:(id)arg5 maxResults:(unsigned int)arg6 traits:(id)arg7;
