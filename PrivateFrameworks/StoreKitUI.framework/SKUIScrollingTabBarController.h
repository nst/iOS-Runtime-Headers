...
- (void).cxx_destruct;
- (void)_animatePaletteWithSetup:(id)arg1 animations:(id)arg2 completion:(id)arg3;
...
- (void)_setViewControllers:(id)arg1 collectionViewsUpdateHandler:(id)arg2 forFinalTearDown:(bool)arg3;
...
- (void)attachTabBarPalette:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
...
- (void)detachTabBarPalette:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
