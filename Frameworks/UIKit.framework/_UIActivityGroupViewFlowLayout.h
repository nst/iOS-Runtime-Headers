...
- (void).cxx_destruct;
- (float)_evaluateHorizontalItemOffsetForItemSize:(struct CGSize { double x1; double x2; })arg1 inset:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2 offscreenPeekInFactor:(float)arg3;
