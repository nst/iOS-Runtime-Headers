...
@interface TSCETectonicShift : TSCEDependencyChanges {
    ...
    boolmApplyToAbsolute;
    boolmIgnoreStickyBits;
    boolmInsertingAfter;
    } mInsertedRange;
    } mRangeForDeletion;
    } mRangeForShift;
