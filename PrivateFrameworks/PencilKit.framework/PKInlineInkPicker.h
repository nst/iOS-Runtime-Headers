...
@interface PKInlineInkPicker : UIControl <PKInkAttributesPickerDelegate, PKInlineColorPickerDelegate, UIPopoverPresentationControllerDelegate, _PKAllowDrawingWhilePresentingPopoverViewDelegate, _PKInlineColorPickerAllowDrawingWithPopoverDelegate> {
...
@property (nonatomic) unsigned long long previousToolIndex;
...
- (void)setPreviousToolIndex:(unsigned long long)arg1;
