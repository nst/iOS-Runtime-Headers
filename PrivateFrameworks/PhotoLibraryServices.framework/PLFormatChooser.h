...
- (id)_bestFormatWithSize:(struct CGSize { double x1; double x2; })arg1 specificVersionType:(long long)arg2 contentMode:(long long)arg3 demoteFactor:(double)arg4 srcAspectRatio:(double)arg5 hasAdjustmentsHandler:(id)arg6 desiredImagePixelSize:(struct CGSize { double x1; double x2; }*)arg7;
...
- (void)chooseFormatsForSize:(struct CGSize { double x1; double x2; })arg1 specificVersionType:(long long)arg2 contentMode:(long long)arg3 demoteFactor:(double)arg4 srcAspectRatio:(double)arg5 degradedFormatPolicy:(long long)arg6 hasAdjustmentsHandler:(id)arg7 desiredImagePixelSize:(struct CGSize { double x1; double x2; }*)arg8 bestFormat:(id*)arg9 degradedFormat:(id*)arg10;
- (void)dealloc;
