...
- (void)_fetchAccountsWithCompletion:(id)arg1;
- (void)_invalidateFetchedAccountsCacheWithCompletion:(id)arg1;
- (id)_localAccountMatchingRemoteAccount:(id)arg1;
- (void)_promptUserForAccountCredential:(id)arg1 withOptions:(id)arg2 completion:(id)arg3;
