...
- (void)_navigateToOneUpBrowserWithOptions:(int)arg1 animated:(BOOL)arg2;
- (void)_navigateToOneUpBrowserWithOptions:(int)arg1 animated:(BOOL)arg2 pinchGestureRecognizer:(id)arg3;
