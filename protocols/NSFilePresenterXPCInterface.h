...
- (void)relinquishToReadingClaimWithID:(void *)arg1 options:(void *)arg2 purposeID:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: id, unsigned int, id, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)relinquishToWritingClaimWithID:(void *)arg1 options:(void *)arg2 purposeID:(void *)arg3 subitemURL:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 10: id, unsigned int, id, NSURLPromisePair *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
