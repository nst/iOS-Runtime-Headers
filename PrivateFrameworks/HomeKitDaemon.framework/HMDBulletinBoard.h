...
- (void)insertBulletinsForChangedCharacteristics:(id)arg1 changedByThisDevice:(bool)arg2 completion:(id)arg3;
- (void)insertImageBulletinsForChangedCharacteristics:(id)arg1 snapshotData:(id)arg2 completion:(id)arg3;
- (bool)isEnabled;
