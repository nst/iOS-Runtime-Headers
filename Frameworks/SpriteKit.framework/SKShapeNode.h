...
+ (id)shapeNodeWithPoints:(struct CGPoint { double x1; double x2; }*)arg1 count:(unsigned long)arg2;
...
+ (id)shapeNodeWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 cornerRadius:(float)arg2;
+ (id)shapeNodeWithRectOfSize:(struct CGSize { double x1; double x2; })arg1;
+ (id)shapeNodeWithRectOfSize:(struct CGSize { double x1; double x2; })arg1 cornerRadius:(float)arg2;
+ (id)shapeNodeWithSplinePoints:(struct CGPoint { double x1; double x2; }*)arg1 count:(unsigned long)arg2;
