...
- (void)addItemWithSagaID:(unsigned long long)arg1 toPlaylistWithPersistentID:(unsigned long long)arg2 completionHandler:(id)arg3;
- (void)addStoreItemWithAdamID:(long long)arg1 completionHandler:(id)arg2;
- (void)addStoreItemWithAdamID:(long long)arg1 toPlaylistWithPersistentID:(unsigned long long)arg2 completionHandler:(id)arg3;
...
- (void)evaluateKeepLocalRulesWithCompletionHandler:(id)arg1;
...
- (void)sdk_addStoreItemWithOpaqueID:(id)arg1 toPlaylistWithPersistentID:(unsigned long long)arg2 completionHandler:(id)arg3;
- (void)sdk_createPlaylistWithPersistenID:(unsigned long long)arg1 properties:(id)arg2 tracklist:(id)arg3 completionHandler:(id)arg4;
...
- (void)updateJaliscoMediaLibraryWithReason:(long long)arg1 completionHandler:(id)arg2;
- (void)updateSubscribedPlaylistWithSagaID:(unsigned long long)arg1 ignoreMinRefreshInterval:(bool)arg2 completionHandler:(id)arg3;
