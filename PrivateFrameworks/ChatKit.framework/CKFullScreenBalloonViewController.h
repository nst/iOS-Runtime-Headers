...
- (void).cxx_destruct;
- (void)_performClosingAnimationsWithSendAnimation:(bool)arg1 withCompletion:(id)arg2;
...
- (void)performCancelAnimationWithCompletion:(id)arg1;
- (void)performClosingAnimationsWithSendAnimation:(bool)arg1 withCompletion:(id)arg2;
- (void)performInitialAnimations;
- (void)performSendAndCloseAnimationWithCompletion:(id)arg1;
- (id)pickerBar;
