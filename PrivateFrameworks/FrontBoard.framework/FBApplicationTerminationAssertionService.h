...
- (void)_queue_continueAcquisition:(id)arg1 error:(id)arg2 completionHandler:(id)arg3;
- (void)_queue_removeTerminationAssertion:(id)arg1;
- (id)_requestPluginHoldForAppInfo:(id)arg1;
- (void)addTerminationAssertion:(id)arg1 completionHandler:(id)arg2;
- (void)canAcquireTerminationAssertion:(id)arg1 completionHandler:(id)arg2;
- (void)dealloc;
- (id)delegate;
- (id)init;
- (void)removeTerminationAssertion:(id)arg1 completionHandler:(id)arg2;
