...
- (struct shared_ptr<PKPath> { struct PKPath {} *x1; struct __shared_weak_count {} *x2; })pathFromOutlineWithSmoothingThreshold:(float)arg1 bounds:(struct { struct { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg2;
...
- (id)physicsBodyFromSmoothedOutline:(float)arg1 size:(struct CGSize { double x1; double x2; })arg2;
