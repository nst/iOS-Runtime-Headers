...
@class <IUWildcatVideoDetailViewControllerDelegate>, IUVideoPartListViewController, IUVideoTitleView, IUWildcatVideoDetailView, IUiPodSegmentedViewController, MPImageCache, MPMediaDownloadObserver, MPMediaItem, MPMediaItemImageRequest, NSSet, UIAlertView, UIImage;
