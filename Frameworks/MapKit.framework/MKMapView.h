...
- (void)_performScenicAnimationForLocation:(struct { double x1; double x2; })arg1 animationType:(int)arg2;
- (void)_populateArchivedSubviews:(id)arg1;
- (void)_prepareScenicAnimationForLocation:(struct { double x1; double x2; })arg1 animationType:(int)arg2 completion:(id)arg3;
