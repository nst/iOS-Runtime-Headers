...
- (void)_globalStatusForApplicationPermission:(unsigned int)arg1 setupInfo:(id)arg2 completionHandler:(id)arg3;
...
- (void)_setApplicationPermission:(unsigned int)arg1 enabled:(BOOL)arg2 setupInfo:(id)arg3 completionHandler:(id)arg4;
...
- (void)requestApplicationPermission:(unsigned int)arg1 setupInfo:(id)arg2 completionHandler:(id)arg3;
...
- (void)setApplicationPermission:(unsigned int)arg1 enabled:(BOOL)arg2 setupInfo:(id)arg3 completionHandler:(id)arg4;
...
- (id)setupQueue;
- (void)statusForApplicationPermission:(unsigned int)arg1 setupInfo:(id)arg2 completionHandler:(id)arg3;
- (void)statusGroupsForApplicationPermission:(unsigned int)arg1 setupInfo:(id)arg2 completionHandler:(id)arg3;
- (id)statusReport;
