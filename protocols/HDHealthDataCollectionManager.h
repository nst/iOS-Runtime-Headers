...
- (void)immediateUpdateForType:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: HKObjectType *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
- (void)removeDataCollectionObserver:(id)arg1;
- (void)removeDataCollectionObserver:(id)arg1 type:(HKObjectType *)arg2;
- (void)sensorDataArrayReceived:(void *)arg1 deviceEntity:(void *)arg2 withCompletion:(void *)arg3; // needs 3 arg types, found 9: NSArray *, HDDeviceEntity *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
