...
- (void)_enumerateCoordinateList:(id)arg1 withTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2 weightedAverageWidth:(float)arg3 block:(id /* block */)arg4;
