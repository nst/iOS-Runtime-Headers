...
@interface _PXZoomAnimationContext : NSObject <PXZoomAnimationContext> {
    id  __allAnimationsCompletionHandler;
...
@property (setter=_setAllAnimationsCompletionHandler:, nonatomic, copy) id _allAnimationsCompletionHandler;
...
- (void)_setAllAnimationsCompletionHandler:(id)arg1;
...
- (void)notifyWhenAllAnimationsCompleted:(id)arg1;
- (void)registerCleanupHandler:(id)arg1;
