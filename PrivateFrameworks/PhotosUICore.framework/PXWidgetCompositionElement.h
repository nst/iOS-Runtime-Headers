...
- (void)_notifyWidgetUsingBlock:(id)arg1;
- (id)_observers;
- (void)_performChanges:(id)arg1 withAnimationOptions:(id)arg2;
- (void)_performContentChangeWhenSafe:(id)arg1;
...
- (id)widget;
- (void)widget:(id)arg1 animateChanges:(id)arg2 withAnimationOptions:(id)arg3;
