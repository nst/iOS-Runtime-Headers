...
- (void)_removeItemsInResponseToUserAction:(id)arg1 completionHandler:(id)arg2;
...
- (void)close;
- (void)dealloc;
- (void)enumerateItemsAsynchronouslyUsingBlock:(id)arg1 completionHandler:(id)arg2;
