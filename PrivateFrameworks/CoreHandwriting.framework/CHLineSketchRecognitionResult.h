...
- (id)initWithString:(id)arg1 score:(double)arg2 rotation:(float)arg3 startLocation:(struct CGPoint { double x1; double x2; })arg4 startEndpointType:(int)arg5 endLocation:(struct CGPoint { double x1; double x2; })arg6 endEndpointType:(int)arg7 midPointLocation:(struct CGPoint { double x1; double x2; })arg8 controlPointLocation:(struct CGPoint { double x1; double x2; })arg9;
