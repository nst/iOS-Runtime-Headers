...
@interface NSObject <ATXScoreLogSerializable, CAAnimatableValue, CARenderValue, CKLParsedObject, DebugHierarchyObject_Fallback, NSObject, PQLResultSetInitializer, _DKProtobufConverting> {
    Class  isa;
}
