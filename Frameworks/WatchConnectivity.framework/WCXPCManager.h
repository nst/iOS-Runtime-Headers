...
- (void)sendMessage:(id)arg1 clientPairingID:(id)arg2 acceptanceHandler:(id)arg3;
- (void)sendMessage:(id)arg1 clientPairingID:(id)arg2 acceptanceHandler:(id)arg3 errorHandler:(id)arg4;
- (void)sessionReadyForInitialStateForClientPairingID:(id)arg1 supportsActiveDeviceSwitch:(bool)arg2 withErrorHandler:(id)arg3;
...
- (void)transferFile:(id)arg1 sandboxToken:(id)arg2 clientPairingID:(id)arg3 errorHandler:(id)arg4;
- (void)transferUserInfo:(id)arg1 withURL:(id)arg2 clientPairingID:(id)arg3 errorHandler:(id)arg4;
- (void)updateApplicationContext:(id)arg1 clientPairingID:(id)arg2 errorHandler:(id)arg3;
- (id)workQueue;
