...
- (struct { int x1; int x2; unsigned int x3; int x4; })_duration;
...
- (void)_figPlaybackItem:(struct OpaqueFigPlaybackItem { }*)arg1 didOutputAttributedStrings:(id)arg2 nativeSampleBuffers:(id)arg3 atItemTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg4 withLegibleOutputsDictionaryKey:(id)arg5;
...
- (int)_fileSize;
- (struct { int x1; int x2; unsigned int x3; int x4; })_forwardPlaybackEndTime;
...
- (void)_informObserversAboutAvailabilityOfDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
...
- (struct { int x1; int x2; unsigned int x3; int x4; })_maximumForwardBufferDuration;
- (id)_mediaKind;
...
- (void)_quietlySetForwardPlaybackEndTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
- (void)_quietlySetImageQueueInterpolationCurve:(id)arg1;
- (void)_quietlySetLimitReadAhead:(BOOL)arg1;
- (void)_quietlySetMaximumForwardBufferDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
- (void)_quietlySetMaximumTrailingBufferDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
- (void)_quietlySetMediaKind:(id)arg1;
- (void)_quietlySetMinimumIntervalForIFrameOnlyPlayback:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
...
- (void)_quietlySetReversePlaybackEndTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
...
- (void)_respondToBecomingReadyForBasicInspectionWithDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
- (struct { int x1; int x2; unsigned int x3; int x4; })_reversePlaybackEndTime;
...
- (void)_setVideoCompositionFrameDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
...
- (struct { int x1; int x2; unsigned int x3; int x4; })maximumForwardBufferDuration;
- (struct { int x1; int x2; unsigned int x3; int x4; })maximumTrailingBufferDuration;
- (id)mediaDataCollectors;
- (id)mediaKind;
- (struct { int x1; int x2; unsigned int x3; int x4; })minimumIntervalForIFrameOnlyPlayback;
...
- (void)setMaximumForwardBufferDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
- (void)setMaximumTrailingBufferDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
- (void)setMediaKind:(id)arg1;
- (void)setMinimumIntervalForIFrameOnlyPlayback:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
