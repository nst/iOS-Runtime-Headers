...
@interface WBReader : NSObject 
{
  ...
  /* Error parsing encoded ivar type info: ^{WrdBinaryReader=^^?^^?^{EshObjectFactory}^{WrdParser}{WrdEshReader="_vptr$EshBinaryReader"^^?"m_pStream"^{SsrwOOStream}"m_pParserVisitor"^{EshParserVisitor}"m_pObjectFactory"^{EshObjectFactory}"m_ulStartPos"I"m_ulEndPos"I"m_containers"{ChStack<EshHeader>="m_stack"^{EshHeader}"m_tmpStack"^{EshHeader}"m_count"L"m_size"L"m_blockSize"L}"m_ulCrtPos"I"m_nextHeader"{EshHeader="m_lLength"i"m_ulOffset"I"m_nInstance"s"m_unType"S"m_bVersion"C}"m_isLowLevel"B}^{WrdRdrText}^{WrdBinTable}^{WrdPAPXFKP}I^{WrdBinTable}^{WrdCHPXFKP}Ii^{WrdSectionDescriptorTable}^{WrdStyleSheet}^{WrdEmbeddedTTFRecordTable}^{WrdDocumentFileRecord}[8{ChMap<ChUINT4,ChUINT4,CsLess<ChUINT4> >="m_map"{map<ChUINT4,ChUINT4,CsLess<ChUINT4>,std::allocator<std::pair<const ChUINT4, ChUINT4> > >="_M_t"{_Rb_tree<ChUINT4,std::pair<const ChUINT4, ChUINT4>,std::_Select1st<std::pair<const ChUINT4, ChUINT4> >,CsLess<ChUINT4>,std::allocator<std::pair<const ChUINT4, ChUINT4> > >="_M_impl"{_Rb_tree_impl<CsLess<ChUINT4>,false>="_M_key_compare"{CsLess<ChUINT4>=}"_M_header"{_Rb_tree_node_base="_M_color"i"_M_parent"^{_Rb_tree_node_base}"_M_left"^{_Rb_tree_node_base}"_M_right"^{_Rb_tree_node_base}}"_M_node_count"I}}}}][8{ChMap<ChUINT4,ChUINT4,CsLess<ChUINT4> >="m_map"{map<ChUINT4,ChUINT4,CsLess<ChUINT4>,std::allocator<std::pair<const ChUINT4, ChUINT4> > >="_M_t"{_Rb_tree<ChUINT4,std::pair<const ChUINT4, ChUINT4>,std::_Select1st<std::pair<const ChUINT4, ChUINT4> >,CsLess<ChUINT4>,std::allocator<std::pair<const ChUINT4, ChUINT4> > >="_M_impl"{_Rb_tree_impl<CsLess<ChUINT4>,false>="_M_key_compare"{CsLess<ChUINT4>=}"_M_header"{_Rb_tree_node_base="_M_color"i"_M_parent"^{_Rb_tree_node_base}"_M_left"^{_Rb_tree_node_base}"_M_right"^{_Rb_tree_node_base}}"_M_node_count"I}}}}]IIIIi{WrdText="_vptr$WrdObject"^^?"m_text"{OcText="_vptr$OcText"^^?"m_encoding"i"m_ulStartCP"I"m_ulCharacterCount"I"m_ulBufferSize"I"m_pBuffer"*"m_pTempBuffer"*"m_isMyBuffer"B}"m_textType"i}^{WrdEmbeddedTrueTypeFont}} */
