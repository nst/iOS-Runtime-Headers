...
@property (setter=_setDidCompleteHandler:, nonatomic, copy) id _didCompleteHandler;
@property (setter=_setDuration:, nonatomic) double _duration;
@property (setter=_setInteractiveUpdateHandler:, nonatomic, copy) id _interactiveUpdateHandler;
...
@property (setter=_setPostInteractiveCompletionHandler:, nonatomic, copy) id _postInteractiveCompletionHandler;
...
@property (setter=_setWillCompleteHandler:, nonatomic, copy) id _willCompleteHandler;
