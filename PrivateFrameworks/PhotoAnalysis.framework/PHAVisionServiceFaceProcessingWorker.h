...
@interface PHAVisionServiceFaceProcessingWorker : PHAVisionServiceWorker <PLPhotoAnalysisVisionServiceFaceProcessingProtocol, PVCVMLIntegrating, PVNotificationListener, PVPersonPromoterDelegate> {
    struct { 
