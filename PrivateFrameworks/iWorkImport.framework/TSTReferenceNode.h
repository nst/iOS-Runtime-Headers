...
- (id)initWithContext:(id)arg1 calculationEngine:(id)arg2 cellRange:(struct TSCERangeCoordinate { struct TSUCellCoord { unsigned short x_1_1_1; unsigned char x_1_1_2; unsigned char x_1_1_3; } x1; struct TSUCellCoord { unsigned short x_2_1_1; unsigned char x_2_1_2; unsigned char x_2_1_3; } x2; })arg3 stickyBits:(unsigned char)arg4 hostTableID:(struct __CFUUID { }*)arg5 tableID:(struct __CFUUID { }*)arg6 referenceColorHelper:(id)arg7 firstIndex:(unsigned int)arg8 lastIndex:(unsigned int)arg9;
- (id)initWithContext:(id)arg1 calculationEngine:(id)arg2 cellRange:(struct TSCERangeCoordinate { struct TSUCellCoord { unsigned short x_1_1_1; unsigned char x_1_1_2; unsigned char x_1_1_3; } x1; struct TSUCellCoord { unsigned short x_2_1_1; unsigned char x_2_1_2; unsigned char x_2_1_3; } x2; })arg3 stickyBits:(unsigned char)arg4 hostTableID:(struct __CFUUID { }*)arg5 tableID:(struct __CFUUID { }*)arg6 referenceColorHelper:(id)arg7 firstIndex:(unsigned int)arg8 lastIndex:(unsigned int)arg9 suppressAutomaticNamedReferenceInvalidation:(BOOL)arg10;
...
- (id)initWithReferenceStart:(id)arg1 referenceEnd:(id)arg2 firstIndex:(unsigned int)arg3 lastIndex:(unsigned int)arg4 suppressAutomaticNamedReferenceInvalidation:(BOOL)arg5;
...
- (void)p_buildASTNodeArray:(/* Warning: unhandled struct encoding: '{TSCEASTNodeArray=*II@}' */ struct TSCEASTNodeArray { char *x1; unsigned int x2; unsigned int x3; id x4; }*)arg1 forTopLeft:(BOOL)arg2 stickyBits:(unsigned char)arg3 hostCell:(struct TSUCellCoord { unsigned short x1; unsigned char x2; unsigned char x3; })arg4;
- (void)p_resetMenu;
