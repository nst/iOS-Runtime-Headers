...
- (void)getClearedInfoWithCompletion:(void *)arg1; // needs 1 arg types, found 10: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, id, void*, inout unsigned short, void*, const const out const void*, void*
- (void)getSectionInfoWithCompletion:(void *)arg1; // needs 1 arg types, found 7: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, BBSectionInfo *, NSError *, void*
