...
@interface BWGNRNode : BWNode <BWBracketSettingsProvider> {
    ...
    NSString * _portType;
    int  _previouslyCompletedFusionSettingsID;
    int  _processingType;
