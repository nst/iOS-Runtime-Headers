...
- (void)_requestDidEnd;
- (void)_requestWillBeginWithRequestClass:(id)arg1 isSpeechRequest:(bool)arg2 analyticsEventProvider:(id)arg3;
- (void)_requestWillBeginWithRequestClass:(id)arg1 isSpeechRequest:(bool)arg2 isBackgroundRequest:(bool)arg3 analyticsEventProvider:(id)arg4;
...
- (void)_startRequestWithInfo:(id)arg1 analyticsEventProvider:(id)arg2;
...
- (void)_tellSpeechDelegateToPerformTwoShotPromptWithType:(long long)arg1 reply:(id)arg2;
...
- (void)_willStartRequestForSpeech:(bool)arg1 analyticsEventProvider:(id)arg2;
- (unsigned int)audioSessionID;
- (float)averagePower;
- (void)boostedPreheatWithStyle:(long long)arg1 completion:(id)arg2;
- (void)cancelRequest;
- (void)cancelSpeech;
- (void)checkLanguageReady:(id)arg1 completion:(id)arg2;
- (void)clearContext;
- (void)dealloc;
- (id)delegate;
- (void)didDismissUI;
...
- (void)getCachedObjectsWithIdentifiers:(id)arg1 completion:(id)arg2;
- (void)getDeferredObjectsWithIdentifiers:(id)arg1 completion:(id)arg2;
...
- (void)startAudioPlaybackRequest:(id)arg1 completion:(id)arg2;
- (void)startContinuationRequestWithUserInfo:(id)arg1;
- (void)startDirectActionRequestWithString:(id)arg1;
- (id)startRecordingAndGetContinueBlockForPendingSpeechRequestWithOptions:(id)arg1;
