...
+ (struct CGSize { double x1; double x2; })backgroundImageSizeForType:(unsigned int)arg1 usingTraitCollection:(id)arg2;
+ (id)sharedInstance;
...
- (struct CGSize { double x1; double x2; })thumbnailImageSizeForImageType:(unsigned int)arg1 usingTraitCollection:(id)arg2 includeScale:(BOOL)arg3;
