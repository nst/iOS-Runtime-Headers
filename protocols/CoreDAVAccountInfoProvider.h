...
- (long long)port;
- (NSURL *)principalURL;
- (void)promptUserForNewCoreDAVPasswordWithCompletionBlock:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, int, void*
- (NSString *)scheme;
...
- (void)webLoginRequestedAtURL:(void *)arg1 reasonString:(void *)arg2 completionBlock:(void *)arg3; // needs 3 arg types, found 8: NSURL *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, int, void*
