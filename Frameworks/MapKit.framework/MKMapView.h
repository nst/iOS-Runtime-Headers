...
@property (getter=_debugConsoleAdditionalInfoProvider, setter=_setDebugConsoleAdditionalInfoProvider:, nonatomic, copy) id debugConsoleAdditionalInfoProvider;
...
- (void)_zoomIn;
- (void)_zoomInWithCompletionHandler:(id)arg1;
- (double)_zoomLevel;
...
- (void)_zoomOut;
- (void)_zoomOutWithCompletionHandler:(id)arg1;
...
- (void)_zoomWithAmount:(double)arg1 completionHandler:(id)arg2;
