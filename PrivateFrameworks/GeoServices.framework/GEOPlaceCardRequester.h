...
- (void)requestMUIDs:(id)arg1 resultProviderID:(int)arg2 includeETA:(BOOL)arg3 traits:(id)arg4 options:(unsigned int)arg5 auditToken:(id)arg6 networkActivity:(id /* block */)arg7 requesterHandler:(id /* block */)arg8;
