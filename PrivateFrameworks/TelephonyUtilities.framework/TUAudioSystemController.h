...
@interface TUAudioSystemController : TUAudioController {
    ...
    unsigned int  _lastDownlinkMutedRequestScheduleTime;
    unsigned int  _lastPhoneCallCategoryRoutesScheduleTime;
    unsigned int  _lastPlayAndRecordRemoteVoiceRoutesScheduleTime;
    unsigned int  _lastPlayAndRecordVideoRoutesScheduleTime;
    unsigned int  _lastPlayAndRecordVoiceRoutesScheduleTime;
    unsigned int  _lastTTYPickableRoutesScheduleTime;
    unsigned int  _lastTTYRequestScheduleTime;
    unsigned int  _lastUplinkMutedRequestScheduleTime;
    unsigned int  _lastVoicemailRoutesScheduleTime;
