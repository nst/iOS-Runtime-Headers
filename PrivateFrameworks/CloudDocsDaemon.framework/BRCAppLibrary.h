...
@property (nonatomic) int maxLostStamp;
...
- (unsigned int)allocateLostStampAddingBackoff:(BOOL)arg1;
- (id)appLibraryID;
...
- (unsigned int)documentEvictableSizeUsage;
- (unsigned int)documentEvictableSizeUsageWithAccessTimeDelta:(double)arg1;
- (unsigned int)documentSizeUsage;
...
- (struct PQLResultSet { Class x1; }*)itemsEnumeratorChildOf:(id)arg1 rankMin:(unsigned int)arg2 rankMax:(unsigned int)arg3 count:(unsigned int)arg4;
- (struct PQLResultSet { Class x1; }*)itemsEnumeratorWithRankMin:(unsigned int)arg1 rankMax:(unsigned int)arg2 namePrefix:(id)arg3 shouldIncludeFolders:(BOOL)arg4 shouldIncludeOnlyFolders:(BOOL)arg5 shouldIncludeDocumentsScope:(BOOL)arg6 shouldIncludeDataScope:(BOOL)arg7 shouldIncludeExternalScope:(BOOL)arg8 shouldIncludeTrashScope:(BOOL)arg9 count:(unsigned int)arg10;
...
- (int)throttleHashWithItemID:(id)arg1;
- (id)tracker;
