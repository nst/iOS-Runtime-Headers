...
- (/* Warning: unhandled struct encoding: '{PQLResultSet=#@#:B@?@BB@@QQ@}' */ struct PQLResultSet { Class x1; id x2; SEL x3; bool x4; id x5; id x6; bool x7; id x8; unsigned long long x9; unsigned long long x10; id x11; }*)enumerateObjects:(id)arg1;
- (/* Warning: unhandled struct encoding: '{PQLResultSet=#@#:B@?@BB@@QQ@}' */ struct PQLResultSet { Class x1; id x2; SEL x3; bool x4; id x5; id x6; bool x7; id x8; unsigned long long x9; unsigned long long x10; id x11; }*)enumerateObjectsOfClass:(Class)arg1;
- (/* Warning: unhandled struct encoding: '{PQLResultSet=#@#:B@?@BB@@QQ@}' */ struct PQLResultSet { Class x1; id x2; SEL x3; bool x4; id x5; id x6; bool x7; id x8; unsigned long long x9; unsigned long long x10; id x11; }*)enumerateObjectsOfClass:(Class)arg1 initializer:(SEL)arg2;
- (id)error;
