...
- (bool)_setFloatValue:(float)arg1 fromCurrentValue:(float)arg2 forRingPropertyType:(unsigned long long)arg3 ofRingAtIndex:(long long)arg4 animated:(bool)arg5 duration:(double)arg6 completion:(id)arg7;
