...
- (void)_updateMapWithAllDataSources:(id)arg1;
- (void)_updateMapWithDataSource:(id)arg1 dataSourceChange:(id)arg2 completion:(id)arg3;
- (void)_updateMapWithDataSources:(id)arg1 dataSourceChangeTable:(id)arg2 completion:(id)arg3;
