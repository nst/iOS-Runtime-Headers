...
- (struct CGSize { float x1; float x2; })_drawComponentsJoinedByString:(id)arg1 atPoint:(struct CGPoint { float x1; float x2; }*)arg2 forWidth:(float)arg3 withFont:(id)arg4 lineBreakMode:(int)arg5;
...
- (BOOL)_validateValue:(id*)arg1 forKeyPath:(id)arg2 ofObjectAtIndex:(unsigned int)arg3 error:(id*)arg4;
...
- (id)arrayByAddingObjects:(const id*)arg1 count:(unsigned int)arg2;
...
- (struct CGSize { float x1; float x2; })drawComponentsJoinedByString:(id)arg1 atPoint:(struct CGPoint { float x1; float x2; })arg2 forWidth:(float)arg3 withFont:(id)arg4 lineBreakMode:(int)arg5;
...
- (BOOL)getObject:(id*)arg1 atIndex:(unsigned int)arg2;
...
- (unsigned int)hash;
- (int)indexForInsertingAttendeeDisplayString:(id)arg1;
- (int)indexForInsertingCalendarAttendeeIntoList:(id)arg1;
- (int)indexForInsertingCalendarAttendeeListAttendee:(id)arg1;
- (unsigned int)indexOf:(id)arg1 :(unsigned int)arg2 :(BOOL)arg3;
- (unsigned int)indexOfAttributeBySelector:(SEL)arg1 equalToObject:(id)arg2;
...
- (unsigned int)indexOfObject:(id)arg1 range:(struct _NSRange { unsigned int x1; unsigned int x2; })arg2 identical:(BOOL)arg3;
...
- (struct _NSRange { unsigned int x1; unsigned int x2; })rangeWithStartIndex:(int)arg1 endIndex:(int)arg2;
...
- (struct CGSize { float x1; float x2; })sizeOfComponentsJoinedByString:(id)arg1 withFont:(id)arg2 forWidth:(float)arg3 lineBreakMode:(int)arg4;
- (id)smilString;
- (id)smsAddresses;
- (id)sortedArrayHint;
