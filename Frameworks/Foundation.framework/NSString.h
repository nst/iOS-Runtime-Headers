...
@interface NSString : NSObject <CKRecordValue, CKShortDescription, NSCopying, NSMutableCopying, NSSecureCoding, PQLValuable, PQLValuable> {
}
...
- (void)tsu_enumerateRangesOfCharactersInSet:(id)arg1 usingBlock:(id)arg2;
