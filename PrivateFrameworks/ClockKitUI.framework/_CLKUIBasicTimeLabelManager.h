...
- (id)_initPrimary:(bool)arg1 withTimeFormatter:(id)arg2 options:(unsigned long long)arg3 labelFactory:(id)arg4;
- (double)_lastLineBaseline;
- (void)_updateAttributedText;
- (bool)animationsPaused;
- (id)effectiveAttributedText;
- (id)effectiveFont;
- (void)enumerateUnderlyingLabelsWithBlock:(id)arg1;
- (id)initWithTimeFormatter:(id)arg1 options:(unsigned long long)arg2 labelFactory:(id)arg3;
