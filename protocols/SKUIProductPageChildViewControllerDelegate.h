...
- (void)productPageChildOpenURL:(void *)arg1 viewControllerBlock:(void *)arg2; // needs 2 arg types, found 6: NSURL *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, UIViewController *, id, void*
