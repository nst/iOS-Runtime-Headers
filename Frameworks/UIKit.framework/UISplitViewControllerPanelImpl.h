...
+ (id)_withDisabledAppearanceTransitions:(bool)arg1 forVisibleDescendantsOf:(id)arg2 perform:(id)arg3;
...
- (void)_withDisabledAppearanceTransitionsPerform:(id)arg1;
...
- (id)panelControllerWillUpdate:(id)arg1;
- (id)possibleStates;
