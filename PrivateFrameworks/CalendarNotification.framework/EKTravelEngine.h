...
@interface EKTravelEngine : NSObject <CLLocationManagerDelegate> {
    ...
    id  _eventSignificantlyChangedBlock;
...
@property (nonatomic, copy) id authorizationChangedBlock;
@property (nonatomic, readonly) bool authorized;
@property (nonatomic) bool authorizedInternal;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (nonatomic, copy) id eventSignificantlyChangedBlock;
...
- (void)_sendFeedbackForPostingNotificationForEventWithExternalURL:(id)arg1 feedback:(id)arg2;
