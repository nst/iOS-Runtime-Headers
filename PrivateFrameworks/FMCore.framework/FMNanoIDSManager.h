...
- (id)_sendMessageWithProtobuf:(id)arg1 inResponseToRequest:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 bypassingDuet:(bool)arg5 deviceID:(id)arg6 responseHandler:(id)arg7;
...
- (id)devices;
- (void)handleRequestsOfType:(unsigned short)arg1 withHandler:(id)arg2;
...
- (void)sendMessageWithProtobuf:(id)arg1 inResponseToRequest:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 bypassingDuet:(bool)arg5 deviceID:(id)arg6 requestAcceptedHandler:(id)arg7 responseHandler:(id)arg8;
- (void)sendMessageWithProtobuf:(id)arg1 inResponseToRequest:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 bypassingDuet:(bool)arg5 requestAcceptedHandler:(id)arg6 responseHandler:(id)arg7;
- (id)service;
