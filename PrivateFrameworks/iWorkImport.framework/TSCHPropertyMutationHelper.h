...
+ (id)convertToStyleSwapTuplesForStyleOwner:(id)arg1 styleSwapType:(int)arg2 nonStyleSwapType:(int)arg3 index:(unsigned int)arg4 fromMutations:(id)arg5 forImport:(BOOL)arg6 withOptionalStyleValueConversionBlock:(id)arg7;
