...
- (void)_reloadRadioBagAvailabilityWithCompletionHandler:(id)arg1;
- (void)_reloadRadioRestriction;
- (void)_updateRadioAvailabilityAllowingNotifications:(bool)arg1;
- (void)_updateRadioAvailabilityWithStoreBagDictionary:(id)arg1 error:(id)arg2 completionHandler:(id)arg3;
- (id)_userDefaultsDomain;
- (void)bagDidChange:(id)arg1;
- (void)dealloc;
- (void)getRadioAvailabilityWithCompletionHandler:(id)arg1;
- (id)init;
