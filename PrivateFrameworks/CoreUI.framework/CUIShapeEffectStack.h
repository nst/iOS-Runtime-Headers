...
@interface CUIShapeEffectStack : NSObject {
    unsigned int  bevelEmbossCount;
    struct { unsigned int x1; double x2; double x3; double x4; double x5; BOOL x6; } * colorOverlay;
    unsigned int  colorOverlayCount;
    struct { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; unsigned int x13; } * emboss;
    struct { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; struct CGPoint { double x_9_1_1; double x_9_1_2; } x9; } * engraveShadow;
    unsigned int  engraveShadowCount;
    struct { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; struct CGPoint { double x_9_1_1; double x_9_1_2; } x9; } * extraShadow;
    unsigned int  extraShadowCount;
    struct { double x1; double x2; double x3; double x4; double x5; BOOL x6; } * hueSaturation;
    unsigned int  hueSaturationCount;
    struct { unsigned int x1; double x2; double x3; double x4; double x5; double x6; } * innerGlow;
    unsigned int  innerGlowCount;
    struct { unsigned int x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; } * innerGradient;
    unsigned int  innerGradientCount;
    struct { unsigned int x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; struct CGPoint { double x_9_1_1; double x_9_1_2; } x9; } * innerShadow;
    unsigned int  innerShadowCount;
    struct { double x1; double x2; double x3; double x4; double x5; double x6; } * outerGlow;
    unsigned int  outerGlowCount;
...
+ (id)gradientWithParameters:(struct { unsigned int x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; }*)arg1 inRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2;
...
- (void)_setColorFillAtIndex:(unsigned int)arg1 FromPreset:(id)arg2 index:(unsigned int)arg3;
- (void)_setEngraveShadowAtIndex:(unsigned int)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (void)_setExtraShadowAtIndex:(unsigned int)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (void)_setHueSaturationAtIndex:(unsigned int)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (void)_setInnerGlowAtIndex:(unsigned int)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (void)_setInnerShadowAtIndex:(unsigned int)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (void)_setInteriorGradientAtIndex:(unsigned int)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (void)_setOuterGlowAtIndex:(unsigned int)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
...
- (void)dealloc;
- (struct { double x1; double x2; double x3; double x4; })effectInsetsWithScale:(float)arg1;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })effectPaddingWithScale:(float)arg1;
- (id)effectPreset;
- (BOOL)hasBevelEmboss;
...
- (id)imageWithBevelEmbossOfImage:(id)arg1 effect:(struct { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; unsigned int x13; })arg2;
- (id)imageWithColorOverlayOfImage:(id)arg1 effect:(struct { unsigned int x1; double x2; double x3; double x4; double x5; BOOL x6; })arg2;
- (id)imageWithEngraveShadowOfImage:(id)arg1 effect:(struct { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; struct CGPoint { double x_9_1_1; double x_9_1_2; } x9; })arg2;
- (id)imageWithExtraShadowOfImage:(id)arg1 effect:(struct { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; struct CGPoint { double x_9_1_1; double x_9_1_2; } x9; })arg2;
- (id)imageWithHueSaturationOfImage:(id)arg1 effect:(struct { double x1; double x2; double x3; double x4; double x5; BOOL x6; })arg2;
- (id)imageWithInnerGlowOfImage:(id)arg1 effect:(struct { unsigned int x1; double x2; double x3; double x4; double x5; double x6; })arg2;
- (id)imageWithInnerShadowOfImage:(id)arg1 effect:(struct { unsigned int x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; struct CGPoint { double x_9_1_1; double x_9_1_2; } x9; })arg2;
- (id)imageWithInteriorGradientFillOfImage:(id)arg1 effect:(struct { unsigned int x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; })arg2;
- (id)imageWithOuterGlowOfImage:(id)arg1 effect:(struct { double x1; double x2; double x3; double x4; double x5; double x6; })arg2;
...
- (void)scaleBrightnessOfEffectColorsByAmount:(float)arg1 onlyTintableColors:(BOOL)arg2;
