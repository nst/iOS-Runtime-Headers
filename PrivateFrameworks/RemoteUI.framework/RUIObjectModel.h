...
- (void)_handleElementChange:(id)arg1 completion:(id)arg2;
...
- (void)_presentConfirmationWithAttributes:(id)arg1 completion:(id)arg2;
- (void)_presentSecondConfirmationWithAttributes:(id)arg1 completion:(id)arg2;
...
- (void)activateElement:(id)arg1 completion:(id)arg2;
- (void)addAlertElement:(id)arg1;
- (id)alert;
- (id)alertController;
- (void)alertView:(id)arg1 pressedButton:(id)arg2 completion:(id)arg3;
- (id)allPages;
- (void)back:(id)arg1;
...
- (void)handleAppleIDAuthenticationIfNeededForAttributes:(id)arg1 completion:(id)arg2;
- (void)handleElementChange:(id)arg1 action:(int)arg2 completion:(id)arg3;
...
- (id)pages;
- (void)parseDidFinish;
- (void)passcodeViewOM:(id)arg1 activatedElement:(id)arg2 completion:(id)arg3;
- (void)populatePostbackDictionary:(id)arg1;
- (id)postbackData;
- (id)postbackDictionary;
- (bool)prepareScriptContext;
- (void)presentConfirmationIfNeededForElement:(id)arg1 completion:(id)arg2;
- (void)presentInParentViewController:(id)arg1 animated:(bool)arg2;
- (void)presentInParentViewController:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
- (void)presentPage:(id)arg1 inViewController:(id)arg2 animated:(bool)arg3 completion:(id)arg4;
...
- (void)tableViewOM:(id)arg1 elementDidChange:(id)arg2 action:(int)arg3 completion:(id)arg4;
