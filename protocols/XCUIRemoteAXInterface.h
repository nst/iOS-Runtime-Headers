...
- (void)registerForAccessibilityNotification:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 8: int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSNumber *, NSError *, void*
...
- (void)unregisterForAccessibilityNotification:(void *)arg1 registrationToken:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 8: int, NSNumber *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
