...
- (void)_didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(bool)arg5 date:(id)arg6 attempts:(long long)arg7 useMessageSuppression:(bool)arg8 account:(id)arg9 completionBlock:(id)arg10;
...
- (void)didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(bool)arg5 date:(id)arg6 useMessageSuppression:(bool)arg7 account:(id)arg8 completionBlock:(id)arg9;
...
- (void)didSendBalloonPayload:(id)arg1 forChat:(id)arg2 style:(unsigned char)arg3 messageGUID:(id)arg4 account:(id)arg5 completionBlock:(id)arg6;
...
- (void)processMessageForSending:(id)arg1 toChat:(id)arg2 style:(unsigned char)arg3 allowWatchdog:(bool)arg4 account:(id)arg5 completionBlock:(id)arg6;
- (void)processMessageForSending:(id)arg1 toChat:(id)arg2 style:(unsigned char)arg3 allowWatchdog:(bool)arg4 completionBlock:(id)arg5;
