...
+ (id)_cnui_userActivityWithActivityType:(id)arg1 destinationID:(id)arg2 customIdentifier:(id)arg3 contact:(id)arg4 intentWithPerson:(id)arg5;
...
- (id)_payloadUpdateBlockForIdentifier:(id)arg1;
...
- (void)_setPayloadIdentifier:(id)arg1 object:(id)arg2 withBlock:(id)arg3;
