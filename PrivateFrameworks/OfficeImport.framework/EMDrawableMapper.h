...
- (struct CGPoint { double x1; double x2; })anchorMarkerToPosition:(struct EDCellAnchorMarker { int x1; double x2; int x3; double x4; })arg1 rowGrid:(double*)arg2 columnGrid:(double*)arg3 start:(BOOL)arg4 relative:(BOOL)arg5;
