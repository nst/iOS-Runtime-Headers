...
- (void)_enumeratePassIndicesInStackOrderWithBlock:(id)arg1;
- (void)_enumeratePassViewsInStackOrderWithBlock:(id)arg1;
...
- (void)updateToStackWithProgress:(double)arg1 originalPosition:(struct CGPoint { double x1; double x2; })arg2 timingFunction:(id)arg3;
