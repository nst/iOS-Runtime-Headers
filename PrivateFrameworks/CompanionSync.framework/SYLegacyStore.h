...
@property (nonatomic, copy) id nextBatchStep;
...
- (void)_handleObjectChanges:(id)arg1 contextInfo:(id)arg2 idsOptions:(id)arg3 blockUntilSent:(bool)arg4 reportError:(id)arg5 notifyingTransaction:(id)arg6;
