...
- (void)documentListController:(void *)arg1 performAction:(void *)arg2 URL:(void *)arg3 originatingView:(void *)arg4 completion:(void *)arg5; // needs 5 arg types, found 9: _UIDocumentListController *, long long, NSURL *, UIView *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*

@optional

- (void)documentListController:(void *)arg1 renameItemAtURL:(void *)arg2 toName:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 10: _UIDocumentListController *, NSURL *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, bool, void*
