...
- (<CNCancelable> *)consumer:(void *)arg1 actionModelsForActionType:(void *)arg2 handler:(void *)arg3; // needs 3 arg types, found 8: <CNUIUserActionListConsumer> *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, CNUIUserActionListModel *, void*
