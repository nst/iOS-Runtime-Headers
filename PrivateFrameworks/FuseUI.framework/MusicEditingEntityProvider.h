...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)_configureEntityValueContextOutput:(id)arg1 forEntry:(const /* Warning: unhandled struct encoding: '{EditingEntityProviderEntry=ii@}' */ struct EditingEntityProviderEntry { int x1; int x2; id x3; }*)arg2;
- (id)_entityValueProviderForEntry:(const /* Warning: unhandled struct encoding: '{EditingEntityProviderEntry=ii@}' */ struct EditingEntityProviderEntry { int x1; int x2; id x3; }*)arg1;
