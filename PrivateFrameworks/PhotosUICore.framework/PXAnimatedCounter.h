...
- (void)setNumber:(unsigned long long)arg1 animated:(bool)arg2 completionBlock:(id)arg3;
- (void)setNumber:(unsigned long long)arg1 withAnimationStyle:(long long)arg2 completionBlock:(id)arg3;
