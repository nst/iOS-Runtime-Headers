...
+ (id)screenCaptureControllerWithSize:(struct CGSize { float x1; float x2; })arg1 minIntervalBetweenFrames:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2;

- (void)dealloc;
- (id)delegate;
- (void)didReceiveSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1 sourceRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg2 destRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg3 transform:(unsigned int)arg4;
- (id)initWithSize:(struct CGSize { float x1; float x2; })arg1 minIntervalBetweenFrames:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2;
