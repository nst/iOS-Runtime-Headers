...
- (struct ColorResult { boolx1; struct Color { float x_2_1_1; float x_2_1_2; float x_2_1_3; float x_2_1_4; } x2; })colorFromRedKey:(id)arg1 greenKey:(id)arg2 blueKey:(id)arg3;
- (void)dealloc;
