...
@interface TSTIdentifierNode : TSTExpressionNode {
    BOOL mHasDollarPrefix;
    NSString *mIdentifier;
    BOOL mIdentifierIsQuoted;
    NSString *mSheetName;
    NSString *mTableName;
}
...
- (id)initWithContext:(id)arg1 identifier:(id)arg2 isQuoted:(BOOL)arg3 hasDollarPrefix:(BOOL)arg4 firstIndex:(unsigned int)arg5 lastIndex:(unsigned int)arg6;
- (BOOL)isQuoted;
