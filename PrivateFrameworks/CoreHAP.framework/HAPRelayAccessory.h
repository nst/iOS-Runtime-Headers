...
- (void)_handleRelayControlPointCharacteristicTransactionWithTLV8Data:(id)arg1 completionHandler:(id)arg2;
...
- (void)addRelayPairingWithIdentifier:(id)arg1 accessToken:(id)arg2 admin:(bool)arg3 queue:(id)arg4 completionHandler:(id)arg5;
...
- (void)removeRelayPairingWithIdentifier:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3;
