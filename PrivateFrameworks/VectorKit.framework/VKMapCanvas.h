...
- (id)initShouldRasterize:(BOOL)arg1 contentScale:(float)arg2 target:(id)arg3 device:(const struct shared_ptr<ggl::Device> { struct Device {} *x1; struct __shared_weak_count {} *x2; }*)arg4 inBackground:(BOOL)arg5 manifestConfiguration:(id)arg6 locale:(id)arg7;
...
- (struct shared_ptr<gss::CartoStyle> { struct CartoStyle {} *x1; struct __shared_weak_count {} *x2; })styleAtScreenPoint:(struct CGPoint { float x1; float x2; })arg1;
