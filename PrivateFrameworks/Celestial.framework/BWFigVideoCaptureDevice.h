...
@interface BWFigVideoCaptureDevice : BWCaptureDevice <BWZoomCompletionDelegate> {
    ...
    double  _autoFlashNormalizedSNRThreshold;
    ...
    struct { 
        ...
        double motionDataBiasErrorEstimate; 
        double synchronizedStreamsTelephotoGain; 
        double synchronizedStreamsTelephotoStableGain; 
        ...
        double synchronizedStreamsTelephotoFocusDistance; 
        int synchronizedStreamsTelephotoLuxLevel; 
        int synchronizedStreamsWideFocusPosition; 
        double synchronizedStreamsWideFocusDistance; 
    ...
    double  _maxISPZoomFactor;
    int  _maxSkippedFramesForStillImageCaptureRetry;
    double  _maxTorchLevel;
    struct OpaqueFigFlatDictionaryKeySpec { } * _metadataKeySpec;
    NSDictionary * _moduleInfoByPortType;
    double  _motionDataBiasErrorEstimateThresholdAbandon;
    double  _motionDataBiasErrorEstimateThresholdDegraded;
    ...
    double  _parallaxMitigationStrength;
    ...
    double  _quadraLowLightResampledNormalizedSNRThreshold;
    double  _rampDefaultBravoSnapDistanceFraction;
    ...
    double  _synchronizedStreamsElevatedSlaveFrameRateLowerBoundZoomFactor;
    double  _synchronizedStreamsElevatedSlaveFrameRateUpperBoundZoomFactor;
    int  _synchronizedStreamsMinimumFocusDistanceChangeForAutoSwitchOver;
    double  _synchronizedStreamsMinimumLuxLevelChangeForAutoSwitchOver;
    int  _synchronizedStreamsNominalMasterToSlaveFrameRateRatio;
    int  _synchronizedStreamsNominalSlaveFrameRate;
    double  _synchronizedStreamsOISSISStereoFusionTeleMinGain;
    NSObject<OS_dispatch_semaphore> * _synchronizedStreamsStartStopSemaphore;
    double  _synchronizedStreamsStereoFusionLowerBoundZoomFactor;
    double  _synchronizedStreamsStereoFusionTeleMaxIntegrationTime;
    double  _synchronizedStreamsStereoFusionUpperBoundZoomFactor;
    ...
    double  _synchronizedStreamsSwitchOverMasterInitialFocusDistance;
    ...
    double  _synchronizedStreamsSwitchOverPreviousZoomFactor;
    BOOL  _synchronizedStreamsSwitchOverResetChangeMonitors;
    double  _synchronizedStreamsSwitchOverTotalGainHysteresisLag;
    BOOL  _synchronizedStreamsSwitchOverUnlockCamera;
    double  _synchronizedStreamsTeleMaxAEGain;
...
- (void)_serviceAutoTorchNotification:(struct { double x1; double x2; double x3; double x4; double x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned char x10; unsigned char x11; unsigned int x12; unsigned int x13; int x14; int x15; unsigned int x16; double x17; double x18; double x19; double x20; int x21; int x22; double x23; int x24; int x25; double x26; int x27; int x28; int x29; int x30; }*)arg1;
...
- (void)_serviceSynchronizedStreamsWithSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1 fromCaptureStream:(id)arg2 frameStatistics:(struct { double x1; double x2; double x3; double x4; double x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned char x10; unsigned char x11; unsigned int x12; unsigned int x13; int x14; int x15; unsigned int x16; double x17; double x18; double x19; double x20; int x21; int x22; double x23; int x24; int x25; double x26; int x27; int x28; int x29; int x30; }*)arg3;
...
- (long)_setExposureModeAutoWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
- (unsigned int)_stillImageCaptureInProgressSubstateForFrameStatistics:(struct { double x1; double x2; double x3; double x4; double x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned char x10; unsigned char x11; unsigned int x12; unsigned int x13; int x14; int x15; unsigned int x16; double x17; double x18; double x19; double x20; int x21; int x22; double x23; int x24; int x25; double x26; int x27; int x28; int x29; int x30; }*)arg1 captureType:(int)arg2 stereoFusionCapture:(BOOL)arg3;
- (id)_stillImageCaptureSettingsForCaptureType:(int)arg1 frameStatistics:(struct { double x1; double x2; double x3; double x4; double x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned char x10; unsigned char x11; unsigned int x12; unsigned int x13; int x14; int x15; unsigned int x16; double x17; double x18; double x19; double x20; int x21; int x22; double x23; int x24; int x25; double x26; int x27; int x28; int x29; int x30; }*)arg2 deliverOriginalImage:(BOOL)arg3 deliverSushiRaw:(BOOL)arg4 includePreBracketedEV0ForProcessing:(BOOL)arg5 clientBracketSettings:(id)arg6;
- (void)_stillImageCaptureStateMachineDidTransitionToInProgress;
- (int)_stillImageSceneTypeForFrameStatistics:(struct { double x1; double x2; double x3; double x4; double x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned char x10; unsigned char x11; unsigned int x12; unsigned int x13; int x14; int x15; unsigned int x16; double x17; double x18; double x19; double x20; int x21; int x22; double x23; int x24; int x25; double x26; int x27; int x28; int x29; int x30; }*)arg1 flashSceneDetectionEnabled:(BOOL)arg2 hdrSceneDetectionEnabled:(BOOL)arg3 sisSceneDetectionEnabled:(BOOL)arg4;
- (BOOL)_switchToOtherStreamForCurrentMasterStream:(id)arg1 requestedZoomFactor:(float)arg2 frameStatistics:(struct { double x1; double x2; double x3; double x4; double x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned char x10; unsigned char x11; unsigned int x12; unsigned int x13; int x14; int x15; unsigned int x16; double x17; double x18; double x19; double x20; int x21; int x22; double x23; int x24; int x25; double x26; int x27; int x28; int x29; int x30; }*)arg3 selectionBehavior:(int)arg4;
...
- (void)_updateSwitchOverStateForCurrentMasterStream:(id)arg1 frameStatistics:(struct { double x1; double x2; double x3; double x4; double x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned char x10; unsigned char x11; unsigned int x12; unsigned int x13; int x14; int x15; unsigned int x16; double x17; double x18; double x19; double x20; int x21; int x22; double x23; int x24; int x25; double x26; int x27; int x28; int x29; int x30; }*)arg2;
...
- (struct { double x1; double x2; double x3; })deviceWhiteBalanceGains;
...
- (struct { double x1; double x2; double x3; })grayWorldDeviceWhiteBalanceGains;
...
- (int)resolveStillImageCaptureTypeFromStatistics:(struct { double x1; double x2; double x3; double x4; double x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned char x10; unsigned char x11; unsigned int x12; unsigned int x13; int x14; int x15; unsigned int x16; double x17; double x18; double x19; double x20; int x21; int x22; double x23; int x24; int x25; double x26; int x27; int x28; int x29; int x30; }*)arg1 flashMode:(int)arg2 hdrMode:(int)arg3 sisMode:(int)arg4 clientBracketMode:(int)arg5;
...
- (long)setExposureModeAutoWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (long)setExposureModeCustomWithExposureDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg1 minFrameRate:(double)arg2 maxFrameRate:(double)arg3 ISO:(float)arg4 requestID:(int)arg5;
...
- (long)setFocusModeAutoWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 continuous:(BOOL)arg2 smooth:(BOOL)arg3 rangeRestrictionNear:(float)arg4 rangeRestrictionFar:(float)arg5;
...
- (long)setWhiteBalanceModeLockedWithGains:(struct { double x1; double x2; double x3; })arg1 requestID:(int)arg2;
