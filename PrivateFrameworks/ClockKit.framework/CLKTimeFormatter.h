...
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } blinkerRangeInTimeAndDesignatorText;
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } blinkerRangeInTimeSubstringFromSeparatorText;
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } blinkerRangeInTimeSubstringToSeparatorText;
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } blinkerRangeInTimeText;
@property (nonatomic) <CLKTimeFormatterDelegate> *delegate;
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } designatorRangeInTimeAndDesignatorText;
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } designatorRangeInTimeAndDesignatorTextWithoutMinutesIfZero;
@property (nonatomic, readonly) NSString *designatorText;
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } lastBlinkerRangeInTimeText;
@property (nonatomic, retain) NSDate *overrideDate;
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } rangeInTimeSubstringFromSecondsSeparatorText;
@property (nonatomic, readonly) BOOL reportingLiveTime;
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } separatorRangeInTimeAndDesignatorText;
@property (nonatomic, readonly) struct _NSRange { unsigned int x1; unsigned int x2; } separatorRangeInTimeText;
...
- (struct _NSRange { unsigned int x1; unsigned int x2; })blinkerRangeInTimeAndDesignatorText;
- (struct _NSRange { unsigned int x1; unsigned int x2; })blinkerRangeInTimeSubstringFromSeparatorText;
- (struct _NSRange { unsigned int x1; unsigned int x2; })blinkerRangeInTimeSubstringToSeparatorText;
- (struct _NSRange { unsigned int x1; unsigned int x2; })blinkerRangeInTimeText;
- (void)dealloc;
- (id)delegate;
- (struct _NSRange { unsigned int x1; unsigned int x2; })designatorRangeInTimeAndDesignatorText;
- (struct _NSRange { unsigned int x1; unsigned int x2; })designatorRangeInTimeAndDesignatorTextWithoutMinutesIfZero;
- (id)designatorText;
- (id)init;
- (struct _NSRange { unsigned int x1; unsigned int x2; })lastBlinkerRangeInTimeText;
- (id)overrideDate;
- (struct _NSRange { unsigned int x1; unsigned int x2; })rangeInTimeSubstringFromSecondsSeparatorText;
- (void)removeObserver:(id)arg1;
- (BOOL)reportingLiveTime;
- (struct _NSRange { unsigned int x1; unsigned int x2; })separatorRangeInTimeAndDesignatorText;
- (struct _NSRange { unsigned int x1; unsigned int x2; })separatorRangeInTimeText;
