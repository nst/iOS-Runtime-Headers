...
- (void)_fetchSupportedServiceIDsWithCompletion:(id)arg1;
...
- (void)getHealthServicePropertyNamesWithHandler:(id)arg1;
...
- (id)startAllHealthServicesDiscoveryWithHandler:(id)arg1;
