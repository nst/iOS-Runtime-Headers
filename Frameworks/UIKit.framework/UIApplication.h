...
@property (setter=__setQueuedOrientationChange:, nonatomic, copy) id __queuedOrientationChange;
...
- (void)__setQueuedOrientationChange:(id)arg1;
...
- (id)_backgroundModes;
- (unsigned long long)_beginBackgroundTaskWithExpirationHandler:(id)arg1;
- (unsigned long long)_beginBackgroundTaskWithName:(id)arg1 expirationHandler:(id)arg2;
- (void)_beginFenceTaskIfNecessary;
- (void)_beginShowingNetworkActivityIndicator;
- (void)_beginSnapshotSessionForScene:(id)arg1 withSnapshotBlock:(id)arg2;
...
- (void)_getEnabledRemoteNotificationTypesWithCompletionHandler:(id)arg1;
- (unsigned char)_getIOHIDKeyboardTypeForGSKeyboardType:(unsigned char)arg1;
- (void)_getScheduledLocalNotificationsWithCompletionHandler:(id)arg1;
- (long long)_getSpringBoardOrientation;
- (void*)_getSymbol:(id)arg1 forFramework:(id)arg2;
- (void)_getUserNotificationCategorieWithCompletionHandler:(id)arg1;
- (void)_getUserNotificationTypesWithCompletionHandler:(id)arg1;
- (void)_handleApplicationActivationWithScene:(id)arg1 transitionContext:(id)arg2 completion:(id)arg3;
- (void)_handleApplicationDeactivationWithScene:(id)arg1 shouldForceExit:(bool)arg2 transitionContext:(id)arg3 completion:(id)arg4;
...
- (void)_handleNonLaunchSpecificActions:(id)arg1 forScene:(id)arg2 withTransitionContext:(id)arg3 completion:(id)arg4;
- (bool)_handlePhysicalButtonEvent:(id)arg1;
- (void)_handlePlatformSpecificActions:(id)arg1 forScene:(id)arg2 withTransitionContext:(id)arg3;
- (void)_handleScreenshot;
- (void)_handleSnapshotAction:(id)arg1 forScene:(id)arg2 completion:(id)arg3;
...
- (void)_performBlockAfterCATransactionCommitSynchronizes:(id)arg1;
- (void)_performBlockAfterCATransactionCommits:(id)arg1;
- (void)_performChanges:(id)arg1 withTransitionContext:(id)arg2;
- (void)_performMemoryWarning;
- (void)_performSnapshotsWithAction:(id)arg1 forScene:(id)arg2 completion:(id)arg3;
- (void)_performWithUICACommitStateSnapshotting:(id)arg1;
...
- (void)_scheduleSceneEventResponseForScene:(id)arg1 withResponseBlock:(id)arg2;
...
- (void)_setWatchSystemAppHIDEventFilter:(id)arg1;
...
- (void)_synchronizeSystemAnimationFencesWithSpinCleanUpBlock:(id)arg1;
...
- (void)_updateStateRestorationArchiveForBackgroundEvent:(id)arg1 saveState:(bool)arg2 exitIfCouldNotRestoreState:(bool)arg3 updateSnapshot:(bool)arg4;
...
- (void)activityContinuationManager:(id)arg1 displayProgressUI:(id)arg2 dismissalHandler:(id)arg3;
- (void)activityContinuationManager:(id)arg1 hideProgressUIWithCompletion:(id)arg2;
...
- (void)finishedIPTest:(id)arg1 extraResults:(id)arg2 withTeardownBlock:(id)arg3;
- (void)finishedIPTest:(id)arg1 waitForCommit:(bool)arg2 extraResults:(id)arg3 withTeardownBlock:(id)arg4;
...
- (void)prepareSnapshotsWithAction:(id)arg1 forScene:(id)arg2 completion:(id)arg3;
...
- (void)setStatusBarOrientation:(long long)arg1 animationParameters:(id)arg2 notifySpringBoardAndFence:(bool)arg3 updateBlock:(id)arg4;
...
+ (id)_pu_debugSearchViewController:(id)arg1 usingBlock:(id)arg2;
+ (id)_pu_debugSearchViewControllerHierarchyUsingBlock:(id)arg1;
+ (id)pu_debugCurrentAsset;
+ (id)pu_debugCurrentViewModel;
+ (id)pu_firstViewControllerPassingTest:(id)arg1;
...
- (void)px_navigateToMomentsViewRevealingAsset:(id)arg1 completionHandler:(id)arg2;
...
- (void)tsu_temporarilyEndIgnoringInteractionEventsForToken:(id)arg1 usingBlock:(id)arg2;
