...
- (void)_queue_performCoachingDiagnosticWithRunDate:(id)arg1 ignoreAnchor:(BOOL)arg2 handler:(id /* block */)arg3 ringHandler:(id /* block */)arg4 completion:(id /* block */)arg5;
