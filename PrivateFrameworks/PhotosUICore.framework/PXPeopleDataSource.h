...
@property (nonatomic, copy) id sortComparator;
@property (nonatomic, readonly) bool useAsynchronousLoad;

- (void).cxx_destruct;
- (void)_asyncLoadImageForItem:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 withCompletionBlock:(id)arg3;
...
- (void)imageAtIndex:(unsigned long long)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 withCompletionBlock:(id)arg3 fastDisplayBlock:(id)arg4;
- (unsigned long long)indexOfMember:(id)arg1;
- (id)initWithName:(id)arg1 objects:(id)arg2;
- (id)initWithName:(id)arg1 objectsReloadBlock:(id)arg2;
- (id)initWithName:(id)arg1 objectsReloadBlock:(id)arg2 asynchronousLoad:(bool)arg3 callbackDelegate:(id)arg4;
- (bool)isDisclosed;
