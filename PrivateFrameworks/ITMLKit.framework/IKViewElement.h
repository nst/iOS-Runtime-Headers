...
- (void)dispatchEvent:(id)arg1 eventAttribute:(id)arg2 canBubble:(bool)arg3 isCancelable:(bool)arg4 extraInfo:(id)arg5 completionBlock:(id)arg6;
...
- (void)retrievePresentationDocument:(id)arg1;
