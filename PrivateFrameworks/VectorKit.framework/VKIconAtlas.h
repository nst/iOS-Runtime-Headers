...
- (id)artworkForName:(id)arg1 style:(struct VKIconStyleInfo { unsigned char x1; struct Matrix<float, 4, 1> { double x_2_1_1[4]; } x2; struct Matrix<float, 4, 1> { double x_3_1_1[4]; } x3[2]; struct Matrix<float, 4, 1> { double x_4_1_1[4]; } x4; unsigned char x5; struct Matrix<float, 4, 1> { double x_6_1_1[4]; } x6; unsigned char x7; unsigned char x8; double x9; struct Matrix<float, 4, 1> { double x_10_1_1[4]; } x10; struct Matrix<float, 2, 1> { double x_11_1_1[2]; } x11; double x12; struct Matrix<float, 4, 1> { double x_13_1_1[4]; } x13; double x14; double x15; double x16; bool x17; unsigned int x18; unsigned int x19; }*)arg2 contentScale:(float)arg3 size:(int)arg4 hasText:(bool)arg5 includeFullBleedColor:(BOOL)arg6;
- (id)artworkForStyleAttributeKey:(unsigned int)arg1 longValue:(unsigned int)arg2 style:(struct VKIconStyleInfo { unsigned char x1; struct Matrix<float, 4, 1> { double x_2_1_1[4]; } x2; struct Matrix<float, 4, 1> { double x_3_1_1[4]; } x3[2]; struct Matrix<float, 4, 1> { double x_4_1_1[4]; } x4; unsigned char x5; struct Matrix<float, 4, 1> { double x_6_1_1[4]; } x6; unsigned char x7; unsigned char x8; double x9; struct Matrix<float, 4, 1> { double x_10_1_1[4]; } x10; struct Matrix<float, 2, 1> { double x_11_1_1[2]; } x11; double x12; struct Matrix<float, 4, 1> { double x_13_1_1[4]; } x13; double x14; double x15; double x16; bool x17; unsigned int x18; unsigned int x19; }*)arg3 contentScale:(float)arg4 size:(int)arg5 includeFullBleedColor:(BOOL)arg6;
- (id)artworkForStyleAttributeKey:(unsigned int)arg1 value:(unsigned int)arg2 style:(struct VKIconStyleInfo { unsigned char x1; struct Matrix<float, 4, 1> { double x_2_1_1[4]; } x2; struct Matrix<float, 4, 1> { double x_3_1_1[4]; } x3[2]; struct Matrix<float, 4, 1> { double x_4_1_1[4]; } x4; unsigned char x5; struct Matrix<float, 4, 1> { double x_6_1_1[4]; } x6; unsigned char x7; unsigned char x8; double x9; struct Matrix<float, 4, 1> { double x_10_1_1[4]; } x10; struct Matrix<float, 2, 1> { double x_11_1_1[2]; } x11; double x12; struct Matrix<float, 4, 1> { double x_13_1_1[4]; } x13; double x14; double x15; double x16; bool x17; unsigned int x18; unsigned int x19; }*)arg3 contentScale:(float)arg4 size:(int)arg5 hasText:(bool)arg6 includeFullBleedColor:(BOOL)arg7;
- (void)dealloc;
- (id)init;
