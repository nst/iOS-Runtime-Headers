...
@interface SXMediaSelectionOptionsAvailabilityObserverFactory : NSObject <SXMediaSelectionOptionsAvailabilityObserverFactory> {
...
- (void).cxx_destruct;
- (id)createMediaSelectionOptionsObserverForVideo:(id)arg1;
