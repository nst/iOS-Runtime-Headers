...
- (void)webViewController:(void *)arg1 decidePolicyForNavigationAction:(void *)arg2 decisionHandler:(void *)arg3; // needs 3 arg types, found 8: SFWebViewController *, WKNavigationAction *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, long long, void*
...
- (void)webViewController:(void *)arg1 didReceiveAuthenticationChallenge:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 9: SFWebViewController *, NSURLAuthenticationChallenge *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, long long, NSURLCredential *, void*
