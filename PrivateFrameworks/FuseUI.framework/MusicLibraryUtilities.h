...
+ (unsigned long long)prepareForSharingPlaylist:(id)arg1 withCompletionHandler:(id)arg2;
+ (void)presentAddToPlaylistBehaviorDialogFromViewController:(id)arg1 withCompletionHandler:(id)arg2;
