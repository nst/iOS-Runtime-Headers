...
- (bool)executeWithExpectedColumnCount:(long long)arg1 resultRowHandler:(id)arg2 error:(id*)arg3;
- (void)finalize;
- (id)init;
- (id)initWithSQL:(id)arg1 database:(id)arg2 error:(id*)arg3;
- (bool)processResultsWithExpectedColumnCount:(long long)arg1 resultRowHandler:(id)arg2 error:(id*)arg3;
