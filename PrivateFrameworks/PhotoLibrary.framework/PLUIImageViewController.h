...
@class MLPhoto, NSString, PLCropOverlay, PLImage, PLImageCache, PLImageLoadingQueue, PLImageSource, PLPhotoTileViewController, PLVideoRemaker, PLVideoView, UIImage;
