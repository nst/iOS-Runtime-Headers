...
@property (nonatomic, copy) id serverRequestResponseHandler;
...
- (void)cancelUploadWithTaskIdentifier:(long long)arg1 sessionIdentifier:(id)arg2 completionHandler:(id)arg3;
- (id)currentTasks;
- (id)database;
- (void)dealloc;
- (void)handleEventsForBackgroundURLSessionWithServerRequestResponseHandler:(id)arg1;
