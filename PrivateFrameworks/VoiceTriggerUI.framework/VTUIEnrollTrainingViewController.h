...
- (void)_advanceState;
- (void)_becomeActive;
- (void)_cleanupTrainingManagerWithCompletion:(id)arg1;
...
- (void)_setupViews;
- (void)_showBadMicAlertCompletion:(id)arg1;
- (void)_showBadMicAlertWithCompletion:(id)arg1;
- (void)_showEnrollmentSuccessView;
- (void)_showInstruction:(long long)arg1 isRetry:(bool)arg2;
- (void)_showIntroView;
- (void)_showRadarExitButton;
- (void)_showResultMark:(bool)arg1 completion:(id)arg2;
- (void)_showStatusMessage:(id)arg1 afterDelay:(double)arg2 completion:(id)arg3;
...
- (void)_showUnsupportedLocaleAlertCompletion:(id)arg1;
...
- (void)_warnForLanguageCompatibilityIfNecessary:(id)arg1;
- (void)aboutTapped;
...
- (void)finish:(id)arg1;
- (id)flamesView;
- (void)getScreenshotImageForDebugController:(id)arg1 withCompletion:(id)arg2;
