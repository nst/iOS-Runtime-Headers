...
- (void)_makeProvider:(id)arg1 provideItemAtURL:(id)arg2 options:(unsigned int)arg3 forAccessClaimWithID:(id)arg4 processIdentifier:(int)arg5 completionHandler:(id /* block */)arg6;
...
- (void)provideItemAtURL:(id)arg1 forClaimWithID:(id)arg2 madeByClientWithProcessIdentifier:(int)arg3 options:(unsigned int)arg4 completionHandler:(id /* block */)arg5;
