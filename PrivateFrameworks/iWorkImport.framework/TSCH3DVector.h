...
+ (id)instanceWithArchive:(const struct Chart3DVectorArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { int x_1_2_1; } x_4_1_1; } x4; float x5; float x6; float x7; float x8; }*)arg1 unarchiver:(id)arg2;
+ (id)vector;
...
- (id)init;
- (id)initWithArchive:(const struct Chart3DVectorArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { int x_1_2_1; } x_4_1_1; } x4; float x5; float x6; float x7; float x8; }*)arg1 unarchiver:(id)arg2;
...
- (void)saveToArchive:(struct Chart3DVectorArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { int x_1_2_1; } x_4_1_1; } x4; float x5; float x6; float x7; float x8; }*)arg1 archiver:(id)arg2;
