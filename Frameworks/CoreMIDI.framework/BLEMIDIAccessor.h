...
+ (id)logEvent:(char *)arg1 length:(unsigned short)arg2 timeStamp:(unsigned int)arg3;
...
+ (unsigned short)timeStampOffset:(unsigned int)arg1;
+ (unsigned int)timeStampWithEpoch:(unsigned int)arg1 offset:(unsigned short)arg2;
