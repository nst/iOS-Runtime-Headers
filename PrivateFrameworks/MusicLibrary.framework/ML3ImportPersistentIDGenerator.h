...
- (int)nextPersistentIDForImportItem:(struct shared_ptr<ML3ImportItem> { struct ML3ImportItem {} *x1; struct __shared_weak_count {} *x2; })arg1;
- (void)removePersistentIDFromIdMapping:(int)arg1;
