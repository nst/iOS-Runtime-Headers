...
- (id)_remoteObjectProxyWithErrorHandler:(id)arg1 isSynchronous:(bool)arg2;
...
- (void)requestTransaction:(id)arg1 forExtensionIdentifier:(id)arg2 completion:(id)arg3;
