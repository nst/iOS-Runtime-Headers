...
- (void)widget:(void *)arg1 animateChanges:(void *)arg2 withAnimationOptions:(void *)arg3; // needs 3 arg types, found 7: <PXWidget> *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*, PXBasicTileAnimationOptions *
