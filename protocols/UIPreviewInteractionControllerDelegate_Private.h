...
- (void)previewInteractionController:(void *)arg1 performCustomCommitForPreviewViewController:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 7: UIPreviewInteractionController *, UIViewController *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
