...
- (bool)isExplicit;
- (id)jsMediaItem;
- (void)loadCertificateDataForURL:(id)arg1 withCallback:(id)arg2;
- (void)loadContentIdentifierDataForURL:(id)arg1 withCallback:(id)arg2;
- (void)loadKeyDataForURL:(id)arg1 keyRequestData:(id)arg2 withCallback:(id)arg3;
- (void)prepareForLoadingWithCallback:(id)arg1;
- (id)ratingBadge;
- (id)resumeTime;
