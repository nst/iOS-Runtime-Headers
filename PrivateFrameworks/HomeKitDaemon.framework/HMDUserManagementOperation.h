...
- (void)_addPairingToAccessory:(id)arg1 identifier:(id)arg2 publicKey:(id)arg3 completionHandler:(id)arg4;
- (void)_endBackoffTimer;
- (bool)_isFinished;
- (void)_removePairingFromAccessory:(id)arg1 identifier:(id)arg2 publicKey:(id)arg3 completionHandler:(id)arg4;
...
- (void)executeWithCompletionQueue:(id)arg1 completionHandler:(id)arg2;
- (id)expirationDate;
- (id)expirationTimer;
- (id)identifier;
- (id)init;
