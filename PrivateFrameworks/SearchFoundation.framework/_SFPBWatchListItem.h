...
@property (nonatomic, readonly) bool hasAddToUpNextText;
@property (nonatomic, readonly) bool hasAddedToUpNextText;
@property (nonatomic, readonly) bool hasContinueInTextFormat;
@property (nonatomic, readonly) bool hasInUpNextText;
@property (nonatomic, readonly) bool hasInstallButtonTitle;
@property (nonatomic, readonly) bool hasOpenButtonTitle;
@property (nonatomic, readonly) bool hasPurchaseOfferTextFormat;
@property (nonatomic, readonly) bool hasSeasonEpisodeTextFormat;
@property (nonatomic, readonly) bool hasWatchListIdentifier;
@property (nonatomic, readonly) bool hasWatchLiveTextFormat;
...
- (bool)hasAddToUpNextText;
- (bool)hasAddedToUpNextText;
- (bool)hasContinueInTextFormat;
- (bool)hasInUpNextText;
- (bool)hasInstallButtonTitle;
- (bool)hasOpenButtonTitle;
- (bool)hasPurchaseOfferTextFormat;
- (bool)hasSeasonEpisodeTextFormat;
- (bool)hasWatchListIdentifier;
- (bool)hasWatchLiveTextFormat;
