...
- (void)controlOutputStream:(void *)arg1 didReceiveRequestToSendControlPacket:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: HAPBTLEControlOutputStream *, HAPBTLEControlPacket *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSError *, void*
