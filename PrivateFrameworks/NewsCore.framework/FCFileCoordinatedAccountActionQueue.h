...
- (void).cxx_destruct;
- (void)enqueueActionWithType:(long long)arg1 completion:(id)arg2;
- (id)fileCoordinatedDictionary;
- (id)init;
- (id)initWithFileURL:(id)arg1;
- (void)peekAtActionTypesWithCompletion:(id)arg1;
- (void)popActionTypesUpToCount:(unsigned long long)arg1 setLocalDataHintIfNeeded:(bool)arg2 completion:(id)arg3;
- (void)readLocalDataHintWithAccessor:(id)arg1;
