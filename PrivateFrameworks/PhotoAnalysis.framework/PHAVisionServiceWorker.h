...
+ (id)assetResourceLargestToSmallestComparator;
+ (id)assetResourceSmallestToLargestComparator;
+ (void)initialize;
...
- (unsigned long long)analyzeAssetWithLocalIdentifier:(id)arg1 dataLoadingOptions:(id)arg2 usingBlock:(id)arg3 error:(id*)arg4;
