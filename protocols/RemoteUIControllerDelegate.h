...
- (void)remoteUIController:(void *)arg1 didReceiveChallenge:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 9: RemoteUIController *, NSURLAuthenticationChallenge *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, long long, NSURLCredential *, void*
