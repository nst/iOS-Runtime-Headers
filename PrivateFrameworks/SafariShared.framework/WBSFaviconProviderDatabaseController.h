...
- (id)_setIconUUID:(id)arg1 forIconURLString:(id)arg2 size:(struct CGSize { double x1; double x2; })arg3;
...
- (void)linkAndUpdateTimestampForIconWithPageURLString:(id)arg1 iconURLString:(id)arg2 iconSize:(struct CGSize { double x1; double x2; })arg3 completionHandler:(id /* block */)arg4;
