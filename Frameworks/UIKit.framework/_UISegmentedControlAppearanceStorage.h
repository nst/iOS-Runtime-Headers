...
- (void)takeTextAttributesFrom:(struct { id x1; id x2; id x3; unsigned char x4; /* Warning: Unrecognized filer type: 'G' using 'void*' */ void*x5; unsigned short x6; int x7; void*x8; void*x9; void*x10; double x11; double x12; })arg1 forState:(unsigned int)arg2;
