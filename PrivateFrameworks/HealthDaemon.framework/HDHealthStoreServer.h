...
@interface HDHealthStoreServer : NSObject <HDDeepBreathingSessionServerDelegate, HDDiagnosticObject, HDHealthStoreServerInterface, HDUnitPreferencesManagerObserver> {
...
- (void)_discardWorkoutRoute:(id)arg1 completion:(id /* block */)arg2;
...
- (void)_finishWorkoutRoute:(id)arg1 workout:(id)arg2 metadata:(id)arg3 completion:(id /* block */)arg4;
...
- (void)_saveWorkoutRouteData:(id)arg1 withRoute:(id)arg2 completion:(id /* block */)arg3;
...
- (void)remote_discardWorkoutRoute:(id)arg1 completion:(id /* block */)arg2;
...
- (void)remote_saveWorkoutRouteData:(id)arg1 withRoute:(id)arg2 completion:(id /* block */)arg3;
