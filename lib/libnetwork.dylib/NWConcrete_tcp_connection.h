...
@interface NWConcrete_tcp_connection : NSObject <OS_tcp_connection> {
    ...
    int  tc_error;
    id  tc_event;
    unsigned int  tc_event_betterroute_changed_outstanding;
    unsigned int  tc_event_betterroute_outstanding;
    unsigned int  tc_event_connected_delivered;
    unsigned int  tc_event_disconnected_delivered;
    unsigned int  tc_event_quality_changed_outstanding;
    unsigned int  tc_event_read_close_delivered;
    unsigned int  tc_event_viable_outstanding;
    ...
    id  tc_nw_tls_message;
    id  tc_nw_tls_prepare;
