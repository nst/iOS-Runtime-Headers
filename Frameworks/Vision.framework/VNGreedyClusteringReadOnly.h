...
- (void)setGreedyClustererFaces_const:(struct shared_ptr<const vision::mod::GreedyClustererFaces> { struct GreedyClustererFaces {} *x1; struct __shared_weak_count {} *x2; })arg1;
