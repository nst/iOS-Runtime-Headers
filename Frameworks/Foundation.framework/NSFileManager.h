...
- (void)_srMoveFileFromURL:(id)arg1 toURL:(id)arg2 completion:(id)arg3;
- (void)_srRemoveFile:(id)arg1 completion:(id)arg2;
...
- (void)fc_quicklyClearDirectory:(id)arg1 callbackQueue:(id)arg2 completion:(id)arg3;
...
- (bool)copySource:(id)arg1 toDestination:(id)arg2 withProgressionBlock:(id)arg3;
...
- (id)unarchiveItemAtPath:(id)arg1 toDirectory:(id)arg2 withProgressionBlock:(id)arg3;
