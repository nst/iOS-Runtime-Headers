...
+ (id)JPEGPhotoDataRepresentationForJPEGSurface:(struct __IOSurface { }*)arg1 size:(unsigned long long)arg2 previewPhotoSurface:(struct __IOSurface { }*)arg3 metadata:(id)arg4;
...
- (void)setPreparedPhotoSettingsArray:(id)arg1 completionHandler:(id)arg2;
