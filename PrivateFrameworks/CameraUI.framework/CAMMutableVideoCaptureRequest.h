...
@property (nonatomic) int maximumRecordedFileSize;
...
@property (nonatomic) int remainingDiskUsageThreshold;
...
- (void)setMaximumRecordedFileSize:(int)arg1;
...
- (void)setRemainingDiskUsageThreshold:(int)arg1;
