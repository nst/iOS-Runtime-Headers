...
- (void)_scrollToSecond:(int)arg1 offset:(double)arg2 animated:(bool)arg3 whenFinished:(id)arg4;
...
- (void)scrollToDate:(id)arg1 offset:(double)arg2 animated:(bool)arg3 whenFinished:(id)arg4;
