...
+ (id)_itemWithTitle:(id)arg1 color:(id)arg2 image:(id)arg3 handler:(id)arg4;
+ (id)_itemWithTitle:(id)arg1 style:(long long)arg2 image:(id)arg3 handler:(id)arg4;
+ (id)itemWithTitle:(id)arg1 style:(long long)arg2 handler:(id)arg3;
