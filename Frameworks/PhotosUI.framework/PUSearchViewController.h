...
@interface PUSearchViewController : UIViewController <PUSearchResultsDataSourceChangeObserver, PUSuggestedSearchResultsDelegate, UISearchBarDelegate, UITableViewDataSource, UITableViewDataSourcePrefetching, UITableViewDelegate> {
    id  __runImmediatelyAfterViewDidAppear;
...
@property (setter=_setRunImmediatelyAfterViewDidAppear:, nonatomic, copy) id _runImmediatelyAfterViewDidAppear;
...
- (id)_runImmediatelyAfterViewDidAppear;
...
- (void)_setRunImmediatelyAfterViewDidAppear:(id)arg1;
