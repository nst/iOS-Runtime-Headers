...
- (void)captureSession:(long long)arg1 didCapturePhotoWithStatus:(long)arg2 thumbnailData:(NSData *)arg3 timestamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4;
