...
@class NSMutableDictionary, UIMovieScrubber, AVRemaker, PLMoviePlayerController, MLPhotoBakedThumbnails, NSArray, NSDictionary, MLPhoto, NSString, PLImageTile, <PLVideoViewDelegate>, UIImageView, UIButton, PLVideoEditingOverlayView, NSTimer;
