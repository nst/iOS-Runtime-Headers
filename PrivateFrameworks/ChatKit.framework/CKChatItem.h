...
@property (nonatomic, readonly) struct CKBalloonDescriptor_t { BOOL x1; BOOL x2; BOOL x3; BOOL x4; unsigned int x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; } balloonDescriptor;
...
- (void).cxx_destruct;
- (id)IMChatItem;
- (void)_setSizeForTesting:(struct CGSize { float x1; float x2; })arg1;
