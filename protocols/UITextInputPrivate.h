...
- (void)handleKeyWebEvent:(void *)arg1 withCompletionHandler:(void *)arg2; // needs 2 arg types, found 8: WebEvent *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, WebEvent *, bool, void*
