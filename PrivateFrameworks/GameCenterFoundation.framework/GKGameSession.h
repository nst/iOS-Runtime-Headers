...
+ (void)createSessionInContainer:(id)arg1 withTitle:(id)arg2 maxConnectedPlayers:(long long)arg3 completionHandler:(id)arg4;
+ (void)getSessionsForZone:(id)arg1 completionHandler:(id)arg2;
+ (void)getZonesWithCompletionHandler:(id)arg1;
+ (id)gk_sessionEventListeners;
+ (void)loadSessionWithIdentifier:(id)arg1 completionHandler:(id)arg2;
+ (void)loadSessionsInContainer:(id)arg1 completionHandler:(id)arg2;
...
+ (void)removeSessionWithIdentifier:(id)arg1 completionHandler:(id)arg2;
+ (bool)supportsSecureCoding;

- (void).cxx_destruct;
- (id)_gkDescriptionWithChildren:(int)arg1;
- (id)badgedPlayers;
- (void)clearBadgeForPlayers:(id)arg1 completionHandler:(id)arg2;
- (id)description;
- (id)descriptionSubstitutionMap;
- (void)encodeWithCoder:(id)arg1;
- (void)getShareURLWithCompletionHandler:(id)arg1;
- (id)identifier;
...
- (void)sendData:(id)arg1 withTransportType:(long long)arg2 completionHandler:(id)arg3;
- (void)sendMessageWithLocalizedFormatKey:(id)arg1 arguments:(id)arg2 data:(id)arg3 toPlayers:(id)arg4 badgePlayers:(bool)arg5 completionHandler:(id)arg6;
- (id)serverChangeTag;
- (void)setConnectionState:(long long)arg1 completionHandler:(id)arg2;
