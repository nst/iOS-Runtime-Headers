...
- (void)continueUploadForBackgroundURLSessionWithService:(id)arg1 session:(id)arg2 responseHandler:(id)arg3;
- (id)description;
- (id)httpResponse;
...
- (id)startBothloadTaskWithURI:(id)arg1 queryItems:(id)arg2 service:(id)arg3 headers:(id)arg4 body:(id)arg5 responseHandler:(id)arg6;
- (id)startDownloadTaskWithURI:(id)arg1 queryItems:(id)arg2 service:(id)arg3 headers:(id)arg4 body:(id)arg5 responseHandler:(id)arg6;
- (id)startUploadTaskWithFile:(id)arg1 URI:(id)arg2 queryItems:(id)arg3 service:(id)arg4 headers:(id)arg5 responseHandler:(id)arg6;
