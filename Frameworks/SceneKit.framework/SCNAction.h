...
@interface SCNAction : NSObject <NSCopying, NSSecureCoding> {
    struct SCNCAction { int (**x1)(); float x2; id x3; id x4; double x5; double x6; double x7; double x8; double x9; bool x10; bool x11; id x12; struct __CFString {} *x13; long long x14; double x15; double x16; double x17; double x18; } * _caction;
}
...
- (struct SCNCAction { int (**x1)(); float x2; id x3; id x4; double x5; double x6; double x7; double x8; double x9; bool x10; bool x11; id x12; struct __CFString {} *x13; long long x14; double x15; double x16; double x17; double x18; }*)caction;
- (id)copy;
