...
- (void)removeAllTiles;
- (void)runMetalConversionOnSurface:(struct __IOSurface { }*)arg1 completionHandler:(id)arg2;
- (void)runVImageConversionOnSurface:(struct __IOSurface { }*)arg1 completionHandler:(id)arg2;
