...
- (void)_queue_pruneExpiredDeletedObjectsWithNowDate:(id)arg1 completion:(id)arg2;
- (void)_queue_pruneExpiredSamplesWithOptions:(unsigned long long)arg1 fromNowDate:(id)arg2 completion:(id)arg3;
...
- (id)profile;
- (void)pruneDatabaseWithCompletion:(id)arg1;
- (void)pruneDatabaseWithOptions:(unsigned long long)arg1 nowDate:(id)arg2 completion:(id)arg3;
- (id)queue;
