...
@property (setter=_setLoadingIndicatorSize:, nonatomic) struct CGSize { double x1; double x2; } loadingIndicatorSize;
...
- (void)_setLoadingIndicatorSize:(struct CGSize { double x1; double x2; })arg1;
