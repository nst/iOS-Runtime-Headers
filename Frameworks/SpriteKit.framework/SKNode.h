...
@interface SKNode : UIResponder <NSCopying, NSCoding> {
    ...
    bool_needsDelete;
    bool_spritesNeedsRemove;
    void *csprite;
}

@property(readonly) struct shared_ptr<PKCAether> { struct PKCAether {} *x1; struct __shared_weak_count {} *x2; } _aether;
@property struct CGPoint { double x1; double x2; } _anchorPoint;
@property(retain) NSMutableDictionary * _info;
@property bool _showBounds;
@property(readonly) struct CGSize { double x1; double x2; } _size;
@property(readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _untransformedBounds;
