...
- (void)locationTracker:(MNLocationTracker *)arg1 displayPrimaryStepManeuverType:(int)arg2 junctionType:(int)arg3 junctionElements:(struct GEOJunctionElement { int x1; int x2; int x3; struct { unsigned int x_4_1_1 : 1; unsigned int x_4_1_2 : 1; unsigned int x_4_1_3 : 1; } x4; }*)arg4 count:(unsigned long long)arg5 instructions:(NSArray *)arg6 shieldType:(int)arg7 shieldText:(NSString *)arg8 drivingSide:(int)arg9 maneuverStepIndex:(unsigned long long)arg10 isSynthetic:(bool)arg11;
- (void)locationTracker:(MNLocationTracker *)arg1 displaySecondaryStepManeuverType:(int)arg2 junctionType:(int)arg3 junctionElements:(struct GEOJunctionElement { int x1; int x2; int x3; struct { unsigned int x_4_1_1 : 1; unsigned int x_4_1_2 : 1; unsigned int x_4_1_3 : 1; } x4; }*)arg4 count:(unsigned long long)arg5 instructions:(NSArray *)arg6 shieldType:(int)arg7 shieldText:(NSString *)arg8 drivingSide:(int)arg9;
...
- (void)locationTracker:(void *)arg1 receivedTrafficIncidentAlert:(void *)arg2 responseCallback:(void *)arg3; // needs 3 arg types, found 8: MNLocationTracker *, MNTrafficIncidentAlert *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
