...
- (void)changeStateOfSearchableItemsWithUIDs:(NSArray *)arg1 toState:(int)arg2 protectionClass:(NSString *)arg3 forBundleID:(NSString *)arg4 forUTIType:(NSString *)arg5 options:(int)arg6;
...
- (void)fetchLastClientStateWithProtectionClass:(void *)arg1 forBundleID:(void *)arg2 clientStateName:(void *)arg3 options:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 11: NSString *, NSString *, NSString *, int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSData *, NSError *, void*
- (void)indexSearchableItems:(void *)arg1 deleteSearchableItemsWithIdentifiers:(void *)arg2 clientState:(void *)arg3 clientStateName:(void *)arg4 protectionClass:(void *)arg5 forBundleID:(void *)arg6 options:(void *)arg7 completionHandler:(void *)arg8; // needs 8 arg types, found 13: NSArray *, NSArray *, NSData *, NSString *, NSString *, NSString *, int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)addInteraction:(void *)arg1 bundleID:(void *)arg2 protectionClass:(void *)arg3 options:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 10: INInteraction *, NSString *, NSString *, int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)deleteAllInteractionsWithBundleID:(void *)arg1 protectionClass:(void *)arg2 options:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: NSString *, NSString *, int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)deleteInteractionsWithGroupIdentifiers:(void *)arg1 bundleID:(void *)arg2 protectionClass:(void *)arg3 options:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 10: NSArray *, NSString *, NSString *, int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)deleteInteractionsWithIdentifiers:(void *)arg1 bundleID:(void *)arg2 protectionClass:(void *)arg3 options:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 10: NSArray *, NSString *, NSString *, int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
