...
- (void).cxx_destruct;
- (void)__activateWithStyle:(long long)arg1 completionBlock:(id)arg2;
- (void)__deactivateWithStyle:(long long)arg1;
- (void)_activateWithStyle:(long long)arg1 completionBlock:(id)arg2;
- (void)_activated;
...
- (void)activateWithCompletionBlock:(id)arg1;
...
- (bool)isActive;
- (void)performFeedbackWithDelay:(double)arg1 insideBlock:(id)arg2;
- (void)prepare;
