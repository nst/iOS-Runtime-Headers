...
+ (void)lookupAndConnectToHost:(id)arg1 port:(unsigned short)arg2 completion:(id)arg3;
+ (void)performDNSLookupForHost:(id)arg1 completion:(id)arg2;

- (void).cxx_destruct;
- (void)_readIntoCacheFromSocket:(int)arg1;
- (void)_writeBytes:(const void*)arg1 offset:(unsigned long long)arg2 length:(unsigned long long)arg3 toSocket:(int)arg4 completion:(id)arg5;
- (void)beginReadingIntoCacheFromSocket:(int)arg1;
- (void)dealloc;
- (void)endReadingIntoCache;
- (id)init;
- (id)observeSocket:(int)arg1 forSourceEventType:(struct dispatch_source_type_s { }*)arg2 handler:(id)arg3;
- (char *)readBytesFromSocket:(int)arg1 maximumSize:(unsigned long long)arg2 bytesRead:(long long*)arg3;
- (void)sendCommand:(id)arg1 toSocket:(int)arg2 completion:(id)arg3;
- (void)sendData:(id)arg1 toSocket:(int)arg2 completion:(id)arg3;
...
- (void)writeBytes:(const void*)arg1 length:(unsigned long long)arg2 toSocket:(int)arg3 completion:(id)arg4;
