...
+ (void)_computeFingerPrintsOfAsset:(id)arg1 completionHandler:(id)arg2;
...
- (id)_imageRequestOptionsForBaseVersion:(long long)arg1 options:(id)arg2 progressEstimateForImageProgress:(id)arg3;
...
- (id)_videoRequestOptionsForBaseVersion:(long long)arg1 options:(id)arg2 progressEstimateForVideoProgress:(id)arg3;
...
- (int)_requestAVAssetWithOptions:(id)arg1 resultHandler:(id)arg2;
...
- (int)downloadResource:(id)arg1 progressHandler:(id)arg2 completionHandler:(id)arg3 dataHandler:(id)arg4;
...
- (int)requestAVAssetWithOptions:(id)arg1 resultHandler:(id)arg2;
- (int)requestExportSessionWithOptions:(id)arg1 exportPreset:(id)arg2 resultHandler:(id)arg3;
- (int)requestImageForTargetSize:(struct CGSize { double x1; double x2; })arg1 contentMode:(long long)arg2 options:(id)arg3 resultHandler:(id)arg4;
- (int)requestPlayerItemWithOptions:(id)arg1 resultHandler:(id)arg2;
...
- (void)fetchIrisForWatchToPath:(id)arg1 completion:(id)arg2;
- (void)fetchJPEGForWatchWithCompletion:(id)arg1;
