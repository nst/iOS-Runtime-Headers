...
- (struct UIOffset { double x1; double x2; })relativeOffsetOfItemAtIndex:(float)arg1 withCenter:(struct CGPoint { double x1; double x2; })arg2;
- (void)reloadData;
...
- (struct CGSize { double x1; double x2; })sizeOfItemAtIndex:(float)arg1;
