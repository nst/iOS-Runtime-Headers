...
- (void)predictItemsAndReturnInputsAndSubscoresForConsumerSubType:(unsigned char)arg1 intent:(id)arg2 candidateBundleIds:(id)arg3 candidateIntenttypes:(id)arg4 reply:(id /* block */)arg5;
- (void)setIntentSessionLoggingToAlwaysSay:(bool)arg1 reply:(id /* block */)arg2;
