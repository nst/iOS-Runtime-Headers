...
- (bool)addSource:(id)arg1 request:(struct nstat_msg_add_src { struct nstat_msg_hdr { unsigned long long x_1_1_1; unsigned int x_1_1_2; unsigned short x_1_1_3; unsigned short x_1_1_4; } x1; unsigned int x2; unsigned char x3[0]; }*)arg2 length:(unsigned long long)arg3;
- (id)clientQueue;
...
- (bool)performQuery:(unsigned int)arg1 sourceRef:(unsigned long long)arg2 completion:(id)arg3;
- (bool)queryAll:(id)arg1;
- (void)queryAllCounts:(id)arg1;
- (void)queryAllDescriptions:(id)arg1;
- (unsigned long long)querySequenceNumber;
- (void)querySource:(id)arg1 completion:(id)arg2;
- (id)queuedQueryAlls;
- (char *)readBuffer;
- (id)readSource;
