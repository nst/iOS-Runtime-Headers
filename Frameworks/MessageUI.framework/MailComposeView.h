...
@class <MailComposeViewDelegate>, ABPeoplePickerNavigationController, ComposeBodyField, ComposeRecipientView, MFComposeFromView, MFComposeHeaderView, MFComposeSubjectView, MFContactsSearchManager, MFContactsSearchResultsModel, NSNumber, UIBarButtonItem, UIKeyboard, UINavigationItem, UIPickerView, UIResponder, UIScrollView, UITableView, UITextContentView, UIToolbar, UIView;
