...
- (void)willSendLightsAndSirensWithPublisherBulletinID:(void *)arg1 recordID:(void *)arg2 inPhoneSection:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 9: NSString *, NSString *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
