...
- (void).cxx_destruct;
- (id)_addObserver:(id)arg1 onMainQueue:(bool)arg2;
- (id)_bufferQueue;
...
- (bool)_isBufferQueue;
- (id)addMainQueueObserver:(id)arg1;
- (id)addObserver:(id)arg1;
- (id)bufferQueueCurrentValue;
- (id)bufferedValues;
- (id)currentValue;
- (void)dealloc;
- (void)disableUntil:(id)arg1;
- (void)disableUntilKeyPath:(id)arg1 ofObject:(id)arg2 evaluates:(id)arg3;
- (void)disableUntilNotification:(id)arg1 fromObject:(id)arg2 usingNotificationCenter:(id)arg3;
- (void)disableWhile:(id)arg1;
- (void)disableWhileKeyPath:(id)arg1 ofObject:(id)arg2 evaluates:(id)arg3;
