...
+ (id)performCommitTransitionWithDelegate:(id)arg1 forViewController:(id)arg2 previewViewController:(id)arg3 previewInteractionController:(id)arg4 completion:(id)arg5;
...
- (void)setAnimations:(id)arg1 completion:(id)arg2 forPresentationPhase:(unsigned long long)arg3;
