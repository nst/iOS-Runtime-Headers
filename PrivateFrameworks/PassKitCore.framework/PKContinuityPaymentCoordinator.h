...
- (void)_queue_sendPaymentStatus:(long long)arg1 completion:(id)arg2;
- (void)_resetRequest;
...
- (void)cancelRemotePaymentRequestWithCompletion:(id)arg1;
...
- (void)sendPaymentClientUpdate:(id)arg1 completion:(id)arg2;
- (void)sendPaymentStatus:(long long)arg1 completion:(id)arg2;
