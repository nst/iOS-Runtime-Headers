...
@interface PASampleTimeSeriesDataStore : NSObject <NSSecureCoding> {
    ...
    unsigned int  _previousSampleTimestamp;
...
@property (readonly) unsigned int dataSource;
...
@property (readonly) unsigned int numSamples;
...
@property unsigned int targetThreadId;
...
- (BOOL)addKCDataThread:(const struct thread_snapshot_v2 { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; short x14; short x15; unsigned char x16; unsigned char x17; unsigned char x18; unsigned char x19; }*)arg1 orDeltaThread:(const struct thread_delta_snapshot_v2 { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; short x7; short x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; }*)arg2 withStack:(id)arg3 andName:(const char *)arg4 toTask:(id)arg5 withCurrentThreads:(id)arg6 withPreviousThreads:(id)arg7;
- (int)addKPerfDataFromKTraceSession:(struct ktrace_session { }*)arg1 beforeTime:(unsigned int)arg2;
...
- (void)backfillKPerfTaskWithDataFromKCDataTask:(const struct task_snapshot_v2 { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; unsigned int x14; int x15; BOOL x16[32]; }*)arg1;
- (void)backfillKPerfThreadWithDataFromKCDataThread:(const struct thread_snapshot_v2 { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; short x14; short x15; unsigned char x16; unsigned char x17; unsigned char x18; unsigned char x19; }*)arg1 inPid:(int)arg2 withLeafUserFrame:(id)arg3 andLeafKernelFrame:(id)arg4 andName:(const char *)arg5 taskIsSuspended:(BOOL)arg6;
- (void)cacheSymbolInformationForAllSymbols;
- (id)cachedSymbolHandleForAddress:(unsigned int)arg1 inPid:(int)arg2;
...
- (id)getMissingSampleThreadInCurrentSampleInTask:(id)arg1 forTid:(unsigned int)arg2 needNewThreadForThisSample:(BOOL)arg3;
- (id)hardwareModel;
...
- (void)setTargetThreadId:(unsigned int)arg1;
...
- (id)symbolHandleForAddress:(unsigned int)arg1 inSampleTask:(id)arg2;
- (id)symbolHandleForOffset:(unsigned int)arg1 inBinaryWithUUID:(id)arg2 inSampleTask:(id)arg3;
...
- (id)timeInsensitiveTaskDataForKCDataStackshotDeltaTask:(const struct task_delta_snapshot_v2 { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; }*)arg1 withLoadInfos:(const struct dyld_uuid_info_64 { unsigned int x1; unsigned char x2[16]; }*)arg2 numLoadInfos:(unsigned int)arg3 andMachineArchitecture:(struct _CSArchitecture { int x1; int x2; })arg4;
- (id)timeInsensitiveTaskDataForKCDataStackshotTask:(const struct task_snapshot_v2 { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; unsigned int x14; int x15; BOOL x16[32]; }*)arg1 withLoadInfos:(const struct dyld_uuid_info_64 { unsigned int x1; unsigned char x2[16]; }*)arg2 numLoadInfos:(unsigned int)arg3 andMachineArchitecture:(struct _CSArchitecture { int x1; int x2; })arg4;
- (id)timeInsensitiveTaskDataForStackshotTask:(id)arg1 andMachineArchitecture:(struct _CSArchitecture { int x1; int x2; })arg2;
- (id)timeInsensitiveTaskDataForUniqueId:(unsigned int)arg1;
- (id)timeInsensitiveTaskDataPid:(int)arg1 andUniqueId:(unsigned int)arg2 andName:(const char *)arg3 didExec:(BOOL)arg4;
