...
@class <CNFDisplayControllerDelegate>, CNFAlertView, CNFAudioDeviceView, CNFHUDView, CNFInterfaceOverlayView, NSObject<CNFDisplayControllerDelegate>, NSString, NSTimer, TPBottomButtonBar, TPBottomDualButtonBar, TPLCDView, UIControl, UIImage, UIImageView, UILabel, UIView;
