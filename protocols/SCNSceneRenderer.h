...
- (SCNNode *)pointOfView;
- (bool)prepareObject:(void *)arg1 shouldAbortBlock:(void *)arg2; // needs 2 arg types, found 6: id, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, bool, id, void*
- (void)prepareObjects:(void *)arg1 withCompletionHandler:(void *)arg2; // needs 2 arg types, found 7: NSArray *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
- (void)presentScene:(void *)arg1 withTransition:(void *)arg2 incomingPointOfView:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 8: SCNScene *, SKTransition *, SCNNode *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
