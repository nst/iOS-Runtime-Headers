...
- (id)registerOneTimeRequest:(id)arg1 priority:(long long)arg2 responseHandler:(id)arg3;
- (id)registerRequest:(id)arg1 priority:(long long)arg2 responseHandler:(id)arg3;
...
- (id)siteMetadataProvider:(id)arg1 registerOneTimeRequest:(id)arg2 priority:(long long)arg3 responseHandler:(id)arg4;
- (id)siteMetadataProvider:(id)arg1 registerRequest:(id)arg2 priority:(long long)arg3 responseHandler:(id)arg4;
