...
@property (nonatomic, readonly) unsigned int encodedLengthIfLocal;
...
@property (nonatomic, readonly) unsigned int lengthIfLocal;
...
+ (id)null;
+ (id)pasteboardTypeForIdentifier:(int)arg1;
...
- (unsigned int)encodedLengthIfLocal;
- (id)filename;
- (BOOL)gilligan_isRemote;
- (unsigned int)hash;
- (int)identifier;
- (id)init;
- (id)initWithIdentifier:(int)arg1 digest:(id)arg2 filename:(id)arg3 storage:(id)arg4 manager:(id)arg5;
- (BOOL)isAcknowledgedByServer;
- (BOOL)isApplicationData;
- (BOOL)isEncrypted;
- (BOOL)isEqual:(id)arg1;
- (BOOL)isExternalData;
- (BOOL)isLengthLikelyToBeGreaterThan:(unsigned int)arg1;
- (BOOL)isReadable;
- (BOOL)isStorageInPackage:(id)arg1;
- (unsigned int)length;
- (unsigned int)lengthIfLocal;
