...
- (id)initWithMapRect:(struct { struct { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg1 andViewSize:(struct CGSize { float x1; float x2; })arg2 zoomLevel:(double)arg3 pitch:(double)arg4;
