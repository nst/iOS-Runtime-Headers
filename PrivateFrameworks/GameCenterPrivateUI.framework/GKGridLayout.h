...
@interface GKGridLayout : UICollectionViewLayout {
    ...
    unsigned int  _invalidationFlags;
...
@property (nonatomic) unsigned int invalidationFlags;
...
- (unsigned int)invalidationFlags;
- (id)keyToMetricData;
...
- (void)setInvalidationFlags:(unsigned int)arg1;
