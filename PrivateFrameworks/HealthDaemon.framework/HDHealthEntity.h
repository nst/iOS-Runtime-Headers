...
+ (unsigned int)_transactionOptionsForWriting:(BOOL)arg1 highPriority:(BOOL)arg2;
...
+ (BOOL)enumerateEntitiesForSyncWithProperties:(id)arg1 predicate:(id)arg2 excludedSyncStore:(id)arg3 syncAnchorRange:(struct HDSyncAnchorRange { int x1; int x2; })arg4 orderingProperties:(id)arg5 orderingDirections:(id)arg6 limit:(unsigned int)arg7 lastSyncAnchor:(int*)arg8 healthDatabase:(id)arg9 error:(id*)arg10 block:(id /* block */)arg11;
...
+ (int)nextSyncAnchorWithStartAnchor:(int)arg1 predicate:(id)arg2 excludedSyncStore:(id)arg3 orderingProperties:(id)arg4 orderingDirections:(id)arg5 limit:(unsigned int)arg6 healthDatabase:(id)arg7 error:(id*)arg8;
...
+ (id)predicateForSyncWithPredicate:(id)arg1 excludedSyncStore:(id)arg2 syncAnchorRange:(struct HDSyncAnchorRange { int x1; int x2; })arg3;
...
+ (id)updateSQLForTimeOffsetWithBindingCount:(unsigned int*)arg1;
