...
@property (nonatomic, copy) id centerImageProvider;
...
- (void)_transitionFromBorderedImage:(id)arg1 toTitle:(id)arg2 withDuration:(double)arg3 completion:(id)arg4;
