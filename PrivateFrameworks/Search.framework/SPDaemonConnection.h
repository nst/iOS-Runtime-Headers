...
- (void)retrieveImageDataForResult:(id)arg1 searchDomain:(unsigned int)arg2 size:(struct CGSize { double x1; double x2; })arg3 completion:(id)arg4;
- (void)retrieveImageDataWithIdentifier:(id)arg1 searchDomain:(unsigned int)arg2 size:(struct CGSize { double x1; double x2; })arg3 completion:(id)arg4;
