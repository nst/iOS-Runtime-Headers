...
- (void).cxx_destruct;
- (float)_evaluateHorizontalItemOffsetForItemSize:(struct CGSize { double x1; double x2; })arg1 containerWidth:(float)arg2 inset:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg3;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_evaluateInsetForSectionAtIndex:(int)arg1;
...
- (struct CGPoint { double x1; double x2; })firstItemCenterForContainerWidth:(float)arg1;
- (id)init;
