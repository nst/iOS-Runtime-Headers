...
@interface UIView : UIResponder <UITextEffectsOrdering, NSCoding, UIPDFTextEffectsOrdering> {
    CALayer *_layer;
    id _tapInfo;
    id _gestureInfo;
...
@property struct CGPoint { float x; float y; } integralCenter;
@property float x;
@property float y;
@property float width;
@property float height;
@property struct CGPoint { float x; float y; } viewFrameOrigin;
