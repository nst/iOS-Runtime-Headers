...
- (void)provideItemAtURL:(void *)arg1 forClaimWithID:(void *)arg2 madeByClientWithProcessIdentifier:(void *)arg3 options:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 11: NSURL *, id, int, unsigned int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, NSError *, void*
