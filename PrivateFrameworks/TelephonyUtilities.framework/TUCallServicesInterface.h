...
- (void)dealloc;
- (id)debugDescription;
- (id)dialWithRequest:(id)arg1 completion:(id)arg2;
...
- (id)localProxyCalls;
- (void)performBlockOnQueue:(id)arg1;
- (void)performBlockOnQueue:(id)arg1 andWait:(bool)arg2;
...
- (void)requestCurrentStateWithCompletionHandler:(id)arg1;
...
- (void)swapCalls;
- (id)synchronousDaemonDelegateWithErrorHandler:(id)arg1;
