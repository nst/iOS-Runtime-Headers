...
+ (unsigned int)tableAreaForCellID:(struct TSUCellCoord { unsigned short x1; unsigned char x2; unsigned char x3; })arg1 inTableWithHeaderColumns:(unsigned short)arg2 headerRows:(unsigned short)arg3 footerRows:(unsigned short)arg4 totalRows:(unsigned short)arg5;
...
- (id)cellIterator;
- (id)cellIteratorWithFlags:(unsigned int)arg1;
...
- (id)cellIteratorWithRegion:(id)arg1 flags:(unsigned int)arg2;
- (id)cellIteratorWithRegion:(id)arg1 flags:(unsigned int)arg2 clampingRange:(struct TSUCellRect { struct TSUCellCoord { unsigned short x_1_1_1; unsigned char x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned short x_2_1_1; unsigned short x_2_1_2; } x2; })arg3;
- (id)cellMapForRegion:(id)arg1 uidBased:(BOOL)arg2;
- (struct TSUCellRect { struct TSUCellCoord { unsigned short x_1_1_1; unsigned char x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned short x_2_1_1; unsigned short x_2_1_2; } x2; })cellRangeForTableArea:(unsigned int)arg1;
...
- (void)iterateCellsInRegion:(id)arg1 usingBlock:(id /* block */)arg2;
- (void)iterateCellsInRegion:(id)arg1 withFlags:(unsigned int)arg2 clampingRange:(struct TSUCellRect { struct TSUCellCoord { unsigned short x_1_1_1; unsigned char x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned short x_2_1_1; unsigned short x_2_1_2; } x2; })arg3 usingBlock:(id /* block */)arg4;
- (void)iterateCellsInRegion:(id)arg1 withFlags:(unsigned int)arg2 usingBlock:(id /* block */)arg3;
- (void)iterateCellsUsingBlock:(id /* block */)arg1;
- (void)iterateCellsWithFlags:(unsigned int)arg1 usingBlock:(id /* block */)arg2;
...
- (void)upgradeDuringDocumentUpgradeIfNeeded:(unsigned int)arg1 tableInfo:(id)arg2;
