...
- (void)_fetchCameraSnapshotForBulletinContext:(id)arg1 completionHandler:(id)arg2;
- (void)_handleCreateSnapshotWithBulletinContext:(id)arg1 error:(id)arg2 cameraSessionID:(id)arg3 completionHandler:(id)arg4;
...
- (void)_takeSnapshot;
- (id)delegate;
- (void)fetchCameraSnapshotForBulletinContext:(id)arg1 completionHandler:(id)arg2;
