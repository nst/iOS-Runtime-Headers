...
- (void)reloadData;
- (void)removeAllCirclesAnimated:(bool)arg1 completionBlock:(id)arg2;
- (void)removeAllRepellors;
- (void)removeCircleAtIndex:(long long)arg1 animated:(bool)arg2 completionBlock:(id)arg3;
- (void)removeCirclesInIndexSet:(id)arg1 animated:(bool)arg2 completionBlock:(id)arg3;
- (void)removeCirclesInIndexSet:(id)arg1 byAnimatingToPoint:(struct CGPoint { double x1; double x2; })arg2 delay:(double)arg3 completionBlock:(id)arg4;
