...
- (void)_extractCrashReporterBinaryImageHintsFromSymbolOwner:(struct _CSTypeRef { NSUInteger x1; NSUInteger x2; })arg1 withNonContiguousMemory:(id)arg2;
...
- (unsigned long long)_readAddressFromMemory:(id)arg1 atSymbol:(struct _CSTypeRef { NSUInteger x1; NSUInteger x2; })arg2;
