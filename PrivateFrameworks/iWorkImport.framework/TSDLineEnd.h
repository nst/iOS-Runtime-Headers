...
+ (id)filledDiamond;
+ (id)filledSquare;
+ (id)instanceWithArchive:(const struct LineEndArchive { int (**x1)(); struct UnknownFieldSet { struct vector<google::protobuf::UnknownField, std::__1::allocator<google::protobuf::UnknownField> > {} *x_2_1_1; } x2; struct Path {} *x3; struct Point {} *x4; int x5; bool x6; struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > {} *x7; int x8; unsigned int x9[1]; }*)arg1 unarchiver:(id)arg2;
+ (id)invertedArrow;
+ (id)line;
...
- (struct CGPath { }*)path;
- (void)saveToArchive:(struct LineEndArchive { int (**x1)(); struct UnknownFieldSet { struct vector<google::protobuf::UnknownField, std::__1::allocator<google::protobuf::UnknownField> > {} *x_2_1_1; } x2; struct Path {} *x3; struct Point {} *x4; int x5; bool x6; struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > {} *x7; int x8; unsigned int x9[1]; }*)arg1 archiver:(id)arg2;
