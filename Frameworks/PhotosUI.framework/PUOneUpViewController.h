...
@property (nonatomic, copy) id unlockDeviceHandler;
@property (nonatomic, copy) id unlockDeviceStatus;
...
- (id)_newOneUpLayout;
- (void)_notifyTileIsReadyWithTimeOut:(double)arg1 completionHandler:(id)arg2;
- (unsigned long long)_options;
- (id)_overOneUpPresentationSession;
- (id)_parallaxComputer;
- (struct CGSize { double x1; double x2; })_pendingViewTransitionSize;
- (void)_performNavigationToAssetDisplayDescriptor:(id)arg1 beforeDate:(id)arg2 completionHandler:(id)arg3;
...
- (void)loadView;
- (void)navigateToAssetDisplayDescriptor:(id)arg1 beforeDate:(id)arg2 completionHandler:(id)arg3;
...
- (void)tilingViewControllerTransition:(id)arg1 adoptTilingView:(id)arg2 fromEndPoint:(id)arg3 isCancelingTransition:(bool)arg4 animationSetupCompletionHandler:(id)arg5;
