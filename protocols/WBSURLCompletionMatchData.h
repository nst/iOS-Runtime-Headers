...
- (void)enumeratePageTitlesUsingBlock:(void *)arg1; // needs 1 arg types, found 8: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSString *, unsigned long long, bool*, void*
- (void)enumerateUserVisibleURLsUsingBlock:(void *)arg1; // needs 1 arg types, found 8: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSString *, unsigned long long, bool*, void*
