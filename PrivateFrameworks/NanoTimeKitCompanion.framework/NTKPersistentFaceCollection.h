...
- (void)_notifyLoaded;
- (void)_performOrEnqueueUpdateOfType:(long long)arg1 forFaceUUID:(id)arg2 block:(id)arg3;
- (void)_performSuppressingFaceObserverCallbacks:(id)arg1;
...
- (void)loadFullCollectionWithOrderedUUIDs:(id)arg1 selectedUUID:(id)arg2 facesByUUID:(id)arg3 seqId:(id)arg4 completion:(id)arg5;
- (void)removeFaceForUUID:(id)arg1 seqId:(id)arg2 completion:(id)arg3;
- (void)reset;
...
- (void)updateFaceForUUID:(id)arg1 withResourceDirectory:(id)arg2 seqId:(id)arg3 completion:(id)arg4;
