...
- (id)_readValuesForCharacteristics:(id)arg1 readSuccessBlock:(id)arg2 failureBlock:(id)arg3;
...
- (void)_transactionLock_executeActionSetTransaction:(id)arg1 completionHandler:(id)arg2;
- (void)_transactionLock_executeReadTransaction:(id)arg1 completionHandler:(id)arg2;
- (void)_transactionLock_executeWriteTransaction:(id)arg1 completionHandler:(id)arg2;
- (id)allReadCharacteristics;
- (void)beginTransactionWithReason:(id)arg1;
- (void)beginTransactionWithReason:(id)arg1 logger:(id)arg2 readValidator:(id)arg3;
...
- (bool)hasCachedReadErrorForAccessory:(id)arg1 passingTest:(id)arg2;
...
- (id)readValuesForCharacteristicsPassingTest:(id)arg1 inServices:(id)arg2;
