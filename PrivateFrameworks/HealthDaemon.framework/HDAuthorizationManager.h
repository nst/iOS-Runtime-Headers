...
- (void)_queue_beginAuthorizationDelegateTransactionWithSessionIdentifier:(id)arg1 completion:(id)arg2;
...
- (void)_queue_enqueueAuthorizationRequestWithIdentifier:(id)arg1 bundleIdentifier:(id)arg2 writeTypes:(id)arg3 readTypes:(id)arg4 authorizationNeededHandler:(id)arg5 completion:(id)arg6;
- (void)_queue_finishRequestGroup:(id)arg1 error:(id)arg2;
- (void)_queue_handleNextAuthorizationRequestGroup;
- (void)_queue_resetAllAuthorizationRecordsWithCompletion:(id)arg1;
- (bool)_queue_resetAuthorizationRecordsForBundleIdentifier:(id)arg1 error:(id*)arg2;
- (void)_queue_setAuthorizationStatuses:(id)arg1 forBundleIdentifier:(id)arg2 completion:(id)arg3;
- (id)activeObjectPromptSessionsBySessionIdentifier;
- (void)applicationsUninstalledNotification:(id)arg1;
- (void)beginAuthorizationDelegateTransactionWithSessionIdentifier:(id)arg1 completion:(id)arg2;
...
- (id)enqueueAuthorizationRequestForBundleIdentifier:(id)arg1 writeTypes:(id)arg2 readTypes:(id)arg3 authorizationNeededHandler:(id)arg4 completion:(id)arg5;
- (id)enqueueObjectAuthorizationRequestForBundleIdentifier:(id)arg1 samples:(id)arg2 promptIfNeeded:(bool)arg3 authorizationNeededHandler:(id)arg4 completion:(id)arg5;
- (void)handleAuthorizationRequestsForBundleIdentifier:(id)arg1 promptHandler:(id)arg2 completion:(id)arg3;
- (void)handleObjectAuthorizationRequestsForBundleIdentifier:(id)arg1 promptHandler:(id)arg2 completion:(id)arg3;
- (id)initWithProfile:(id)arg1;
- (void)openAppForAuthorization:(id)arg1 sessionIdentifier:(id)arg2 completion:(id)arg3;
...
- (void)resetAllAuthorizationRecordsWithCompletion:(id)arg1;
