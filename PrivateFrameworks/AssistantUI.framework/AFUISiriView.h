...
- (void)_loadReportBugButtonTemplateImageInBackgroundWithCompletion:(id)arg1;
...
- (void)showPasscodeUnlockWithStatusText:(id)arg1 completionHandler:(id)arg2 unlockCompletionHandler:(id)arg3;
