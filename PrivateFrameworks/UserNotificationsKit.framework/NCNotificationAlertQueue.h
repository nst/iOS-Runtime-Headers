...
- (bool)_performDestinationOperationForRequest:(id)arg1 block:(id)arg2;
- (void)_postEnqueuedNotificationRequestsCoalescingWith:(id)arg1;
- (void)_postNextNotificationRequest;
- (void)_postNextNotificationRequestPassingTest:(id)arg1;
...
- (void)destination:(id)arg1 didBecomeReadyToReceiveNotificationsPassingTest:(id)arg2;
...
- (void)destination:(id)arg1 executeAction:(id)arg2 forNotificationRequest:(id)arg3 withParameters:(id)arg4 completion:(id)arg5;
- (void)destination:(id)arg1 requestPermissionToExecuteAction:(id)arg2 forNotificationRequest:(id)arg3 withParameters:(id)arg4 completion:(id)arg5;
