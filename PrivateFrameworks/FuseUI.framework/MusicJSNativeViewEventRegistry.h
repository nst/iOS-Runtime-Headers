...
- (void).cxx_destruct;
- (id)_descriptionForNativeViewEventType:(int)arg1;
- (void)_dispatchNativeViewEventOfType:(int)arg1 withExtraInfo:(id)arg2 forJSNativeViewController:(id)arg3 appContext:(id)arg4 jsContext:(id)arg5 completion:(id /* block */)arg6;
...
- (unsigned int)_indexOfEventListener:(id)arg1 forNativeViewIdentifier:(id)arg2 eventType:(id)arg3 returningContainerMutableArray:(id*)arg4;
...
- (BOOL)_shouldUseInternalEventRegistryListenersToDispatchNativeViewEventOfType:(int)arg1;
- (void)addNativeViewAppearanceListener:(id)arg1 :(id)arg2 :(id)arg3;
- (void)dispatchNativeViewEventOfType:(int)arg1 forViewController:(id)arg2;
- (void)dispatchNativeViewEventOfType:(int)arg1 withExtraInfo:(id)arg2 forViewController:(id)arg3 completion:(id /* block */)arg4;
