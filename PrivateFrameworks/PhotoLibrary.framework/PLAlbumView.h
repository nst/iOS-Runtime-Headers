...
@class <PLAlbumViewDataSource>, <PLAlbumViewDelegate>, NSIndexPath, NSMutableArray, NSMutableSet, NSSet, PLAlbumFooterView, PLAlbumSelectionControlsView, PLAutoScroller, PLPhotosPickerSession, UIGestureRecognizer, UILongPressGestureRecognizer, UITableView, UITapGestureRecognizer, UIView;
