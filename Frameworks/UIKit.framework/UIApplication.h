...
@class <UIApplicationDelegate>, IUiPodTabBarController, IUiPodViewController, NSArray, NSMutableArray, NSMutableSet, NSString, NSTimer, UIAlertView, UIColor, UIEvent, UINavigationController, UIStatusBar, UIStatusBarWindow, UIViewController, UIWindow;
