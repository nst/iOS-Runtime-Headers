...
@property(readonly) BOOL isPOI;
@property(readonly) BOOL isVisible;
@property(readonly) BOOL updateHasFailed;
@property(readonly) NSString * iconName;
@property(readonly) float verticalPadding;
@property(readonly) VGLIcon * renderableIcon;
@property(getter=isDrawingRenderableIcon,readonly) BOOL drawingRenderableIcon;
...
- (BOOL)isPOI;
- (id)renderableIcon;
- (struct { float x1; float x2; float x3; float x4; })boundsAtPixel:(struct { float x1; float x2; })arg1;
