...
- (void)performIOChannelReadWithAccessor:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, <TSUReadChannel> *, void*
- (bool)readOnly;
...
- (bool)needsDownload;
- (void)performReadOnBookmarkDataSourceURLWithAccessor:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSURL *, void*
