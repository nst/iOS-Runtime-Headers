...
+ (struct CGSize { float x1; float x2; })stringSizeForText:(id)arg1 ctFontRef:(struct __CTFont { }*)arg2;
...
- (id)init;
- (struct CGSize { float x1; float x2; })stringSizeForSpaceWithFontName:(id)arg1 fontSize:(int)arg2;
- (struct CGSize { float x1; float x2; })stringSizeForText:(id)arg1 fontName:(id)arg2 fontSize:(int)arg3;
