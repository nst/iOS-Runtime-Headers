...
- (void)addProgressBlock:(id)arg1 completionHandler:(id)arg2 withTaskIdentifier:(id)arg3;
- (void)cancelTaskWithIdentifier:(id)arg1;
- (void)dealloc;
- (id)initWithProgressBlock:(id)arg1 completionHandler:(id)arg2 forTaskIdentifier:(id)arg3 highPriority:(bool)arg4;
- (bool)isHighPriority;
- (void)keepAlive;
