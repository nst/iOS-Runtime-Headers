...
- (void).cxx_destruct;
- (id)description;
- (id)initWithKey:(const struct VKTileKey { unsigned int x1; int x2; int x3; unsigned int x4; }*)arg1 modelTile:(id)arg2 tileType:(int)arg3 labelManager:(const struct shared_ptr<vk::LabelManager> { }*)arg4;
