...
- (void)p_upgradeTablesIfNeeded:(unsigned int)arg1;
- (id)packageDataForWrite;
- (void)pauseRecalculation;
- (void)pauseRecalculationSometimeSoon;
- (void)performHyperlinkUpgradesIfNecessaryForVersion:(unsigned int)arg1;
- (void)performStylesheetUpdatesIfNecessaryForVersion:(unsigned int)arg1;
...
- (void)upgradeTextStylesForUnityPlusFromFileFormatVersion:(unsigned int)arg1;
