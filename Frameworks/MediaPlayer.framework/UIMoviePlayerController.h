...
@class UIImage, MPMovieErrorLog, <MPVideoControllerProtocol>, MPAVItem, MPAVController, MPVideoView, MPSystemNowPlayingController, UIViewController, UINavigationController, MPTransitionController, NSArray, UIView, NSDate, UIMovieSnapshotView, NSString, _UIHostedWindow, UIMovieView, MPMovieAccessLog;
