...
@class <UIKeyInput>, <UIKeyboardCandidateList>, <UIKeyboardImplGeometryDelegate>, <UIKeyboardInput>, <UIKeyboardRecording><UIApplicationEventRecording>, <UIKeyboardTypology>, NSArray, NSMutableArray, NSMutableDictionary, NSObject<UIKeyboardRecording><UIApplicationEventRecording>, NSString, NSTimer, UIAlertView, UIAutocorrectInlinePrompt, UIDelayedAction, UIKeyboardCandidate, UIKeyboardInputManager, UIKeyboardLayout, UIResponder, UIResponder<UIKeyInput>, UIResponder<UITextInput>, UIResponder<UITextInputPrivate>, UITextInputArrowKeyHistory, UITextInputTraits, UIView;
