...
- (void)addFace:(struct CAMeshFace { unsigned int x1[4]; double x2[4]; })arg1;
...
- (void)replaceFaceAtIndex:(unsigned long)arg1 withFace:(struct CAMeshFace { unsigned int x1[4]; double x2[4]; })arg2;
- (void)replaceVertexAtIndex:(unsigned long)arg1 withVertex:(struct CAMeshVertex { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CAPoint3D { double x_2_1_1; double x_2_1_2; double x_2_1_3; } x2; })arg2;
