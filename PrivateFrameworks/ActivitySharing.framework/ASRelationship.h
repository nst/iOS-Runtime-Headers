...
@property (nonatomic, copy) CKRecordID *relationshipShareID;
@property (nonatomic, copy) CKRecordID *remoteActivityDataShareID;
@property (nonatomic, copy) CKRecordID *remoteRelationshipShareID;
