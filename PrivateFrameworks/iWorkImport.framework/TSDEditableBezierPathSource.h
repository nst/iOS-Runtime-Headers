...
- (float)distanceToPoint:(struct CGPoint { double x1; double x2; })arg1 subpathIndex:(unsigned int*)arg2 elementIndex:(unsigned int*)arg3 tValue:(float*)arg4 threshold:(float)arg5;
- (id)firstNode;
