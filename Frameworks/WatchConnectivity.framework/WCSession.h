...
- (void).cxx_destruct;
- (id)_init;
- (void)_onqueue_notifyOfMessageError:(id)arg1 withErrorHandler:(id)arg2;
...
- (id)createAndStartTimerOnWorkQueueWithHandler:(id)arg1;
...
- (void)didSessionStateChange:(id)arg1 withChangeHandler:(id)arg2;
...
- (void)onqueue_sendMessageData:(id)arg1 replyHandler:(id)arg2 errorHandler:(id)arg3 dictionaryMessage:(bool)arg4;
...
- (void)sendMessage:(id)arg1 replyHandler:(id)arg2 errorHandler:(id)arg3;
- (void)sendMessageData:(id)arg1 replyHandler:(id)arg2 errorHandler:(id)arg3;
