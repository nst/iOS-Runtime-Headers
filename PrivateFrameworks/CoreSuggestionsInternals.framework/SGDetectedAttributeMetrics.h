...
+ (id)contactStore;
+ (id)findContactFromEntity:(id)arg1 withType:(struct SGMContactDetailType_ { unsigned long long x1; })arg2 detailValue:(id)arg3;
+ (id)instance;
+ (void)recordExtractionEventFromSource:(struct SGMDocumentType_ { unsigned long long x1; })arg1 foundInSignature:(bool)arg2 detailType:(struct SGMContactDetailType_ { unsigned long long x1; })arg3 outcome:(struct SGMContactDetailExtractionOutcome_ { unsigned long long x1; })arg4 foundInSenderCNContact:(bool)arg5;
+ (void)recordExtractionOutcome:(struct SGMContactDetailExtractionOutcome_ { unsigned long long x1; })arg1 fromEntity:(id)arg2;
+ (void)recordExtractionOutcome:(struct SGMContactDetailExtractionOutcome_ { unsigned long long x1; })arg1 fromEntity:(id)arg2 foundInSignature:(bool)arg3 detailType:(struct SGMContactDetailType_ { unsigned long long x1; })arg4 detailValue:(id)arg5;
