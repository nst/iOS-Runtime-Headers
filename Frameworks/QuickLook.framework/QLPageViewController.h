...
- (void)_setCurrentPageIndex:(unsigned long long)arg1 direction:(long long)arg2 animated:(bool)arg3 completion:(id)arg4;
- (void)_setUp;
- (void)_setViewControllers:(id)arg1 direction:(long long)arg2 animated:(bool)arg3 completion:(id)arg4;
