...
- (void).cxx_destruct;
- (void)addDocumentFeatureInfoWithIdentifier:(id)arg1 readVersion:(unsigned int)arg2 writeVersion:(unsigned int)arg3;
...
- (id)alternateForVersion:(unsigned int)arg1;
- (void)archive;
- (id)archiveGroup;
- (BOOL)beginArchive;
- (BOOL)beginWrite;
...
- (BOOL)needsArchive;
- (id)objectUUID;
- (void)requiresDocumentReadVersion:(unsigned int)arg1 writeVersion:(unsigned int)arg2;
- (void)requiresDocumentReadVersion:(unsigned int)arg1 writeVersion:(unsigned int)arg2 featureIdentifier:(id)arg3;
- (void)requiresDocumentVersion:(unsigned int)arg1;
- (void)requiresDocumentVersion:(unsigned int)arg1 featureIdentifier:(id)arg2;
- (void)serialize;
- (id)serializeGroup;
- (id)serializedData;
- (BOOL)shouldSaveAlternates;
- (BOOL)success;
- (BOOL)updateMessageInfo:(struct MessageInfo { int (**x1)(); struct UnknownFieldSet { struct vector<google::protobuf::UnknownField, std::__1::allocator<google::protobuf::UnknownField> > {} *x_2_1_1; } x2; unsigned int x3[1]; int x4; struct RepeatedField<unsigned int> { unsigned int *x_5_1_1; int x_5_1_2; int x_5_1_3; } x5; int x6; unsigned int x7; unsigned int x8; struct RepeatedPtrField<TSP::FieldInfo> { void **x_9_1_1; int x_9_1_2; int x_9_1_3; int x_9_1_4; } x9; struct RepeatedField<unsigned int> { unsigned int *x_10_1_1; int x_10_1_2; int x_10_1_3; } x10; int x11; struct RepeatedField<unsigned int> { unsigned int *x_12_1_1; int x_12_1_2; int x_12_1_3; } x12; int x13; struct RepeatedField<unsigned int> { unsigned int *x_14_1_1; int x_14_1_2; int x_14_1_3; } x14; int x15; struct FieldPath {} *x16; struct RepeatedPtrField<TSP::FieldPath> { void **x_17_1_1; int x_17_1_2; int x_17_1_3; int x_17_1_4; } x17; unsigned int x18; }*)arg1 withArchiver:(id)arg2;
