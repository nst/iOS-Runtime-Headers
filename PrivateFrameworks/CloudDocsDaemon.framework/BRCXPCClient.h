...
- (void)_setupAppLibraryAndZoneWithID:(id)arg1 andSendReply:(id)arg2;
...
- (void)accessLogicalOrPhysicalURL:(id)arg1 accessKind:(long long)arg2 dbAccessKind:(long long)arg3 asynchronously:(bool)arg4 handler:(id)arg5;
