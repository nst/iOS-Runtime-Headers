...
- (void)_updatePassDescriptionsWithCompletionHandler:(id)arg1;
- (void)_updateRelevantPassIDs;
- (void)addPass:(id)arg1 completion:(id)arg2;
...
- (void)getSecureElementIdentifiers:(id)arg1;
- (void)getSharedWebServiceContextWithCompletion:(id)arg1;
...
- (void)handlePaymentTransactions:(id)arg1 forPassUniqueIDs:(id)arg2 completion:(id)arg3;
...
- (void)handleValueAddedServiceTransactions:(id)arg1 forPassUniqueIDs:(id)arg2 completion:(id)arg3;
...
- (void)noteWebServiceUpdateNeededWithCompletion:(id)arg1;
- (id)passCache;
- (id)passDescriptions;
...
- (void)setExpressTransitUniqueID:(id)arg1 applicationIdentifier:(id)arg2 completion:(id)arg3;
...
- (void)setPreferredPaymentApplication:(id)arg1 forPaymentPass:(id)arg2 completion:(id)arg3;
...
- (void)setSharedWebServiceContext:(id)arg1 completion:(id)arg2;
