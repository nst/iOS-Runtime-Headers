...
- (void)_assignTransaction:(int)arg1 forLibraryIDIndexSet:(id)arg2 missingLibraryIDIndexSet:(id*)arg3 database:(struct sqlite3 { }*)arg4;
- (void)_assignTransaction:(int)arg1 forLibraryIDs:(id)arg2 missingLibraryIDIndexSet:(id*)arg3 database:(struct sqlite3 { }*)arg4;
- (void)_assignTransaction:(int)arg1 forSpotlightTombstones:(id)arg2 type:(int)arg3 database:(struct sqlite3 { }*)arg4;
...
- (id)_messageForStatement:(struct sqlite3_stmt { }*)arg1 options:(unsigned int)arg2 timestamp:(unsigned int)arg3 isProtectedDataAvailable:(BOOL)arg4;
- (id)_newConnection;
...
- (void)_purgeSpotlightTombstonesBeforeTransaction:(int)arg1 database:(struct sqlite3 { }*)arg2;
...
- (int)addReferenceForContext:(id)arg1 usingDatabase:(struct sqlite3 { }*)arg2 mergeHandler:(id /* block */)arg3;
...
- (id)conversationIDsOfMessagesInSameThreadAsMessageWithLibraryID:(unsigned int)arg1 messageIDHash:(int)arg2;
- (int)conversationIdForMessageIds:(id)arg1;
...
- (struct __CFDictionary { }*)copySendersByLibraryIDForConversation:(int)arg1 mailbox:(id)arg2 limit:(int)arg3;
...
- (unsigned int)flagsForConversationId:(int)arg1;
...
- (id)messageIdsForConversationId:(int)arg1 limit:(unsigned int)arg2;
...
- (void)notifyConversation:(int)arg1 hasMergedIntoConversation:(int)arg2;
...
- (int)oldestKnownConversationInMailbox:(id)arg1;
...
- (id)searchableIndex;
- (id)searchableIndex:(id)arg1 assignTransaction:(int)arg2 updates:(id)arg3;
- (void)searchableIndex:(id)arg1 invalidateItemsGreaterThanTransaction:(int)arg2;
- (void)sendMessagesForStatement:(struct sqlite3_stmt { }*)arg1 db:(struct sqlite3 { }*)arg2 to:(id)arg3 options:(unsigned int)arg4 timestamp:(unsigned int)arg5;
...
- (void)setConversationInfo:(int)arg1 syncKey:(id)arg2 flags:(unsigned int)arg3;
- (void)setData:(id)arg1 forMessage:(id)arg2 isPartial:(BOOL)arg3;
- (void)setDelegate:(id)arg1;
- (void)setFlags:(unsigned int)arg1 forConversationId:(int)arg2;
