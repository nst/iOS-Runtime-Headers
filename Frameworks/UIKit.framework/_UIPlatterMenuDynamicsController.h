...
- (int)_stateForPosition:(struct CGPoint { double x1; double x2; })arg1 offset:(struct CGVector { double x1; double x2; })arg2 velocity:(struct CGVector { double x1; double x2; })arg3;
...
- (void)performActionsAndEnterState:(int)arg1 velocity:(struct CGVector { double x1; double x2; })arg2 underDirectManipulation:(BOOL)arg3;
