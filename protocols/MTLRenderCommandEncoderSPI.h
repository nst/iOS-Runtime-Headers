...
- (void)addSplitHandler:(void *)arg1; // needs 1 arg types, found 7: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, <MTLRenderCommandEncoderSPI> *, unsigned long long, void*
