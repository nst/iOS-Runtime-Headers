...
- (void)addStoreItemIDs:(id)arg1 andAddTracksToCloudLibrary:(bool)arg2 withCompletion:(id)arg3;
...
- (void)enumerateEntityChangesAfterSyncAnchor:(id)arg1 maximumRevisionType:(int)arg2 inUsersLibrary:(bool)arg3 usingBlock:(id)arg4;
