...
- (void).cxx_destruct;
- (float)_previewMarginForContentSize:(struct CGSize { double x1; double x2; })arg1;
- (void)_resetAccessoryView;
- (void)_setConstraints;
- (void)_setupConstraints;
- (void)_setupView;
- (float)_textTopMarginForContentSize:(struct CGSize { double x1; double x2; })arg1;
- (id)accessoryView;
...
- (void)setIntrinsicSize:(struct CGSize { double x1; double x2; })arg1 forVerticalSizeClass:(int)arg2;
