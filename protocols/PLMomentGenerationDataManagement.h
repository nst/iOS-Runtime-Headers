...
- (void)beginObservingNetworkReachabilityChangesWithBlock:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
- (void)enumerateAssetsWithIDs:(void *)arg1 usingBlock:(void *)arg2; // needs 2 arg types, found 9: NSArray *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, <PLMomentAssetData> *, unsigned long long, bool*, void*
...
- (void)performBlock:(void *)arg1 synchronously:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 11: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*, bool, id, void*, void, id, void*
- (void)performDataTransaction:(void *)arg1 synchronously:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 11: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*, bool, id, void*, void, id, void*
- (void)resetOnFailure;
- (bool)save:(id*)arg1;
