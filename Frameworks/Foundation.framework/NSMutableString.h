...
- (void)replaceAllSubstr:(id)arg1 with:(id)arg2 escStr:(id)arg3 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg4;
- (void)replaceAllSubstr:(id)arg1 with:(id)arg2 escStr:(id)arg3;
- (void)replaceAllSubstr:(id)arg1 with:(id)arg2 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
...
- (void)replaceOccurrencesOfString:(id)arg1 withString:(id)arg2;
- (bool)replaceSubstr:(id)arg1 with:(id)arg2 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
