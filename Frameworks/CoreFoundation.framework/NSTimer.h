...
+ (id)pu_scheduledTimerWithTimeInterval:(double)arg1 repeats:(bool)arg2 block:(id)arg3;
+ (id)pu_scheduledTimerWithTimeInterval:(double)arg1 weakTarget:(id)arg2 selector:(SEL)arg3 userInfo:(id)arg4 repeats:(bool)arg5;
+ (id)pu_timerWithFireDate:(id)arg1 interval:(double)arg2 repeats:(bool)arg3 block:(id)arg4;

// Image: /System/Library/PrivateFrameworks/PhotosPlayer.framework/PhotosPlayer

+ (void)blockInvoke:(id)arg1;
+ (id)is_timerWithTimeInterval:(double)arg1 block:(id)arg2 repeats:(bool)arg3;

// Image: /System/Library/PrivateFrameworks/SafariShared.framework/SafariShared

+ (id)safari_scheduledTimerWithTimeInterval:(double)arg1 repeats:(bool)arg2 block:(id)arg3;
+ (id)safari_timerWithTimeInterval:(double)arg1 repeats:(bool)arg2 block:(id)arg3;
