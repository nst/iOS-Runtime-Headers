...
- (void)_contentsOfDirectoryAtPath:(id)arg1 downloadIfNecessary:(bool)arg2 completionHandler:(id)arg3;
- (void)_continueContentsOfFile:(id)arg1 error:(id)arg2 completionHandler:(id)arg3;
- (void)_continuePreviewOfItem:(id)arg1 preview:(id)arg2 error:(id)arg3 completionHandler:(id)arg4;
...
- (void)_dispatchMaybeCallSelector:(SEL)arg1 path:(id)arg2 function:(const char *)arg3 line:(unsigned int)arg4 block:(id)arg5;
- (void)_downloadItem:(id)arg1 completionHandler:(id)arg2;
- (void)_downloadStaleDirectory:(id)arg1 completionHandler:(id)arg2;
- (void)_downloadStaleFile:(id)arg1 completionHandler:(id)arg2;
...
- (void)_startDownloadItem:(id)arg1 completionHandler:(id)arg2;
- (void)_startFetchingUpdates;
- (void)_startUploadingFile:(id)arg1 completionHandler:(id)arg2;
...
- (void)_uploadItem:(id)arg1 completionHandler:(id)arg2;
- (void)allPendingUploadsWithCompletionHandler:(id)arg1;
- (void)attributesOfItemAtPath:(id)arg1 completionHandler:(id)arg2;
- (void)cancelDownloadingItemAtPath:(id)arg1 completionHandler:(id)arg2;
- (void)cancelUploadingItemAtPath:(id)arg1 completionHandler:(id)arg2;
- (id)completionHandlerQueue;
- (bool)connectionStatus;
- (void)connectivityTracker:(id)arg1 didUpdateConnectionStatus:(bool)arg2;
- (void)contentsOfDirectoryAtPath:(id)arg1 completionHandler:(id)arg2;
- (void)contentsOfFileAtPath:(id)arg1 completionHandler:(id)arg2;
- (void)createDirectoryAtPath:(id)arg1 attributes:(id)arg2 completionHandler:(id)arg3;
- (void)dealloc;
- (id)delegateForFilterPath:(id)arg1;
- (bool)deleteAllLocalData;
- (id)downloadTaskForItemAtPath:(id)arg1;
- (void)evictItemAtPath:(id)arg1 completionHandler:(id)arg2;
...
- (void)preflightWriteToNewFileAtPath:(id)arg1 source:(id)arg2 completionHandler:(id)arg3;
- (void)rebuildDatabaseWithCompletionHandler:(id)arg1;
...
- (void)startDownloadingItemAtPath:(id)arg1 completionHandler:(id)arg2;
- (void)startUploadingItemAtPath:(id)arg1 completionHandler:(id)arg2;
- (void)thumbnailOfItemAtPath:(id)arg1 completionHandler:(id)arg2;
- (id)uploadForItemAtPath:(id)arg1;
- (void)writeToFileAtPath:(id)arg1 source:(id)arg2 completionHandler:(id)arg3;
