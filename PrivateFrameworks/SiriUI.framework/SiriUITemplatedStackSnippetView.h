...
- (void)_triggerLayoutAnimated:(bool)arg1 completion:(id)arg2;
- (void)addTemplateSubview:(id)arg1;
- (void)adjustAuxiliaryViewHeight:(double)arg1 animated:(bool)arg2 completion:(id)arg3;
- (id)auxiliaryView;
- (id)dataSource;
- (id)delegate;
...
- (void)layoutSubviews;
- (void)reloadData;
- (void)setAuxiliaryView:(id)arg1 atIndex:(unsigned long long)arg2 initialHeight:(double)arg3 animated:(bool)arg4 completion:(id)arg5;
