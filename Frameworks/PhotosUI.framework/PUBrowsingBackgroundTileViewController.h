...
@interface PUBrowsingBackgroundTileViewController : PUTileViewController <PUBrowsingViewModelChangeObserver> {
    ...
    id  __nextColorUpdateAnimatorBlock;
...
@property (setter=_setNextColorUpdateAnimatorBlock:, nonatomic, copy) id _nextColorUpdateAnimatorBlock;
...
- (void)_invalidateColorWithAnimatorBlock:(id)arg1;
...
- (void)_setNextColorUpdateAnimatorBlock:(id)arg1;
