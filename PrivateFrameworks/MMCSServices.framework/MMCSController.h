...
- (void)_handleRegistrationForMMCSPutFile:(id)arg1 preauthenticate:(bool)arg2 completionBlock:(id)arg3;
...
- (void)_registerFiles:(id)arg1 preauthenticate:(bool)arg2 completionBlock:(id)arg3;
- (void)_registerPowerAssertionIfNeeded;
- (void)_registerTransfers:(id)arg1 preauthenticate:(bool)arg2 completionBlock:(id)arg3;
...
- (void)putFiles:(id)arg1 requestURL:(id)arg2 requestorID:(id)arg3 authToken:(id)arg4 preauthenticate:(bool)arg5 completionBlock:(id)arg6;
- (void)registerFilesForDownload:(id)arg1 completionBlock:(id)arg2;
- (void)registerFilesForUpload:(id)arg1 withPreauthentication:(bool)arg2 completionBlock:(id)arg3;
