...
@class <PLAirTunesServicePhotoBrowsingDataSource>, AirPlayRemoteSlideshow, MCMediaControlClientRemote, MediaControlClient, NSDictionary, NSMutableArray, NSNetService, NSObject<OS_dispatch_queue>, NSString;
