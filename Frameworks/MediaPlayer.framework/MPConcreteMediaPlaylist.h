...
- (void)addMediaItems:(id)arg1 completionHandler:(id)arg2;
...
- (void)setItems:(id)arg1 completionBlock:(id)arg2;
- (void)setItemsWithPersistentIDs:(id)arg1 completionBlock:(id)arg2;
