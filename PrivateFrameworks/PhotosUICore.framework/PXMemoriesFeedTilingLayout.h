...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_contentsRectForItemAtIndexPath:(struct PXSimpleIndexPath { unsigned int x1; int x2; int x3; int x4; })arg1 forAspectRatio:(float)arg2;
...
- (id)_viewSpecForTileWithIdentifier:(struct PXTileIdentifier { unsigned int x1; unsigned int x2[10]; })arg1 boundingSize:(struct CGSize { double x1; double x2; })arg2;
...
- (struct PXSimpleIndexPath { unsigned int x1; int x2; int x3; int x4; })indexPathForMemoryAtPoint:(struct CGPoint { double x1; double x2; })arg1;
