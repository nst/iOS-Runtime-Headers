...
- (AXHAAccessQueue *)userInterfaceClient:(AXUIClient *)arg1 accessQueueForProcessingMessageWithIdentifier:(unsigned long long)arg2;
...
- (void)userInterfaceClient:(void *)arg1 processMessageFromServerAsynchronously:(void *)arg2 withIdentifier:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 10: AXUIClient *, NSDictionary *, unsigned long long, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSDictionary *, NSError *, void*
