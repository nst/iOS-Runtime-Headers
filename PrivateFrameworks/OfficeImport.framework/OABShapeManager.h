...
@interface OABShapeManager : OABShapeBaseManager <OABPropertiesManager>
{
  ...
  /* Error parsing encoded ivar type info: ^{EshShape=^^?S{EshContentData="m_optB"{EshOpt="_vptr$EshObject"^^?"m_unType"S"m_header"{EshHeader="m_lLength"i"m_ulOffset"I"m_nInstance"s"m_unType"S"m_bVersion"C}"m_data"{ChMap<ChUINT4,EshOpt::Value,CsLess<ChUINT4> >="m_map"{map<ChUINT4,EshOpt::Value,CsLess<ChUINT4>,std::allocator<std::pair<const ChUINT4, EshOpt::Value> > >="_M_t"{_Rb_tree<ChUINT4,std::pair<const ChUINT4, EshOpt::Value>,std::_Select1st<std::pair<const ChUINT4, EshOpt::Value> >,CsLess<ChUINT4>,std::allocator<std::pair<const ChUINT4, EshOpt::Value> > >="_M_impl"{_Rb_tree_impl<CsLess<ChUINT4>,false>="_M_key_compare"{CsLess<ChUINT4>=}"_M_header"{_Rb_tree_node_base="_M_color"i"_M_parent"^{_Rb_tree_node_base}"_M_left"^{_Rb_tree_node_base}"_M_right"^{_Rb_tree_node_base}}"_M_node_count"I}}}}"m_color"{EshColor="m_data"{Data="m_type"i"m_value"(Value="m_rgb"{RGB="m_bRed"C"m_bGreen"C"m_bBlue"C}"m_schemeIndex"S"m_paletteIndex"S"m_adjustedColor"{AdjustedColor="m_refColor"C"m_bParam"C"m_adjust"b4"m_isInvert"b1"m_isInvert128"b1"m_isGray"b1})}}}"m_optX"{EshOpt="_vptr$EshObject"^^?"m_unType"S"m_header"{EshHeader="m_lLength"i"m_ulOffset"I"m_nInstance"s"m_unType"S"m_bVersion"C}"m_data"{ChMap<ChUINT4,EshOpt::Value,CsLess<ChUINT4> >="m_map"{map<ChUINT4,EshOpt::Value,CsLess<ChUINT4>,std::allocator<std::pair<const ChUINT4, EshOpt::Value> > >="_M_t"{_Rb_tree<ChUINT4,std::pair<const ChUINT4, EshOpt::Value>,std::_Select1st<std::pair<const ChUINT4, EshOpt::Value> >,CsLess<ChUINT4>,std::allocator<std::pair<const ChUINT4, EshOpt::Value> > >="_M_impl"{_Rb_tree_impl<CsLess<ChUINT4>,false>="_M_key_compare"{CsLess<ChUINT4>=}"_M_header"{_Rb_tree_node_base="_M_color"i"_M_parent"^{_Rb_tree_node_base}"_M_left"^{_Rb_tree_node_base}"_M_right"^{_Rb_tree_node_base}}"_M_node_count"I}}}}"m_color"{EshColor="m_data"{Data="m_type"i"m_value"(Value="m_rgb"{RGB="m_bRed"C"m_bGreen"C"m_bBlue"C}"m_schemeIndex"S"m_paletteIndex"S"m_adjustedColor"{AdjustedColor="m_refColor"C"m_bParam"C"m_adjust"b4"m_isInvert"b1"m_isInvert128"b1"m_isGray"b1})}}}"m_sp"{EshSp="_vptr$EshObject"^^?"m_unType"S"m_header"{EshHeader="m_lLength"i"m_ulOffset"I"m_nInstance"s"m_unType"S"m_bVersion"C}"m_ulSpid"I"m_isGroup"B"m_isChild"B"m_isPatriarch"B"m_isDeleted"B"m_isOleShape"B"m_isHaveMaster"B"m_isFlipH"B"m_isFlipV"B"m_isConnector"B"m_isHaveAnchor"B"m_isBackground"B"m_isHaveSpt"B}"m_anchor"{CsRect<ChSINT4>="m_data"[4i]}}{EshTextBox="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshFill="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshStroke="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshShadow="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshExtrusion="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshCallout="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}^^?{EshShapeProperties="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}"_vptr$EshBackgroundProperties"^^?}{EshShapeLocks="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshShapeImageData="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshTextPath="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshPath="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshSkew="_vptr$EshObject"^^?"m_unType"S"m_data"^{EshContentData}}{EshQuickTimeData="_vptr$EshObject"^^?"m_unType"S"m_header"{EshHeader="m_lLength"i"m_ulOffset"I"m_nInstance"s"m_unType"S"m_bVersion"C}"m_data"{OcBinaryData="_vptr$OcBinaryData"^^?"m_ulStartOffset"I"m_ulByteCount"I"m_ulBufferSize"I"m_pBuffer"*"m_isMyBuffer"B}}} */
