...
@property (nonatomic, readonly) struct { int x1; int x2; unsigned int x3; int x4; } frameDuration;
...
- (void)dealloc;
- (void)finalize;
- (struct { int x1; int x2; unsigned int x3; int x4; })frameDuration;
- (id)init;
- (id)instructionForFigInstruction:(void*)arg1;
- (id)instructions;
- (BOOL)isValidForAsset:(id)arg1 timeRange:(struct { struct { int x_1_1_1; int x_1_1_2; unsigned int x_1_1_3; int x_1_1_4; } x1; struct { int x_2_1_1; int x_2_1_2; unsigned int x_2_1_3; int x_2_1_4; } x2; })arg2 validationDelegate:(id)arg3;
...
- (void)setFrameDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
