...
- (struct PXTileIdentifier { unsigned long long x1; unsigned long long x2[10]; })hitTestTileAtPoint:(struct CGPoint { double x1; double x2; })arg1 padding:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2 passingTest:(id)arg3;
