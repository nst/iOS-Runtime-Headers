...
- (void)_requestImageForAsset:(id)arg1 tileSize:(struct CGSize { double x1; double x2; })arg2 completion:(id)arg3;
- (void)_requestPlayerItemForAsset:(id)arg1 preparation:(id)arg2 completion:(id)arg3;
