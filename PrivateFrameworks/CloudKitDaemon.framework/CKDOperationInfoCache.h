...
- (void)_locked_enumerateCallbackArgumentsForOperationWithID:(id)arg1 usingBlock:(id)arg2;
...
- (void)enumerateCallbackArgumentsForOperationWithID:(id)arg1 usingBlock:(id)arg2;
