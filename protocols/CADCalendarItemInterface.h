...
- (void)CADDatabaseAddContactWithIdentifier:(void *)arg1 forCalendarItem:(void *)arg2 withReply:(void *)arg3; // needs 3 arg types, found 8: NSString *, struct { int x1; int x2; }, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, void*
...
- (void)CADDatabaseExportCalendarItemAsICS:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 8: struct { int x1; int x2; }, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSData *, void*
...
- (void)CADDatabaseGetContactIdentifierForCalendarItem:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 8: struct { int x1; int x2; }, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSArray *, void*
- (void)CADDatabaseRemoveContactIdentifier:(void *)arg1 forCalendarItem:(void *)arg2 withReply:(void *)arg3; // needs 3 arg types, found 8: NSString *, struct { int x1; int x2; }, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, void*
