...
+ (void)_checkIntersectionOfLineSegmentStartingAt:(struct CGPoint { double x1; double x2; })arg1 endingAt:(struct CGPoint { double x1; double x2; })arg2 withCircleAt:(struct CGPoint { double x1; double x2; })arg3 andRadius:(float)arg4 results:(id)arg5;
+ (void)_collectIntersectionsOfLineSegmentStartingAt:(struct CGPoint { double x1; double x2; })arg1 endingAt:(struct CGPoint { double x1; double x2; })arg2 withCornerCirclesOfRoundedRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 withRadius:(float)arg4 results:(id)arg5;
+ (id)_cornersOfRotatedRectangle:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 angle:(float)arg2;
+ (struct CGPoint { double x1; double x2; })_farthestPointFrom:(struct CGPoint { double x1; double x2; })arg1 inArray:(id)arg2;
+ (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })_rawAffineTransformForExifOrientation:(int)arg1;
...
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_strokeAlignedRectForRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withStrokeWidth:(float)arg2 shouldAlignStrictlyToScreen:(BOOL)arg3 alignToScreenUsingPageController:(id)arg4 orAlignToBitmapContext:(struct CGContext { }*)arg5 usingAnnotation:(id)arg6;
+ (void)adjustOriginalExifOrientationOnAnnotation:(id)arg1 flatteningOriginalModelExif:(int)arg2;
+ (struct CGPoint { double x1; double x2; })adjustPoint:(struct CGPoint { double x1; double x2; })arg1 forExifOrientation:(int)arg2 aboutCenter:(struct CGPoint { double x1; double x2; })arg3;
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })adjustRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 forExifOrientation:(int)arg2 aboutCenter:(struct CGPoint { double x1; double x2; })arg3;
+ (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })affineTransformFlatteningOriginalModelExif:(int)arg1 withOriginalModelSize:(struct CGSize { double x1; double x2; })arg2;
+ (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })affineTransformForExifOrientation:(int)arg1 aboutCenter:(struct CGPoint { double x1; double x2; })arg2;
+ (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })affineTransformRecenteringAboutOriginForExifOrientation:(int)arg1 withOriginalSize:(struct CGSize { double x1; double x2; })arg2;
+ (float)angleBetweenPoint:(struct CGPoint { double x1; double x2; })arg1 andPoint:(struct CGPoint { double x1; double x2; })arg2;
+ (float)angleOfVector:(struct CGVector { double x1; double x2; })arg1;
+ (BOOL)annotationHasRotation:(id)arg1 outAngle:(float*)arg2;
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })boundsOfRotatedRectangle:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 angle:(float)arg2;
...
+ (float)distanceBetweenPoints:(struct CGPoint { double x1; double x2; })arg1 andPoint:(struct CGPoint { double x1; double x2; })arg2;
+ (unsigned int)draggableArea:(unsigned int)arg1 convertedForExif:(int)arg2;
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })effectiveDrawingBoundsForAnnotation:(id)arg1 forDisplay:(BOOL)arg2 pageControllerOrNil:(id)arg3 outScaleFactor:(float*)arg4;
...
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })integralRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withOptions:(unsigned int)arg2;
+ (void)intersectCircleAtPoint:(struct CGPoint { double x1; double x2; })arg1 withRadius:(float)arg2 withCircleAtPoint:(struct CGPoint { double x1; double x2; })arg3 withRadius:(float)arg4 firstOutPoint:(struct CGPoint { double x1; double x2; }*)arg5 secondOutPoint:(struct CGPoint { double x1; double x2; }*)arg6;
...
+ (struct CGPoint { double x1; double x2; })intersectLineSegmentStartingAt:(struct CGPoint { double x1; double x2; })arg1 ending:(struct CGPoint { double x1; double x2; })arg2 withCircleWithCenter:(struct CGPoint { double x1; double x2; })arg3 andRadius:(float)arg4 farthestResult:(BOOL)arg5;
...
+ (struct CGPoint { double x1; double x2; })intersectLineSegmentStartingAt:(struct CGPoint { double x1; double x2; })arg1 ending:(struct CGPoint { double x1; double x2; })arg2 withRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 andRoundedCornerRadius:(float)arg4;
+ (struct CGPoint { double x1; double x2; })intersectRayStartingAt:(struct CGPoint { double x1; double x2; })arg1 ending:(struct CGPoint { double x1; double x2; })arg2 withCircleWithCenter:(struct CGPoint { double x1; double x2; })arg3 andRadius:(float)arg4 farthestResult:(BOOL)arg5;
...
+ (float)lengthOfVector:(struct CGVector { double x1; double x2; })arg1;
+ (struct CGPath { }*)newPathWithPath:(struct CGPath { }*)arg1 applyingExifOrientation:(int)arg2 aboutCenter:(struct CGPoint { double x1; double x2; })arg3;
...
+ (struct CGPoint { double x1; double x2; })pointAtAngle:(float)arg1 inCircleWithCenter:(struct CGPoint { double x1; double x2; })arg2 andRadius:(float)arg3;
...
+ (float)radiusOfCenteredCircleFor:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })renderingStrokeAlignedRectForRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withStrokeWidth:(float)arg2 alignToScreenUsingPageController:(id)arg3 orAlignToContext:(struct CGContext { }*)arg4 usingAnnotation:(id)arg5;
+ (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })rotationTransformAroundPoint:(struct CGPoint { double x1; double x2; })arg1 withAngle:(float)arg2;
+ (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })rotationTransformForRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withAngle:(float)arg2;
...
+ (float)scaleOfTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1;
+ (struct CGPoint { double x1; double x2; })snapVector:(struct CGPoint { double x1; double x2; })arg1 toDiagonalForAspectRatio:(float)arg2 ignoreWidth:(BOOL)arg3 ignoreHeight:(BOOL)arg4;
...
+ (id)verticesOfPolygonWithPointCount:(unsigned int)arg1 inRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 rotation:(float)arg3 flippedVertically:(BOOL)arg4;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })screenStrokeAlignedRectForRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withStrokeWidth:(float)arg2;
