...
@interface SCNActionScale : SCNAction {
  ...
  /* Error parsing encoded ivar type info: ^{SCNCActionScale=^^?f@?@BddffdBB@?^{__CFString}ifffffffffcc} */
    struct SCNCActionScale { int (**x1)(); float x2; id x3; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x4; id x5; bool x6; double x7; double x8; float x9; float x10; double x11; bool x12; bool x13; id x14; void*x15; struct __CFString {} *x16; int x17; float x18; float x19; float x20; float x21; float x22; float x23; float x24; float x25; float x26; BOOL x27; BOOL x28; } *_mycaction;
