...
- (unsigned int)_arrivalStateForStep:(id)arg1;
...
- (id)_projectedArrivalDateForStepAtIndex:(unsigned int)arg1;
- (void)_reachedStep:(id)arg1;
- (void)_recordTraceEvent:(int)arg1 withData:(id)arg2;
- (void)_refreshTimetable;
- (id)_remainingSteps;
- (double)_remainingTimeUntilNextStep;
- (double)_remainingTimeUntilStepAtIndex:(unsigned int)arg1;
- (void)_setarrivalState:(unsigned int)arg1 forStep:(id)arg2;
