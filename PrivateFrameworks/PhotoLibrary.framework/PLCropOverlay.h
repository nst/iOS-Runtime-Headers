...
@class UIProgressHUD, PLToolbar, PLCropLCDLayer, TPPushButton, PLCropOverlayCropView, UIImageView, UIView, PLCropOverlayBottomBar, TPBottomDualButtonBar, TPCameraPushButton;
