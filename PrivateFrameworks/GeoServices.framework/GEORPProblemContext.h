...
@interface GEORPProblemContext : PBCodable <NSCopying> {
    ...
    unsigned int  _originatingAuxiliaryControlIndex;
    int  _pinType;
    GEOPDPlace * _place;
...
@property (nonatomic) unsigned int originatingAuxiliaryControlIndex;
...
- (id)originalPlace;
- (unsigned int)originatingAuxiliaryControlIndex;
- (int)pinType;
...
- (void)setOriginatingAuxiliaryControlIndex:(unsigned int)arg1;
