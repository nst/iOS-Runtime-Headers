...
@property (nonatomic, retain) AWDHealthKitAchievement *achievement;
@property (nonatomic, retain) AWDHealthKitActivityCache *activityCache;
@property (nonatomic) int alertType;
@property (nonatomic, retain) AWDHealthKitConcurrentCalendarItem *calendarItem;
...
@property (nonatomic, retain) AWDHealthKitNotificationResponseFlags *responseFlags;
@property (nonatomic) long long startDate;
@property (nonatomic) int testAction;
@property (nonatomic) unsigned long long timestamp;
@property (nonatomic, retain) NSMutableArray *views;
@property (nonatomic, retain) AWDHealthKitWeeklySummaryDetail *weeklySummaryDetail;
