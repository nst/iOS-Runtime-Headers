...
@interface IKAppCache : NSObject <IKAppContextInternalDelegate> {
    ...
    id  _validationCompletionHandler;
...
@property (nonatomic, copy) id validationCompletionHandler;
...
- (id)appJSChecksum;
- (id)appJSURL;
- (void)appJSURLWithCompletion:(id)arg1;
...
- (void)updateCacheWithValidatedJS:(id)arg1 completion:(id)arg2;
