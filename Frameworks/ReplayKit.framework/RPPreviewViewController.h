...
+ (void)loadPreviewViewControllerWithMovieURL:(id)arg1 attachmentURL:(id)arg2 overrideShareMessage:(id)arg3 overrideTintColor:(id)arg4 completion:(id)arg5;
+ (void)loadPreviewViewControllerWithMovieURL:(id)arg1 completion:(id)arg2;
