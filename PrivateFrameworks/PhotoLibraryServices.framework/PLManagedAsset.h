...
@property (nonatomic) int externalUsageIntent;
@property (nonatomic, retain) id faceAdjustmentVersion;
@property (nonatomic) int faceAreaPoints;
...
@property (nonatomic) unsigned int localResourcesState;
...
@property (nonatomic) int videoCpDurationValue;
...
+ (BOOL)isPhotoIrisPlaceholderWithPhotoIris:(BOOL)arg1 videoCpDuration:(int)arg2 isCloudShared:(BOOL)arg3 videoCpFilePath:(id)arg4;
...
+ (unsigned int)localResourceOptionFromResourceType:(unsigned int)arg1 useMaster:(BOOL)arg2;
...
+ (unsigned int)totalSizeOfUnpushedOriginalsInPhotoLibrary:(id)arg1;
...
- (void)_asyncGenerateRenderImageFileWithSize:(struct CGSize { double x1; double x2; })arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 adjustmentDataBlob:(id)arg4 originalImageFilePath:(id)arg5 originalImageEXIFOrientation:(int)arg6 renderedImageFilePath:(id)arg7 completionHandler:(id /* block */)arg8;
...
- (BOOL)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 videoDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg3 stillDisplayTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg4 createSidecar:(BOOL)arg5;
...
- (void)getFileURL:(id*)arg1 originalFilename:(id*)arg2 uti:(id*)arg3 fileSize:(int*)arg4 forSidecarMatchingUTI:(id)arg5 requireExactMatch:(BOOL)arg6;
...
- (void)setExternalUsageIntent:(int)arg1;
...
- (struct CGSize { double x1; double x2; })targetSizeForInputSize:(struct CGSize { double x1; double x2; })arg1 maxPixelSize:(unsigned int)arg2;
- (id)textBadgeString;
...
- (void)updatePhotoIrisMetadataWithMediaGroupUUID:(id)arg1 videoDuration:(struct { int x1; int x2; unsigned int x3; int x4; })arg2 stillDisplayTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg3;
