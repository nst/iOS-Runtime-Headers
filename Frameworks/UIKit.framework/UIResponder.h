...
@interface UIResponder : NSObject <DebugHierarchyObject_Fallback, UIResponderStandardEditActions, UITextInputAdditions, UITextInput_Internal, _UIStateRestorationContinuation, _UITouchable> {
