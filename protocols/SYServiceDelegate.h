...
- (void)service:(void *)arg1 incomingData:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: SYService *, NSData *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
- (void)service:(void *)arg1 incomingStream:(void *)arg2 metadata:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 10: SYService *, NSInputStream *, NSDictionary *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
