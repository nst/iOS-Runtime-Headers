...
- (void).cxx_destruct;
- (void)_addEvent:(id)arg1 completionHandler:(id)arg2;
...
- (void)_removeEvent:(id)arg1 completionHandler:(id)arg2;
...
- (void)_updatePredicate:(id)arg1 completionHandler:(id)arg2;
- (void)_updateRecurrences:(id)arg1 completionHandler:(id)arg2;
- (void)_updateRegion:(id)arg1 forLocationEvent:(id)arg2 completionHandler:(id)arg3;
- (void)_updateTriggerValue:(id)arg1 forCharacteristicEvent:(id)arg2 completionHandler:(id)arg3;
- (void)addEvent:(id)arg1 completionHandler:(id)arg2;
- (id)currentEvents;
- (void)dealloc;
...
- (id)predicate;
- (id)recurrences;
- (void)removeEvent:(id)arg1 completionHandler:(id)arg2;
- (void)setCurrentEvents:(id)arg1;
- (void)setPredicate:(id)arg1;
- (void)setRecurrences:(id)arg1;
- (void)updatePredicate:(id)arg1 completionHandler:(id)arg2;
- (void)updateRecurrences:(id)arg1 completionHandler:(id)arg2;
