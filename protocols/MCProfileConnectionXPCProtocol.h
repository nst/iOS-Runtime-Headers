...
- (void)doMCICDidFinishPreflightWithError:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 10: NSError *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, BOOL, unsigned int, NSError *, void*
...
- (void)doMCICDidRequestUserInput:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 10: NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, BOOL, unsigned int, NSError *, void*
