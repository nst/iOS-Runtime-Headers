...
- (void)dealloc;
- (void)drawAttributedString:(struct __CFAttributedString { }*)arg1 paragraphStyle:(id)arg2 intoContext:(struct CGContext { }*)arg3 atPosition:(struct CGPoint { double x1; double x2; })arg4 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg5 viewScale:(double)arg6;
