...
@property (setter=_setActiveRect:, nonatomic) struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; } _activeRect;
@property (setter=_setCachedRect:, nonatomic) struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; } _cachedRect;
...
@property (setter=_setDirtyRect:, nonatomic) struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; } _dirtyRect;
@property (nonatomic, readonly) NSMutableIndexSet *_dirtyTileIndexes;
@property (setter=_setLayoutDesiredOrigin:, nonatomic) struct CGPoint { float x1; float x2; } _layoutDesiredOrigin;
@property (setter=_setLayoutWithInitializedVisibleOrigin:, nonatomic) PXTilingLayout *_layoutWithInitializedVisibleOrigin;
@property (setter=_setMaxPreheatPadding:, nonatomic) struct UIEdgeInsets { float x1; float x2; float x3; float x4; } _maxPreheatPadding;
@property (setter=_setPagedRect:, nonatomic) struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; } _pagedRect;
...
@property (setter=_setUpdatedPreferredVisibleOrigin:, nonatomic) struct CGPoint { float x1; float x2; } _updatedPreferredVisibleOrigin;
@property (setter=_setVisibleRect:, nonatomic) struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; } _visibleRect;
...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; } layoutContentBounds;
@property (nonatomic, readonly) struct CGPoint { float x1; float x2; } layoutOrigin;
@property (nonatomic, readonly) struct CGPoint { float x1; float x2; } layoutPreferredOrigin;
@property (nonatomic, readonly) struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; } layoutScrollBounds;
...
- (void).cxx_destruct;
- (struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })_activeRect;
- (struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })_cachedRect;
...
- (struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })_dirtyRect;
...
- (void)_invalidateRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1;
- (void)_invalidateScrollControllerMetrics;
- (void)_invalidateScrollInfo;
- (void)_invalidateTiles;
- (struct CGPoint { float x1; float x2; })_layoutDesiredOrigin;
- (id)_layoutWithInitializedVisibleOrigin;
- (void)_markRectAsCached:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1;
- (struct UIEdgeInsets { float x1; float x2; float x3; float x4; })_maxPreheatPadding;
- (BOOL)_needsUpdate;
- (struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })_pagedRect;
- (id)_preheatRecordForPreheatHandler:(id)arg1 context:(void*)arg2 createIfNeeded:(BOOL)arg3;
- (id)_preheatRecords;
- (void)_prepareBufferForCount:(unsigned int)arg1;
- (struct CGSize { float x1; float x2; })_referenceSize;
- (id)_scrollInfo;
- (void)_setActiveRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1;
- (void)_setCachedRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1;
- (void)_setContentInset:(struct UIEdgeInsets { float x1; float x2; float x3; float x4; })arg1;
- (void)_setCurrentLayout:(id)arg1;
- (void)_setDirtyRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1;
- (void)_setLayoutDesiredOrigin:(struct CGPoint { float x1; float x2; })arg1;
- (void)_setLayoutWithInitializedVisibleOrigin:(id)arg1;
- (void)_setMaxPreheatPadding:(struct UIEdgeInsets { float x1; float x2; float x3; float x4; })arg1;
- (void)_setNeedsUpdate;
- (void)_setPagedRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1;
- (void)_setReferenceSize:(struct CGSize { float x1; float x2; })arg1;
- (void)_setScrollInfo:(id)arg1;
- (void)_setTargetLayout:(id)arg1;
- (void)_setUpdatedPreferredVisibleOrigin:(struct CGPoint { float x1; float x2; })arg1;
- (void)_setVisibleRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1;
- (id)_tileStates;
...
- (struct CGPoint { float x1; float x2; })_updatedPreferredVisibleOrigin;
...
- (struct CGPoint { float x1; float x2; })convertPointFromLayout:(struct CGPoint { float x1; float x2; })arg1;
- (struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })convertRectFromLayout:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1;
...
- (BOOL)getTile:(out void**)arg1 geometry:(out struct PXTileGeometry { struct CGRect { struct CGPoint { float x_1_2_1; float x_1_2_2; } x_1_1_1; struct CGSize { float x_2_2_1; float x_2_2_2; } x_1_1_2; } x1; struct CGPoint { float x_2_1_1; float x_2_1_2; } x2; struct CGSize { float x_3_1_1; float x_3_1_2; } x3; struct CGAffineTransform { float x_4_1_1; float x_4_1_2; float x_4_1_3; float x_4_1_4; float x_4_1_5; float x_4_1_6; } x4; float x5; float x6; BOOL x7; struct CGSize { float x_8_1_1; float x_8_1_2; } x8; struct CGRect { struct CGPoint { float x_1_2_1; float x_1_2_2; } x_9_1_1; struct CGSize { float x_2_2_1; float x_2_2_2; } x_9_1_2; } x9; void *x10; }*)arg2 group:(out unsigned int*)arg3 userData:(out id*)arg4 forTileWithIdentifier:(struct PXTileIdentifier { unsigned int x1; unsigned int x2[10]; })arg5;
- (struct PXTileIdentifier { unsigned int x1; unsigned int x2[10]; })hitTestTileAtPoint:(struct CGPoint { float x1; float x2; })arg1 padding:(struct UIEdgeInsets { float x1; float x2; float x3; float x4; })arg2 passingTest:(id /* block */)arg3;
- (id)imageTileWithIdentifier:(struct PXTileIdentifier { unsigned int x1; unsigned int x2[10]; })arg1;
- (id)init;
- (id)initWithLayout:(id)arg1;
- (void)invalidateLayoutPreferredVisibleOrigin;
- (void)invalidateScrollControllerMetrics;
- (struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })layoutContentBounds;
- (struct CGPoint { float x1; float x2; })layoutOrigin;
- (struct CGPoint { float x1; float x2; })layoutPreferredOrigin;
- (struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })layoutScrollBounds;
- (id)observer;
- (void)registerPreheatHandler:(id)arg1 withPadding:(struct UIEdgeInsets { float x1; float x2; float x3; float x4; })arg2 tileGroup:(unsigned int)arg3 context:(void*)arg4;
- (void)requestFocus;
- (id)scrollController;
- (id)scrollDelegate;
- (id)scrollInfo;
...
- (void)setReferenceSize:(struct CGSize { float x1; float x2; })arg1 contentInset:(struct UIEdgeInsets { float x1; float x2; float x3; float x4; })arg2;
...
- (id)targetLayout;
- (id)tileAnimator;
- (struct PXTileIdentifier { unsigned int x1; unsigned int x2[10]; })tileIdentifierForTile:(void*)arg1;
- (id)tileSource;
