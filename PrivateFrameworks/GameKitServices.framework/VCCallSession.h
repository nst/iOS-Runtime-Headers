...
@class AVAudioPayload, AVAudioTier, AVAudioTierPicker, GKRingBuffer, LoopbackSocketTunnel, NSArray, NSData, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSObject<VCCallSessionDelegate>, NSObject<VideoConferenceChannelQualityDelegate>, NSObject<VideoConferenceRealTimeChannel>, NSString, TCPTunnelClient, TimingCollection, VCBitrateArbiter, VCCallInfo, VCCallLinkCongestionDetector, VCCapabilities, VCSessionMessaging;
