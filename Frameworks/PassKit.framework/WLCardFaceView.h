...
@class <WLCardFaceDelegate>, NSArray, NSMutableArray, NSMutableSet, PKPass, UIImage, UIImageView, UIView, WLBarCodeStickerView, WLCardColorProfile, WLCardFaceTemplate;
