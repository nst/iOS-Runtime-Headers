...
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *updateVoiceShortcutsSharedVocabularyQueue;

+ (void)initialize;
+ (id)sharedManager;

- (void).cxx_destruct;
- (void)_updateVoiceShortcutsSharedVocabularyAccessSpecifier:(id)arg1 completion:(id /* block */)arg2;
...
- (void)scheduleVocabularySyncToServerWithAccessSpecifier:(id)arg1 completion:(id /* block */)arg2;
...
- (id)updateVoiceShortcutsSharedVocabularyQueue;
