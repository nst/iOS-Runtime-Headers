...
@interface AVItem : NSObject  {
  ...
  /* Error parsing encoded ivar type info: ^{AVItemPrivate=@@"NSString"dfffIcc@"NSDictionary"iqqc@"NSDictionary"@"NSURL"@"NSURL"cc@"NSDictionary"@"NSURL"^{OpaqueMD5CheckProgress}^{OpaqueFigThread}^{OpaqueFigByteStream}i@"NSDate"@"NSDate"} */
