...
- (id)initWithContext:(id)arg1 documentRevision:(id)arg2 saveToken:(unsigned int)arg3 fileFormatVersion:(unsigned int)arg4 metadataObject:(id)arg5 dataAttributesSnapshot:(id)arg6 packageWriteCoordinator:(id)arg7;
