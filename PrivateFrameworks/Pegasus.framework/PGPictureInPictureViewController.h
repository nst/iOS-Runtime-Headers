...
+ (void)animateViewWithAnimationType:(long long)arg1 initialSpringVelocity:(double)arg2 animations:(id)arg3 completion:(id)arg4;
...
- (void)loadView;
- (id)loadedTimeRanges;
- (void)performResumeAnimationWithCompletionHandler:(id)arg1;
- (void)performRotateAnimationWithRotation:(long long)arg1 completionHandler:(id)arg2;
- (void)performStartAnimationWithCompletionHandler:(id)arg1;
- (void)performStopAnimationWithFinalLayerFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 completionHandler:(id)arg2;
- (void)performSuspendAnimationWithCompletionHandler:(id)arg1;
...
- (void)prepareStartAnimationWithInitialLayerFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 completionHandler:(id)arg2;
