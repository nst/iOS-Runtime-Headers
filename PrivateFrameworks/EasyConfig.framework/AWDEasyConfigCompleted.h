...
@interface AWDEasyConfigCompleted : PBCodable <NSCopying> {
    ...
    int  _rssiOfSWAP;
    double  _secondsToApplyConfig;
    double  _secondsToCompleteFullConfig;
    double  _secondsToCompleteMFiSAPAuth;
    double  _secondsToCompletePostConfigCheck;
    double  _secondsToFindPostConfigDevice;
    double  _secondsToFindPreConfigDevice;
    double  _secondsToGetLinkUpOnDestination;
    double  _secondsToGetLinkUpOnSWAP;
...
@property (nonatomic) double secondsToApplyConfig;
@property (nonatomic) double secondsToCompleteFullConfig;
@property (nonatomic) double secondsToCompleteMFiSAPAuth;
@property (nonatomic) double secondsToCompletePostConfigCheck;
@property (nonatomic) double secondsToFindPostConfigDevice;
@property (nonatomic) double secondsToFindPreConfigDevice;
@property (nonatomic) double secondsToGetLinkUpOnDestination;
@property (nonatomic) double secondsToGetLinkUpOnSWAP;
