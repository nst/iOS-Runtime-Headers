...
@interface ETGLSketchRenderer : NSObject {
    ...
    double  _currentTimeClock;
    double  _currentTimeIndex;
    double  _deathTime;
...
@property (nonatomic, readonly) double currentTimeClock;
@property (nonatomic, readonly) double currentTimeIndex;
@property (nonatomic) double deathTime;
@property (nonatomic) <ETGLSketchRendererDelegate> *delegate;
@property (nonatomic) BOOL isDying;
@property (nonatomic) double lastBirth;
