...
- (void)clearConnectionInfoForIdentifier:(id)arg1;
- (id)configuration;
...
- (void)copyConnectionInfoForIdentifier:(id)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (id)delegate;
- (id)fallbackCounts;
- (void)fetchConnectionInfoForFlow:(unsigned long long)arg1 withCompletionHandler:(id /* block */)arg2;
