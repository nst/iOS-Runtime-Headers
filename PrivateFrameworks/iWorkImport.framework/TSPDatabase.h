...
- (bool)insertObjectWithIdentifier:(long long)arg1 stateIdentifier:(const struct ObjectStateIdentifier { boolx1; long long x2; boolx3; id x4; }*)arg2 classType:(int)arg3 error:(id*)arg4;
