...
- (void)verifyAppWithPID:(void *)arg1 uuid:(void *)arg2 matchesAppRule:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: int, NSUUID *, NEAppRule *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, BOOL, void*
