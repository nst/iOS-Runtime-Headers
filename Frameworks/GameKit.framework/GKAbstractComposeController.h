...
@class ABPeoplePickerNavigationController, CKService, GKBackgroundView, GKRecipientGenerator, GKRecipientListView, GKRecipientSelectionView, NSDictionary, NSMutableArray, NSOperationQueue, UIFrameAnimation, UIImageView, UINavigationController, UINavigationItem, UITextContentView, UIToolbar;
