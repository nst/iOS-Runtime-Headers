...
@class GKRingBuffer, LoopbackSocketTunnel, NSArray, NSObject<VCCallSessionDelegate>, NSObject<VideoConferenceChannelQualityDelegate>, NSObject<VideoConferenceRealTimeChannel>, NSString, TCPTunnelClient, VCCallInfo, VCCallLinkCongestionDetector, VCCapabilities;
