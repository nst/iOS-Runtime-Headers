...
- (void)fetchMediaRemoteNowPlayingApplicationBundleId:(id)arg1;
- (void)fetchMediaRemoteNowPlayingApplicationPlaybackState:(id)arg1;
...
- (id)queue;
- (void)receivePrediction:(id)arg1 reply:(id)arg2;
