...
- (oneway void)authenticatedPlayersDidChange:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 6: NSArray *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
...
- (oneway void)setCurrentGame:(void *)arg1 serverEnvironment:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 7: GKGameInternal *, long long, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
