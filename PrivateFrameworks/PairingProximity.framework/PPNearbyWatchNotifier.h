...
@property (nonatomic, copy) id discoveryCompletion;
...
- (id)discoverForNearbyWatchesWithCompletion:(id)arg1;
- (id)discoverForTimeInterval:(double)arg1 signalLimit:(long long)arg2 completion:(id)arg3;
