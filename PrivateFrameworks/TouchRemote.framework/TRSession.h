...
- (void)_handleHeartbeatWithResponseHandler:(id)arg1;
- (void)_handleRequest:(id)arg1;
- (id)_handlerForEventClass:(Class)arg1;
- (id)_handlerForRequestClass:(Class)arg1;
...
- (void)setEventHandler:(id)arg1 forEventClass:(Class)arg2;
...
- (void)setRequestHandler:(id)arg1 forRequestClass:(Class)arg2;
- (void)startHeartbeat;
