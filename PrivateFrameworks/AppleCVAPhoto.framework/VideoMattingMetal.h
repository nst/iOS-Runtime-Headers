...
- (void)encodeForegroundMaskToBuffer:(id)arg1 disparity:(id)arg2 weight:(id)arg3 foregroundMask:(id)arg4 erodedForegroundMask:(id)arg5 shiftMin:(unsigned int)arg6 focusDisparity:(float)arg7 hardness:(float)arg8 minDistToDeweight:(float)arg9 unconfidentWeight:(float)arg10;
...
- (id)initWithStaticParams:(const struct VideoMattingStaticParams { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; float x9; float x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; unsigned int x18; unsigned int x19; int x20; }*)arg1 renderingShiftUpdateRate:(float)arg2 renderingShiftBlurRadius:(float)arg3 renderingInvalidShiftFillValue:(float)arg4 renderingLensFocalLength_mm:(float)arg5 useTemporalConfidence:(bool)arg6;
