...
@property (nonatomic, readonly) struct shared_ptr<mlcore::Library> { struct Library {} *x1; struct __shared_weak_count {} *x2; } _MediaLibrary_coreLibrary;
...
- (id)_MLCoreStorage;
- (struct shared_ptr<mlcore::Library> { struct Library {} *x1; struct __shared_weak_count {} *x2; })_MediaLibrary_coreLibrary;
...
- (unsigned int)_persistentIDForAssetURL:(id)arg1;
...
- (void)addStoreItem:(int)arg1 andAddTracksToCloudLibrary:(BOOL)arg2 withCompletion:(id /* block */)arg3;
...
- (id)collectionWithPersistentID:(unsigned int)arg1 groupingType:(int)arg2;
- (id)collectionWithPersistentID:(unsigned int)arg1 groupingType:(int)arg2 verifyExistence:(BOOL)arg3;
...
- (id)entityWithPersistentID:(int)arg1 entityType:(int)arg2;
...
- (unsigned int)filterAvailableContentGroups:(unsigned int)arg1 withOptions:(unsigned int)arg2;
...
- (BOOL)itemExistsInDatabaseWithPersistentID:(unsigned int)arg1;
- (BOOL)itemExistsWithPersistentID:(unsigned int)arg1;
- (id)itemWithPersistentID:(unsigned int)arg1;
- (id)itemWithPersistentID:(unsigned int)arg1 verifyExistence:(BOOL)arg2;
- (id)itemWithStoreID:(unsigned int)arg1;
- (id)lastModifiedDate;
...
- (id)name;
- (id)newPlaylistWithPersistentID:(unsigned int)arg1;
...
- (id)playlistWithPersistentID:(unsigned int)arg1;
