...
- (void)_writeBytes:(const void*)arg1 offset:(unsigned long)arg2 length:(unsigned long)arg3 toSocket:(int)arg4 completion:(id /* block */)arg5;
...
- (char *)readBytesFromSocket:(int)arg1 maximumSize:(unsigned long)arg2 bytesRead:(int*)arg3;
...
- (void)writeBytes:(const void*)arg1 length:(unsigned long)arg2 toSocket:(int)arg3 completion:(id /* block */)arg4;
