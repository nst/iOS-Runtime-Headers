...
- (void)fetchServerConfigForBuddyWithCachePolicy:(int)arg1 completion:(id /* block */)arg2;
- (void)fetchServerConfigForSettingsWithCachePolicy:(int)arg1 completion:(id /* block */)arg2;
- (id)init;
