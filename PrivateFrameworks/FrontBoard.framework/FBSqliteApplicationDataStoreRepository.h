...
- (bool)_dbQueue_executeStatement:(id)arg1 bindings:(id)arg2 resultRowHandler:(id)arg3;
- (bool)_dbQueue_executeStatement:(id)arg1 bindings:(id)arg2 resultRowHandler:(id)arg3 error:(out id*)arg4;
...
- (void)_dbQueue_performWithSavepoint:(id)arg1 handler:(id)arg2;
...
- (void)objectForKeys:(id)arg1 forAllApplicationsWithResult:(id)arg2;
