...
- (void)messageCenter:(void *)arg1 activeDeviceDidChange:(void *)arg2 acknowledgementHandler:(void *)arg3; // needs 3 arg types, found 7: HDIDSMessageCenter *, IDSDevice *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
