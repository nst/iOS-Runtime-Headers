...
- (id)characterRangesForSelection:(id)arg1 selectedSubstringsBlock:(id)arg2;
- (bool)check:(id*)arg1;
...
- (void)enumerateRangesModifiedAfter:(id)arg1 usingBlock:(id)arg2;
- (void)enumerateSubstrings:(id)arg1;
...
- (id)timestamp;
- (void)traverseUnordered:(id)arg1;
