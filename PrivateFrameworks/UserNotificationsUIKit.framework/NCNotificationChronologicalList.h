...
- (void).cxx_destruct;
- (id)_allNotificationRequestsFromSectionIndex:(unsigned int)arg1;
...
- (unsigned int)_insertionIndexForSection:(id)arg1;
...
- (id)identifierForSectionIndex:(unsigned int)arg1;
- (id)init;
...
- (int)sectionIndexForListSectionIdentifier:(id)arg1;
- (id)sections;
...
- (id)titleForSectionIndex:(unsigned int)arg1;
