...
- (unsigned int)_connectionTypeForEdge:(struct { struct { /* ? */ } *x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; struct { /* ? */ } *x6; struct { /* ? */ } *x7; }*)arg1 points:(struct { double x1; double x2; }*)arg2 connectingTilePoint:(struct Matrix<float, 2, 1> { double x1[2]; })arg3;
