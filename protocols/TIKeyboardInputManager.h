...
- (void)handleAcceptedCandidate:(void *)arg1 keyboardState:(void *)arg2 completionHandlerWithKeyboardOutput:(void *)arg3; // needs 3 arg types, found 9: TIKeyboardCandidate *, TIKeyboardState *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, TIKeyboardConfiguration *, TIKeyboardOutput *, void*
