...
- (id)_validator;
- (void)_writeLatestVocabularyItems:(id)arg1 forIntentSlot:(id)arg2 completion:(id)arg3;
- (id)appBundleID;
- (id)appBundlePath;
- (id)baseDirectoryPath;
- (void)checkIfSyncSlot:(id)arg1 isAllowedWithCompletion:(id)arg2;
- (id)deleteEverything;
...
- (void)writeLatestVocabularyItems:(id)arg1 forIntentSlot:(id)arg2 completion:(id)arg3;
