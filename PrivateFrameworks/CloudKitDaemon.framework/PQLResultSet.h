...
- (struct PQLResultSet { Class x1; id x2; Class x3; SEL x4; BOOL x5; id x6; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x7; id x8; BOOL x9; BOOL x10; id x11; id x12; unsigned int x13; unsigned int x14; id x15; }*)enumerateObjects:(id)arg1;
     /* Encoded args for previous method: ^{PQLResultSet=#@#:c@?@cc@@II@}12@0:4@?8 */

- (struct PQLResultSet { Class x1; id x2; Class x3; SEL x4; BOOL x5; id x6; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x7; id x8; BOOL x9; BOOL x10; id x11; id x12; unsigned int x13; unsigned int x14; id x15; }*)enumerateObjectsOfClass:(Class)arg1;
     /* Encoded args for previous method: ^{PQLResultSet=#@#:c@?@cc@@II@}12@0:4#8 */

- (struct PQLResultSet { Class x1; id x2; Class x3; SEL x4; BOOL x5; id x6; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x7; id x8; BOOL x9; BOOL x10; id x11; id x12; unsigned int x13; unsigned int x14; id x15; }*)enumerateObjectsOfClass:(Class)arg1 initializer:(SEL)arg2;
     /* Encoded args for previous method: ^{PQLResultSet=#@#:c@?@cc@@II@}16@0:4#8:12 */
