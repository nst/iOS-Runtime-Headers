...
- (bool)zoomTransition:(void *)arg1 transitionImageForPhotoToken:(void *)arg2 callback:(void *)arg3; // needs 3 arg types, found 8: PUPhotoBrowserZoomTransition *, id, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, UIImage *, void*
