...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_frameForAtomAtIndex:(unsigned int)arg1 withStartingPoint:(struct CGPoint { double x1; double x2; })arg2 row:(inout unsigned int*)arg3;
- (void)_reflow;
- (void)_reflowIfNeeded;
- (float)_remainingSpaceForRowAtPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (struct CGPoint { double x1; double x2; })baselinePointForRow:(unsigned int)arg1;
