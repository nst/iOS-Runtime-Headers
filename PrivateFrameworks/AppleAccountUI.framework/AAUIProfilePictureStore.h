...
- (void)_familyMember:(id)arg1 rawImageAndCropRect:(id)arg2;
- (id)_familyMemberPersonPicture:(id)arg1;
- (void)_fetchAndCacheRawImageAndCropRectWithRequest:(id)arg1 personID:(id)arg2 completion:(id)arg3;
...
- (void)_fetchProfilePictureSupersetWithRequest:(id)arg1 personID:(id)arg2 completion:(id)arg3;
- (void)_fetchProfilePictureWithRequest:(id)arg1 personID:(id)arg2 completion:(id)arg3;
- (void)_invalidateMonogrammer;
- (id)_meCardPicture;
- (void)_meCardRawImageAndCropRect:(id)arg1;
...
- (void)fetchRawImageAndCropRectForAccountOwner:(id)arg1;
- (void)fetchRawImageAndCropRectForFamilyMember:(id)arg1 completion:(id)arg2;
- (id)init;
