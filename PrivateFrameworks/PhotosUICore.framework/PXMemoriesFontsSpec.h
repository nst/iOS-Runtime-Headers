...
+ (id)_fontSpecCache;
+ (void)_getSpecSet:(out int*)arg1 variant:(out int*)arg2 forDescriptor:(struct PXViewSpecDescriptor { int x1; unsigned int x2; struct CGSize { double x_3_1_1; double x_3_1_2; } x3; })arg3 extendedTraitCollection:(id)arg4;
+ (int)_memoryLabelKindForDescriptor:(struct PXViewSpecDescriptor { int x1; unsigned int x2; struct CGSize { double x_3_1_1; double x_3_1_2; } x3; })arg1;
+ (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_paddingForFontSet:(int)arg1 specSet:(int)arg2 variant:(int)arg3 width:(float)arg4;
...
+ (id)memoriesFontsSpecForDescriptor:(struct PXViewSpecDescriptor { int x1; unsigned int x2; struct CGSize { double x_3_1_1; double x_3_1_2; } x3; })arg1 extendedTraitCollection:(id)arg2;
+ (void)preloadFontsSpecsForExtendedTraitCollection:(id)arg1;
+ (id)supportedTitleFontNames;

- (void).cxx_destruct;
- (id)_initWithIdentifier:(struct PXMemoryFontsSpecIdentifier { int x1; int x2; int x3; double x4; })arg1 titleFontName:(id)arg2;
