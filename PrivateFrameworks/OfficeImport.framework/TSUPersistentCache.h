...
- (void)dataForKey:(id)arg1 queue:(id)arg2 completion:(id)arg3;
- (void)dealloc;
- (id)directoryURL;
...
- (void)performAccessWithKey:(id)arg1 barrier:(bool)arg2 async:(bool)arg3 usingBlock:(id)arg4;
- (void)performAccessWithKey:(id)arg1 usingBlock:(id)arg2;
