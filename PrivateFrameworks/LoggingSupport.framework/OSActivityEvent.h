...
@property (readonly) unsigned long long machTimestamp;
@property (readonly) unsigned long long parentActivityID;
...
@property (readonly) unsigned long long processUniqueID;
...
@property (readonly) struct timeval { long long x1; int x2; } timeGMT;
