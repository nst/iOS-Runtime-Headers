...
- (id)footerViews;
- (id)headerViews;
- (void)hideTextCompletionViewControllerAnimated:(bool)arg1 completion:(id)arg2;
...
- (void)showTextCompletionViewController:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
