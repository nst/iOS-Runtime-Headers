...
@interface AVController : NSObject 
{
  ...
  /* Error parsing encoded ivar type info: ^{AVControllerPrivate=@"NSString"@"NSString"@"NSNumber"@#@"AVQueueFeeder"i@"NSString"fffi@"CALayer"cc@"NSObject"^{OpaqueFigVisualContext}@"NSString"^{__CFRunLoop}Iiiiccccc@"NSMutableArray"@"NSMutableDictionary"^{OpaqueFigPlayer}@"AVQueue"@"AVPlaybackQueue"@"AVPlaybackItem"cc@"NSDictionary"@"NSDictionary"} */
