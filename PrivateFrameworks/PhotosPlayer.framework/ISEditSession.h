...
@property (readonly) struct CGSize { float x1; float x2; } outputVideoSize;
...
- (struct CGSize { float x1; float x2; })_inputImageSize;
- (unsigned int)_inputOrientation;
- (struct { long long x1; int x2; unsigned int x3; long long x4; })_inputVideoDuration;
- (float)_inputVideoScale;
- (struct CGSize { float x1; float x2; })_inputVideoSize;
- (id)_inputVideoTrack;
- (struct CGAffineTransform { float x1; float x2; float x3; float x4; float x5; float x6; })_inputVideoTransform;
- (id)_loadInputImage;
- (unsigned int)_loadInputImageOrientation;
- (id)_loadInputImageProperties;
- (id)_loadInputImageWithSubsampleFactor:(int)arg1;
- (struct { long long x1; int x2; unsigned int x3; long long x4; })_loadInputVideoDuration;
- (id)_outputImage;
- (id)_outputImageProperties;
- (struct CGSize { float x1; float x2; })_outputImageSize;
- (id)_outputVideoMetadata;
- (struct CGSize { float x1; float x2; })_outputVideoSize;
- (struct CGSize { float x1; float x2; })_outputVideoSizeForScale:(float)arg1;
- (void)_prepareForPlaybackWithTargetSize:(struct CGSize { float x1; float x2; })arg1 options:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)_processImage:(id)arg1 scale:(float)arg2 error:(id*)arg3;
- (void)_renderImageToURL:(id)arg1 fileType:(id)arg2 targetSize:(struct CGSize { float x1; float x2; })arg3 completionHandler:(id /* block */)arg4;
- (void)_renderImageWithTargetSize:(struct CGSize { float x1; float x2; })arg1 completionHandler:(id /* block */)arg2;
- (void)_renderVideoToURL:(id)arg1 fileType:(id)arg2 targetSize:(struct CGSize { float x1; float x2; })arg3 volume:(float)arg4 completionHandler:(id /* block */)arg5;
- (id)_scaledInputImageForTargetScale:(float)arg1;
- (float)_targetScaleForTargetSize:(struct CGSize { float x1; float x2; })arg1;
- (id)_temporaryURLOfType:(id)arg1;
- (id)_videoCompositionForTargetSize:(struct CGSize { float x1; float x2; })arg1;
- (float)audioVolume;
- (void)cancel;
- (void)dealloc;
...
- (id)inputImage;
- (id)inputImageForRenderScale:(float)arg1;
- (unsigned int)orientation;
- (id)outputImage;
- (struct CGSize { float x1; float x2; })outputImageSize;
- (struct CGSize { float x1; float x2; })outputVideoSize;
- (struct { long long x1; int x2; unsigned int x3; long long x4; })photoTime;
- (void)prepareForPlaybackWithTargetSize:(struct CGSize { float x1; float x2; })arg1 options:(id)arg2 completionHandler:(id /* block */)arg3;
