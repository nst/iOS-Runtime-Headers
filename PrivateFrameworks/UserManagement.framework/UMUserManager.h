...
- (void)createUser:(id)arg1 passcodeData:(id)arg2 completionHandler:(id)arg3;
- (id)currentUser;
- (id)currentUserSwitchContext;
- (void)currentUserSwitchContextHasBeenUsed;
- (void)deleteUser:(id)arg1 completionHandler:(id)arg2;
- (void)disableUser:(id)arg1 completionHandler:(id)arg2;
- (id)init;
- (bool)isMultiUser;
- (void)loadUser:(id)arg1 passcodeData:(id)arg2 completionHandler:(id)arg3;
