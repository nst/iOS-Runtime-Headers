...
+ (id)achievementValueForKey:(id)arg1 category:(int)arg2 healthDaemon:(id)arg3 error:(id*)arg4;
+ (id)achievementValueForKey:(id)arg1 healthDaemon:(id)arg2 error:(id*)arg3;
+ (id)codableAchievementValuesForKeys:(id)arg1 category:(int)arg2 healthDaemon:(id)arg3 error:(id*)arg4;
+ (id)databaseTable;
...
+ (int)protectionClass;
+ (BOOL)removeAchievementValuesForKeys:(id)arg1 category:(int)arg2 healthDaemon:(id)arg3 error:(id*)arg4;
+ (BOOL)removeUserDefaultForKey:(id)arg1 bundleIdentifier:(id)arg2 healthDaemon:(id)arg3 error:(id*)arg4;
+ (BOOL)setAchievementValuesWithDictionary:(id)arg1 category:(int)arg2 healthDaemon:(id)arg3 error:(id*)arg4;
