...
- (void)_downloadAndAddPassWithCompletion:(id)arg1;
...
- (void)dealloc;
- (id)delegate;
- (void)fetchVerificationOptionsWithCompletion:(id)arg1;
...
- (id)passSnapshot;
- (id)passView;
- (void)performVerificationOptionsRequest:(id)arg1 completion:(id)arg2;
- (void)performVerificationUpdateRequest:(id)arg1 completion:(id)arg2;
...
- (void)submitVerificationCode:(id)arg1 completion:(id)arg2;
