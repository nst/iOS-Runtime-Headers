...
@interface TSTTableModel : TSPObject <TSTTableStrokeProviding, TSDMixing> {
    ...
    boolmRepeatingHeaderColumnsEnabled;
    boolmRepeatingHeaderRowsEnabled;
    boolmStyleApplyClearsAll;
    boolmTableNameBorderEnabled;
    boolmTableNameEnabled;
    boolmWasUnarchivedFromAProvidedTable;
...
@property double tableNameHeight;
