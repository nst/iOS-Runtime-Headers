...
@property (nonatomic, readonly) struct CGImage { }*previewImage;
...
@property (nonatomic, readonly) struct CGImage { }*senderIcon;
@property (nonatomic, readonly) bool senderIsMe;
@property (nonatomic, readonly, copy) NSString *senderLastName;
@property (nonatomic, readonly) struct CGImage { }*smallPreviewImage;
...
- (struct CGImage { }*)smallPreviewImage;
