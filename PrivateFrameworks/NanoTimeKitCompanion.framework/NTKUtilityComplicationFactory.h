...
- (void)_configureLayout:(id)arg1 withNormalSize:(struct CGSize { double x1; double x2; })arg2 editingSize:(struct CGSize { double x1; double x2; })arg3 addCircleOverrides:(bool)arg4 makeRuleBlock:(id)arg5;
