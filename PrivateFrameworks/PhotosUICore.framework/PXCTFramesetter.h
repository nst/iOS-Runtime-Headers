...
- (void)dealloc;
- (id)frameWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 maximumLineCount:(unsigned int)arg2 allowTruncation:(BOOL)arg3;
