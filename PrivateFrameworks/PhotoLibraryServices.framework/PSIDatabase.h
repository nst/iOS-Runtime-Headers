...
- (unsigned int)_inqAddUUID:(id)arg1 string:(id)arg2 category:(short)arg3 owningGroupId:(unsigned int)arg4 isInBatch:(BOOL)arg5;
- (unsigned int)_inqAssetIdForUUID:(id)arg1 insertIfNeeded:(BOOL)arg2;
- (void)_inqAsync:(id /* block */)arg1;
- (id)_inqDequeueGroupObjectWithId:(unsigned int)arg1 isCachedGroup:(BOOL*)arg2;
...
- (unsigned int)_inqGroupIdForCategory:(short)arg1 owningGroupId:(unsigned int)arg2 contentString:(id)arg3 insertIfNeeded:(BOOL)arg4 tokenOutput:(const struct tokenOutput_t { id x1; id x2; struct { /* ? */ } x3; int x4; int x5; struct { /* ? */ } *x6; int x7; int x8; }*)arg5 shouldUpdateOwningGroupId:(BOOL)arg6;
- (struct __CFArray { }*)_inqNewAssetIdsForGroupId:(unsigned int)arg1;
- (struct __CFArray { }*)_inqNewAssetUUIDsForAssetIds:(const void**)arg1 count:(long)arg2;
- (id)_inqNewContentStringForGroupId:(unsigned int)arg1;
- (id)_inqNewGroupArraysFromGroupIdSets:(id)arg1 forQuery:(id)arg2;
- (struct __CFSet { }*)_inqNewGroupIdsForAssetId:(unsigned int)arg1;
- (struct __CFSet { }*)_inqNewGroupIdsForDeleteOperationWithMatchingGroupIds:(const void**)arg1 count:(long)arg2;
- (struct __CFSet { }*)_inqNewGroupIdsMatchingToken:(id)arg1;
- (id)_inqNewGroupsWithMatchingGroupIds:(const void**)arg1 count:(long)arg2 matchingPredicateBlock:(id /* block */)arg3;
...
- (void)_inqUpdateGATableWithGroupId:(unsigned int)arg1 assetId:(unsigned int)arg2;
- (unsigned int)_inqUpdateGroupAndPrefixTreeForString:(id)arg1 category:(short)arg2 owningGroupId:(unsigned int)arg3;
- (unsigned int)_inqUpdateGroupAndPrefixTreeForString:(id)arg1 category:(short)arg2 owningGroupId:(unsigned int)arg3 shouldUpdateOwningGroupId:(BOOL)arg4;
- (void)_inqUpdatePrefixTreeWithGroupId:(unsigned int)arg1 text:(id)arg2;
