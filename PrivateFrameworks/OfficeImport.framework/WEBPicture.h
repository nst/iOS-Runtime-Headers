...
@interface WEBPicture : WDRun 
{
  ...
  /* Error parsing encoded ivar type info: ^{WrdPictureProperties=^^?^^?iiii^{WrdBorder}^{WrdBorder}^{WrdBorder}^{WrdBorder}{CsPoint<short int>="m_data"[2s]}{CsSize<short int>="m_data"[2s]}{CsSize<short int>="m_data"[2s]}i[4s]sS[2S]($_194="m_metafileBounds"[4s]"m_bitmapHeader"{$_195="m_bitsPerPixel"s})BBBB} */
    struct WrdPictureProperties { int (**x1)(); int (**x2)(); NSInteger x3; NSInteger x4; NSInteger x5; NSInteger x6; struct WrdBorder {} *x7; struct WrdBorder {} *x8; struct WrdBorder {} *x9; struct WrdBorder {} *x10; struct CsPoint<short int> { 
            ...
            short m_data[2]; 
        } x13; NSInteger x14; short x15[4]; short x16; unsigned short x17; unsigned short x18[2]; union $_194 { 
...
- (void)dealloc;
- (struct WrdPictureProperties { int (**x1)(); int (**x2)(); NSInteger x3; NSInteger x4; NSInteger x5; NSInteger x6; struct WrdBorder {} *x7; struct WrdBorder {} *x8; struct WrdBorder {} *x9; struct WrdBorder {} *x10; struct CsPoint<short int> { short x_11_1_1[2]; } x11; struct CsSize<short int> { short x_12_1_1[2]; } x12; struct CsSize<short int> { short x_13_1_1[2]; } x13; NSInteger x14; short x15[4]; short x16; unsigned short x17; unsigned short x18[2]; union $_194 { short x_19_1_1[4]; struct $_195 { short x_2_2_1; } x_19_1_2; } x19; /* Warning: Unrecognized filer type: 'B' using 'void*' */ void*x20; void*x21; void*x22; void*x23; }*)pictureProperties;
     /* Encoded args for previous method: ^{WrdPictureProperties=^^?^^?iiii^{WrdBorder}^{WrdBorder}^{WrdBorder}^{WrdBorder}{CsPoint<short int>=[2s]}{CsSize<short int>=[2s]}{CsSize<short int>=[2s]}i[4s]sS[2S]($_194=[4s]{$_195=s})BBBB}8@0:4 */
