...
+ (id)calloutWithCornerRadius:(float)arg1 tailPosition:(struct CGPoint { double x1; double x2; })arg2 tailSize:(float)arg3 naturalSize:(struct CGSize { double x1; double x2; })arg4;
+ (id)quoteBubbleWithTailPosition:(struct CGPoint { double x1; double x2; })arg1 tailSize:(float)arg2 naturalSize:(struct CGSize { double x1; double x2; })arg3;
...
- (id)initWithCornerRadius:(float)arg1 tailPosition:(struct CGPoint { double x1; double x2; })arg2 tailSize:(float)arg3 naturalSize:(struct CGSize { double x1; double x2; })arg4 tailAtCenter:(BOOL)arg5;
- (id)interiorWrapPath;
- (BOOL)isCircular;
...
- (void)p_getTailPath:(id)arg1 center:(struct CGPoint { double x1; double x2; }*)arg2 tailSize:(float*)arg3 intersections:(struct CGPoint { double x1; double x2; })arg4;
