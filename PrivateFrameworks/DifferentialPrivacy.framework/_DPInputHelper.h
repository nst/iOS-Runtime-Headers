...
- (id)nonEmptyStringsFromFileAtPath:(id)arg1 encoding:(unsigned int)arg2;
- (id)nonEmptyStringsFromFileAtPath:(id)arg1 separatedBy:(id)arg2 encoding:(unsigned int)arg3;
