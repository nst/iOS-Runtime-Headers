...
- (struct CGSize { double x1; double x2; })contentOffsetForSegment:(unsigned int)arg1;
- (struct CGSize { double x1; double x2; })contentOffsetForSegmentAtIndex:(unsigned int)arg1;
- (struct UIOffset { double x1; double x2; })contentPositionAdjustmentForSegmentType:(int)arg1 barMetrics:(int)arg2;
- (int)controlSize;
- (void)dealloc;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withStyle:(int)arg2 withItems:(id)arg3;
...
- (void)setContentOffset:(struct CGSize { double x1; double x2; })arg1 forSegment:(unsigned int)arg2;
- (void)setContentOffset:(struct CGSize { double x1; double x2; })arg1 forSegmentAtIndex:(unsigned int)arg2;
- (void)setContentPositionAdjustment:(struct UIOffset { double x1; double x2; })arg1 forSegmentType:(int)arg2 barMetrics:(int)arg3;
...
- (void)setImagePadding:(struct CGSize { double x1; double x2; })arg1 forSegment:(unsigned int)arg2;
