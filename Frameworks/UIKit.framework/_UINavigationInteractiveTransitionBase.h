...
@class <_UINavigationInteractiveTransitionBaseDelegate>, CADisplayLink, UIGestureRecognizer, UIPanGestureRecognizer, UIView, UIViewController, _UINavigationParallaxTransition;
