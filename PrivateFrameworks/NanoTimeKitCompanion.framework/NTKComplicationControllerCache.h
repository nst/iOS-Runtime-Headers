...
- (id)controllerForComplication:(id)arg1 family:(long long)arg2 face:(id)arg3 create:(id)arg4;
- (void)dealloc;
...
- (id)init;
- (id)legacyControllerForComplication:(id)arg1 face:(id)arg2 slot:(id)arg3 create:(id)arg4;
