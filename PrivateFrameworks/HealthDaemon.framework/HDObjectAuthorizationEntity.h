...
+ (BOOL)_insertCodableObjectAuthorizations:(id)arg1 syncProvenance:(int)arg2 profile:(id)arg3 error:(id*)arg4;
+ (BOOL)_setObjectAuthorizationRecords:(id)arg1 syncProvenance:(int)arg2 skipErrors:(BOOL)arg3 profile:(id)arg4 error:(id*)arg5;
...
+ (BOOL)setObjectAuthorizationRecords:(id)arg1 syncProvenance:(int)arg2 profile:(id)arg3 error:(id*)arg4;
+ (id)uniquedColumns;
