...
@interface PUOneUpPresentationHelper : NSObject <PUPhotosPreviewPresentationControllerDelegate, PUPinchedTileTrackerDelegate, PUTilingViewControllerTransitionEndPoint, PUTilingViewTileSource, PUTilingViewTileTransitionDelegate, PUTilingViewTileUseDelegate, UIGestureRecognizerDelegate> {
    ...
    id  __browsingSessionCreationBlock;
...
@property (nonatomic, readonly, copy) id _browsingSessionCreationBlock;
...
- (bool)_handleInteractivePresentationWithBlock:(id)arg1;
...
- (void)_presentOneUpViewController:(id)arg1 animated:(bool)arg2 interactiveMode:(long long)arg3 completion:(id)arg4;
...
- (void)cancelCommitTransitionForPreviewViewController:(id)arg1 completion:(id)arg2;
...
- (id)init;
- (id)initWithBrowsingSessionCreationBlock:(id)arg1;
