...
@class <MKMapViewDelegate><MKMapViewDelegatePrivate>, MKAnnotationContainerView, MKAttributionLabel, MKMapGestureController, MKMapView, MKMapViewPositioningChange, MKOverlayContainerView, MKVariableDelayTapRecognizer, NSTimer, UIEvent, UIGestureRecognizer, UIImageView, UILabel, UILongPressGestureRecognizer, UITapGestureRecognizer, UITouch, UIView, VKMapView;
