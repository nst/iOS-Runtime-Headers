...
- (id)context;
- (id)fetchClassificationWithCompletion:(id)arg1;
- (id)fetchContentWithCompletion:(id)arg1;
- (id)fetchHeadlineWithCompletion:(id)arg1;
- (id)fetchThumbnailWithCompletion:(id)arg1;
- (id)headline;
