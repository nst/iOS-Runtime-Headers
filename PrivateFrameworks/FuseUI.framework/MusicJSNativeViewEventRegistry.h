...
- (void)_dispatchNativeViewEventOfType:(long long)arg1 withExtraInfo:(id)arg2 forJSNativeViewController:(id)arg3 appContext:(id)arg4 jsContext:(id)arg5 completion:(id)arg6;
...
- (void)dispatchNativeViewEventOfType:(long long)arg1 withExtraInfo:(id)arg2 forViewController:(id)arg3 completion:(id)arg4;
...
- (void)requestAccessToJSNativeViewControllerForViewController:(id)arg1 usingBlock:(id)arg2;
