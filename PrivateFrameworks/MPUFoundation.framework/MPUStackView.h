...
@property struct CGSize { double x1; double x2; } baseSize;
...
@property struct UIOffset { double x1; double x2; } maximumRelativeOffsetStep;
@property(readonly) long long numberOfItems;
@property UIView * perspectiveTargetView;
@property struct CGSize { double x1; double x2; } sizeInsetStep;
