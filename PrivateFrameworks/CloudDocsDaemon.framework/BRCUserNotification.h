...
- (void).cxx_destruct;
- (void)_displayDialogWithType:(unsigned long)arg1 dict:(id)arg2 options:(id)arg3 userReplyBlock:(id)arg4;
- (void)_displayDialogWithType:(unsigned long)arg1 dict:(id)arg2 userReplyBlock:(id)arg3;
...
- (void)_updateDialogWithType:(unsigned long)arg1 dict:(id)arg2 userReplyBlock:(id)arg3;
- (void)close;
- (void)dealloc;
- (id)init;
