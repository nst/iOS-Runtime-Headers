...
@property(retain) HDLastIntervalInfo * lastIntervalInfo;
@property(retain) HKStatistics * lastStatistics;
...
- (id)_mergedSumsForStartDate:(id)arg1 endDate:(id)arg2 predicate:(id)arg3 orderedSourceIds:(id)arg4 unit:(id)arg5 bySource:(id)arg6 dataCount:(unsigned int*)arg7 shouldStopProcessing:(id)arg8 database:(id)arg9;
