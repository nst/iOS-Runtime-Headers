...
- (void)overwriteAccessTimeForItemAtURL:(id)arg1 atime:(unsigned int)arg2 reply:(id /* block */)arg3;
...
- (void)purgeAmount:(int)arg1 withUrgency:(int)arg2 reply:(id /* block */)arg3;
- (void)readerThrottleBackoffForDocumentAtPath:(id)arg1 containerID:(id)arg2 reply:(id /* block */)arg3;
- (void)reclaimAmount:(int)arg1 withUrgency:(int)arg2 reply:(id /* block */)arg3;
