...
- (void)buildTrafficWithRoadData:(id)arg1 trafficMeshStyle:(const struct TrafficMeshStyle { int x1[4]; }*)arg2 addSegment:(id)arg3;
...
- (void)dealloc;
- (id)dynamicTiles;
- (void)enumerateTrafficRoadPiecesForTile:(id)arg1 usingFunction:(const struct function<void (const md::RoadPiece &)>={type=[24C] {}*)arg2;
- (id)incidents;
