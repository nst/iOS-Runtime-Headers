...
- (void)_sendMessage:(int)arg1 withPurchaseIdentifiers:(id)arg2 afterPurchase:(id)arg3 completionBlock:(id /* block */)arg4;
- (void)_sendMessage:(int)arg1 withPurchases:(id)arg2 afterPurchase:(id)arg3 completionBlock:(id /* block */)arg4;
