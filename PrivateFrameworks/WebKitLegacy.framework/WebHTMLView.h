...
- (unsigned int)characterIndexForPoint:(struct CGPoint { double x1; double x2; })arg1;
- (void)clearFocus;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })firstRectForCharacterRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1;
- (BOOL)hasMarkedText;
