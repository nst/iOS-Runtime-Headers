...
- (void)observer:(void *)arg1 prepareAttachment:(void *)arg2 beforeDeliveringBulletin:(void *)arg3 withCompletionHandler:(void *)arg4; // needs 4 arg types, found 9: BBObserver *, BBAttachmentMetadata *, BBBulletin *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, unsigned int, void*
