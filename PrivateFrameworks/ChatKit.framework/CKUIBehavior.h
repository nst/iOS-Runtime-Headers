...
@property(readonly) double checkmarkHorizontalPadding;
@property(readonly) UIImage * chevronImage;
@property(readonly) unsigned long long commonRepliesLoadLimit;
@property(readonly) UIFont * contactAttachmentNameFont;
@property(readonly) UIFont * contactAttachmentOrgFont;
@property(readonly) double contactBalloonHeight;
@property(readonly) double contactBalloonInnerItemSpacing;
@property(readonly) double contactBalloonMinWidth;
@property(readonly) double contactBalloonNameOrgSpacing;
@property(readonly) double contactBalloonOrgBottomSpacing;
@property(readonly) double contactBalloonTopNameSpacing;
@property(readonly) Class contactBalloonViewClass;
@property(readonly) struct CGSize { double x1; double x2; } contactImageSize;
...
@property(readonly) double conversationListCellBackgroundPadding;
@property(readonly) double conversationListCellLeftMargin;
@property(readonly) unsigned long long conversationListCellMaxSummaryLength;
@property(readonly) double conversationListCellRightMargin;
@property(readonly) unsigned long long conversationListCellSummaryNumberOfLines;
...
@property(readonly) double emojiPreviewMaxWidth;
...
@property(readonly) double nanoNoteSenderContentSpace;
...
@property(readonly) long long playButtonBackdropStyle;
...
@property(readonly) double statusButtonCharge;
...
@property(readonly) double summaryDateConversationListSpace;
...
@property(readonly) long long transcriptLoadingIndicatorStyle;
