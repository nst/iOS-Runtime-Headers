...
@class CALayer, DOMHTMLElement, DOMNode, DOMNode<UIFormControl>, NSMutableArray, NSMutableSet, NSTimer, UIAutoscrollTimer, UIInformalDelegate, UIModalView, UITextInputTraits, UITextLoupe, UIView, WebPDFView, WebView, WebViewReachabilityObserver;
