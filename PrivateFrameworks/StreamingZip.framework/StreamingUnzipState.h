...
@interface StreamingUnzipState : NSObject {
    unsigned int  _bytesHashedInChunk;
    struct { 
        char *dst_ptr; 
    ...
    struct { unsigned char x1[4]; union { struct { struct { unsigned int x_1_3_1; } x_1_2_1; struct { unsigned int x_2_3_1; } x_1_2_2; struct { unsigned int x_3_3_1; } x_1_2_3; } x_2_1_1; struct { struct { unsigned int x_1_3_1; } x_2_2_1; struct { unsigned int x_2_3_1; } x_2_2_2; struct { unsigned int x_3_3_1; } x_2_2_3; } x_2_1_2; } x2; } * _dataDescriptor;
    ...
    unsigned int  _hashedChunkSize;
    NSArray * _hashes;
    NSMutableData * _inMemoryFileData;
    NSString * _lastChunkPartialHash;
    unsigned int  _lastResumptionSavedOffset;
    unsigned int  _recordsProcessed;
    BOOL  _storeCurrentFileInMemory;
    NSDictionary * _streamInfoDict;
    unsigned char  _streamState;
    unsigned int  _thisStageBytesComplete;
    unsigned int  _totalFileSizeWritten;
    unsigned int  _totalRecordCount;
    unsigned int  _totalUncompressedBytes;
    unsigned int  _uncompressedBytesOutput;
    NSMutableData * _unsureData;
    NSString * _unzipPath;
}

@property (nonatomic, readonly) unsigned int bytesHashedInChunk;
@property (nonatomic, readonly) struct { char *x1; unsigned int x2; char *x3; unsigned int x4; void *x5; }*cmpState;
...
@property (nonatomic) unsigned int thisStageBytesComplete;
@property (nonatomic) unsigned int totalFileSizeWritten;
@property (nonatomic) unsigned int totalRecordCount;
@property (nonatomic) unsigned int totalUncompressedBytes;
@property (nonatomic) unsigned int uncompressedBytesOutput;
...
- (void).cxx_destruct;
- (id)_checkHashForOffset:(unsigned int)arg1;
- (void)_internalSetStreamState:(unsigned char)arg1;
- (unsigned int)bytesHashedInChunk;
- (id)checkLastChunkPartialHash;
- (void)clearSavedState;
- (struct { char *x1; unsigned int x2; char *x3; unsigned int x4; void *x5; }*)cmpState;
...
- (int)currentOutputFD;
- (struct { unsigned char x1[4]; union { struct { struct { unsigned int x_1_3_1; } x_1_2_1; struct { unsigned int x_2_3_1; } x_1_2_2; struct { unsigned int x_3_3_1; } x_1_2_3; } x_2_1_1; struct { struct { unsigned int x_1_3_1; } x_2_2_1; struct { unsigned int x_2_3_1; } x_2_2_2; struct { unsigned int x_3_3_1; } x_2_2_3; } x_2_1_2; } x2; }*)dataDescriptor;
- (void)dealloc;
- (BOOL)denyInvalidSymlinks;
- (id)finishStream;
- (struct { int x1; union { struct CC_MD5state_st { unsigned int x_1_2_1; unsigned int x_1_2_2; unsigned int x_1_2_3; unsigned int x_1_2_4; unsigned int x_1_2_5; unsigned int x_1_2_6; unsigned int x_1_2_7[16]; int x_1_2_8; } x_2_1_1; struct CC_SHA1state_st { unsigned int x_2_2_1; unsigned int x_2_2_2; unsigned int x_2_2_3; unsigned int x_2_2_4; unsigned int x_2_2_5; unsigned int x_2_2_6; unsigned int x_2_2_7; unsigned int x_2_2_8[16]; int x_2_2_9; } x_2_1_2; struct CC_MD2state_st { int x_3_2_1; unsigned char x_3_2_2[16]; unsigned int x_3_2_3[16]; unsigned int x_3_2_4[16]; } x_2_1_3; struct CC_MD4state_st { unsigned int x_4_2_1; unsigned int x_4_2_2; unsigned int x_4_2_3; unsigned int x_4_2_4; unsigned int x_4_2_5; unsigned int x_4_2_6; unsigned int x_4_2_7[16]; unsigned int x_4_2_8; } x_2_1_4; struct CC_SHA256state_st { unsigned int x_5_2_1[2]; unsigned int x_5_2_2[8]; unsigned int x_5_2_3[16]; } x_2_1_5; struct CC_SHA256state_st { unsigned int x_6_2_1[2]; unsigned int x_6_2_2[8]; unsigned int x_6_2_3[16]; } x_2_1_6; struct CC_SHA512state_st { unsigned int x_7_2_1[2]; unsigned int x_7_2_2[8]; unsigned int x_7_2_3[16]; } x_2_1_7; } x2; })hashContext;
- (unsigned int)hashedChunkSize;
- (id)inMemoryFileData;
- (id)init;
...
- (void)setCurrentOffset:(unsigned int)arg1;
- (void)setCurrentOutputFD:(int)arg1;
- (void)setDataDescriptor:(struct { unsigned char x1[4]; union { struct { struct { unsigned int x_1_3_1; } x_1_2_1; struct { unsigned int x_2_3_1; } x_1_2_2; struct { unsigned int x_3_3_1; } x_1_2_3; } x_2_1_1; struct { struct { unsigned int x_1_3_1; } x_2_2_1; struct { unsigned int x_2_3_1; } x_2_2_2; struct { unsigned int x_3_3_1; } x_2_2_3; } x_2_1_2; } x2; }*)arg1;
- (void)setDenyInvalidSymlinks:(BOOL)arg1;
- (void)setInMemoryFileData:(id)arg1;
- (void)setLastChunkPartialHash:(id)arg1;
- (void)setRecordsProcessed:(unsigned int)arg1;
- (void)setStoreCurrentFileInMemory:(BOOL)arg1;
- (void)setStreamInfoDict:(id)arg1;
- (void)setStreamState:(unsigned char)arg1;
- (void)setThisStageBytesComplete:(unsigned int)arg1;
- (void)setTotalFileSizeWritten:(unsigned int)arg1;
- (void)setTotalRecordCount:(unsigned int)arg1;
- (void)setTotalUncompressedBytes:(unsigned int)arg1;
- (void)setUncompressedBytesOutput:(unsigned int)arg1;
- (void)setUnsureData:(id)arg1;
- (BOOL)storeCurrentFileInMemory;
- (id)streamInfoDict;
- (unsigned char)streamState;
- (unsigned int)thisStageBytesComplete;
- (unsigned int)totalFileSizeWritten;
- (unsigned int)totalRecordCount;
- (unsigned int)totalUncompressedBytes;
- (unsigned int)uncompressedBytesOutput;
- (id)unsureData;
- (id)unzipPath;
- (id)updateHashFromOffset:(unsigned int)arg1 withBytes:(const void*)arg2 length:(unsigned long)arg3;
- (id)updateHashFromOffset:(unsigned int)arg1 withBytes:(const void*)arg2 length:(unsigned long)arg3 onlyFinishCurrentChunk:(BOOL)arg4;
