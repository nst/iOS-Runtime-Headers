...
- (void).cxx_destruct;
- (void)_didObtainCoordination:(id)arg1 context:(id)arg2 url1:(id)arg3 url2:(id)arg4 handler:(id)arg5 fcHandler:(id)arg6 error:(id)arg7;
- (void)_willRequestCoordinationWithContext:(id)arg1 url1:(id)arg2 url2:(id)arg3;
- (void)cancel;
- (void)cancelAfterDelay:(double)arg1;
- (bool)forRead;
- (id)initWithSession:(id)arg1 forRead:(bool)arg2 doneHandler:(id)arg3;
- (bool)isUpdateForReconnecting;
- (void)scheduleDeleteOfItemAtURL:(id)arg1 queue:(id)arg2 taskTracker:(id)arg3 accessor:(id)arg4;
- (void)scheduleReadOfItemAtURL:(id)arg1 queue:(id)arg2 taskTracker:(id)arg3 accessor:(id)arg4;
- (void)scheduleRenameOfItemAtURL:(id)arg1 toItemAtURL:(id)arg2 contentUpdate:(bool)arg3 queue:(id)arg4 taskTracker:(id)arg5 accessor:(id)arg6;
- (void)scheduleUpdateOfItemAtURL:(id)arg1 queue:(id)arg2 taskTracker:(id)arg3 accessor:(id)arg4;
