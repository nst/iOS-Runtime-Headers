...
- (void)URLSession:(void *)arg1 dataTask:(void *)arg2 didReceiveResponse:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: NSURLSession *, NSURLSessionDataTask *, NSURLResponse *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, void*
...
- (void)URLSession:(void *)arg1 task:(void *)arg2 didReceiveChallenge:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 10: NSURLSession *, NSURLSessionTask *, NSURLAuthenticationChallenge *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSURLCredential *, void*
- (void)URLSession:(NSURLSession *)arg1 task:(NSURLSessionTask *)arg2 didSendBodyData:(int)arg3 totalBytesSent:(int)arg4 totalBytesExpectedToSend:(int)arg5;
