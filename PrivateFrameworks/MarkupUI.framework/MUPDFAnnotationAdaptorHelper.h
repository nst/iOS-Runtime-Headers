...
+ (float)_pointSizeFromAppearanceTokens:(id)arg1;
...
+ (void)migrateAppearanceStreamFromCGPDFAnnotationDict:(struct CGPDFDictionary { }*)arg1 toAKAnnotation:(id)arg2 compensatingForPageRotation:(unsigned int)arg3;
