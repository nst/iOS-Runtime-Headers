...
- (void)_fetchAppConfigurationForStoreFrontID:(id)arg1 cachePolicy:(unsigned long long)arg2 refreshRate:(double)arg3 completionQueue:(id)arg4 completion:(id)arg5;
- (void)_fetchTrendingSearchesForStoreFrontID:(id)arg1 cachePolicy:(unsigned long long)arg2 completionQueue:(id)arg3 completion:(id)arg4;
...
- (id)accessQueue;
- (void)addChangeObservationBlock:(id)arg1;
...
- (void)fetchAppConfigurationIfNeededWithCompletion:(id)arg1;
- (void)fetchAppConfigurationIfNeededWithCompletionQueue:(id)arg1 completion:(id)arg2;
- (void)fetchAppConfigurationIfNeededWithCompletionQueue:(id)arg1 force:(bool)arg2 completion:(id)arg3;
- (void)fetchTrendingSearchesIfNeededWithCompletion:(id)arg1;
