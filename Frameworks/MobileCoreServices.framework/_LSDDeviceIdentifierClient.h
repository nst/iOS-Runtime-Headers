...
- (void)getClientProcessVendorNameAndBundleIdentifierWithCompletionHandler:(id)arg1;
- (void)getIdentifierOfType:(long long)arg1 completionHandler:(id)arg2;
- (void)getIdentifierOfType:(long long)arg1 vendorName:(id)arg2 bundleIdentifier:(id)arg3 completionHandler:(id)arg4;
