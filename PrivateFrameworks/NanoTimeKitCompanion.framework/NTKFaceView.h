...
- (void)_enableCrown;
- (void)_endScrubbingAnimated:(bool)arg1 withCompletion:(id)arg2;
...
- (void)_performSuppressingLayoutOnGeometryChange:(id)arg1;
...
- (void)_startScrubbingAnimated:(bool)arg1 withCompletion:(id)arg2;
...
- (void)endScrubbingAnimated:(bool)arg1 withCompletion:(id)arg2;
- (void)enumerateComplicationDisplayWrappersWithBlock:(id)arg1;
- (long long)faceStyle;
...
- (void)startScrubbingAnimated:(bool)arg1 withCompletion:(id)arg2;
