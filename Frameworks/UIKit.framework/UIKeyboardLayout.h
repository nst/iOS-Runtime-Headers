...
- (void)_notifyLayoutOfGesturePosition:(struct CGPoint { double x1; double x2; })arg1 relativeToEdge:(unsigned int)arg2;
...
- (struct CGPoint { double x1; double x2; })_uikbrtTouchDrifting:(id)arg1 touchCenterForFingerID:(unsigned int)arg2;
...
- (void)_updateTouchState:(id)arg1 errorVector:(struct CGPoint { double x1; double x2; })arg2 rowOffsetFromHomeRow:(int)arg3;
...
- (BOOL)handRestRecognizerShouldNeverIgnoreTouchState:(id)arg1 fromPoint:(struct CGPoint { double x1; double x2; })arg2 toPoint:(struct CGPoint { double x1; double x2; })arg3 forRestingState:(unsigned int)arg4 otherRestedTouchLocations:(id)arg5;
...
- (BOOL)queryShouldNeverIgnoreTouchStateWithIdentifier:(id)arg1 touchState:(id)arg2 startPoint:(struct CGPoint { double x1; double x2; })arg3 forRestingState:(unsigned int)arg4;
- (void)recognizer:(id)arg1 beginTouchDownForTouchWithId:(id)arg2 atPoint:(struct CGPoint { double x1; double x2; })arg3 forBeginState:(unsigned int)arg4 whenStateReady:(id /* block */)arg5;
...
- (void)recognizer:(id)arg1 shouldContinueTrackingTouchWithId:(id)arg2 startingAt:(double)arg3 atPoint:(struct CGPoint { double x1; double x2; })arg4 currentPoint:(struct CGPoint { double x1; double x2; })arg5 forContinueState:(unsigned int)arg6 whenStateReady:(id /* block */)arg7;
