...
- (long long)addReferenceForContext:(id)arg1 usingDatabase:(struct sqlite3 { }*)arg2 mergeHandler:(id)arg3;
...
- (void)checkDataConsistencyWithFailure:(id)arg1;
...
- (void)iterateMessagesMatchingCriterion:(id)arg1 options:(unsigned int)arg2 handler:(id)arg3;
...
- (id)updateFlagsForMessages:(id)arg1 changes:(id)arg2 transformer:(id)arg3;
