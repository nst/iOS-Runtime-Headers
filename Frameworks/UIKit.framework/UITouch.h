...
@property (setter=_setSenderID:, nonatomic) unsigned int _senderID;
...
@property (setter=_setZGradient:, nonatomic) double _zGradient;
...
- (void)_setSenderID:(unsigned int)arg1;
