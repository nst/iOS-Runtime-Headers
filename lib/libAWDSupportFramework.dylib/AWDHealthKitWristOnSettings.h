...
@property (nonatomic, retain) AWDHealthKitAchievementStatistics *achievementStatistics;
...
@property (nonatomic, retain) AWDHealthKitConcurrentCalendarItem *firstCalendarItemOfDay;
...
@property (nonatomic, retain) AWDHealthKitUserCharacteristics *userCharacteristics;
