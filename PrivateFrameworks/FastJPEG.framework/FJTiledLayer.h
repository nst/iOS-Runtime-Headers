/* Generated by RuntimeBrowser
   Image: /System/Library/PrivateFrameworks/FastJPEG.framework/FastJPEG
 */

@class <FJTileProcessor>, CALayer, FJCache, NSData, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>;
...
@interface FJTiledLayer : CALayer {
    ...
    int _decoderCount;
    struct jpegDecoder { struct ffjdec {} *x1; id x2; } *_decoders;
    long _err;
...
@property <FJTileProcessor> * tileProcessor;
