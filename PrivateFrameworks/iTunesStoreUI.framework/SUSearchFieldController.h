...
@class <SUSearchFieldControllerDelegate>, SUCompletionTableViewController, SUKeyboardBackstopViewController, SUSearchFieldConfiguration, UIPopoverController, UISearchField;
