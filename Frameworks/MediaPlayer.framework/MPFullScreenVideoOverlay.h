...
@class <MPVideoOverlayDelegate>, MPAVItem, MPDetailSlider, MPNowPlayingItemQueueInfoButton, MPTransportControls, MPVideoViewController, UIImageView, UILabel, UINavigationBar, UINavigationButton, UINavigationItem, UIView;
