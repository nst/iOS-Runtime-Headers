...
@class <SUScriptInterfaceDelegate>, NSMutableDictionary, NSURL, SUScriptAccountManager, SUScriptMediaLibrary, SUScriptNotificationObserver, SUScriptOperationDelegate, SUScriptWindowContext, WebScriptObject;
