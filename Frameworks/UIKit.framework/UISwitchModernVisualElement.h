...
- (void)_handlePanWithGestureLocationInBounds:(struct CGPoint { double x1; double x2; })arg1 horizontalTranslation:(double)arg2 gestureState:(long long)arg3 resetPanTranslationBlock:(id)arg4;
