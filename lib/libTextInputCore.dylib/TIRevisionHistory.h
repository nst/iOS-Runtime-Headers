...
- (id)documentState;
- (id)documentText;
- (void)enumerateSentenceStemUsingBlock:(id)arg1;
- (void)enumerateSentenceStemUsingIteratorBlock:(id)arg1;
...
- (void)rejectToken:(id)arg1 withContext:(const struct TITokenID { unsigned int x1; unsigned int x2; }*)arg2 contextLength:(unsigned long long)arg3;
- (void)rejectTokensInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)replaceSelectionWithText:(id)arg1 selectedTokenReplacementHandler:(id)arg2;
...
- (id)tokenization;
- (unsigned long long)tokenizeDocumentTextInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withTokenHandler:(id)arg2;
- (void*)tokenizer;
