...
- (void)enumerateRealSectionsForVisualSection:(void *)arg1 usingBlock:(void *)arg2; // needs 2 arg types, found 8: long long, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, unsigned long long, bool*, void*
