...
@class <PLAlbumsControllerDelegate>, MLPhoto, MLPhotoAlbum, NSData, NSTimer, PLAlbumScrollView, PLAlbumView, PLCropOverlay, PLEmptyAlbumView, PLImageTileView, PLMobileMeHelper, PLPhotoScrollerViewController, PLProgressView, PLPublishingAgent, PLToolbar, PLVideoRemaker, UIActionSheet, UILongPressGestureRecognizer, UIModalView, UINavigationController, UIProgressHUD, UITransitionView, UIView, UIWindow;
