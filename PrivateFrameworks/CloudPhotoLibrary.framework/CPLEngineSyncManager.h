...
- (id)task:(id)arg1 wantsToCheckRecordsExistence:(id)arg2 fetchRecordProperties:(id)arg3 withCompletionHandler:(id)arg4;
- (id)task:(id)arg1 wantsToDownloadBatchesFromSyncAnchor:(id)arg2 progressHandler:(id)arg3 completionHandler:(id)arg4;
- (id)task:(id)arg1 wantsToPushBatch:(id)arg2 progressBlock:(id)arg3 continuationBlock:(id)arg4;
- (id)task:(id)arg1 wantsToQueryTaskForCursor:(id)arg2 class:(Class)arg3 progressHandler:(id)arg4 completionHandler:(id)arg5;
