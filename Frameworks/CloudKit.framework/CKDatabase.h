...
- (void)clearCacheEntriesForRecord:(id)arg1 completionHandler:(id)arg2;
- (void)clearCacheEntriesForZone:(id)arg1 completionHandler:(id)arg2;
- (void)clearCachesWithOptions:(unsigned long long)arg1 completionHandler:(id)arg2;
