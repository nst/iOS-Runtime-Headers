...
- (void)requestSeekToTime:(double)arg1 currentTime:(double)arg2 completion:(id)arg3;
...
- (void)shouldChangeToMediaAtIndex:(unsigned long long)arg1 completion:(id)arg2;
- (bool)shouldHandleStateEvent:(id)arg1;
- (void)shouldHandleStateEvent:(id)arg1 completion:(id)arg2;
- (long long)state;
