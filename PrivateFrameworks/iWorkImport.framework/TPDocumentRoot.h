...
+ (struct CGSize { double x1; double x2; })pageSizeFromPaperSize:(struct CGSize { double x1; double x2; })arg1 pageScale:(float)arg2 orientation:(unsigned int)arg3;
...
- (void)pUpgradeSection:(id)arg1 documentVersion:(unsigned int)arg2;
...
- (void)upgradeFromOldSectionWithPageSize:(struct CGSize { double x1; double x2; })arg1 leftMargin:(float)arg2 rightMargin:(float)arg3 topMargin:(float)arg4 bottomMargin:(float)arg5 headerMargin:(float)arg6 footerMargin:(float)arg7;
- (BOOL)useLigatures;
