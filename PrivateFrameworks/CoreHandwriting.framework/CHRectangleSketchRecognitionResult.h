...
- (id)initWithString:(id)arg1 score:(double)arg2 rotation:(float)arg3 upperLeftPoint:(struct CGPoint { double x1; double x2; })arg4 upperRightPoint:(struct CGPoint { double x1; double x2; })arg5 lowerLeftPoint:(struct CGPoint { double x1; double x2; })arg6 lowerRightPoint:(struct CGPoint { double x1; double x2; })arg7;
