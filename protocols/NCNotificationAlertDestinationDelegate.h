...
- (void)destination:(void *)arg1 didBecomeReadyToReceiveNotificationsPassingTest:(void *)arg2; // needs 2 arg types, found 7: <NCNotificationDestination> *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, bool, id, NCNotificationRequest *, void*
