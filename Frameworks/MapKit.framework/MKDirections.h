...
- (void).cxx_destruct;
- (void)_calculateETAWithTraits:(id)arg1 completionHandler:(id)arg2;
- (void)_cleanupLocationOperation;
- (void)_establishCurrentLocationAndThen:(id)arg1;
- (void)_performWithValidCurrentLocationAndWaypointsForQuickETA:(bool)arg1 traits:(id)arg2 handler:(id)arg3;
