...
@property (nonatomic) struct { int x1; int x2; unsigned int x3; int x4; } activeVideoMaxFrameDuration;
@property (nonatomic) struct { int x1; int x2; unsigned int x3; int x4; } activeVideoMinFrameDuration;
