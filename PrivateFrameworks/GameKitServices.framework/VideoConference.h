...
@class CALayer, CameraRemoteFrameSynchronizer, GKNATObserver, NSArray, NSLock, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<VideoConferenceChannelQualityDelegate>, NSObject<VideoConferenceDelegate>, NSObject<VideoConferenceRealTimeChannel>, NSObject<VideoConferenceSpeakingDelegate>, NSString, VCCallSession, VCVideoRule, VideoAttributes, VideoConferenceManager;
