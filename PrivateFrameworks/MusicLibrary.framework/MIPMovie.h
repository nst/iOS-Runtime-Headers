...
@interface MIPMovie : PBCodable <NSCopying> {
    ...
    BOOL  _rental;
    int  _rentalDuration;
    int  _rentalPlaybackDuration;
    int  _rentalPlaybackStartedDateTime;
    int  _rentalStartedDateTime;
...
@property (nonatomic) int rentalDuration;
@property (nonatomic) int rentalPlaybackDuration;
@property (nonatomic) int rentalPlaybackStartedDateTime;
@property (nonatomic) int rentalStartedDateTime;
...
- (BOOL)rental;
- (int)rentalDuration;
- (int)rentalPlaybackDuration;
- (int)rentalPlaybackStartedDateTime;
- (int)rentalStartedDateTime;
...
- (void)setRentalDuration:(int)arg1;
- (void)setRentalPlaybackDuration:(int)arg1;
- (void)setRentalPlaybackStartedDateTime:(int)arg1;
- (void)setRentalStartedDateTime:(int)arg1;
