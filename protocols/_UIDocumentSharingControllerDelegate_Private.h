...
- (void)_documentSharingControllerPerformAuxiliaryAction:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 6: UIDocumentSharingController *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
