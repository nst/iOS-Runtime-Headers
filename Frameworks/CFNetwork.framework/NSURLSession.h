...
- (void)delegate_AVAssetDownloadTask:(id)arg1 didFinishDownloadingToURL:(id)arg2 completionHandler:(id)arg3;
...
- (void)_safari_downloadFirstValidImageWithURLs:(id)arg1 failedURLDownloadsToErrorsDictionary:(id)arg2 completionHandler:(id)arg3;
- (void)safari_downloadFirstValidImageWithURLs:(id)arg1 completionHandler:(id)arg2;
- (void)safari_downloadImageWithURL:(id)arg1 completionHandler:(id)arg2;
