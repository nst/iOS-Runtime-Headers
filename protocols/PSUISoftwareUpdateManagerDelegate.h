...
- (void)manager:(void *)arg1 promptForDevicePasscodeWithCompletion:(void *)arg2; // needs 2 arg types, found 7: PSUISoftwareUpdateManager *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSString *, void*
