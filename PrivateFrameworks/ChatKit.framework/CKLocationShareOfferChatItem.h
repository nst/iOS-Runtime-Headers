...
- (id)_generateThumbnailFillToSize:(struct CGSize { double x1; double x2; })arg1 contentAlignmentInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2 withCoordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg3 forState:(int)arg4;
