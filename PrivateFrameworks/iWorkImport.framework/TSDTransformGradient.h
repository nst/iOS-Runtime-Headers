...
@property (nonatomic, readonly) struct CGSize { float x1; float x2; } baseNaturalSize;
...
- (void)p_setBaseNaturalSize:(struct CGSize { float x1; float x2; })arg1;
- (void)p_setDefaultValues;
- (void)p_setEndPoint:(struct CGPoint { float x1; float x2; })arg1;
- (void)p_setStartPoint:(struct CGPoint { float x1; float x2; })arg1;
