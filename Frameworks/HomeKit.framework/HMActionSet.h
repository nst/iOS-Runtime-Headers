...
- (void).cxx_destruct;
- (void)_addAction:(id)arg1 completionHandler:(id)arg2;
...
- (void)_removeAction:(id)arg1 completionHandler:(id)arg2;
- (void)_unconfigure;
- (void)_updateAction:(id)arg1 changes:(id)arg2 completionHandler:(id)arg3;
