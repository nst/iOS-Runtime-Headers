...
+ (void)_drawIconInContext:(struct CGContext { }*)arg1 imageSize:(struct CGSize { double x1; double x2; })arg2 iconBase:(id)arg3 calendar:(id)arg4 dayNumberString:(id)arg5 dateNameBlock:(id)arg6 dateNameFormatType:(long long)arg7 format:(long long)arg8 showGrid:(bool)arg9;
...
+ (id)_iconImageWithFormat:(int)arg1 square:(bool)arg2 outline:(bool)arg3 drawBlock:(id)arg4;
