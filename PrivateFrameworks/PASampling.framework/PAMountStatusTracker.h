...
- (unsigned int)forEachMountBlockingThread:(unsigned int)arg1 withSanitizedPaths:(BOOL)arg2 betweenMachStartTime:(double)arg3 andEndTime:(double)arg4 runBlock:(id /* block */)arg5;
