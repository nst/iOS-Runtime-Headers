...
- (bool)_animateAlongsideTransitionInView:(id)arg1 systemCompletion:(bool)arg2 animation:(id)arg3 completion:(id)arg4;
...
- (bool)isRotating;
- (void)notifyWhenInteractionChangesUsingBlock:(id)arg1;
