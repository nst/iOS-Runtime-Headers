...
- (void)_setObscuredContentHiddenForScrubbing:(bool)arg1 animated:(bool)arg2 withCompletion:(id)arg3;
...
- (void)enumerateTickCollectionNodes:(id)arg1;
- (id)face;
- (id)faceCircleSprite;
- (id)faceColor;
- (void)forEachActiveVariant:(id)arg1;
- (id)handColor;
