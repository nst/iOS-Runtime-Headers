...
@property (nonatomic, readonly) struct CullingGridWithHeight { double x1[16]; } cullingGrid;
...
- (struct Box<float, 2> { struct Matrix<float, 2, 1> { double x_1_1_1[2]; } x1; struct Matrix<float, 2, 1> { double x_2_1_1[2]; } x2; })_shadowBounds;
- (float)alpha;
- (id)animation;
...
- (struct CullingGridWithHeight { double x1[16]; })cullingGrid;
- (void)dealloc;
...
- (BOOL)heightAtPoint:(const struct Matrix<float, 2, 1> { double x1[2]; }*)arg1 outZ:(float*)arg2;
