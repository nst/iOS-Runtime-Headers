...
@class <SKProductPageViewControllerDelegate>, <SKProductPageViewControllerDelegatePrivate>, NSDictionary, SKStorePageViewController, SUBarButtonItem, SUDialogManager, SUPreviewOverlayViewController, SUPurchaseManager;
