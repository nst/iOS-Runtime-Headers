...
@class <TSWPFootnoteHeightMeasurer>, <TSWPFootnoteMarkProvider>, <TSWPOffscreenColumn>, NSMutableArray, TSDBezierPath, TSDCanvas, TSDLayout, TSPObject<TSDHint>, TSWPLayoutManager;
