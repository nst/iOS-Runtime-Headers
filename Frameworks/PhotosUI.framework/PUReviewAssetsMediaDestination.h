...
- (int)_workImageVersionForContentEditingOutput:(id)arg1;
...
- (int)saveInternalEditsForAsset:(id)arg1 usingPhotoEditModel:(id)arg2 version:(int)arg3 livePhotoEditModel:(id)arg4 completionHandler:(id /* block */)arg5;
