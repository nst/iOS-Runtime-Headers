...
+ (void*)sectionSortKeyBytesForCharacters:(unsigned short*)arg1 count:(NSUInteger)arg2 getLength:(NSInteger*)arg3;
+ (unsigned char)languagePreferenceSortKeyPrefixForCharacters:(unsigned short*)arg1 count:(NSUInteger)arg2;
+ (unsigned short)indexBarBucketCharacterForSortKeyBytes:(void*)arg1 length:(NSInteger)arg2;
