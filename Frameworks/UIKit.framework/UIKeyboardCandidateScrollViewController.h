...
@class <UIKeyboardCandidateListDelegate>, <UIKeyboardCandidateScrollViewControllerDelegate>, NSArray, NSMutableDictionary, UIButton, UIKeyboardCandidatePadInlineFloatingBackgroundView, UIKeyboardCandidateScrollView, UIKeyboardCandidateScrollViewLayoutState;
