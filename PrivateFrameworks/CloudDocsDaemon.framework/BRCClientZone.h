...
@property (nonatomic, readonly) unsigned int currentRequestID;
...
@property (nonatomic, readonly) int lastInsertedRank;
...
- (void)_dumpRecursivePropertiesOfItemByRowID:(unsigned int)arg1 context:(id)arg2 depth:(int)arg3;
...
- (void)didApplyTombstoneForRank:(int)arg1;
- (void)didClearOutOfQuota;
- (void)didGCTombstoneRanks:(id)arg1;
- (void)didSyncDownRequestID:(unsigned int)arg1 maxApplyRank:(int)arg2 caughtUpWithServer:(BOOL)arg3 syncDownDate:(id)arg4;
...
- (int)lastInsertedRank;
- (void)learnCKInfosFromSavedRecords:(id)arg1;
- (BOOL)needsSave;
- (void)networkReachabilityChanged:(BOOL)arg1;
- (unsigned int)nextSyncUpRequestID;
...
- (id)serverItemByRowID:(unsigned int)arg1;
- (id)serverItemByRowID:(unsigned int)arg1 db:(id)arg2;
- (int)serverRankByItemID:(id)arg1;
- (int)serverRankByItemID:(id)arg1 db:(id)arg2;
- (id)serverZone;
- (id)session;
