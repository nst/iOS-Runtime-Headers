...
+ (BOOL)adjustRanker:(id)arg1 forModel:(unsigned int)arg2;
...
+ (unsigned int)modelTypeForConsumerIdentifier:(id)arg1 modelSettings:(id)arg2;
+ (id)nameFromModelID:(unsigned int)arg1;
