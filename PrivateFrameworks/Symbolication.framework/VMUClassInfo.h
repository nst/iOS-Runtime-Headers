...
@property (readonly) unsigned int remoteIsa;
...
- (void)_setClassNameWithAddress:(unsigned int)arg1 reader:(id /* block */)arg2;
- (void)_setDefaultScanType:(unsigned int)arg1;
- (void)_setDisplayName:(id)arg1;
- (void)_setFields:(id)arg1;
- (void)_setIsa:(unsigned int)arg1;
...
- (void)enumerateExternalValuesFromObject:(unsigned int)arg1 withSize:(unsigned int)arg2 block:(id /* block */)arg3;
- (void)enumerateScanningLocationsForSize:(unsigned int)arg1 withBlock:(id /* block */)arg2;
- (void)enumerateStoredEntriesForObject:(unsigned int)arg1 ofSize:(unsigned int)arg2 externalValues:(id)arg3 block:(id /* block */)arg4;
