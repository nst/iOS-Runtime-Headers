...
- (id)_PCSServiceStringFromCKServiceType:(unsigned int)arg1;
- (id)_addIdentity:(struct _PCSIdentitySetData { }*)arg1 withService:(unsigned int)arg2 toPCS:(struct _OpaquePCSShareProtection { }*)arg3;
- (struct _OpaquePCSShareProtection { }*)_addPublicIdentityForService:(unsigned int)arg1 toSharePCS:(struct _OpaquePCSShareProtection { }*)arg2 withError:(id*)arg3;
...
- (struct _PCSIdentitySetData { }*)_copyServiceIdentityWithType:(unsigned int)arg1 useCache:(BOOL)arg2 withError:(id*)arg3;
- (struct _PCSIdentitySetData { }*)_copyServiceIdentityWithType:(unsigned int)arg1 withError:(id*)arg2;
...
- (id)addIdentityForService:(unsigned int)arg1 toPCS:(struct _OpaquePCSShareProtection { }*)arg2;
...
- (id)addSharingIdentity:(struct _PCSIdentityData { }*)arg1 toSharePCS:(struct _OpaquePCSShareProtection { }*)arg2 permission:(unsigned int)arg3;
- (BOOL)canDecryptInvitedProtectionData:(id)arg1 participantProtectionInfo:(id)arg2 serviceType:(unsigned int)arg3 error:(id*)arg4;
- (id)context;
- (id)contextObserver;
- (struct _PCSPublicIdentityData { }*)copyDiversifiedIdentityForService:(unsigned int)arg1 withError:(id*)arg2;
- (id)copyDiversifiedPublicKeyForService:(unsigned int)arg1 withError:(id*)arg2;
...
- (struct _OpaquePCSShareProtection { }*)createSharePCSForService:(unsigned int)arg1 withError:(id*)arg2;
...
- (struct _OpaquePCSShareProtection { }*)createSharePCSFromData:(id)arg1 withService:(unsigned int)arg2 error:(id*)arg3;
- (struct _OpaquePCSShareProtection { }*)createSharePCSFromData:(id)arg1 withService:(unsigned int)arg2 logFailure:(BOOL)arg3 error:(id*)arg4;
...
- (id)operationQueue;
- (id)pcsDataFromFetchedShare:(id)arg1 withServiceType:(unsigned int)arg2 error:(id*)arg3;
- (id)pcsUpdateSource;
