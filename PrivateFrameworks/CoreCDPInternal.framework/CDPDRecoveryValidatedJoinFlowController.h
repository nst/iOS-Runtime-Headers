...
- (unsigned int)_escapeOfferForDevices:(id)arg1 remoteApproval:(BOOL)arg2 forMultipleICSC:(BOOL)arg3;
...
- (void)_handleLimit:(unsigned int)arg1 forDevice:(id)arg2 completion:(id /* block */)arg3;
...
- (void)_showEntryLimitError:(id)arg1 withRecoveryOptionHandlers:(id)arg2 defaultIndex:(int)arg3 completion:(id /* block */)arg4;
- (id)_skipSignInRecoveryOptionWithCompletion:(id /* block */)arg1;
- (id)_softLimitErrorBodyForDevice:(id)arg1;
- (id)_userInfoForLimit:(unsigned int)arg1 withDevice:(id)arg2;
