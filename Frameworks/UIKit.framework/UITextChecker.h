...
- (struct _NSRange { unsigned int x1; unsigned int x2; })_chunkAndFindMisspelledWordInString:(id)arg1 languages:(id)arg2 learnedDictionaries:(id)arg3 wordCount:(int*)arg4 correction:(id*)arg5 usingChecker:(id)arg6;
- (BOOL)_doneLoading;
...
- (struct _NSRange { unsigned int x1; unsigned int x2; })checkSpellingOfString:(id)arg1 startingAt:(int)arg2 languages:(id)arg3 wrap:(BOOL)arg4 correction:(id*)arg5;
...
- (struct _NSRange { unsigned int x1; unsigned int x2; })rangeOfMisspelledWordInString:(id)arg1 range:(struct _NSRange { unsigned int x1; unsigned int x2; })arg2 startingAt:(int)arg3 wrap:(BOOL)arg4 languages:(id)arg5;
