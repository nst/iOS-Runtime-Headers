...
@interface GQHPagesState : GQHState <GQWrapPointGenerator> {
    ...
    struct CGSize { 
        double width; 
        double height; 
    boolmCurrentFrameHasSandbagFloats;
    boolmDidFindContainerHint;
    boolmDidInsertPageHeader;
    boolmHasLayoutDrawables;
    boolmIsMappingHeadersFooters;
    boolmMappingFloatingDrawables;
    boolmSplitNextAttachment;
    boolmStartedPage;
    boolmStartedSection;
