...
- (void)dealloc;
- (void)debugDump;
- (void)enumerateCellStoragesInRange:(struct TSUCellRect { struct TSUCellCoord { unsigned short x_1_1_1; unsigned char x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned short x_2_1_1; unsigned short x_2_1_2; } x2; })arg1 withBlock:(id)arg2;
...
- (void)enumerateTilesInRowRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 usingBlock:(id)arg2;
- (id)formatDataList;
- (id)formulaDataList;
