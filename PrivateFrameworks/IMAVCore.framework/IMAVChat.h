...
@class <IMAVChatDelegate>, <IMAVChatTheaterDelegate>, IMAVChatFeature, IMAVChatParticipant, IMAccount, IMHandle, IMPair, NSArray, NSData, NSDate, NSDictionary, NSError, NSMutableArray, NSMutableDictionary, NSNumber, NSString, NSTimer;
