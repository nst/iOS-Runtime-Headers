...
- (void)pictureInPictureProxy:(void *)arg1 restoreUserInterfaceForPictureInPictureStopWithCompletionHandler:(void *)arg2; // needs 2 arg types, found 7: PGPictureInPictureProxy *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
