...
- (id)createBatchesForChanges:(id)arg1 insertedPhotoCount:(unsigned int*)arg2 insertedVideoCount:(unsigned int*)arg3 totalSizeOfUnpushedOriginals:(unsigned int*)arg4;
- (id)createUploadBatchesForDeletionFromEvent:(id)arg1;
- (void)dealloc;
- (void)handleUploadBatchesForDeletionFromEvent:(id)arg1;
- (void)handleUploadBatchesFromEvent:(id)arg1 insertedPhotoCount:(unsigned int*)arg2 insertedVideoCount:(unsigned int*)arg3 totalSizeOfUnpushedOriginals:(unsigned int*)arg4 shouldTriggerPrefetch:(BOOL*)arg5;
- (BOOL)hasBatchesToUpload;
- (id)initWithLibrary:(id)arg1;
- (BOOL)initialUpload;
- (unsigned int)numberOfBatchesToUpload;
- (id)pop;
- (id)processCommitError:(id)arg1 andFinalizeError:(id)arg2 forUploadBatchContainer:(id)arg3 totalSizeOfUnpushedOriginals:(unsigned int*)arg4;
