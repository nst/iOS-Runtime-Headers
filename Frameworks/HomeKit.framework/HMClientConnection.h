...
- (void)_reportResultsTohandler:(id)arg1;
- (void)_start;
- (id)clientQueue;
- (void)dealloc;
- (id)init;
...
- (id)msgDispatcher;
- (void)requestSiriSyncDataWithValidity:(id)arg1 completion:(id)arg2;
- (void)sendSiriCommand:(id)arg1 completionHandler:(id)arg2;
