...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)_setupTrafficColorsWithRoadLayoutContext:(struct RoadLayoutContext { struct LayoutContext {} *x1; float x2; float x3; BOOL x4; BOOL x5; float x6; float x7; struct CGSize { float x_8_1_1; float x_8_1_2; } x8; struct CGSize { float x_9_1_1; float x_9_1_2; } x9; bool x10; unsigned char x11; float x12; float x13; float x14; float x15; struct Matrix<float, 4, 1> { float x_16_1_1[4]; } x16[5]; bool x17; }*)arg1 trafficStyleAttributes:(const struct FeatureAttributeSet { struct vector<gss::FeatureAttributePair, std::__1::allocator<gss::FeatureAttributePair> > { struct FeatureAttributePair {} *x_1_1_1; struct FeatureAttributePair {} *x_1_1_2; struct __compressed_pair<gss::FeatureAttributePair *, std::__1::allocator<gss::FeatureAttributePair> > { struct FeatureAttributePair {} *x_3_2_1; } x_1_1_3; } x1; }*)arg2 styleZ:(float)arg3;
