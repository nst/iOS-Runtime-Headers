...
@interface UIScreen : NSObject <DebugHierarchyObject_Fallback, UICoordinateSpace, UITraitEnvironment, _CRKImageLoaderDelegate, _UIFocusEnvironmentInternal, _UIFocusEnvironmentPrivate, _UIFocusRegionContainer, _UITraitEnvironmentInternal> {
