...
+ (void)syncAndDispatchForEntryCache:(id)arg1 forEntryKey:(id)arg2 withBlock:(id)arg3;
...
- (void)enumerateEntryCache:(id)arg1 withBlock:(id)arg2;
- (void)enumerateStagingEntryCacheForEntryKey:(id)arg1 withBlock:(id)arg2;
- (void)enumerateStagingEntryCacheWithBlock:(id)arg1;
...
- (void)updateStagingEntryCacheWithEntry:(id)arg1 withBlock:(id)arg2;
