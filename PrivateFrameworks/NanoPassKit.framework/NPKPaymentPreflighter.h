...
@interface NPKPaymentPreflighter : NSObject {
    ...
    id  _preflightCompletionHandler;
    bool  _preflighting;
...
@property (nonatomic, copy) id preflightCompletionHandler;
...
- (void)addCardPreflightWithCompletion:(id)arg1;
...
- (void)transferToCompanionPreflightWithCompletion:(id)arg1;
- (bool)watchConnected;
