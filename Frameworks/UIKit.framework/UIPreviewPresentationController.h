...
@interface UIPreviewPresentationController : UIPresentationController <UIForcePresentationController, UIInteractionProgressObserver, _UIPlatterMenuDynamicsControllerDelegate, _UIPreviewActionSheetViewDelegate> {
...
@property (nonatomic, retain) UIVisualEffectView *presentationBackgroundView;
...
+ (id)_visualEffectForPresentationPhase:(unsigned int)arg1 traitCollection:(id)arg2;
...
- (id)_preferredVisualEffectForPreviewPresentationPhase:(unsigned int)arg1;
...
- (void)_updateRevealContainerView:(id)arg1 forTableViewCell:(id)arg2 sourceRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg3;
...
- (void)setPresentationBackgroundView:(id)arg1;
