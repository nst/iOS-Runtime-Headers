...
@property (nonatomic, copy) id afterAppearanceBlock;
...
+ (id)XPCInterface;
+ (id)_allDescriptions;
+ (bool)_allViewControllersInArray:(id)arg1 allowAutorotationToInterfaceOrientation:(long long)arg2 predicate:(id)arg3;
...
+ (void)_withDisabledAppearanceTransitions:(bool)arg1 forDescendantsOf:(id)arg2 visibleOnly:(bool)arg3 perform:(id)arg4;
+ (void)_withDisabledAppearanceTransitionsForVisibleDescendantsOf:(id)arg1 perform:(id)arg2;
...
- (void)_commitPreviewTransitionAsDetailOfSplitViewController:(id)arg1 withDelegate:(id)arg2 completion:(id)arg3;
- (id)_completionBlock;
...
- (void)_performCoordinatedPresentOrDismiss:(id)arg1 animated:(bool)arg2;
...
- (void)_transitionToNavigationViewController:(id)arg1 withWrapper:(id)arg2;
- (void)_transitionToViewController:(id)arg1 whilePerforming:(id)arg2 completion:(id)arg3;
...
+ (void)pu_copyAssets:(id)arg1 completionHandler:(id)arg2;
...
- (void)ph_loadTransitionSourcePlaceholderViewUsingFactory:(id)arg1;
...
- (void)_sf_presentViewControllerOnTopOfPresentedViewController:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
...
- (bool)bs_addChildViewController:(id)arg1 animated:(bool)arg2 transitionBlock:(id)arg3;
...
- (bool)bs_removeChildViewController:(id)arg1 animated:(bool)arg2 transitionBlock:(id)arg3;
...
- (void)music_presentSearchViewControllerAnimated:(bool)arg1 completion:(id)arg2;
...
- (id)_gkPresentActivityViewControllerForActivityItems:(id)arg1 fromView:(id)arg2 withCompletionHandler:(id)arg3;
...
+ (id)px_viewControllerWithAsynchronousOutputProducer:(id)arg1;
+ (id)px_viewControllerWithContinuousOutputProducer:(id)arg1;
+ (id)px_viewControllerWithOutput:(id)arg1;
...
- (void)px_enumerateDescendantViewControllersWithOptions:(unsigned long long)arg1 usingBlock:(id)arg2;
...
- (void)px_presentViewControllerInNavigationController:(id)arg1 animated:(bool)arg2 dimissButtonLocation:(long long)arg3 completion:(id)arg4;
...
- (void)switchViewController:(id)arg1 toViewController:(id)arg2 duration:(double)arg3 options:(unsigned long long)arg4 animations:(id)arg5 completion:(id)arg6;
