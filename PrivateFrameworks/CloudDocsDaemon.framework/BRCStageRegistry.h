...
@interface BRCStageRegistry : NSObject <BRCLowDiskDelegate, BRCModule> {
    ...
    unsigned int  _stageDirectoryFileID;
...
- (id)_pathInStage:(unsigned int)arg1 index:(unsigned char*)arg2 generationID:(unsigned int*)arg3;
...
- (int)deviceID;
- (BOOL)didFlushStagedFileID:(unsigned int)arg1;
- (void)disarmLockedTestTimer;
- (BOOL)existsInOldVersionStage:(unsigned int)arg1 generationID:(unsigned int*)arg2;
- (BOOL)existsInStage:(unsigned int)arg1 generationID:(unsigned int*)arg2;
- (void)forgetWatchedLockedFileID:(id)arg1;
- (void)forgetWatchedLockedFileIDsForAppLibrary:(id)arg1;
- (void)garbageCollectPackages;
- (int)garbageCollectSpace:(int)arg1;
- (id)initWithAccountSession:(id)arg1;
- (BOOL)isCancelled;
- (void)lowDiskStatusChangedForDevice:(int)arg1 hasEnoughSpace:(BOOL)arg2;
- (BOOL)makeDirectoryInStageGatherFileID:(unsigned int*)arg1 generationID:(unsigned int*)arg2 error:(id*)arg3;
...
- (BOOL)makeSideFaultInStageGatherFileID:(unsigned int*)arg1 generationID:(unsigned int*)arg2 documentID:(unsigned int*)arg3 properties:(id)arg4 inAppLibrary:(id)arg5 forCreation:(BOOL)arg6 error:(id*)arg7;
- (BOOL)makeSymlinkWithTarget:(id)arg1 inStageGatherFileID:(unsigned int*)arg2 generationID:(unsigned int*)arg3 error:(id*)arg4;
- (BOOL)moveFromStage:(unsigned int)arg1 toPath:(id)arg2 fileName:(id)arg3 error:(id*)arg4;
- (BOOL)moveFromStageToGraveyard:(unsigned int)arg1 forItemID:(id)arg2;
...
- (void)open;
- (int)purgableSpace;
- (int)purgeGraveyardSpace:(int)arg1 withUrgency:(int)arg2;
- (int)purgeSpace:(int)arg1 withUrgency:(int)arg2;
- (BOOL)rememberStagedDownloadWithID:(id)arg1 gatherFileID:(unsigned int*)arg2 generationID:(unsigned int*)arg3 documentID:(unsigned int*)arg4 appLibrary:(id)arg5 error:(id*)arg6;
- (void)resume;
- (BOOL)transferDocumentID:(unsigned int)arg1 fromOldVersionStage:(unsigned int)arg2 toStage:(unsigned int)arg3;
