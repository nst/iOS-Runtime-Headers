...
- (void)deactivateWithCompletion:(id)arg1;
- (id)delegate;
- (long long)editMode;
...
- (void)setForEditMode:(long long)arg1 gestureDidScrollHandler:(id)arg2;
- (void)setForEditMode:(long long)arg1 gestureDidStopHandler:(id)arg2;
- (void)setForEditMode:(long long)arg1 gestureDiscreteScrollHandler:(id)arg2;
