...
@property (nonatomic) struct { double x1; double x2; double x3; double x4; } innerColor;
...
- (struct { double x1; double x2; double x3; double x4; })innerColor;
- (BOOL)isStale;
- (double)presentationCourse;
- (float)scale;
- (void)setInnerColor:(struct { double x1; double x2; double x3; double x4; })arg1;
