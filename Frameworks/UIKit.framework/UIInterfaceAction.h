...
+ (id)actionWithTitle:(id)arg1 type:(long long)arg2 handler:(id)arg3;
+ (bool)changedProperties:(id)arg1 containsAny:(id)arg2;

- (void).cxx_destruct;
- (void)_addActionDisplayPropertyObserver:(id)arg1;
- (id)_imageTintColor;
- (void)_invokeHandlerWithCompletionBlock:(id)arg1;
- (bool)_isFocused;
- (bool)_isPreferred;
...
- (id)description;
- (id)handler;
- (id)initWithTitle:(id)arg1 type:(long long)arg2 customContentViewController:(id)arg3 customContentView:(id)arg4 handler:(id)arg5;
- (bool)isEnabled;
- (id)leadingImage;
