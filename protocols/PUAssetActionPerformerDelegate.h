...
- (bool)assetActionPerformer:(void *)arg1 dismissViewController:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 7: PUAssetActionPerformer *, UIViewController *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
