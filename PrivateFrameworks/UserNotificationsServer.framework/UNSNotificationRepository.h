...
- (void)_queue_removeNotificationRecordsPassingTest:(id)arg1 forBundleIdentifier:(id)arg2;
...
- (void)notificationRecordsForBundleIdentifier:(id)arg1 withCompletionHandler:(id)arg2;
- (void)performMigration;
- (void)removeAllNotificationRecordsForBundleIdentifier:(id)arg1;
- (void)removeNotificationRecordsPassingTest:(id)arg1 forBundleIdentifier:(id)arg2;
- (void)removeNotificationRepository;
- (void)removeObserver:(id)arg1 forBundleIdentifier:(id)arg2;
- (void)removeStoreForBundleIdentifier:(id)arg1;
- (void)saveNotificationRecord:(id)arg1 forBundleIdentifier:(id)arg2 withCompletionHandler:(id)arg3;
