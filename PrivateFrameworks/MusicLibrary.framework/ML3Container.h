...
- (BOOL)_computeBeginPhysicalOrder:(long long*)arg1 andIncrement:(long long*)arg2 forCount:(unsigned int)arg3 afterPhysicalOrder:(long long)arg4 forceReorder:(BOOL)arg5;
- (BOOL)_insertTracksWithPersistentIDs:(long long*)arg1 count:(unsigned int)arg2 afterPhysicalOrder:(long long)arg3 insertedPhysicalOrdersOut:(long long*)arg4 fullReorderOccurredOut:(BOOL*)arg5 forceReorder:(BOOL)arg6;
...
- (BOOL)insertTracksWithPersistentIDs:(long long*)arg1 count:(unsigned int)arg2 afterPhysicalOrder:(long long)arg3 insertedPhysicalOrdersOut:(long long*)arg4 fullReorderOccurredOut:(BOOL*)arg5;
