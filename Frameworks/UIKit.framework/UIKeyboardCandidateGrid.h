...
@class <UIKeyboardCandidateListDelegate>, <UIScrollViewDelegate>, NSArray, NSMutableDictionary, NSString, UIImageView, UIKeyboardCandidateGridHeader, UIKeyboardCandidateScrollViewController, UIKeyboardCandidateSortControl, UIView;
