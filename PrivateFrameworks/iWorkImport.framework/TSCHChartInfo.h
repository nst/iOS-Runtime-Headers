...
@class <TSCHStyleActAlike>, NSArray, NSMutableArray, NSMutableDictionary, NSString, TSCHChartDrawableInfo, TSCHChartLayoutCache, TSCHChartMediator, TSCHChartModel, TSCHChartStylePreset, TSCHChartType, TSCHLegendModel, TSDInfoGeometry, TSPLazyReference, TSSStylesheet;
...
- (id)styleOwnerForRef:(struct { int x1; unsigned int x2; })arg1;
- (id)styleOwnerForSelectionPath:(id)arg1;
- (id)styleOwnerFromSwapType:(int)arg1 andIndex:(unsigned int)arg2;
- (struct { int x1; unsigned int x2; })styleOwnerRefForStyleOwner:(id)arg1;
