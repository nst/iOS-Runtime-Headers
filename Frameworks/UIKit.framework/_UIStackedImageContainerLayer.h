...
- (long long)_selectionStyle;
- (void)_setControlState:(unsigned long long)arg1 animated:(bool)arg2 focusAnimationCoordinator:(id)arg3 completion:(id)arg4;
...
- (void)setPressed:(bool)arg1 animated:(bool)arg2 completion:(id)arg3;
