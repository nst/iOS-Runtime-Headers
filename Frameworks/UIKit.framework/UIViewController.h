...
@class GKBackgroundView, IUWildcatVideosViewController, IUiPodSegmentedViewController, NSArray, NSBundle, NSDictionary, NSMutableArray, NSString, SUStorePageProtocol, SUViewControllerFactory, UIBarButtonItem, UIDropShadowView, UINavigationController, UINavigationItem, UIPopoverController, UIResponder, UISearchDisplayController, UISplitViewController, UIStoryboard, UITabBarController, UITabBarItem, UITransitionView, UIView, UIViewController;
