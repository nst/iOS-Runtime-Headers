...
+ (void)_wakeUpBirdWithUID:(unsigned int)arg1 queue:(id)arg2 thenContinue:(id)arg3;
+ (void)ensureProvidersIfNecessaryForClaim:(id)arg1 readingAtLocation:(id)arg2 queue:(id)arg3 thenContinue:(id)arg4;
...
- (void)_enumerateSubarbitersUsingBlock:(id)arg1;
...
- (void)addProvider:(id)arg1 withID:(id)arg2 uniqueID:(id)arg3 forProvidedItemsURL:(id)arg4 options:(unsigned long long)arg5 withServer:(id)arg6 reply:(id)arg7;
- (oneway void)cancelAccessClaimForID:(id)arg1;
- (void)dealloc;
- (void)getDebugInformationIncludingEverything:(bool)arg1 withString:(id)arg2 fromPid:(int)arg3 thenContinue:(id)arg4;
- (void)grantAccessClaim:(id)arg1 withReply:(id)arg2;
- (void)grantSubarbitrationClaim:(id)arg1 withServer:(id)arg2 reply:(id)arg3;
- (id)initWithQueue:(id)arg1 isSubarbiter:(bool)arg2 listener:(id)arg3;
- (bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;
- (void)performBarrierWithCompletionHandler:(id)arg1;
- (oneway void)prepareToArbitrateForURLs:(id)arg1;
- (void)provideDebugInfoWithLocalInfo:(id)arg1 completionHandler:(id)arg2;
- (void)provideSubarbiterDebugInfoIncludingEverything:(bool)arg1 completionHandler:(id)arg2;
...
- (id)rootNode;
- (void)startArbitratingWithReply:(id)arg1;
