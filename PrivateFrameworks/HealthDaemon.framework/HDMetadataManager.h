...
- (id)metadataForDataEntityWithPersistentID:(long long)arg1 baseMetadata:(id)arg2 keyFilter:(id)arg3 statement:(id)arg4 error:(id*)arg5;
- (id)metadataForDataEntityWithPersistentID:(long long)arg1 keyFilter:(id)arg2 error:(id*)arg3;
