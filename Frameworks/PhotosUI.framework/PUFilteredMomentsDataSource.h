...
- (void)_updateAssetUUIDs:(id)arg1 localIdenifiers:(id)arg2 taskId:(unsigned long long)arg3 completion:(id)arg4;
- (id)assetUUIDs;
- (id)delegate;
- (id)fetchResult;
- (id)init;
...
- (void)updateAssetUUIDs:(id)arg1 localIdenifiers:(id)arg2 completion:(id)arg3;
