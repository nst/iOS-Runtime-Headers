...
+ (void)copyPixelsToImage:(id)arg1 atPoint:(struct { long long x1; long long x2; })arg2 fromBuffer:(id)arg3;
...
+ (void)copySurface:(id)arg1 toSurfaceImage:(id)arg2 atPoint:(struct { long long x1; long long x2; })arg3;
+ (void)copySurfaceImage:(id)arg1 toImage:(id)arg2;
+ (void)copyTexture:(id)arg1 toSurfaceImage:(id)arg2 atPoint:(struct { long long x1; long long x2; })arg3 withContext:(id)arg4;
