...
@property unsigned long long currentEventsRevision;
@property(copy,readonly) NSString * eventsRevisionVersionToken;
...
- (id)_revisionsIndexSetUsingPersisentIDGenerationBlock:(id)arg1 count:(unsigned int)arg2;
