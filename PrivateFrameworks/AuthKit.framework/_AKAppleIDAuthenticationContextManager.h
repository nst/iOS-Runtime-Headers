...
- (void)dismissICSCRecoveryUIForContext:(id)arg1 completion:(id /* block */)arg2;
...
- (void)presentICSCRecoveryUIForContext:(id)arg1 withInfo:(id)arg2 completion:(id /* block */)arg3;
