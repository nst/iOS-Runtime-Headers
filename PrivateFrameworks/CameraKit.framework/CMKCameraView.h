...
@property (setter=_setCurrentDominantPhysicalButton:, nonatomic) int _currentDominantPhysicalButton;
...
- (int)_currentDominantPhysicalButton;
...
- (void)_setCurrentDominantPhysicalButton:(int)arg1;
...
- (BOOL)_shouldHideShutterIndicatorForMode:(int)arg1;
