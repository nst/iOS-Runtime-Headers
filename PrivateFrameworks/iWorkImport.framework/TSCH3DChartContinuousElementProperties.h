...
@property(readonly) float p_sageInterSetDepthGapProperty;
@property(readonly) long long seriesCount;
@property(readonly) float shadowCameraDepthLimitAdjustmentFactor;
...
- (void)reset;
- (void)resetWithEnumerator:(id)arg1 layoutSettings:(struct { boolx1; boolx2; boolx3; boolx4; boolx5; boolx6; unsigned long long x7; })arg2;
