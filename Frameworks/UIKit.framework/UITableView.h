...
@class NSMutableArray, UIColor, UIGestureRecognizer, NSTimer, UITouch, UIRefreshControl, UISwipeGestureRecognizer, UILongPressGestureRecognizer, UIView, NSArray, <UITableViewDelegate>, UITableViewCell, NSMutableDictionary, <UITableViewDataSource>, NSIndexPath;
...
@property(setter=_setRefreshControl:,retain) UIRefreshControl * _refreshControl;
