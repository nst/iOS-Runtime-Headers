...
@interface TSCH3DChartRenderer : TSCHRenderer {
    ...
    boolmCanRender;
    boolmHasAnimationBounds;
    boolmResetTrackingOnNextRender;
...
- (bool)allocateFramebufferForBodyCanvasVisibleRect:(const struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg1;
...
- (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })p_affineTransformForFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 rotation:(double)arg2;
...
- (void)renderIntoContext:(struct CGContext { }*)arg1 bodyCanvasVisibleRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 scene:(id)arg3 GLContext:(id)arg4 needLayout:(bool)arg5;
...
- (id)textIdentifierAtPoint:(struct CGPoint { double x1; double x2; })arg1;
- (void)updateLayout;
