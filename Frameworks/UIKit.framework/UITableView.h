...
@class <UITableViewDataSource>, <UITableViewDelegate>, NSArray, NSIndexPath, NSMutableArray, NSMutableDictionary, UIColor, UISwipeGestureRecognizer, UITableViewCell, UIView;
