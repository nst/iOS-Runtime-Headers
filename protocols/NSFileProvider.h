...
- (void)_provideItemAtURL:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: NSURL *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSError *, void*
...
- (void)_provideItemAtURL:(void *)arg1 toReaderWithID:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: NSURL *, id, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSError *, void*
