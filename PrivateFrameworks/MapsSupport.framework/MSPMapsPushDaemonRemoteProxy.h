...
- (void)commitFavoritesSerializedRepresentation:(id)arg1 completion:(id)arg2;
- (void)commitHistorySerializedRepresentation:(id)arg1 completion:(id)arg2;
- (void)favoritesDidChange;
- (void)fetchCurrentAnnouncement:(id)arg1;
- (void)fetchDevicePushToken:(id)arg1;
- (void)fetchFavoritesSerializedRepresentationWithCompletion:(id)arg1;
- (void)fetchHistorySerializedRepresentationWithCompletion:(id)arg1;
- (void)fetchProblemStatus;
- (void)fetchUserRoutingPreferencesWithCompletion:(id)arg1;
- (void)historyDidChange;
- (id)init;
- (void)openConnection;
- (void)problemStatusResponseWithNotificationID:(id)arg1 completion:(id)arg2;
