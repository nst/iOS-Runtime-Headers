...
- (void).cxx_destruct;
- (void)_abortManualCurlAtLocation:(struct CGPoint { double x1; double x2; })arg1 withSuggestedVelocity:(float)arg2;
...
- (void)_completeManualCurlAtLocation:(struct CGPoint { double x1; double x2; })arg1 withSuggestedVelocity:(float)arg2;
...
- (void)_endManualCurlAtLocation:(struct CGPoint { double x1; double x2; })arg1 withSuggestedVelocity:(float)arg2 shouldComplete:(BOOL)arg3;
- (void)_enqueueCurlOfType:(int)arg1 fromLocation:(struct CGPoint { double x1; double x2; })arg2 inDirection:(int)arg3 withView:(id)arg4 revealingView:(id)arg5 completion:(id /* block */)arg6 finally:(id /* block */)arg7;
...
- (float)_inputTimeForProgress:(float)arg1 distanceToTravel:(float)arg2 radius:(float*)arg3 minRadius:(float)arg4 angle:(float)arg5 dAngle:(float)arg6 touchLocation:(struct CGPoint { double x1; double x2; })arg7 state:(id)arg8;
...
- (struct CGPoint { double x1; double x2; })_referenceLocationForInitialLocation:(struct CGPoint { double x1; double x2; })arg1 direction:(int)arg2;
...
- (void)_updatedInputsFromState:(id)arg1 forLocation:(struct CGPoint { double x1; double x2; })arg2 time:(float*)arg3 radius:(float*)arg4 angle:(float*)arg5;
- (int)_validatedPageCurlTypeForPageCurlType:(int)arg1 inDirection:(int)arg2;
- (id)_wrappedManualPageCurlDirection;
- (void)dealloc;
- (id)initWithSpineLocation:(int)arg1 andContentRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 inContentView:(id)arg3;
