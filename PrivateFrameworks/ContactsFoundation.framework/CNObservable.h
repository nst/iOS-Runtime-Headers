...
+ (id)observableWithRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1 interval:(double)arg2 scheduler:(id)arg3;
...
- (id)buffer:(unsigned int)arg1 interval:(double)arg2;
- (id)buffer:(unsigned int)arg1 interval:(double)arg2 scheduler:(id)arg3;
