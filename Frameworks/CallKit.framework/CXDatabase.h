...
- (bool)executeSQL:(id)arg1 withStatementPreparationBlock:(id)arg2 error:(id*)arg3;
- (bool)executeSQL:(id)arg1 withStatementPreparationBlock:(id)arg2 transient:(bool)arg3 error:(id*)arg4;
- (id)init;
...
- (bool)selectSQL:(id)arg1 withBindings:(id)arg2 expectedColumnCount:(long long)arg3 resultRowHandler:(id)arg4 error:(id*)arg5;
- (bool)selectSQL:(id)arg1 withBindings:(id)arg2 expectedColumnCount:(long long)arg3 transient:(bool)arg4 resultRowHandler:(id)arg5 error:(id*)arg6;
