...
- (void)deferNotificationsUntilAfterPerformingBlock:(id)arg1;
...
- (void)postNotificationsForCall:(id)arg1 afterUpdatesInBlock:(id)arg2;
- (void)postNotificationsForCall:(id)arg1 usingComparisonCall:(id)arg2;
- (void)postNotificationsForCall:(id)arg1 usingComparisonCall:(id)arg2 afterUpdatesInBlock:(id)arg3;
- (void)postNotificationsForCallCenter:(id)arg1 afterUpdatesInBlock:(id)arg2;
