...
- (void)cacheBannerForContext:(void *)arg1 withCompletion:(void *)arg2; // needs 2 arg types, found 6: SBUIBannerContext *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
