...
+ (void)__loadActualAccessibilityBundle:(id)arg1 didLoadCallback:(id)arg2 loadSubbundles:(bool)arg3;
...
+ (void)_loadAXBundleForBundle:(id)arg1 didLoadCallback:(id)arg2;
+ (void)_loadAXBundleForBundle:(id)arg1 didLoadCallback:(id)arg2 forceLoad:(bool)arg3 loadSubbundles:(bool)arg4 loadAllAccessibilityInfo:(bool)arg5;
+ (void)_stringLocalizationStarted:(id)arg1;
+ (void)initialize;
+ (void)loadAccessibilityBundle:(id)arg1 didLoadCallback:(id)arg2;
+ (void)loadAccessibilityBundle:(id)arg1 didLoadCallback:(id)arg2 force:(bool)arg3;
+ (void)loadActualAccessibilityBundle:(id)arg1 didLoadCallback:(id)arg2 loadSubbundles:(bool)arg3;
