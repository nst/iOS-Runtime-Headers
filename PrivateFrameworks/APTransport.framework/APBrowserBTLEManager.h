...
@interface APBrowserBTLEManager : NSObject <APBluetoothClientDelegate> {
    ...
    /* Warning: unhandled struct encoding: '{OpaqueAPBrowserBTLEManager={__CFRuntimeBase=Q[4C]I}@}' */ struct OpaqueAPBrowserBTLEManager { struct __CFRuntimeBase { unsigned long long x_1_1_1; unsigned char x_1_1_2[4]; unsigned int x_1_1_3; } x1; id x2; } * _managerRef;
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{OpaqueAPBrowserBTLEManager={__CFRuntimeBase=Q[4C]I}@}' */ struct OpaqueAPBrowserBTLEManager { struct __CFRuntimeBase { unsigned long long x_1_1_1; unsigned char x_1_1_2[4]; unsigned int x_1_1_3; } x1; id x2; }*managerRef;
...
- (/* Warning: unhandled struct encoding: '{OpaqueAPBrowserBTLEManager={__CFRuntimeBase=Q[4C]I}@}' */ struct OpaqueAPBrowserBTLEManager { struct __CFRuntimeBase { unsigned long long x_1_1_1; unsigned char x_1_1_2[4]; unsigned int x_1_1_3; } x1; id x2; }*)managerRef;
...
- (int)setEventHandler:(int (*)arg1 context:(void*)arg2 managerRef:(/* Warning: unhandled struct encoding: '{OpaqueAPBrowserBTLEManager={__CFRuntimeBase=Q[4C]I}@}' */ struct OpaqueAPBrowserBTLEManager { struct __CFRuntimeBase { unsigned long long x_1_1_1; unsigned char x_1_1_2[4]; unsigned int x_1_1_3; } x1; id x2; }*)arg3;
...
- (void)setManagerRef:(/* Warning: unhandled struct encoding: '{OpaqueAPBrowserBTLEManager={__CFRuntimeBase=Q[4C]I}@}' */ struct OpaqueAPBrowserBTLEManager { struct __CFRuntimeBase { unsigned long long x_1_1_1; unsigned char x_1_1_2[4]; unsigned int x_1_1_3; } x1; id x2; }*)arg1;
