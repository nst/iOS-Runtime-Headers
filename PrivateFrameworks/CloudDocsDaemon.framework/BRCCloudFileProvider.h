...
- (void).cxx_destruct;
- (void)__provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 session:(id)arg3 recursively:(bool)arg4 readingOptions:(unsigned long long)arg5 completionHandler:(id)arg6;
...
- (void)_waitForDownloadOfDirectory:(id)arg1 key:(id)arg2 readingOptions:(unsigned long long)arg3 completionHandler:(id)arg4;
- (void)_waitForDownloadOfDocument:(id)arg1 key:(id)arg2 requireCurrent:(bool)arg3 readingOptions:(unsigned long long)arg4 completionHandler:(id)arg5;
