...
- (void)addIncomingCallWithUUID:(id)arg1 update:(id)arg2 completion:(id /* block */)arg3;
- (void)callWithUUID:(id)arg1 changedFrequencyData:(id)arg2 forDirection:(int)arg3;
- (void)callWithUUID:(id)arg1 crossDeviceIdentifier:(id)arg2 changedBytesOfDataUsed:(int)arg3;
- (void)callWithUUID:(id)arg1 endedAtDate:(id)arg2 privateReason:(int)arg3;
- (void)callWithUUID:(id)arg1 endedAtDate:(id)arg2 reason:(int)arg3;
