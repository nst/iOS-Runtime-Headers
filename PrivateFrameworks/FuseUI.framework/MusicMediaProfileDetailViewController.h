...
- (void).cxx_destruct;
- (void)_accessMoreRelatedContentDocumentUsingBlock:(id)arg1;
...
- (void)_dispatchNativeViewEventOfType:(long long)arg1 withExtraInfo:(id)arg2 forViewController:(id)arg3 completion:(id)arg4;
