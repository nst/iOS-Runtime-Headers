...
@interface PUCameraTransientAssetsMediaProvider : PUMediaProvider {
    ...
    id  _supplementaryLivePhotoImageSource;
}
...
@property (nonatomic, copy) id supplementaryLivePhotoImageSource;
...
- (void)_requestAVAssetForVideoURL:(id)arg1 resultHandler:(id)arg2;
- (int)_requestLivePhotoForTransientAsset:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(id)arg5;
- (bool)_requestLivePhotoWithSupplementaryImageSourceIfPossibleWithAsset:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(id)arg5;
...
- (id)init;
- (id)initWithTransientImageManager:(id)arg1 supplementaryLivePhotoImageSource:(id)arg2;
