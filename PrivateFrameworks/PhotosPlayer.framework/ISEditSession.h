...
- (unsigned int)_inputOrientation;
- (struct { int x1; int x2; unsigned int x3; int x4; })_inputVideoDuration;
...
- (struct { int x1; int x2; unsigned int x3; int x4; })_loadInputVideoDuration;
- (id)_outputImage;
...
- (struct CGSize { double x1; double x2; })_outputVideoSizeForScale:(float)arg1;
...
- (float)_targetScaleForTargetSize:(struct CGSize { double x1; double x2; })arg1;
...
- (id)imageProperties;
- (id)init;
- (id)initWithPhotoURL:(id)arg1 videoURL:(id)arg2 photoTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg3 photoOrientation:(unsigned int)arg4;
- (id)inputImage;
