...
- (void)_ensurePDFIsUnlockedFirstAttempt:(bool)arg1 completionHandler:(id)arg2;
- (void)_generatePrintPreview:(id)arg1;
...
- (id)printingItem;
- (id)printingItems;
- (bool)savePDFToURL:(id)arg1 completionHandler:(id)arg2;
