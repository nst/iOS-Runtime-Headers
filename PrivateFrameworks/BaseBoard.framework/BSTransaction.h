...
- (void)_enumerateChildTransactionRelationshipsWithBlock:(id)arg1;
- (void)_enumerateChildTransactionsWithBlock:(id)arg1;
- (void)_enumerateChildTransactionsWithSchedulingPolicy:(unsigned long long)arg1 block:(id)arg2;
- (void)_enumerateObserversWithBlock:(id)arg1;
- (void)_enumerateParentTransactionRelationshipsWithBlock:(id)arg1;
- (void)_enumerateParentTransactionsWithBlock:(id)arg1;
- (void)_enumerateParentTransactionsWithSchedulingPolicy:(unsigned long long)arg1 block:(id)arg2;
- (void)_evaluateCompletion;
- (bool)_evaluateParentTransactionsWithSchedulingPolicy:(unsigned long long)arg1 evaluator:(id)arg2;
...
- (void)_preventTransactionCompletionForReason:(id)arg1 ignoringAuditHistory:(bool)arg2 andExecuteBlock:(id)arg3;
...
- (id)milestones;
- (id)queue;
- (void)registerBlockObserver:(id)arg1;
