...
- (id)entryWithName:(id)arg1 dataLength:(int)arg2;
...
- (struct SFUZipEndOfCentralDirectory { unsigned int x1; int x2; int x3; })readEndOfCentralDirectoryFromInputStream:(id)arg1;
- (void)readEntries;
...
- (struct SFUZipEndOfCentralDirectory { unsigned int x1; int x2; int x3; })readZip64EndOfCentralDirectoryFromInputStream:(id)arg1 eocdOffset:(int)arg2;
- (struct SFUZipEndOfCentralDirectory { unsigned int x1; int x2; int x3; })readZip64EndOfCentralDirectoryFromInputStream:(id)arg1 offset:(int)arg2;
- (const char *)searchForEndOfCentralDirectoryFromInputStream:(id)arg1 offset:(int*)arg2;
