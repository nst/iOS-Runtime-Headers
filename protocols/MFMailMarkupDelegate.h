...
- (void)handleMarkupURL:(void *)arg1 attachment:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: NSURL *, MFAttachment *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, MFAttachment *, void*
