...
- (void)fetchCarrierBundleNATKeepAliveIntervalOverCell:(id)arg1 handler:(id)arg2;
- (void)fetchClientListenerWithBundleID:(id)arg1 completionQueue:(id)arg2 handler:(id)arg3;
- (void)fetchUpgradeInfoForPluginType:(id)arg1 completionQueue:(id)arg2 handler:(id)arg3;
- (id)filterIndexWithFilter:(id)arg1;
- (long long)generation;
- (void)getCurrentIndexWithCompletionHandler:(id)arg1;
- (void)handleApplicationsRemoved:(id)arg1 withCompletionHandler:(id)arg2;
...
- (void)saveConfigurationToDisk:(id)arg1 currentSignature:(id)arg2 userUUID:(id)arg3 isUpgrade:(bool)arg4 completionQueue:(id)arg5 completionHandler:(id)arg6;
...
- (void)triggerLocalAuthenticationForConfigurationWithID:(id)arg1 withCompletionQueue:(id)arg2 handler:(id)arg3;
