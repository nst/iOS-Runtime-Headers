...
- (void)_loadDNDEnabledStateFromNPS:(id)arg1;
- (bool)_loadDNDMirrorStateFromDefaults;
- (id)_newDomainAccessor;
- (void)_resolveDNDStateWithBBState:(unsigned long long)arg1 bbDate:(id)arg2 npsState:(unsigned long long)arg3 npsDate:(id)arg4 currentDate:(id)arg5 deviceIsCompanion:(bool)arg6 triggeredBySource:(unsigned long long)arg7 behaviorOverrides:(id)arg8 completion:(id)arg9;
