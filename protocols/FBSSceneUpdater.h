...
- (void)scene:(void *)arg1 sendMessage:(void *)arg2 withResponse:(void *)arg3; // needs 3 arg types, found 9: FBSScene *, FBSSceneMessage *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, FBSSceneMessage *, NSError *, void*
