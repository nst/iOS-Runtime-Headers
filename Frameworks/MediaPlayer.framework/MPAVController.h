...
@interface MPAVController : NSObject <AVAudioSessionDelegateMediaPlayerOnly, MPAVControllerProtocol, MPAVErrorResolverDelegate, MPAVRoutingControllerDelegate> {
...
@property (nonatomic) int EQPreset;
@property (nonatomic, readonly) unsigned int _displayPlaybackState;
...
@property (nonatomic, readonly) unsigned int numberOfItems;
...
- (void)_switchToFeeder:(id)arg1 mode:(int)arg2 index:(unsigned int)arg3 play:(BOOL)arg4 configureFeederBlock:(id /* block */)arg5;
