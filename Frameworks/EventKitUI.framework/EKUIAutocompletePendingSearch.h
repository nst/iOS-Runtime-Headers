...
- (void).cxx_destruct;
- (void)cancel;
- (id)initWithEventStore:(id)arg1 searchString:(id)arg2 maximumResultCount:(unsigned long long)arg3 completionHandler:(id)arg4;
- (void)searchWithString:(id)arg1 completionHandler:(id)arg2;
