...
@interface MusicProfileSplitMainViewController : UIViewController <MusicClientContextConsuming, MusicContainerScrollViewDelegate, SKUIScrollingSegmentedControllerDelegate> {
    ...
    struct { 
        ...
        unsigned int contentScrollViewWillEndDraggingWithVelocity : 1; 
...
@property (nonatomic, retain) NSDictionary *availableContentFlags;
...
- (void).cxx_destruct;
- (struct CGPoint { float x1; float x2; })_adjustContentOffsetForBounds:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1 inScrollView:(id)arg2;
