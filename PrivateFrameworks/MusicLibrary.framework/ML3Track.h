...
+ (id)_normalizedImportChapters:(id)arg1 trackPersistentID:(int)arg2;
...
+ (id)flattenedChapterDataFromDAAPInfoDictionary:(id)arg1 trackPersistentID:(int)arg2;
+ (id)flattenedChapterDataFromSyncInfoDictionaries:(id)arg1 trackPersistentID:(int)arg2;
+ (id)flattenedChapterDataWithImportChapters:(id)arg1 library:(id)arg2 trackPersistentID:(int)arg3;
...
+ (BOOL)trackWithPersistentID:(int)arg1 existsInLibrary:(id)arg2;
+ (BOOL)trackWithPersistentID:(int)arg1 existsInLibraryWithConnection:(id)arg2;
+ (BOOL)trackWithPersistentID:(int)arg1 visibleInLibrary:(id)arg2;
+ (BOOL)unlinkRedownloadableAssetsFromLibrary:(id)arg1 persistentIDs:(id)arg2;
+ (BOOL)unlinkRedownloadableAssetsFromLibrary:(id)arg1 persistentIDs:(id)arg2 deletedFileSize:(int*)arg3;
+ (BOOL)unlinkRedownloadableAssetsFromLibrary:(id)arg1 persistentIDs:(id)arg2 deletionType:(int)arg3 deletedFileSize:(int*)arg4;
