...
- (void)infoCardTransitAnalyticsDidSelectionAction:(int)arg1 resultIndex:(int)arg2 targetID:(unsigned int)arg3 transitSystem:(id <GEOTransitSystem>)arg4 transitDepartureSequence:(id <GEOTransitDepartureSequence>)arg5 transitCardCategory:(int)arg6 transitIncident:(id <GEOTransitIncident>)arg7 feedbackDelegateSelector:(int)arg8;
