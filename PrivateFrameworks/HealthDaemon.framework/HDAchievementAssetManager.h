...
- (void)_performAchievementsUpdateIfWaitingWithCompletion:(id)arg1;
- (void)_performActivity:(id)arg1;
- (bool)_queue_isWaitingToRun;
- (void)_queue_notifyObservers;
- (void)_queue_performAchievementsUpdateWithCompletion:(id)arg1;
- (void)_queue_setWaitingToRun:(bool)arg1;
- (void)_registerActivity;
- (void)_requestNanoSyncAfterAssetUpdates;
- (void)_setLastSuccessfulUpdateDate:(id)arg1;
- (void)_setNeedsUpdateWithCompletion:(id)arg1;
...
- (void)updateAllAssetsWithCompletion:(id)arg1;
