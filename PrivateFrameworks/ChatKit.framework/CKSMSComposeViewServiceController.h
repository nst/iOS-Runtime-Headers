...
- (void)composeChatController:(id)arg1 shouldSendComposition:(id)arg2 inConversation:(id)arg3 completion:(id)arg4;
...
- (void)setGameCenterModeWithPickerBlock:(id)arg1;
