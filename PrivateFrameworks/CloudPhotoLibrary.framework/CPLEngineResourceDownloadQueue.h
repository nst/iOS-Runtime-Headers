...
- (id)_downloadTaskForLocalResource:(id)arg1 clientBundleID:(id)arg2 highPriority:(bool)arg3 background:(bool)arg4 backgroundTaskIdentifier:(unsigned long long)arg5 proposedTaskIdentifier:(id)arg6 didStartHandler:(id)arg7 progressHandler:(id)arg8 completionHandler:(id)arg9;
...
- (id)_realDownloadTaskForCloudResource:(id)arg1 clientBundleID:(id)arg2 launchHandler:(id)arg3 didStartHandler:(id)arg4 progressHandler:(id)arg5 completionHandler:(id)arg6;
...
- (id)dequeueBackgroundDownloadTasks:(unsigned long long)arg1 forResourceType:(unsigned long long)arg2 eachWithCompletionHandler:(id)arg3;
...
- (id)downloadTaskForLocalResource:(id)arg1 clientBundleID:(id)arg2 highPriority:(bool)arg3 proposedTaskIdentifier:(id)arg4 didStartHandler:(id)arg5 progressHandler:(id)arg6 completionHandler:(id)arg7;
