...
+ (void)addToScalar:(id)arg1 value:(int)arg2 domain:(int)arg3;
...
+ (double)pushTimeIntervalForDistribution:(id)arg1 domain:(int)arg2 sinceStartTime:(unsigned int)arg3;
+ (double)pushTimeIntervalForDistribution:(id)arg1 domain:(int)arg2 sinceStartTime:(unsigned int)arg3 significantDigits:(unsigned int)arg4;
...
+ (void)setScalar:(id)arg1 value:(int)arg2 domain:(int)arg3;

- (void).cxx_destruct;
- (void)addToScalar:(id)arg1 value:(int)arg2;
...
- (void)setScalar:(id)arg1 value:(int)arg2;
