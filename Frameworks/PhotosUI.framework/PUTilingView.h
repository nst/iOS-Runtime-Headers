...
@interface PUTilingView : UIScrollView {
    ...
    id  _onNextTileControllersUpdateBlock;
...
@property (nonatomic, copy) id onNextTileControllersUpdateBlock;
...
- (void)_enumerateActiveTileControllersUsingBlock:(id)arg1;
- (void)_enumerateAllTileControllersUsingBlock:(id)arg1;
...
- (void)_updateTileControllersWithLayout:(id)arg1 reactivatability:(id)arg2 appearanceHandler:(id)arg3 updateHandler:(id)arg4 disappearanceHandler:(id)arg5 heartBeatHandler:(id)arg6;
...
- (void)enumerateAllTileControllersUsingBlock:(id)arg1;
- (void)enumeratePresentedTileControllersInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 usingBlock:(id)arg2;
...
- (void)registerPostLayoutBlock:(id)arg1 forIdentifier:(id)arg2;
...
- (void)transitionToLayout:(id)arg1 withContext:(id)arg2 animationSetupCompletionHandler:(id)arg3;
