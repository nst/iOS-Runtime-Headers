...
- (void)createSnapShotWithCoordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg1 zoomLevel:(unsigned long long)arg2 size:(struct CGSize { double x1; double x2; })arg3 handler:(id)arg4;
