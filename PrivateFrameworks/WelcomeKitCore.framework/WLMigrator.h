...
+ (void)_cleanUpAfterFinalizeMigratableAppsWithCompletion:(id)arg1;
+ (id)_dataTypesAndSizesXMLDataFromMap:(id)arg1;
+ (id)_deviceType;
+ (void)_parseDataTypesXMLData:(id)arg1 completion:(id)arg2;
+ (void)_presentPromptForMigrableApps:(id)arg1;
...
+ (void)finalizeMigratableAppsWithCompletion:(id)arg1;
...
- (id)_selectDataTypes;
- (void)_selectFromDataTypeToSizeMap:(id)arg1 completion:(id)arg2;
...
- (id)auth;
- (void)cancelMigrationWithReply:(id)arg1;
