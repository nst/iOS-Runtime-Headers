...
- (void)_compressFileAtPath:(id)arg1 toPath:(id)arg2 withCompletionBlock:(id)arg3;
- (void)_decompressFileAtPath:(id)arg1 toPath:(id)arg2 withCompletionBlock:(id)arg3;
