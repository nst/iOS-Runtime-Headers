...
- (int)widgetListViewController:(WGWidgetListViewController *)arg1 columnModeForTransitionToSize:(struct CGSize { double x1; double x2; })arg2 withCoordinator:(id <UIViewControllerTransitionCoordinator>)arg3;
