...
- (void)_didReceiveNotification:(id)arg1 remoteNotification:(id)arg2 localNotification:(id)arg3 withCompletion:(id)arg4;
- (void)didReceiveLocalNotification:(id)arg1 withCompletion:(id)arg2;
- (void)didReceiveNotification:(id)arg1 withCompletion:(id)arg2;
