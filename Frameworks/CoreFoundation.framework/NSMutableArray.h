...
- (void)hk_removeObjectsPassingTest:(id)arg1;
...
- (void)_uikbrtInsert:(id)arg1 beforeItemPassingTest:(id)arg2;
...
- (void)_cn_sortUsingAuxiliarySortOrder:(id)arg1 transform:(id)arg2;
...
- (id)fc_mergeSortedOrderedCollection:(id)arg1 usingComparator:(id)arg2;
- (id)fc_popFirstObject;
- (id)fc_popLastObject;
- (void)fc_removeFirstObject;
- (void)fc_removeObject:(id)arg1 sortedUsingSelector:(SEL)arg2;
- (void)fc_removeObjectsPassingTest:(id)arg1;
...
- (id)tsu_dequeue;
- (void)tsu_enqueue:(id)arg1;
- (unsigned long long)tsu_insertObject:(id)arg1 usingComparator:(id)arg2;
- (id)tsu_pop;
- (void)tsu_push:(id)arg1;
- (void)tsu_removeObjectsIdenticalToObjectsInArray:(id)arg1;
- (void)tsu_trimObjectsFromIndex:(unsigned long long)arg1;
