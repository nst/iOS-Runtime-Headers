...
@property (nonatomic, readonly) int _totalNumberOfSections;

- (void).cxx_destruct;
- (id)_assetsDataSourceForExternalIndexPath:(id)arg1 outDataSourceIndex:(out int*)arg2 outLocalIndexPath:(out id*)arg3;
