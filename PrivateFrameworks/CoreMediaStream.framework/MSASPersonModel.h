...
- (id)_commandWithMinimumIdentifier:(id)arg1 outParams:(id*)arg2 outCommandIdentifier:(int*)arg3 outPersonID:(id*)arg4 outAlbumGUID:(id*)arg5 outAssetCollectionGUID:(id*)arg6;
...
- (id)commandAtHeadOfQueueOutParams:(id*)arg1 outCommandIdentifier:(int*)arg2 outPersonID:(id*)arg3 outAlbumGUID:(id*)arg4 outAssetCollectionGUID:(id*)arg5;
- (id)commandWithMinimumIdentifier:(int)arg1 outParams:(id*)arg2 outCommandIdentifier:(int*)arg3 outPersonID:(id*)arg4 outAlbumGUID:(id*)arg5 outAssetCollectionGUID:(id*)arg6;
- (int)countOfEnqueuedCommand:(id)arg1;
- (int)countOfEnqueuedCommands;
...
- (void)dbQueueEnqueueCommand:(id)arg1 params:(id)arg2 personID:(id)arg3 albumGUID:(id)arg4 assetCollectionGUID:(id)arg5 sequenceNumber:(int)arg6;
- (BOOL)dbQueueIsAssetCollectionWithGUIDPending:(id)arg1;
- (BOOL)dbQueueIsGUIDQueued:(id)arg1 inQueue:(id)arg2;
- (int)dbQueueNextCommandSequenceNumber;
- (void)dbQueueRemoveAllEntriesFromTable:(id)arg1;
- (void)dbQueueRemoveCommandAtHeadOfQueue;
- (void)dbQueueRemoveCommandIdentifier:(int)arg1;
...
- (int)dbQueueSmallestCommandSequenceNumber;
...
- (void)removeCommandIdentifier:(int)arg1;
...
- (void)setParams:(id)arg1 forCommandWithIdentifier:(int)arg2;
