...
- (void)_queue_extendAssertionWithBundleID:(id)arg1 dataCode:(long long)arg2 completion:(id)arg3;
...
- (id)appAssertions;
- (id)daemon;
- (void)extendAssertionWithBundleID:(id)arg1 dataCode:(long long)arg2 completion:(id)arg3;
- (id)init;
