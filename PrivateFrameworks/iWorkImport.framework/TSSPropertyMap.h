...
- (void)pSetRepeatedArrayOfFloats:(const struct RepeatedField<float> { float *x1; int x2; int x3; }*)arg1 forProperty:(int)arg2 defaultValues:(double[9])arg3 validator:(id)arg4;
