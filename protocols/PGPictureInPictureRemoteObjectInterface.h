...
- (oneway void)initializePictureInPictureWithControlsStyle:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 8: int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, BOOL, NSError *, void*
- (oneway void)rotateContentContainer:(void *)arg1 withCompletionHandler:(void *)arg2; // needs 2 arg types, found 9: int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, BOOL, NSError *, BKSAnimationFenceHandle *, void*
...
- (oneway void)updatePreferredContentSize:(void *)arg1 withCompletionHandler:(void *)arg2; // needs 2 arg types, found 8: struct CGSize { float x1; float x2; }, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, BOOL, NSError *, void*
