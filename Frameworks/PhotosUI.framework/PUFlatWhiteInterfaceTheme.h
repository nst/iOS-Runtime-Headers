...
@property(readonly) double albumListDisabledAlbumStackViewAlpha;
@property(readonly) double albumListDisabledAlbumTitleAlpha;
...
@property(readonly) double bannerHeight;
...
@property(readonly) double cloudFeedSeparatorHeight;
...
@property(readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } commentsButtonTextInset;
@property(readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } contentCommentsButtonImageInset;
...
@property(readonly) long long defaultKeyboardAppearance;
@property(copy,readonly) NSString * description;
@property(readonly) unsigned long long emptyPlaceholderStyle;
...
@property(readonly) long long photoBrowserStatusBarStyle;
@property(readonly) UIColor * photoCollectionToolbarButtonTintColor;
@property(readonly) double photoCollectionToolbarIconToTextSpacerWidth;
@property(readonly) UIImage * photoCollectionToolbarShadowImage;
@property(readonly) long long photoCollectionToolbarStyle;
@property(readonly) double photoCollectionToolbarTextTitleSpacerWidth;
...
@property(readonly) long long topLevelStatusBarStyle;
@property(readonly) double videoPaletteBottomMargin;
@property(readonly) double videoPaletteSideMargin;
