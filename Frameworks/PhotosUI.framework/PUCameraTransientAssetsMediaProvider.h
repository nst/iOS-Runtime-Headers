...
- (void)_handleLivePhotoPairedVideoRequestResultURL:(id)arg1 stillDisplayTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 error:(id)arg3 requestID:(int)arg4;
