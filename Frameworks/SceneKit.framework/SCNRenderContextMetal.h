...
@interface SCNRenderContextMetal : SCNRenderContextImp <SCNBufferStream> {
    ...
    struct { 
        struct unordered_map<unsigned int, SCNMTLLightSetData, std::__1::hash<unsigned int>, std::__1::equal_to<unsigned int>, std::__1::allocator<std::__1::pair<const unsigned int, SCNMTLLightSetData> > > { 
            struct __hash_table<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, std::__1::__unordered_map_hasher<unsigned int, std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, std::__1::hash<unsigned int>, true>, std::__1::__unordered_map_equal<unsigned int, std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, std::__1::equal_to<unsigned int>, true>, std::__1::allocator<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData> > > { 
                struct unique_ptr<std::__1::__hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> *[], std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> *> > > { 
                    struct __compressed_pair<std::__1::__hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> **, std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> *> > > { 
                        struct __hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> {} **__first_; 
                        struct __bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> *> > { 
                            struct __compressed_pair<unsigned long, std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> *> > { 
                                unsigned long __first_; 
                            } __data_; 
                        } __second_; 
                    } __ptr_; 
                } __bucket_list_; 
                struct __compressed_pair<std::__1::__hash_node_base<std::__1::__hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> *>, std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> > > { 
                    struct __hash_node_base<std::__1::__hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> *> { 
                        struct __hash_node<std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, void *> {} *__next_; 
                    } __first_; 
                } __p1_; 
                struct __compressed_pair<unsigned long, std::__1::__unordered_map_hasher<unsigned int, std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, std::__1::hash<unsigned int>, true> > { 
                    unsigned long __first_; 
                } __p2_; 
                struct __compressed_pair<float, std::__1::__unordered_map_equal<unsigned int, std::__1::__hash_value_type<unsigned int, SCNMTLLightSetData>, std::__1::equal_to<unsigned int>, true> > { 
                    double __first_; 
                } __p3_; 
            } __table_; 
        } frameLightingSetDatas; 
        unsigned int currentLightingHashKey; 
        struct { 
            int count; 
