...
- (id)initWithComposedRoute:(id)arg1 transitStep:(id)arg2 stepIndex:(unsigned int)arg3 geoStep:(id)arg4 pointRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg5 maneuverPointRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg6;
- (id)initWithComposedRoute:(id)arg1 transitStep:(id)arg2 stepIndex:(unsigned int)arg3 startCoordinate:(struct { double x1; double x2; })arg4 endCoordinate:(struct { double x1; double x2; })arg5 pointRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg6;
- (id)instructions;
- (BOOL)isArrivalStep;
