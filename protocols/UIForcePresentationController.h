...
- (id)presentationPhaseCompletionBlock:(void *)arg1; // needs 1 arg types, found 5: id, unsigned long long, void*, id, SEL
...
- (void)setPresentationPhaseCompletionBlock:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, unsigned long long, void*
