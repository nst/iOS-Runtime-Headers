...
- (void)pauseAllActiveWorkoutsWithCompletion:(void *)arg1; // needs 1 arg types, found 5: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
- (void)performBlockWithPowerAssertionIdentifier:(void *)arg1 transactionName:(void *)arg2 powerAssertionInterval:(void *)arg3 block:(void *)arg4; // needs 4 arg types, found 8: NSString *, NSString *, double, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
...
- (void)setCurrentActivityCacheOverrideDate:(void *)arg1 timeZone:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: NSDate *, NSTimeZone *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
