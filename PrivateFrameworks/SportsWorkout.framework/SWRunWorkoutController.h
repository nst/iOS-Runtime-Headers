...
@class SWUserInteractionSnapshotObserver, SWRunWorkout, CLLocation, SWRunWorkoutPreset, SWRemote, SWDataControllerSnapshotObserver, SWFastestDistanceWindowObserver, SWRunSensor, SWIntervalSnapshotObserver, SWDataController, CLLocationManager, NSString, NSMutableArray, NSTimer;
