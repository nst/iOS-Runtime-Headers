...
- (void)loadURLWithMatchRequest:(id)arg1 completionHandler:(id)arg2;
...
- (void)reserveShareParticipantSlots:(long long)arg1 andInvitePlayers:(id)arg2 withMessage:(id)arg3 handler:(id)arg4;
