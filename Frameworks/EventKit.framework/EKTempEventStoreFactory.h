...
+ (int)_storeTypeForTestBackingStoreType:(int)arg1;
+ (id)_tempBase;
+ (id)createEventStoreWithType:(int)arg1;
+ (id)createEventStoreWithType:(int)arg1 options:(id)arg2 forPath:(id*)arg3 forDirectory:(id*)arg4;
+ (id)createEventStoreWithType:(int)arg1 options:(id)arg2 forPath:(id*)arg3 forDirectory:(id*)arg4 existingPath:(id)arg5;
