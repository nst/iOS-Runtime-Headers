...
@class <PLVideoViewDelegate>, AVRemaker, MLPhoto, MLPhotoBakedThumbnails, NSArray, NSDictionary, NSMutableDictionary, NSString, NSTimer, PLAirPlayBackgroundView, PLAirTunesService, PLMoviePlayerController, PLPhotoTileViewController, PLVideoEditingOverlayView, PLVideoOutBackgroundView, PLVideoPosterFrameView, UIButton, UIImage, UIImageView, UIMovieScrubber, UIView;
