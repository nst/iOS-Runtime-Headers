...
@property (nonatomic, readonly) id _resultHandler;
...
- (id)initWithAsset:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 contentMode:(long long)arg3 options:(id)arg4 imageManager:(id)arg5 resultHandler:(id)arg6;
- (void)start;
