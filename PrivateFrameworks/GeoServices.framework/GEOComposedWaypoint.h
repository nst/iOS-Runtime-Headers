...
+ (id)composedWaypointForID:(unsigned int)arg1 traits:(id)arg2 clientAttributes:(id)arg3 completionHandler:(id /* block */)arg4 networkActivityHandler:(id /* block */)arg5;
...
+ (id)composedWaypointForTransitID:(unsigned int)arg1 coordinate:(struct { double x1; double x2; })arg2 isCurrentLocation:(BOOL)arg3 traits:(id)arg4 clientAttributes:(id)arg5 completionHandler:(id /* block */)arg6 networkActivityHandler:(id /* block */)arg7;
