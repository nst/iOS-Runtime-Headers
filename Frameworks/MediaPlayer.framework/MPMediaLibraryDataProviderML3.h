...
- (void)_addGlobalPlaylistToLibraryDatabase:(id)arg1 asLibraryOwned:(bool)arg2 completion:(id)arg3;
...
- (void)_importStoreItemElements:(id)arg1 andAddTracksToCloudLibrary:(bool)arg2 usingCloudAdamID:(long long)arg3 withCompletion:(id)arg4;
...
- (void)addItemsWithIdentifiers:(id)arg1 toPlaylistWithIdentifier:(long long)arg2 completionBlock:(id)arg3;
- (void)addNonLibraryOwnedPlaylistWithGlobalID:(id)arg1 completion:(id)arg2;
- (void)addPlaylistStoreItemsForLookupItems:(id)arg1 withCompletion:(id)arg2;
...
- (void)enumerateEntityChangesAfterSyncAnchor:(id)arg1 maximumRevisionType:(int)arg2 inUsersLibrary:(bool)arg3 itemBlock:(id)arg4 collectionBlock:(id)arg5;
...
- (void)removeItemsAtIndexes:(id)arg1 inPlaylistWithIdentifier:(long long)arg2 completionBlock:(id)arg3;
...
- (void)sdk_addItemWithOpaqueIdentifier:(id)arg1 toPlaylistWithIdentifier:(long long)arg2 completionBlock:(id)arg3;
- (long long)sdk_addPlaylistWithValuesForProperties:(id)arg1;
- (void)setItemsWithIdentifiers:(id)arg1 forPlaylistWithIdentifier:(long long)arg2 completionBlock:(id)arg3;
