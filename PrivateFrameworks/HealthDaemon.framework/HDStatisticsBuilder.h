...
- (id)_initialStatisticsForTimePeriod:(id)arg1 database:(id)arg2 shouldStopProcessing:(id)arg3 error:(id*)arg4;
...
- (bool)initialStatisticsForCollection:(id)arg1 shouldStopProcessing:(id)arg2 shouldSuspend:(id)arg3 batchHandler:(id)arg4 error:(id*)arg5;
