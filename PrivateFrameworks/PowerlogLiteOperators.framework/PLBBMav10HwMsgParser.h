...
@interface PLBBMav10HwMsgParser : PLMav7BasebandHardwareMessage {
    ...
    struct { unsigned int x1; unsigned int x2; } * _apps_sleepNew;
    struct { unsigned int x1[12]; } * _mcpm_sleep_vetoNew;
    struct { unsigned int x1; unsigned int x2; } * _mpss_sleepNew;
    ...
    struct { unsigned char x1[4]; unsigned int x2; unsigned int x3; unsigned int x4[2][3]; unsigned int x5[2][4]; unsigned int x6[2]; unsigned int x7[4]; unsigned int x8[4]; unsigned int x9[12]; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; } * _rfWCDMA;
    struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; } * _rpmNew;
}

@property (nonatomic) struct { unsigned int x1[5]; }*appsNew;
@property (nonatomic) struct { unsigned int x1; unsigned int x2; }*apps_sleepNew;
@property (nonatomic) struct { unsigned int x1[12]; }*mcpm_sleep_vetoNew;
@property (nonatomic) struct { unsigned int x1; unsigned int x2; }*mpss_sleepNew;
...
@property (nonatomic) struct { unsigned char x1[4]; unsigned int x2; unsigned int x3; unsigned int x4[2][3]; unsigned int x5[2][4]; unsigned int x6[2]; unsigned int x7[4]; unsigned int x8[4]; unsigned int x9[12]; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; }*rfWCDMA;
@property (nonatomic) struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; }*rpmNew;
...
- (struct { unsigned int x1; unsigned int x2; }*)apps_sleepNew;
...
- (struct { unsigned int x1; unsigned int x2; }*)mpss_sleepNew;
...
- (struct { unsigned char x1[4]; unsigned int x2; unsigned int x3; unsigned int x4[2][3]; unsigned int x5[2][4]; unsigned int x6[2]; unsigned int x7[4]; unsigned int x8[4]; unsigned int x9[12]; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; }*)rfWCDMA;
- (struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; }*)rpmNew;
- (void)setAppsNew:(struct { unsigned int x1[5]; }*)arg1;
- (void)setApps_sleepNew:(struct { unsigned int x1; unsigned int x2; }*)arg1;
- (void)setMcpm_sleep_vetoNew:(struct { unsigned int x1[12]; }*)arg1;
- (void)setMpss_sleepNew:(struct { unsigned int x1; unsigned int x2; }*)arg1;
...
- (void)setRfWCDMA:(struct { unsigned char x1[4]; unsigned int x2; unsigned int x3; unsigned int x4[2][3]; unsigned int x5[2][4]; unsigned int x6[2]; unsigned int x7[4]; unsigned int x8[4]; unsigned int x9[12]; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; }*)arg1;
- (void)setRpmNew:(struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; }*)arg1;
