...
@interface MTLDebugIndirectArgumentEncoder : MTLToolsIndirectArgumentEncoder {
...
- (void)setIndirectArgumentBuffer:(id)arg1 startOffset:(unsigned long long)arg2 elementIndex:(unsigned long long)arg3;
