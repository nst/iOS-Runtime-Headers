...
+ (void)transcodeVideoWithObjectBuilder:(id)arg1 outputURL:(id)arg2 startTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg3 endTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg4 presetName:(id)arg5 outputFileType:(id)arg6 metadata:(id)arg7 completionHandler:(id /* block */)arg8;
