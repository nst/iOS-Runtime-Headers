...
@class <GKLeaderboardViewControllerDelegate>, <GKLeaderboardViewControllerPrivateDelegate>, GKGame, GKLeaderboardViewController, GKPlayer, GKSparseLeaderboard, GKTableView, GKUITheme, NSDictionary, NSMutableDictionary, NSString, UISegmentedControl, UIView;
