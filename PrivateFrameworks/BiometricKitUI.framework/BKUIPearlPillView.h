...
- (void).cxx_destruct;
- (void)_setState:(unsigned long long)arg1 animated:(bool)arg2 completion:(id /* block */)arg3;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (bool)isCompleted;
- (double)pillFlatLength;
- (double)pillInitialHeight;
- (double)pillInitialLength;
- (double)pillMaxHeight;
- (double)pillMaxLength;
- (void)setColor:(id)arg1 animated:(bool)arg2;
- (void)setColor:(id)arg1 animationDuration:(double)arg2 completion:(id /* block */)arg3;
- (void)setSize:(struct CGSize { double x1; double x2; })arg1 animationDuration:(double)arg2 completion:(id /* block */)arg3;
