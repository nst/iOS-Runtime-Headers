...
- (id)infrequentRecentResultWithDisplayName:(id)arg1 value:(id)arg2 lastSendingAddress:(id)arg3 dateCount:(unsigned int)arg4 date:(id)arg5 group:(BOOL)arg6 completesChosenGroup:(BOOL)arg7;
...
- (id)recentResultWithDisplayName:(id)arg1 value:(id)arg2 lastSendingAddress:(id)arg3 dateCount:(unsigned int)arg4 date:(id)arg5 group:(BOOL)arg6 completesChosenGroup:(BOOL)arg7;
