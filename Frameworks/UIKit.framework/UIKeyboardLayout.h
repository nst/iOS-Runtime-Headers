...
@interface UIKeyboardLayout : UIView <_UIKBRTRecognizerDelegate, _UIKBRTTouchDriftingDelegate, _UIScreenEdgePanRecognizerDelegate> {
    ...
    id  _deferredTaskForActiveTouch;
...
@property (nonatomic, copy) id deferredTaskForActiveTouch;
...
- (void)_enumerateDeferredTouchUUIDs:(id)arg1 withBlock:(id)arg2;
...
- (bool)_shouldAllowKeyboardHandlingIfNecessaryForTouch:(id)arg1 phase:(long long)arg2 withTouchState:(id)arg3 task:(id)arg4;
...
- (void)recognizer:(id)arg1 beginTouchDownForTouchWithId:(id)arg2 atPoint:(struct CGPoint { double x1; double x2; })arg3 forBeginState:(unsigned long long)arg4 whenStateReady:(id)arg5;
- (void)recognizer:(id)arg1 cancelTouchOnLayoutWithId:(id)arg2 startPoint:(struct CGPoint { double x1; double x2; })arg3 endPoint:(struct CGPoint { double x1; double x2; })arg4 whenReady:(id)arg5;
- (void)recognizer:(id)arg1 continueTrackingIgnoredTouchWithId:(id)arg2 currentPoint:(struct CGPoint { double x1; double x2; })arg3 whenReady:(id)arg4;
- (void)recognizer:(id)arg1 releaseTouchToLayoutWithId:(id)arg2 startPoint:(struct CGPoint { double x1; double x2; })arg3 endPoint:(struct CGPoint { double x1; double x2; })arg4 whenReady:(id)arg5;
- (void)recognizer:(id)arg1 restartTouchDownForTouchWithId:(id)arg2 startingAt:(double)arg3 atPoint:(struct CGPoint { double x1; double x2; })arg4 currentPoint:(struct CGPoint { double x1; double x2; })arg5 whenStateReady:(id)arg6;
- (void)recognizer:(id)arg1 shouldContinueTrackingTouchWithId:(id)arg2 startingAt:(double)arg3 atPoint:(struct CGPoint { double x1; double x2; })arg4 currentPoint:(struct CGPoint { double x1; double x2; })arg5 forContinueState:(unsigned long long)arg6 whenStateReady:(id)arg7;
- (void)recognizer:(id)arg1 willIgnoreTouchWithId:(id)arg2 startingAt:(double)arg3 atPoint:(struct CGPoint { double x1; double x2; })arg4 currentPoint:(struct CGPoint { double x1; double x2; })arg5 whenReady:(id)arg6;
...
- (id)touchUpTaskForTouchState:(id)arg1;
- (id)touchVelocities;
