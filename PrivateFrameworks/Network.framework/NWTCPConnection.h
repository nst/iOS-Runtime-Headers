...
- (void)readLength:(unsigned long long)arg1 completionHandler:(id)arg2;
- (void)readMinimumLength:(unsigned long long)arg1 maximumLength:(unsigned long long)arg2 completionHandler:(id)arg3;
- (void)readMinimumLength:(unsigned long long)arg1 maximumLength:(unsigned long long)arg2 timeout:(unsigned long long)arg3 completionHandler:(id)arg4;
- (void)readToPattern:(id)arg1 maximumLength:(unsigned long long)arg2 completionHandler:(id)arg3;
- (id)remoteAddress;
...
- (long long)state;
- (id)txtRecord;
- (void)write:(id)arg1 completionHandler:(id)arg2;
- (void)writeClose;
