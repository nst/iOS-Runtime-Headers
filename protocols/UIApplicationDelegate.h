...
- (bool)application:(void *)arg1 continueUserActivity:(void *)arg2 restorationHandler:(void *)arg3; // needs 3 arg types, found 8: UIApplication *, NSUserActivity *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSArray *, void*
...
- (void)application:(void *)arg1 didReceiveRemoteNotification:(void *)arg2 fetchCompletionHandler:(void *)arg3; // needs 3 arg types, found 8: UIApplication *, NSDictionary *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, unsigned long long, void*
...
- (void)application:(void *)arg1 handleActionWithIdentifier:(void *)arg2 forLocalNotification:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 8: UIApplication *, NSString *, UILocalNotification *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
- (void)application:(void *)arg1 handleActionWithIdentifier:(void *)arg2 forLocalNotification:(void *)arg3 withResponseInfo:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 9: UIApplication *, NSString *, UILocalNotification *, NSDictionary *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
- (void)application:(void *)arg1 handleActionWithIdentifier:(void *)arg2 forRemoteNotification:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 8: UIApplication *, NSString *, NSDictionary *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
- (void)application:(void *)arg1 handleActionWithIdentifier:(void *)arg2 forRemoteNotification:(void *)arg3 withResponseInfo:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 9: UIApplication *, NSString *, NSDictionary *, NSDictionary *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
- (void)application:(void *)arg1 handleEventsForBackgroundURLSession:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 7: UIApplication *, NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
- (bool)application:(UIApplication *)arg1 handleOpenURL:(NSURL *)arg2;
- (void)application:(void *)arg1 handleWatchKitExtensionRequest:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 8: UIApplication *, NSDictionary *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSDictionary *, void*
...
- (void)application:(void *)arg1 performActionForShortcutItem:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: UIApplication *, UIApplicationShortcutItem *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
- (void)application:(void *)arg1 performFetchWithCompletionHandler:(void *)arg2; // needs 2 arg types, found 7: UIApplication *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, unsigned long long, void*
