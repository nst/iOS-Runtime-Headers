...
- (void)_verifyCharacteristicSignature:(id)arg1 completionHandler:(id)arg2;
- (void)_verifyServiceSignature:(id)arg1 completionHandler:(id)arg2;
...
- (void)addPairingWithIdentifier:(id)arg1 publicKey:(id)arg2 admin:(bool)arg3 completionQueue:(id)arg4 completionHandler:(id)arg5;
...
- (void)removePairingForCurrentControllerWithCompletionQueue:(id)arg1 completionHandler:(id)arg2;
- (void)removePairingWithIdentifier:(id)arg1 completionQueue:(id)arg2 completionHandler:(id)arg3;
