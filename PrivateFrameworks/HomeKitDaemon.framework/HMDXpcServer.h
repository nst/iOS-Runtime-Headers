...
- (void)_sendMessage:(id)arg1 andInvokeCompletionHandler:(id)arg2 withDeliveryCompletion:(id)arg3;
...
- (void)sendMessage:(id)arg1 target:(id)arg2 completionQueue:(id)arg3 deliveryCompletionHandler:(id)arg4;
