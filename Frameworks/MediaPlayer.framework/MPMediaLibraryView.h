...
- (void)performCoreQuery:(struct shared_ptr<mlcore::Query> { struct Query {} *x1; struct __shared_weak_count {} *x2; })arg1 withCompletion:(id)arg2;
- (void)performCoreSearchQuery:(struct shared_ptr<mlcore::LocalizedSearchQuery> { struct LocalizedSearchQuery {} *x1; struct __shared_weak_count {} *x2; })arg1 withCompletion:(id)arg2;
