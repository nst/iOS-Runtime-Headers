...
@property (nonatomic, copy) id contactProvider;
...
@property (nonatomic, copy) id ignoreResultBlock;
@property (copy) NSString *lastSendingAddress;
@property (nonatomic, copy) id membersProvider;
...
+ (id)calDAVResultWithAddress:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 resultType:(long long)arg4 groupMembersProvider:(id)arg5;
+ (id)calDAVResultWithAddress:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 resultType:(long long)arg4 groupMembersProvider:(id)arg5 userInfo:(id)arg6;
...
+ (id)localeForHashing;
+ (id)messagesResultWithAddress:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 resultType:(long long)arg4 addressType:(long long)arg5 identifier:(id)arg6 contactProvider:(id)arg7 groupMembersProvider:(id)arg8 userInfo:(id)arg9;
+ (id)messagesResultWithAddress:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 resultType:(long long)arg4 groupMembersProvider:(id)arg5 userInfo:(id)arg6;
+ (id)resultWithDisplayName:(id)arg1;

- (void).cxx_destruct;
- (void)addDiagnosticLog:(id)arg1;
- (void)addDiagnosticLogFuture:(id)arg1;
- (id)address;
- (long long)addressType;
- (long long)compare:(id)arg1;
- (long long)compare:(id)arg1 withPriorityComparator:(id)arg2;
