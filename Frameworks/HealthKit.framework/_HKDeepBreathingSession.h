...
- (void).cxx_destruct;
- (void)_attachServerWithClientQueue:(id)arg1 healthStore:(id)arg2 completion:(id)arg3;
...
- (id)_serverProxy;
- (id)_serverWithErrorHandler:(id)arg1;
...
- (void)startSessionWithStartDate:(id)arg1 completion:(id)arg2;
