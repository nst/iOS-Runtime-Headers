...
@interface CAMCameraRollController : NSObject <PLCameraPreviewWellImageChangeObserver, PUBrowsingViewModelChangeObserver, PUOneUpPresentationHelperAssetDisplayDelegate, PUOneUpPresentationHelperDelegate, PUPhotosDataSourceChangeObserver, UIInteractionProgressObserver, UIViewControllerPreviewingDelegate, UIViewControllerPreviewingDelegate_Private> {
...
@property (setter=_setPhotosDataSource:, nonatomic, retain) PUPhotosDataSource *_photosDataSource;
@property (nonatomic, readonly) NSMutableSet *_sessionAssetUUIDs;
@property (setter=_setShouldPauseAudioSessionUpdatesForCameraRollDismissal:, nonatomic) BOOL _shouldPauseAudioSessionUpdatesForCameraRollDismissal;
