...
@property (nonatomic, readonly) const /* Warning: unhandled struct encoding: '{unordered_set<unsigned int' */ struct *nodesOnSelectedLines; /* unknown property attribute:  std::__1::equal_to<unsigned int> >=f}}} */
@property (nonatomic, readonly) const /* Warning: unhandled struct encoding: '{unordered_set<unsigned int' */ struct *selectedLines; /* unknown property attribute:  std::__1::equal_to<unsigned int> >=f}}} */
...
- (void)_debugHighlightItemAtScreenPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (struct shared_ptr<md::TransitItemMarker> { struct TransitItemMarker {} *x1; struct __shared_weak_count {} *x2; })_itemAtScreenPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)clearDelegates;
- (void)dealloc;
- (void)debugHighlightObjectAtScreenPoint:(struct CGPoint { double x1; double x2; })arg1;
