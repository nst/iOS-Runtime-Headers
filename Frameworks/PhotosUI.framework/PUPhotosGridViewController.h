...
- (void)_navigateToPhotosSearchAnimated:(BOOL)arg1 completion:(id /* block */)arg2;
...
- (void)_presentSearchViewControllerAnimated:(BOOL)arg1 completion:(id /* block */)arg2;
...
- (void)paste:(id)arg1;
- (void)performCommitTransitionForPreviewViewController:(id)arg1 completion:(id /* block */)arg2;
