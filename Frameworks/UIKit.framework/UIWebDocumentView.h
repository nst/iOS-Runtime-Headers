...
@class <UITextInputDelegate>, <UITextInputTokenizer>, CALayer, DOMHTMLElement, DOMNode, NSDictionary, NSTimer, UIActionSheet, UIAutoscroll, UIColor, UIInformalDelegate, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIResponder<UITextInput>, UITapGestureRecognizer, UITextChecker, UITextInputTraits, UITextInteractionAssistant, UITextPosition, UITextRange, UITextSelectionView, UIView, UIView<UITextSelectingContent>, UIWebSelectionAssistant, UIWindow, WebThreadSafeUndoManager, WebView, WebViewReachabilityObserver;
