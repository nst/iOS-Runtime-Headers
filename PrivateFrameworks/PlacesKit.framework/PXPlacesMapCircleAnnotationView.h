...
- (id)renderCircleWithRadius:(float)arg1;
- (id)renderTextLayerWithSize:(struct CGSize { double x1; double x2; })arg1 usingFontName:(id)arg2 fontSize:(int)arg3 text:(id)arg4;
