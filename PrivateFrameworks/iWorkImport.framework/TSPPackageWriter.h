...
- (id)copyData:(id)arg1 withReadChannel:(id)arg2 decryptionInfo:(id)arg3 size:(unsigned int)arg4 preferredFilename:(id)arg5 error:(id*)arg6;
- (void)dealloc;
