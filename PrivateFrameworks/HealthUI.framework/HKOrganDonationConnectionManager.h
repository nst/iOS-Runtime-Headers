...
+ (void)organDonationSignificantDate:(id)arg1;
...
- (id)_genericJSONDataTaskWithRequest:(id)arg1 completionHandler:(id)arg2;
- (id)_getRequestWithURL:(id)arg1 bearerToken:(id)arg2;
- (void)_handleServerErrorWithResponse:(id)arg1 originRequest:(id)arg2 payload:(id)arg3 completion:(id)arg4;
- (void)_handleURLTaskError:(id)arg1 withCompletion:(id)arg2;
...
- (void)_scheduleAccessTokenDependentRequest:(id)arg1 withCompletion:(id)arg2;
...
- (id)defaultSession;
- (id)delegate;
- (void)deleteRegistrantWithCompletion:(id)arg1;
- (id)init;
- (id)jwtHeader;
- (id)jwtPayloadWithRegistrant:(id)arg1;
- (void)openRegisterMeSiteInSafariIfAuthenticated;
- (id)payload;
- (void)refreshBearerTokenWithRefreshToken:(id)arg1 completion:(id)arg2;
- (id)refreshToken;
- (void)reloadRegistrantWithCompletion:(id)arg1;
...
- (void)submitRegistrant:(id)arg1 completion:(id)arg2;
- (void)updateRegistrantWithParams:(id)arg1 completion:(id)arg2;
