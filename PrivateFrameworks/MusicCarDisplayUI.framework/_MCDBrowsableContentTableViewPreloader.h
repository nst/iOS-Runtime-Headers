...
- (long long)index;
- (id)indexPath;
- (id)initWithContainer:(id)arg1 index:(long long)arg2 sourceViewController:(id)arg3 rootTableView:(bool)arg4 tabbedBrowsing:(bool)arg5 cancelledBlock:(id)arg6;
- (bool)isCancelled;
