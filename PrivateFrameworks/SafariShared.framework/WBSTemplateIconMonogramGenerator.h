...
- (id)monogramWithTitle:(id)arg1 url:(id)arg2 size:(struct CGSize { double x1; double x2; })arg3 fontSize:(float)arg4 fontWeight:(int)arg5 baselineOffset:(float)arg6 backgroundColor:(id)arg7 cornerRadius:(float)arg8;
