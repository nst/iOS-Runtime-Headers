...
@property(readonly) UIColor * attachmentBalloonSubtitleTextColor;
@property(readonly) UIColor * attachmentBalloonTitleTextColor;
...
@property(readonly) float balloonMaskTailHeight;
@property(readonly) float balloonMaskTailWidth;
@property(readonly) NSString * balloonName;
...
@property(readonly) BOOL calculatesWidthForAttachmentBalloons;
...
@property(readonly) float checkmarkHorizontalPadding;
@property(readonly) UIImage * chevronImage;
@property(readonly) unsigned int commonRepliesLoadLimit;
@property(readonly) UIFont * contactAttachmentNameFont;
@property(readonly) UIFont * contactAttachmentOrgFont;
@property(readonly) float contactBalloonHeight;
@property(readonly) float contactBalloonInnerItemSpacing;
@property(readonly) float contactBalloonMinWidth;
@property(readonly) float contactBalloonNameOrgSpacing;
@property(readonly) float contactBalloonOrgBottomSpacing;
@property(readonly) float contactBalloonTopNameSpacing;
@property(readonly) Class contactBalloonViewClass;
@property(readonly) struct CGSize { float x1; float x2; } contactImageSize;
...
@property(readonly) float conversationListCellBackgroundPadding;
@property(readonly) float conversationListCellLeftMargin;
@property(readonly) unsigned int conversationListCellMaxSummaryLength;
@property(readonly) float conversationListCellRightMargin;
@property(readonly) unsigned int conversationListCellSummaryNumberOfLines;
@property(readonly) float conversationListContactImageDiameter;
@property(readonly) UIColor * conversationListDateColor;
@property(readonly) UIFont * conversationListDateFont;
@property(readonly) float conversationListEditingTableMarginWidth;
@property(readonly) struct UIEdgeInsets { float x1; float x2; float x3; float x4; } conversationListFilterSegmentInset;
@property(readonly) UIColor * conversationListGroupCountColor;
@property(readonly) UIFont * conversationListGroupCountFont;
...
@property(readonly) Class conversationListNavigationControllerClass;
@property(readonly) UIColor * conversationListSenderColor;
@property(readonly) UIFont * conversationListSenderFont;
@property(readonly) UIColor * conversationListSummaryColor;
@property(readonly) UIFont * conversationListSummaryFont;
@property(readonly) float conversationListTableMarginWidth;
@property(readonly) Class conversationListTableViewClass;
@property(readonly) UIColor * darkAppTintColor;
@property(readonly) BOOL darkUIEnabled;
@property(readonly) NSDictionary * datestampTranscriptBoldTextAttributes;
@property(readonly) NSDictionary * datestampTranscriptTextAttributes;
...
@property(readonly) UIImage * detailsImage;
...
@property(readonly) float emojiPreviewMaxWidth;
...
@property(readonly) UIColor * grayTextColor;
@property(readonly) BOOL handlesBalloonViewTitleTapsSeparately;
@property(readonly) UIFont * headerFont;
@property(readonly) BOOL hideUnreadCountInTitleBar;
@property(readonly) BOOL hidesUnreadIndicatorWhenEditing;
@property(readonly) BOOL hyphenatesTextContent;
@property(readonly) unsigned int initialConversationViewingMessageCount;
@property(readonly) BOOL isAccessibilityPreferredContentSizeCategory;
@property(readonly) BOOL isSizeConstrained;
...
@property(readonly) UIColor * messagesControllerBackgroundColor;
...
@property(readonly) BOOL modifiesFirstBalloonLayout;
@property(readonly) BOOL modifiesSingleLineBalloonLayout;
...
@property(readonly) float nanoNoteSenderContentSpace;
@property(readonly) Class navigationBarClass;
@property(readonly) UIColor * notificationSubtitleColor;
@property(readonly) unsigned int numberOfAssetsInPhotoPicker;
@property(readonly) unsigned int numberOfButtonsInPhotoPicker;
@property(readonly) BOOL opensLocationsInMapsApp;
...
@property(readonly) float photoPickerMaxPopoverPhotoHeight;
...
@property(readonly) struct CGSize { float x1; float x2; } photoSheetProgressIndicatorSize;
@property(readonly) float photoSheetVideoIconPadding;
@property(readonly) BOOL photosIsWhitelisted;
@property(readonly) UIImage * playButtonArrowImage;
@property(readonly) int playButtonBackdropStyle;
@property(readonly) UIImage * playButtonImage;
@property(readonly) BOOL playButtonPunchesOutArrow;
@property(readonly) BOOL playsInlineVideo;
...
@property(readonly) UIColor * progressBarTrackTintColor;
@property(readonly) BOOL promptsForReadReceiptsSetting;
...
@property(readonly) BOOL recordsRecentContact;
@property(readonly) BOOL resetsIdleTimer;
...
@property(readonly) BOOL scrollToBottomStopsAtTopOfLastBubble;
...
@property(readonly) BOOL shouldAdjustWidthForSendFailure;
...
@property(readonly) BOOL shouldFillAttachmentBalloon;
@property(readonly) BOOL shouldGrabBackgroundAssertion;
@property(readonly) BOOL shouldHomogenizeAtomsForPreferredService;
@property(readonly) BOOL shouldInsetForStatusBar;
...
@property(readonly) BOOL shouldShowSearchBarInConversationList;
...
@property(readonly) BOOL shouldUseRotisserieScrolling;
...
@property(readonly) BOOL showsBalloonChevron;
@property(readonly) BOOL showsCompositionPanel;
@property(readonly) BOOL showsConversationListCellChevronImage;
@property(readonly) BOOL showsFileSizeInSubtitle;
@property(readonly) BOOL showsNoMessagesDialog;
@property(readonly) BOOL showsPlaceCardForBalloonViewTitleTap;
@property(readonly) BOOL showsProgressInNavigationBar;
@property(readonly) BOOL showsSendAnimation;
@property(readonly) BOOL showsVCalViewer;
@property(readonly) NSString * skinnyBalloonName;
@property(readonly) float skinnyBalloonWidthDifference;
@property(readonly) NSString * skinnyTaillessBalloonName;
...
@property(readonly) NSString * strokedBalloonName;
@property(readonly) NSString * strokedTaillessBalloonName;
@property(readonly) float summaryDateConversationListSpace;
@property(readonly) unsigned int supportedInterfaceOrientations;
@property(readonly) BOOL supportsContiguousAttachments;
@property(readonly) BOOL supportsPassbookAttachments;
@property(readonly) BOOL supportsTypingIndicatorAnimation;
@property(readonly) NSString * taillessBallonName;
...
@property(readonly) BOOL timestampsPushBalloons;
...
@property(readonly) float transcriptButtonCharge;
@property(readonly) struct UIEdgeInsets { float x1; float x2; float x3; float x4; } transcriptButtonContentEdgeInsets;
@property(readonly) NSDictionary * transcriptButtonTextAttributes;
@property(readonly) BOOL transcriptCanUseOpaqueMask;
...
@property(readonly) UIFont * transcriptJunkHeaderButtonFont;
@property(readonly) float transcriptJunkHeaderButtonHeight;
@property(readonly) UIFont * transcriptJunkHeaderTitleFont;
@property(readonly) int transcriptLoadingIndicatorStyle;
...
@property(readonly) BOOL useSingleLineForContactVCardNames;
@property(readonly) BOOL usesCustomSplitViewMasterColumnWidth;
@property(readonly) BOOL usesDataDetectorsUI;
@property(readonly) BOOL usesEntryView;
@property(readonly) BOOL usesJoystick;
@property(readonly) BOOL usesNavigationBarControls;
