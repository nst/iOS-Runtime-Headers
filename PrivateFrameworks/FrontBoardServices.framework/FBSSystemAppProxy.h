...
- (void)dataResetWithRequest:(id)arg1 completion:(id)arg2;
- (void)dealloc;
...
- (id)init;
- (void)isPasscodeLockedOrBlockedWithCompletion:(id)arg1;
- (void)openApplication:(id)arg1 options:(id)arg2 clientHandle:(id)arg3 withResult:(id)arg4;
...
- (void)setKeyboardFocusApplicationWithBundleID:(id)arg1 pid:(int)arg2 completion:(id)arg3;
...
- (void)terminateApplication:(id)arg1 forReason:(int)arg2 andReport:(bool)arg3 withDescription:(id)arg4 completion:(id)arg5;
- (void)terminateApplicationGroup:(int)arg1 forReason:(int)arg2 andReport:(bool)arg3 withDescription:(id)arg4 completion:(id)arg5;
