...
- (void)_sendSimpleMessage:(id)arg1 completionBlock:(id)arg2;
- (void)addUploadObserver:(id)arg1;
- (void)cancelAllUploadsWithCompletionBlock:(id)arg1;
- (void)cancelUploads:(id)arg1 completionBlock:(id)arg2;
- (void)dealloc;
- (void)getUploadsWithCompletionBlock:(id)arg1;
- (id)init;
- (id)initWithUploadKinds:(id)arg1;
- (void)pauseAllUploadsWithCompletionBlock:(id)arg1;
- (void)pauseUploads:(id)arg1 completionBlock:(id)arg2;
- (void)removeUploadObserver:(id)arg1;
- (void)resumeAllUploadsWithCompletionBlock:(id)arg1;
- (void)resumeUploads:(id)arg1 completionBlock:(id)arg2;
- (id)uploadKinds;
