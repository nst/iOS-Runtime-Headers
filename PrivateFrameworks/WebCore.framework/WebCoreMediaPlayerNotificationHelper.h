...
@class NSMutableDictionary, NSObject, WebCoreMediaPlayerNotificationHelper;
...
@interface WebCoreMediaPlayerNotificationHelper : NSObject {
    struct MediaPlayerPrivateiPhone { int (**x1)(); struct MediaPlayer {} *x2; struct RetainPtr<NSObject> { 
        ...
        } x5; int x6; int x7; int x8; int x9; float x10; unsigned int x11 : 1; unsigned int x12 : 1; unsigned int x13 : 1; unsigned int x14 : 1; unsigned int x15 : 1; unsigned int x16 : 1; } *_client;
...
- (void)disconnect;
- (id)initWithClient:(struct MediaPlayerPrivateiPhone { int (**x1)(); struct MediaPlayer {} *x2; struct RetainPtr<NSObject> { id x_3_1_1; } x3; struct RetainPtr<WebCoreMediaPlayerNotificationHelper> { id x_4_1_1; } x4; struct RetainPtr<NSMutableDictionary> { id x_5_1_1; } x5; int x6; int x7; int x8; int x9; float x10; unsigned int x11 : 1; unsigned int x12 : 1; unsigned int x13 : 1; unsigned int x14 : 1; unsigned int x15 : 1; unsigned int x16 : 1; }*)arg1;
