...
- (void)_contentViewControllerWillTransitionToSize:(struct CGSize { double x1; double x2; })arg1 withAnimations:(id)arg2;
...
- (void)_performAction:(id)arg1 invokeActionBlock:(id)arg2 dismissAndPerformActionIfNotAlreadyPerformed:(id)arg3;
- (void)_performBatchActionChangesWithBlock:(id)arg1;
...
+ (id)mf_actionSheetWithTitle:(id)arg1 cancellationHandler:(id)arg2;
+ (id)mutedThreadActionAlertControllerWithHandler:(id)arg1;
+ (id)notifyMeConfirmationControllerWithHandler:(id)arg1;

- (void)mf_addCancelActionWithHandler:(id)arg1;
...
+ (id)alertControllerForAddingDestinationWithType:(unsigned long long)arg1 andProceed:(id)arg2;
+ (id)alertControllerForAddingDestinationWithTypeString:(id)arg1 andProceed:(id)arg2;
+ (id)alertControllerForAddingHomeWithProceed:(id)arg1;
+ (id)alertControllerForAddingRoomWithProceed:(id)arg1;
+ (id)alertControllerForAddingServiceGroupWithProceed:(id)arg1;
+ (id)alertControllerForAddingZoneWithProceed:(id)arg1;
