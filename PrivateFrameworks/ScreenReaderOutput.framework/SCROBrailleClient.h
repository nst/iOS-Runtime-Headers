...
@interface SCROBrailleClient : NSObject {
    ...
    bool_delegateWantsKeypresses;
    bool_displayDescriptorCallbackEnabled;
    bool_isReady;
    bool_keepConnectionAlive;
    bool_needsDisplay;
    bool_wantsDisconnectMessage;
    bool_wantsDisplayConfigurationChanged;
    bool_wantsReconnectMessage;
}
