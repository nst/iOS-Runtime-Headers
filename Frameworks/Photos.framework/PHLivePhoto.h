...
+ (int)requestLivePhotoWithResourceFileURLs:(id)arg1 placeholderImage:(id)arg2 targetSize:(struct CGSize { double x1; double x2; })arg3 contentMode:(long long)arg4 resultHandler:(id)arg5;
...
- (void)_loadConstituentURLsWithNetworkAccessAllowed:(bool)arg1 completionHandler:(id)arg2;
...
- (void)saveToPhotoLibraryWithCompletionHandler:(id)arg1;
