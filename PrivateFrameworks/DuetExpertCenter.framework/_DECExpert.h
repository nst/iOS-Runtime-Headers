...
- (void)predictionForCategories:(unsigned long long)arg1 consumer:(unsigned long long)arg2 criteria:(id)arg3 limit:(unsigned long long)arg4 reply:(id)arg5;
- (void)prewarmPredictionForCategories:(unsigned long long)arg1 consumer:(unsigned long long)arg2 reply:(id)arg3;
- (id)queue;
- (void)receiveAppWidgetFeedback:(id)arg1 consumerType:(unsigned long long)arg2 reply:(id)arg3;
- (void)receiveFeedback:(id)arg1 consumer:(unsigned long long)arg2 reply:(id)arg3;
- (void)receiveUserAction:(id)arg1 reply:(id)arg2;
- (void)receiveZkwSpotlightFeedback:(id)arg1 consumerType:(unsigned long long)arg2 reply:(id)arg3;
- (void)restoreModelWithReply:(id)arg1;
- (void)saveModelWithByteLimit:(unsigned long long)arg1 reply:(id)arg2;
