...
@property(readonly) /* Warning: unhandled struct encoding: '{Matrix<float' */ struct  centroid; /* unknown property attribute:  1>=[2f]} */
...
@property(readonly) struct * fillMeshes; /* unknown property attribute:  std::__1::allocator<ggl::PolygonBase::CompressedMeshMesh> >=^{CompressedMeshMesh}}} */
@property(readonly) struct * fillMeshesForPointyRoofs; /* unknown property attribute:  std::__1::allocator<ggl::PolygonBase::CompressedMeshMesh> >=^{CompressedMeshMesh}}} */
@property(readonly) BOOL isFixedSize;
@property(readonly) struct  origin; /* unknown property attribute:  1>=[3f]} */
...
@property(readonly) struct  size; /* unknown property attribute:  1>=[3f]} */
...
@property(readonly) float tileZoom;
