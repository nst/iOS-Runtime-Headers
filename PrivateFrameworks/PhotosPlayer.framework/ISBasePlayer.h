...
@property (setter=_setVideoForwardPlaybackEndTime:, nonatomic) struct { int x1; int x2; unsigned int x3; int x4; } _videoForwardPlaybackEndTime;
@property (setter=_setVideoVolume:, nonatomic) double _videoVolume;
...
- (void)_setForwardPlaybackEndTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
- (void)_setLastAppliedLayoutInfo:(id)arg1;
- (void)_setPlayerItemDidPlayToEndObserver:(id)arg1;
- (void)_setStatus:(int)arg1;
- (void)_setVideoForwardPlaybackEndTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg1;
...
- (struct { int x1; int x2; unsigned int x3; int x4; })_videoForwardPlaybackEndTime;
- (float)_videoVolume;
...
- (BOOL)behavior:(id)arg1 seekVideoPlayerToTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg2 completionHandler:(id /* block */)arg3;
- (void)behavior:(id)arg1 setAudioEnabled:(BOOL)arg2;
- (void)behavior:(id)arg1 setCrossfadePlayRate:(float)arg2;
- (void)behavior:(id)arg1 setVideoForwardPlaybackEndTime:(struct { int x1; int x2; unsigned int x3; int x4; })arg2;
