...
- (void)_commonInit;
- (id)_createRegistrationWithReplyMachPort:(unsigned int)arg1 forAsyncReplyOnQueue:(id)arg2 responseHandler:(id)arg3;
...
- (bool)_prepareToSendMessage:(id)arg1 withError:(id*)arg2 prepSuccessHandler:(id)arg3;
...
- (bool)sendAsyncMessage:(id)arg1 replyOnQueue:(id)arg2 replyHandler:(id)arg3;
- (bool)sendAsyncMessage:(id)arg1 withReplyHandler:(id)arg2;
