...
- (id)delegate;
- (void)dismissCurrentFullscreenBrowserAnimated:(bool)arg1 completion:(id)arg2;
...
- (void)presentCurrentBrowserFullscreenAnimated:(bool)arg1 completion:(id)arg2;
...
- (void)transitionCurrentBrowserToCollapsedPresentationAnimated:(bool)arg1 completion:(id)arg2;
- (void)transitionCurrentBrowserToExpandedPresentationAnimated:(bool)arg1 completion:(id)arg2;
- (bool)underTest;
