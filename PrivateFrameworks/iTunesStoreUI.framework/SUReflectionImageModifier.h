...
@property float reflectionHeight; /* unknown property attribute: V_reflectionHeight */
@property(retain) UIGradient *gradient; /* unknown property attribute: V_gradient */
