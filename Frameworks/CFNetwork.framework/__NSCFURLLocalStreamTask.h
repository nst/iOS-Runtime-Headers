...
- (long long)_expectedWorkload;
- (bool)_goneSecure;
- (id)_initCommonWithSession:(id)arg1 disavow:(id)arg2;
- (id)_initWithExistingTask:(id)arg1 disavow:(id)arg2;
- (id)_initWithSession:(id)arg1 disavow:(id)arg2;
...
- (void)_onqueue_addBlockOpAtHead:(id)arg1 description:(const char *)arg2;
...
- (void)_onqueue_readDataOfMinLength:(unsigned long long)arg1 maxLength:(unsigned long long)arg2 timeout:(double)arg3 completionHandler:(id)arg4;
...
- (void)_onqueue_writeData:(id)arg1 timeout:(double)arg2 completionHandler:(id)arg3;
...
- (id)initWithNetService:(id)arg1 session:(id)arg2 disavow:(id)arg3;
- (id)originalRequest;
