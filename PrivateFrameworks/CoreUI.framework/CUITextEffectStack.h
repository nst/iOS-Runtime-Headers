...
- (void)_drawShadow:(struct { float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; struct CGPoint { double x_9_1_1; double x_9_1_2; } x9; })arg1 usingQuartz:(id)arg2 inContext:(struct CGContext { }*)arg3;
...
- (void)drawUsingQuartz:(id)arg1 inContext:(struct CGContext { }*)arg2 inBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 atScale:(double)arg4;
