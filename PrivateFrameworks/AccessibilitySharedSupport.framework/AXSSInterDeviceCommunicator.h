...
@interface AXSSInterDeviceCommunicator : NSObject <IDSServiceDelegate, MCNearbyServiceAdvertiserDelegate, MCNearbyServiceBrowserDelegate, MCSessionDelegate> {
    ...
    MCPeerID * _master;
    unsigned int  _numberOfBurstPacketsRemaining;
...
@property (nonatomic) unsigned int numberOfBurstPacketsRemaining;
...
- (id)localPeerID;
- (id)master;
- (unsigned int)numberOfBurstPacketsRemaining;
- (void)search;
- (id)searchObserver;
- (id)searchResults;
- (id)securityHelper;
...
- (void)setNumberOfBurstPacketsRemaining:(unsigned int)arg1;
