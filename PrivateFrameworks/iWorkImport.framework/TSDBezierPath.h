...
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })p_pathToBounds:(struct Path { int x1; int x2; int x3; struct path_descr {} *x4; int x5; int x6; boolx7; boolx8; int x9; int x10; int x11; char *x12; }*)arg1;
...
- (void)addClip;
- (void)addIntersectionsWithLine:(struct CGPoint { double x1; double x2; }[2])arg1 to:(id)arg2;
...
- (struct CGPoint { double x1; double x2; })nearestAngleOnPathToLine:(struct CGPoint { double x1; double x2; }[2])arg1;
- (struct CGPoint { double x1; double x2; })nearestPointOnPathToLine:(struct CGPoint { double x1; double x2; }[2])arg1;
- (id)outlineStroke;
