...
- (void)observer:(void *)arg1 addBulletin:(void *)arg2 forFeed:(void *)arg3 playLightsAndSirens:(void *)arg4 withReply:(void *)arg5; // needs 5 arg types, found 10: BBObserver *, BBBulletin *, unsigned long long, bool, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
...
- (void)observer:(void *)arg1 composedImageFromThumbnailData:(void *)arg2 forAttachment:(void *)arg3 bulletin:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 10: BBObserver *, NSData *, BBAttachmentMetadata *, BBBulletin *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, UIImage *, void*
...
- (void)observer:(void *)arg1 prepareAttachment:(void *)arg2 beforeDeliveringBulletin:(void *)arg3 withCompletionHandler:(void *)arg4; // needs 4 arg types, found 9: BBObserver *, BBAttachmentMetadata *, BBBulletin *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, unsigned long long, void*
- (void)observer:(void *)arg1 processData:(void *)arg2 forAttachment:(void *)arg3 bulletin:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 10: BBObserver *, NSData *, BBAttachmentMetadata *, BBBulletin *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSData *, void*
