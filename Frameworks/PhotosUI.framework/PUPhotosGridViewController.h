...
@property (nonatomic, copy) id onViewDidAppearCompletion;
...
@property (setter=ppt_setNextDeleteFinishedBlock:, nonatomic, copy) id ppt_nextDeleteFinishedBlock;
...
- (void)_presentSharingViewController:(id)arg1 completion:(id)arg2;
...
- (id)displayTitleInfoForDetailsOfAssetCollection:(id)arg1 withTitleCategory:(long long)arg2 preferredAttributesPromise:(id)arg3;
...
- (void)sender:(id)arg1 shareAssetsInFetchResult:(id)arg2 forAssetCollection:(id)arg3 withCompletion:(id)arg4;
- (void)sender:(id)arg1 shareSelectedAssetsWithCompletion:(id)arg2;
- (id)sessionInfo;
