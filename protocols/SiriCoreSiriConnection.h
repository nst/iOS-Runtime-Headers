...
- (void)barrier:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
- (void)cancelSynchronously:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 6: bool, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
- (NSString *)connectionId;
- (<SiriCoreSiriConnectionDelegate> *)delegate;
- (bool)deviceIsInWalkaboutExperimentGroup;
- (void)getAnalysisInfo:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, SiriCoreAceConnectionAnalysisInfo *, void*
- (void)getConnectionMetrics:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, SiriCoreConnectionMetrics *, void*
...
- (void)sendCommand:(void *)arg1 errorHandler:(void *)arg2; // needs 2 arg types, found 7: <SiriCoreSessionObject> *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSError *, void*
