...
- (void)_plansForRenewal:(bool)arg1 completion:(id)arg2 latitude:(id)arg3 longitude:(id)arg4;
- (void)_reconnect;
- (void)_subscriptionDetailsWithCompletion:(id)arg1 andServerSync:(bool)arg2;
