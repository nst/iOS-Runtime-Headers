...
- (BOOL)assetExplorerReviewScreenActionManager:(id)arg1 canPerformActionType:(unsigned int)arg2 onAsset:(id)arg3 inAssetCollection:(id)arg4;
...
- (BOOL)assetExplorerReviewScreenActionManager:(id)arg1 shouldEnableActionType:(unsigned int)arg2 onAsset:(id)arg3 inAssetCollection:(id)arg4;
...
- (id)delegate;
- (id)initWithDataSourceManager:(id)arg1 mediaProvider:(id)arg2 reviewAssetProvider:(id)arg3 initialIndexPath:(id)arg4 initialSelectedAssetUUIDs:(id)arg5 initialDisabledLivePhotoAssetUUIDs:(id)arg6 sourceType:(unsigned int)arg7;
