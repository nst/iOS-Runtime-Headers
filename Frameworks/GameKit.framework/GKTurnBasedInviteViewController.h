...
@class <GKTurnBasedInviteViewControllerDelegate>, GKFriendPickerViewController, GKGameDetailHeaderView, GKMatchRequest, GKMatchmakerNavView, GKPlayer, GKTableView, GKUITheme, NSArray, NSError, NSMutableArray, NSMutableDictionary, NSString, UIActivityIndicatorView, UIButton, UILabel, UIView;
