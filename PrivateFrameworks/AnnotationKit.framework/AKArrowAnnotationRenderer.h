...
+ (void)_arrowHeadLineIntersection:(id)arg1 outStartIntersection:(struct CGPoint { double x1; double x2; }*)arg2 outBezierStartParameter:(float*)arg3 outEndIntersection:(struct CGPoint { double x1; double x2; }*)arg4 outBezierEndParameter:(float*)arg5;
...
+ (struct CGPoint { double x1; double x2; })_cubicBezierPointForParameter:(float)arg1 start:(struct CGPoint { double x1; double x2; })arg2 controlPt1:(struct CGPoint { double x1; double x2; })arg3 controlPt2:(struct CGPoint { double x1; double x2; })arg4 end:(struct CGPoint { double x1; double x2; })arg5;
