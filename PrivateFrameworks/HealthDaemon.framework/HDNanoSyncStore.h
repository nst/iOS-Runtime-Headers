...
- (void)addIncomingSyncObserverWithTimeout:(double)arg1 timeoutHandler:(id)arg2 completion:(id)arg3;
- (void)addPendingRequestContext:(id)arg1 forUUID:(id)arg2;
- (id)beginRestoreSessionWithUUID:(id)arg1 timeout:(double)arg2 timeoutHandler:(id)arg3;
