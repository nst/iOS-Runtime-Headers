...
- (void)_getLocalIconForBundleID:(id)arg1 iconVariant:(int)arg2 block:(id)arg3;
- (void)_getLocalIconForBundleID:(id)arg1 iconVariant:(int)arg2 queue:(id)arg3 block:(id)arg4;
- (void)_setCachedIcon:(id)arg1 forIconVariant:(int)arg2 inBundleID:(id)arg3;
- (id)connectToService;
- (bool)connectionMayBeValid;
- (void)dealloc;
- (void)getCachedIconForBundleID:(id)arg1 iconVariant:(int)arg2 outIconImage:(id*)arg3 queue:(id)arg4 updateBlock:(id)arg5 timeout:(double)arg6;
- (void)getCachedIconForBundleID:(id)arg1 iconVariant:(int)arg2 outIconImage:(id*)arg3 updateBlock:(id)arg4;
- (void)getCachedIconForBundleID:(id)arg1 iconVariant:(int)arg2 outIconImage:(id*)arg3 updateBlock:(id)arg4 timeout:(double)arg5;
- (void)getIconForBundleID:(id)arg1 iconVariant:(int)arg2 block:(id)arg3 timeout:(double)arg4;
- (void)getIconForBundleID:(id)arg1 iconVariant:(int)arg2 queue:(id)arg3 block:(id)arg4 timeout:(double)arg5;
- (void)getRemoteIconForBundleID:(id)arg1 iconVariant:(int)arg2 block:(id)arg3 timeout:(double)arg4;
- (void)getRemoteIconForBundleID:(id)arg1 iconVariant:(int)arg2 queue:(id)arg3 block:(id)arg4 timeout:(double)arg5;
- (void)getRemoteIconForBundleIDBypassingCache:(id)arg1 iconVariant:(int)arg2 block:(id)arg3 timeout:(double)arg4;
- (id)grabIconForBundleID:(id)arg1 iconVariant:(int)arg2 updateBlock:(id)arg3;
- (id)iconCacheQueue;
- (id)init;
- (id)nrgdConnection;
- (id)queue;
