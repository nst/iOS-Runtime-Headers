...
- (void)createAdditionStagedAtURL:(void *)arg1 creationInfo:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 9: NSURL *, NSDictionary *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, GSAddition *, NSError *, void*
- (NSURL *)documentURL;
...
- (void)removeAdditions:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 8: NSArray *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSDictionary *, NSError *, void*
- (void)removeAllAdditionsForNamespaces:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: NSArray *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSError *, void*
