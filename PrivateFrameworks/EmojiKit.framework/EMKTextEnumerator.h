...
- (void)enumerateEmojiSignifiersInString:(id)arg1 touchingRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 language:(id)arg3 usingBlock:(id)arg4;
- (id)init;
