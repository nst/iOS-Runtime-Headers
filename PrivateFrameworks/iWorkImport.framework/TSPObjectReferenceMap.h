...
- (id)descriptionOfAllPossiblePathsToObjectIdentifier:(long long)arg1 withLimit:(unsigned int)arg2;
...
- (id)parentObjectPathsForObjectIdentifier:(long long)arg1 limit:(unsigned int)arg2 totalParentObjects:(unsigned int*)arg3;
- (id)parentObjectsForObject:(id)arg1;
- (id)parentObjectsForObjectIdentifier:(long long)arg1;
- (unsigned int)visitObjectWithIdentifier:(long long)arg1 level:(unsigned int)arg2 mode:(int)arg3 limit:(unsigned int)arg4 pathSuffix:(id)arg5 visitedObjectIdentifiers:(id)arg6 updatingParentObjectPaths:(id)arg7;
