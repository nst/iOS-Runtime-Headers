...
@property (nonatomic) unsigned int maxDatabaseSize;
...
- (void)_evict;
- (unsigned int)_freeableDiskSpace;
...
- (void)_shrinkToUnderSize:(unsigned int)arg1 vacuum:(BOOL)arg2;
...
- (void)setMaxDatabaseSize:(unsigned int)arg1;
- (void)shrinkBySize:(unsigned int)arg1 callback:(id /* block */)arg2 onQueue:(id)arg3;
- (void)shrinkToSize:(unsigned int)arg1 finished:(id /* block */)arg2 onQueue:(id)arg3;
