...
@class GKBackgroundView, IUWildcatVideosViewController, IUiPodSegmentedViewController, NSArray, NSBundle, NSDictionary, NSMutableArray, NSString, SUStorePageProtocol, UIBarButtonItem, UIDimmingView, UIDropShadowView, UINavigationController, UINavigationItem, UIPopoverController, UIResponder, UISearchDisplayController, UISplitViewController, UIStoryboard, UITabBarController, UITabBarItem, UITransitionView, UIView, UIViewController;
