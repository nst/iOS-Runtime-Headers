...
- (void).cxx_destruct;
- (id)URLForTilePath:(struct { int x1; int x2; int x3; double x4; })arg1;
- (id)URLTemplate;
- (void)_assignProviderID;
- (void)_flushCaches;
- (struct _GEOTileKey { unsigned int x1 : 6; unsigned int x2 : 26; unsigned int x3 : 26; unsigned int x4 : 6; unsigned int x5 : 8; unsigned int x6 : 8; unsigned int x7 : 8; unsigned int x8 : 1; unsigned int x9 : 7; unsigned char x10[4]; })_keyForPath:(struct { int x1; int x2; int x3; double x4; })arg1;
...
- (void)loadTileAtPath:(struct { int x1; int x2; int x3; double x4; })arg1 result:(id /* block */)arg2;
- (int)maximumZ;
- (int)minimumZ;
