...
- (bool)_saveUser:(id)arg1 password:(id)arg2 forURL:(id)arg3 formType:(unsigned long long)arg4 promptingPolicy:(long long)arg5 webView:(id)arg6 completionHandler:(id)arg7;
...
- (bool)_webView:(id)arg1 saveCredentialsForURL:(id)arg2 formSubmission:(bool)arg3 formWithMetadata:(id)arg4 fromFrame:(id)arg5 username:(id)arg6 password:(id)arg7 submissionHandler:(id)arg8;
...
- (bool)_webView:(id)arg1 willSubmitLoginFormWithMetadata:(id)arg2 formSubmission:(bool)arg3 fromFrame:(id)arg4 submissionHandler:(id)arg5;
...
- (void)gatherAutoFillDisplayDataWithFormMetadata:(id)arg1 multiRoundAutoFillManager:(id)arg2 completionHandler:(id)arg3;
- (void)gatherAutoFillDisplayDataWithTextField:(id)arg1 displayedInQuickType:(bool)arg2 prefix:(id)arg3 completionHandler:(id)arg4;
- (void)gatherValuesForForm:(id)arg1 inFrame:(id)arg2 multiRoundAutoFillManager:(id)arg3 completionHandler:(id)arg4;
- (id)init;
...
- (bool)webView:(id)arg1 frame:(id)arg2 willNavigateFromForm:(id)arg3 bySubmitting:(bool)arg4 submissionHandler:(id)arg5;
