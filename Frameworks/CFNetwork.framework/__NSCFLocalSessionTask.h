...
- (void)_finishBecomeStream:(id)arg1 forConnection:(id)arg2 completionHandler:(id)arg3;
...
- (void)_onqueue_needConnectedSocketToHost:(id)arg1 port:(unsigned long long)arg2 withCompletion:(id)arg3;
...
- (void)_onqueue_submitConnectionWork:(id)arg1;
...
- (void)_private_onqueue_becomeStreamTaskWithCompletionHandler:(id)arg1;
- (void)_private_onqueue_didReceiveResponse:(id)arg1;
- (void)_private_onqueue_didReceiveResponseDisposition:(long long)arg1 completion:(id)arg2;
