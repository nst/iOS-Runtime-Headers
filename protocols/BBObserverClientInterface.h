...
- (void)getObserverDebugInfo:(void *)arg1; // needs 1 arg types, found 6: id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, NSString *, void*
...
- (void)updateBulletin:(void *)arg1 withHandler:(void *)arg2; // needs 2 arg types, found 8: BBBulletinUpdateTransaction *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, NSError *, void*
