...
- (void).cxx_destruct;
- (void)_displayKissAtPoint:(struct CGPoint { double x1; double x2; })arg1 angle:(float)arg2 leavesMark:(BOOL)arg3 inScene:(id)arg4;
...
- (void)addKissAtNormalizedPoint:(struct CGPoint { double x1; double x2; })arg1 angle:(float)arg2 time:(double)arg3 toScene:(id)arg4;
- (id)archiveData;
