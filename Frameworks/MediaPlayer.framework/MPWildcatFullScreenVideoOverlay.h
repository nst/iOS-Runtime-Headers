...
@class MPWildcatFullScreenTransportControls, NSString, UIActivityIndicatorView, UIBarButtonItem, UIImageView, UILabel, UINavigationBar, UINavigationButton, UINavigationItem, UIPopoverController;
