...
- (TSPData *)reader:(TSPReader *)arg1 wantsDataForIdentifier:(int)arg2;
- (int)reader:(TSPReader *)arg1 wantsObjectIdentifierForUUID:(NSUUID *)arg2;
- (int)sourceType;
...
- (void)reader:(TSPReader *)arg1 didResetObjectIdentifierForObject:(TSPObject *)arg2 originalObjectIdentifier:(int)arg3;
- (void)reader:(TSPReader *)arg1 didResetObjectUUID:(NSUUID *)arg2 forObjectIdentifier:(int)arg3 originalObjectUUID:(NSUUID *)arg4;
