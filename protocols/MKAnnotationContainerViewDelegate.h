...
- (float)annotationContainer:(MKAnnotationContainerView *)arg1 pinDropDistanceForCoordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg2 maxDistance:(float*)arg3;
- (void)annotationContainer:(void *)arg1 scrollToRevealCalloutWithOffset:(void *)arg2 annotationCoordinate:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 8: MKAnnotationContainerView *, struct CGPoint { float x1; float x2; }, struct CLLocationCoordinate2D { double x1; double x2; }, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
...
- (struct CGPoint { float x1; float x2; })convertCoordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg1 toPointToView:(UIView *)arg2;
- (struct CLLocationCoordinate2D { double x1; double x2; })convertPoint:(struct CGPoint { float x1; float x2; })arg1 toCoordinateFromView:(UIView *)arg2;
