...
- (void)_cancelSession;
- (void)_consumeRemainingStreamDataWithIdentifier:(id)arg1 completion:(id)arg2;
- (void)_enqueueSingleMessage:(id)arg1 withMessageID:(unsigned short)arg2 priority:(long long)arg3 options:(id)arg4 userContext:(id)arg5 callback:(id)arg6;
...
- (void)_handleIncomingStreamDataWithIdentifier:(id)arg1 completion:(id)arg2;
- (void)_handleProtobuf:(id)arg1 ofType:(unsigned short)arg2 identifier:(id)arg3 isResponse:(bool)arg4 withCompletion:(id)arg5;
- (void)_handleSessionRestart:(id)arg1 priority:(long long)arg2 options:(id)arg3 userContext:(id)arg4 callback:(id)arg5;
- (void)_processNMSMessageData:(id)arg1 context:(id)arg2;
- (void)_readNextProtobuf:(id)arg1;
- (void)_reallyHandleSessionRestart:(id)arg1 priority:(long long)arg2 options:(id)arg3 userContext:(id)arg4 callback:(id)arg5;
...
- (void)endSession;
- (void)enqueueSyncRequest:(id)arg1 withMessageID:(unsigned short)arg2 priority:(long long)arg3 options:(id)arg4 userContext:(id)arg5 callback:(id)arg6;
