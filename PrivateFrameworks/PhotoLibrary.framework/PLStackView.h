...
@class <PLStackViewDataSource>, <PLStackViewDelegate>, CADynamicsBehavior, NSArray, NSData, NSIndexSet, NSMutableArray, NSMutableDictionary, NSMutableIndexSet, NSString, PLAutoScroller, PLExpandableView, PLStackItemViewCell, PLStackedImageView, PLTableView, UIGestureRecognizer, UIImage, UILongPressGestureRecognizer, UIView;
...
@property struct CGPoint { float x1; float x2; } collapsedImageOffset;
...
- (struct CGPoint { float x1; float x2; })collapsedImageOffset;
...
- (void)setCollapsedImageOffset:(struct CGPoint { float x1; float x2; })arg1;
