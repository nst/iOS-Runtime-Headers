...
@property(readonly) TSURangeList * rangeList;

- (id)addressWithNewRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1;
- (id)addressWithNewRangeList:(id)arg1;
- (void)dealloc;
- (id)initWithParent:(id)arg1 location:(unsigned int)arg2 length:(unsigned int)arg3;
- (id)initWithParent:(id)arg1 range:(struct _NSRange { unsigned int x1; unsigned int x2; })arg2;
...
- (struct _NSRange { unsigned int x1; unsigned int x2; })onlyRange;
- (id)pathElement;
- (id)rangeList;
