...
- (id)delegate;
- (id)description;
- (void)getChildrenInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 completion:(id)arg2;
- (void)getCountOfChildrenWithCompletion:(id)arg1;
- (void)getNowPlayingIdentifiersWithCompletion:(id)arg1;
- (void)getPlaybackProgressSupportForChildrenWithCompletion:(id)arg1;
- (void)getRootItemWithCompletion:(id)arg1;
- (id)identifier;
- (id)indexPath;
- (void)invalidate;
- (bool)isValidForRefreshedParent:(id)arg1;
- (id)model;
- (void)refreshWithCompletion:(id)arg1;
- (id)rootItem;
...
- (id)title;
- (void)updateRootItemWithCompletion:(id)arg1;
