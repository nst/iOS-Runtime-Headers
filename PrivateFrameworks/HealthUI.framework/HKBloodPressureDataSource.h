...
- (void).cxx_destruct;
- (void)_callCompletionWithSystolicResults:(id)arg1 diastolicResults:(id)arg2 statisticsOptions:(unsigned int)arg3 blockStart:(id)arg4 blockEnd:(id)arg5 completion:(id /* block */)arg6;
