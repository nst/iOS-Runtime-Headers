...
@interface TSCECalculationEngine : TSPObject {
    ...
    struct _opaque_pthread_t { long x1; struct __darwin_pthread_handler_rec {} *x2; BOOL x3[596]; } *mRecalculationThread;
