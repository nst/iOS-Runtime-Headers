...
- (void)_legacyAuthenticateWithAction:(id)arg1 attemptCount:(unsigned int)arg2 replyHandler:(id /* block */)arg3;
- (void)_legacyAuthenticateWithUserAgent:(id)arg1 deviceGUID:(id)arg2 accountID:(id)arg3 password:(id)arg4 attemptCount:(unsigned int)arg5 completion:(id /* block */)arg6;
