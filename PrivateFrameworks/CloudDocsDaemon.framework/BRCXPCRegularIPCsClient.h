...
- (void)getContainerForURLFast:(id)arg1 reply:(id)arg2;
...
- (void)handleShareURL:(id)arg1 withBlock:(id)arg2;
...
- (void)startOperation:(id)arg1 toCopySharingAccessToken:(id)arg2 wantsPermissions:(BOOL)arg3 reply:(id)arg4;
...
- (void)startOperation:(id)arg1 toDestroySharingInfo:(id)arg2 reply:(id)arg3;
