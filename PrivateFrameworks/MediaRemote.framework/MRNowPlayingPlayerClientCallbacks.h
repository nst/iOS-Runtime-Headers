...
@property (nonatomic, readonly) NSArray *artworkURLTemplateCallbacks;
...
- (void*)addArtworkURLTemplateCallback:(id /* block */)arg1 prepend:(bool)arg2;
...
- (id)artworkCallbacks;
- (id)artworkURLTemplateCallbacks;
