...
- (void).cxx_destruct;
- (void)_addActionSet:(id)arg1 completionHandler:(id)arg2;
- (void)_addActionSetWithCompletionHandler:(id)arg1;
- (void)_configure:(id)arg1 uuid:(id)arg2 messageDispatcher:(id)arg3 clientQueue:(id)arg4 delegateCaller:(id)arg5;
- (void)_enable:(bool)arg1 completionHandler:(id)arg2;
...
- (void)addActionSetWithCompletionHandler:(id)arg1;
- (id)clientQueue;
