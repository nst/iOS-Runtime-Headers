...
- (void).cxx_destruct;
- (id)_openDatabaseWithAccessType:(int)arg1 onQueue:(id)arg2 error:(id*)arg3;
- (void)_requestAccessType:(int)arg1 onQueue:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)requestAccessType:(int)arg1 onQueue:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)requestAccessType:(int)arg1 onQueue:(id)arg2 completionHandlerWithInvalidationHandler:(id /* block */)arg3;
