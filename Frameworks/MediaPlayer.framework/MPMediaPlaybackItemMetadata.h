...
@property (nonatomic, readonly) int albumStoreAdamID;
...
@property (nonatomic, readonly) int artistStoreAdamID;
...
@property (nonatomic, readonly) int mediaLibraryPersistentID;
...
@property (nonatomic, readonly) unsigned int storeSagaID;
@property (nonatomic, readonly) int storeSubscriptionAdamID;
@property (nonatomic, readonly) double volumeNormalization;
