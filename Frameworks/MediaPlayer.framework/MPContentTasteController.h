...
- (void)dealloc;
- (id)init;
- (void)setTasteType:(long long)arg1 forMediaEntity:(id)arg2 withCompletionHandler:(id)arg3;
- (void)setTasteType:(long long)arg1 forModel:(id)arg2 withCompletionHandler:(id)arg3;
- (void)setTasteType:(long long)arg1 forPlaylistGlobalID:(id)arg2 withCompletionHandler:(id)arg3;
- (void)setTasteType:(long long)arg1 forStoreAdamID:(long long)arg2 withContentType:(long long)arg3 completionHandler:(id)arg4;
