...
@property (nonatomic, copy) id timeSinceRecordingBeganHandler;
...
- (void)dealloc;
- (void)endTransaction;
- (id)initWithPath:(id)arg1 clMapMatching:(bool)arg2 errorHandler:(id)arg3;
...
- (void)saveTraceWithHandler:(id)arg1;
