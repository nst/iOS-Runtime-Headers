...
@class MPNowPlayingItemQueueInfoButton, MPWildcatFullScreenTransportControls, NSString, UIActivityIndicatorView, UIImageView, UILabel, UINavigationBar, UINavigationButton, UINavigationItem, UIPopoverController;
