...
+ (void)raiseTypeExceptionForValue:(struct TSCEValue { unsigned long long x1[88]; int x2; })arg1 functionSpec:(id)arg2 argumentIndex:(int)arg3;
...
- (id)bakedString;
- (bool)boolean;
- (bool)booleanForFunction:(id)arg1 argumentIndex:(int)arg2 warningReportingContext:(struct TSCEWarningReportingContext { boolx1; boolx2; struct ObjcSharedPtr<NSMutableSet> { id x_3_1_1; } x3; }*)arg3;
- (id)copyWithZone:(struct _NSZone { }*)arg1;
- (id)date;
- (id)dateForFunction:(id)arg1 argumentIndex:(int)arg2 warningReportingContext:(struct TSCEWarningReportingContext { boolx1; boolx2; struct ObjcSharedPtr<NSMutableSet> { id x_3_1_1; } x3; }*)arg3;
- (id)dateValue;
- (void)dealloc;
- (int)deepType;
...
- (bool)isNativelyEqual:(struct TSCEValue { unsigned long long x1[88]; int x2; })arg1;
...
- (id)string;
- (id)stringForFunction:(id)arg1 argumentIndex:(int)arg2 warningReportingContext:(struct TSCEWarningReportingContext { boolx1; boolx2; struct ObjcSharedPtr<NSMutableSet> { id x_3_1_1; } x3; }*)arg3;
- (id)stringValue;
- (id)tokenString;
