...
+ (void)savePhoto:(id)arg1 contentOffset:(struct CGPoint { double x1; double x2; })arg2 zoomScale:(double)arg3 inDirectory:(id)arg4 completion:(id)arg5;
+ (void)savePhoto:(id)arg1 contentOffset:(struct CGPoint { double x1; double x2; })arg2 zoomScale:(double)arg3 supplement:(id)arg4 inDirectory:(id)arg5 completion:(id)arg6;
+ (void)savePhoto:(id)arg1 imageData:(id)arg2 irisURL:(id)arg3 contentOffset:(struct CGPoint { double x1; double x2; })arg4 zoomScale:(double)arg5 supplement:(id)arg6 inDirectory:(id)arg7 completion:(id)arg8;
