...
- (void)completeSendStringActionForTouchUp:(id)arg1 withActions:(unsigned int)arg2 timestamp:(double)arg3 interval:(double)arg4 didLongPress:(BOOL)arg5 prevActions:(unsigned int)arg6 executionContext:(id)arg7;
- (void)continueFromInternationalActionForTouchUp:(id)arg1 withActions:(unsigned int)arg2 timestamp:(double)arg3 interval:(double)arg4 didLongPress:(BOOL)arg5 prevActions:(unsigned int)arg6 executionContext:(id)arg7;
...
- (void)updateSelectedVariantIndexForKey:(id)arg1 withActions:(unsigned int)arg2 withPoint:(struct CGPoint { double x1; double x2; })arg3;
- (void)updateShiftKeyState;
- (void)updateTransitionWithFlags:(unsigned int)arg1;
