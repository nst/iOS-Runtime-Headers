...
- (void)closeSessionWithCompletion:(id)arg1;
- (void)closeSessionWithStatus:(int)arg1 successfully:(bool)arg2;
- (void)closeSessionWithStatus:(int)arg1 successfully:(bool)arg2 complete:(id)arg3;
...
- (void)feedSpeechRecognitionTrailingSamplesWithCompletedBlock:(id)arg1;
- (void)feedSpeechRecognitionWithPCMBuffer;
- (void)finishSpeechRecognitionTask;
- (void)handleAudioBufferForVTWithAudioInput:(id)arg1 withDetectedBlock:(id)arg2;
- (void)handleAudioInput:(id)arg1;
- (void)handleMasterTimeout:(id)arg1;
- (id)initWithUtteranceId:(long long)arg1 sessionNumber:(long long)arg2 Locale:(id)arg3 audioSession:(id)arg4 phraseSpotter:(id)arg5 speechRecognizer:(id)arg6 speechRecognitionRequest:(id)arg7 sessionDelegate:(id)arg8 sessionDispatchQueue:(id)arg9 completion:(id)arg10;
