...
@interface HUAlarmEditSettingViewController : UIViewController <HUAlarmTonePickerDelegate, UITableViewDataSource, UITableViewDelegate> {
...
@property (nonatomic, retain) HUAlarmTonePickerViewController *tonePickerViewController;
