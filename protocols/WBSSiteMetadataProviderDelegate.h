...
- (id)siteMetadataProvider:(void *)arg1 registerOneTimeRequest:(void *)arg2 priority:(void *)arg3 responseHandler:(void *)arg4; // needs 4 arg types, found 9: <WBSSiteMetadataProvider> *, WBSSiteMetadataRequest *, long long, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, WBSSiteMetadataResponse *, void*
- (id)siteMetadataProvider:(void *)arg1 registerRequest:(void *)arg2 priority:(void *)arg3 responseHandler:(void *)arg4; // needs 4 arg types, found 9: <WBSSiteMetadataProvider> *, WBSSiteMetadataRequest *, long long, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, WBSSiteMetadataResponse *, void*
