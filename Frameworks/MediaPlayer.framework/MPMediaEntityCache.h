...
- (id)_entityWithIdentifier:(long long)arg1 mediaEntityType:(long long)arg2 collectionGroupingType:(long long)arg3 loadEntityBlock:(id)arg4;
- (void)_performWithExclusiveAccessForDataProviderEntityClass:(Class)arg1 block:(id)arg2;
- (void)_performWithSharedAccessForDataProviderEntityClass:(Class)arg1 block:(id)arg2;
