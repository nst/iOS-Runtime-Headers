...
@class <EKDayViewControllerDataSource>, <EKDayViewControllerDelegate>, CalendarOccurrencesCollection, EKDayBannerView, EKDayView, EKEventGestureController, NSCalendar, NSDateComponents, UIScrollView, UIView;
