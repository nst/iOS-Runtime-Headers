...
@property (nonatomic) unsigned int supportedEscapeOfferMask;
...
- (void)_handleMultiCSCRecoveryResults:(id)arg1 type:(unsigned int)arg2 secret:(id)arg3 device:(id)arg4 completion:(id /* block */)arg5;
...
- (void)_performSingleiCSCRecoveryWithSecret:(id)arg1 type:(unsigned int)arg2 completion:(id /* block */)arg3;
