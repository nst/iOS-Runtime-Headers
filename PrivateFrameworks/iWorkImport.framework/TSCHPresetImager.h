...
- (id)p_chartType;
- (struct CGSize { double x1; double x2; })p_drawAndOffsetMultiDataSliderIntoContext:(struct CGContext { }*)arg1 size:(struct CGSize { double x1; double x2; })arg2 contentsScale:(float)arg3;
- (void)p_drawShadowedContentIntoContext:(struct CGContext { }*)arg1 size:(struct CGSize { double x1; double x2; })arg2 contentsScale:(float)arg3 preset:(id)arg4 shouldCache:(BOOL*)arg5;
- (void)p_drawUnshadowedContentIntoContext:(struct CGContext { }*)arg1 size:(struct CGSize { double x1; double x2; })arg2 contentsScale:(float)arg3 preset:(id)arg4 shouldCache:(BOOL*)arg5;
