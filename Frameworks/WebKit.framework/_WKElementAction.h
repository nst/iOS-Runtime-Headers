...
+ (id)_elementActionWithType:(int)arg1 title:(id)arg2 actionHandler:(id /* block */)arg3;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)_initWithTitle:(id)arg1 actionHandler:(id /* block */)arg2 type:(int)arg3 assistant:(id)arg4;
