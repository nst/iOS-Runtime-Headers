...
- (void)fileWriter:(id)arg1 pausedRecordingForSettingsID:(unsigned int)arg2;
- (void)fileWriter:(id)arg1 resumedRecordingForSettingsID:(unsigned int)arg2;
- (void)fileWriter:(id)arg1 startedRecordingForSettingsID:(unsigned int)arg2;
...
- (void)stillImageCoordinator:(id)arg1 didCapturePhotoForSettings:(id)arg2 resolvedCaptureType:(int)arg3 pts:(struct { int x1; int x2; unsigned int x3; int x4; })arg4;
- (void)stillImageCoordinator:(id)arg1 didCapturePreBracketedEV0ImageForSettings:(id)arg2 resolvedCaptureType:(int)arg3 pts:(struct { int x1; int x2; unsigned int x3; int x4; })arg4;
