...
@class <_MFComposeRecipientViewStyleDelegate>, MFComposeRecipientAtom, MFComposeTextField, NSArray, NSMutableArray, NSMutableDictionary, NSTimer, UIButton, UIImage;
