...
- (void).cxx_destruct;
- (id)_closestFocusableRegionInArray:(id)arg1 toPoint:(struct CGPoint { double x1; double x2; })arg2 usingHeading:(unsigned int)arg3;
- (id)_closestFocusableRegionInArray:(id)arg1 toPoint:(struct CGPoint { double x1; double x2; })arg2 usingHeading:(unsigned int)arg3 withFocusedView:(id)arg4 consideringFavoredRegion:(BOOL)arg5 includingFocusedView:(BOOL)arg6;
- (BOOL)_containsFocusableRegionForView:(id)arg1;
- (struct CGPoint { double x1; double x2; })_focusCandidateSearchOriginForFocusedFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 heading:(unsigned int)arg2 minimumSearchArea:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3;
