...
@class <TSCHNotifyOnModify>, NSMutableArray;
...
- (int)direction;
- (BOOL)dirty;
- (id)extractColumnNames:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1;
- (id)extractRowNames:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1 deleteValueRows:(BOOL)arg2;
- (id)extractValueColumns:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1;
- (id)extractValueRows:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1;
- (id)getNewColumnName;
- (id)getNewRowName;
