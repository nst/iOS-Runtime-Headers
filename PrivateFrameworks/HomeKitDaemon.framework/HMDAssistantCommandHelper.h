...
@interface HMDAssistantCommandHelper : NSObject <HMFLogging, HMFMessageReceiver, HMFTimerDelegate> {
...
- (id)actionTimer;
- (void)addActionSetRequest:(id)arg1 actionSet:(id)arg2 completionHandler:(id)arg3;
- (void)addReadRequests:(id)arg1 home:(id)arg2 completion:(id)arg3;
- (void)addWriteRequests:(id)arg1 home:(id)arg2 completion:(id)arg3;
- (void)dealloc;
- (id)home;
