...
- (void).cxx_destruct;
- (void)_addModifyRecordsOperationsWithCloudObjectsToSave:(id)arg1 delete:(id)arg2 waitForDependencies:(bool)arg3 completionHandler:(id)arg4;
- (void)_processCloudObjects:(id)arg1 completionHandler:(id)arg2;
- (void)_syncWithCompletionHandler:(id)arg1;
...
- (void)addFetchOperationsForRecordIDs:(id)arg1 qualityOfService:(long long)arg2 completionHandler:(id)arg3;
- (void)addModifyRecordsOperationsWithCloudObjectsToSave:(id)arg1 delete:(id)arg2 waitForDependencies:(bool)arg3 completionHandler:(id)arg4;
- (void)addOperationToProcessObjectsWithCompletionHandler:(id)arg1;
- (void)addOperationsToFetchRecordZoneChangesForZoneIDs:(id)arg1 completionHandler:(id)arg2;
- (void)addStateHandler;
- (id)allCloudObjectsInContext:(id)arg1;
- (id)allZoneIDs;
- (bool)canRetryImmediatelyAfterError:(id)arg1;
- (void)cancelEverythingWithCompletionHandler:(id)arg1;
...
- (void)dealloc;
- (void)deleteCloudObjects:(id)arg1 completionHandler:(id)arg2;
- (void)deleteRecordZonesWithZoneIDs:(id)arg1 markZonesAsUserPurged:(bool)arg2 completionHandler:(id)arg3;
...
- (void)fetchCloudObjects:(id)arg1 completionHandler:(id)arg2;
- (void)fetchDatabaseChangesForDatabases:(id)arg1 completionHandler:(id)arg2;
- (void)fetchDatabaseChangesOperation:(id)arg1 changeTokenUpdated:(id)arg2;
- (void)fetchDatabaseChangesOperation:(id)arg1 finishedWithServerChangeToken:(id)arg2 error:(id)arg3 completionHandler:(id)arg4;
...
- (void)fetchDatabaseChangesWithCompletionHandler:(id)arg1;
...
- (void)fetchRecordIDs:(id)arg1 completionHandler:(id)arg2;
- (void)fetchRecordZoneChangesForZoneIDs:(id)arg1 completionHandler:(id)arg2;
...
- (void)fetchRecordZoneChangesWithCompletionHandler:(id)arg1;
- (void)fetchSubscriptionsForDatabase:(id)arg1 completionHandler:(id)arg2;
- (void)fetchUserRecordWithCompletionHandler:(id)arg1;
- (void)finishOperationsForRecordID:(id)arg1 completionHandler:(id)arg2;
- (void)firePollingSyncRequest;
- (void)handleGenericPartialFailuresForError:(id)arg1 operation:(id)arg2;
- (void)handleNotification:(id)arg1 completionHandler:(id)arg2;
...
- (id)operationQueue;
- (id)operationToFetchDatabaseChangesForDatabase:(id)arg1 completionHandler:(id)arg2;
...
- (void)processAllCloudObjectsWithCompletionHandler:(id)arg1;
- (void)processObjectIDs:(id)arg1 completionHandler:(id)arg2;
- (void)processPendingCloudObjects;
- (void)processPendingCloudObjectsWithCompletionHandler:(id)arg1;
- (id)processingQueue;
- (id)processingSelectorDelayer;
- (void)pushCloudObjects:(id)arg1 completionHandler:(id)arg2;
...
- (void)saveSubscriptionsForDatabase:(id)arg1 completionHandler:(id)arg2;
...
- (void)syncWithCompletionHandler:(id)arg1;
- (double)timeIntervalToRetryAfterFromError:(id)arg1;
- (void)updateAccountStatusWithCompletionHandler:(id)arg1;
