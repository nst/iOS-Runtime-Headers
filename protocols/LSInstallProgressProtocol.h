...
- (void)installationFailedForApplication:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 7: NSString *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
...
- (void)sendInstalledNotificationForApp:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 7: LSApplicationProxy *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
- (void)sendInstalledNotificationForApps:(NSArray *)arg1 Plugins:(NSArray *)arg2;
- (void)sendUninstalledNotificationForApp:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 7: LSApplicationProxy *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, bool, void*
