...
- (void)didUpdateFeedback:(GEOAlightNotificationFeedback *)arg1 forAlightingStepAtIndex:(unsigned int)arg2;
- (void)didUpdateHeading:(double)arg1 accuracy:(double)arg2;
- (void)didUpdateMatchedLocation:(MNLocationDetails *)arg1;
- (void)didUpdateProceedToRouteDistance:(double)arg1 displayString:(NSString *)arg2 closestStepIndex:(unsigned int)arg3;
...
- (void)displayPrimaryStep:(GEOStep *)arg1 instructions:(NSArray *)arg2 shieldType:(int)arg3 shieldText:(NSString *)arg4 drivingSide:(int)arg5 maneuverStepIndex:(unsigned int)arg6 isSynthetic:(BOOL)arg7;
