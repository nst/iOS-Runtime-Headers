...
+ (void)deletePlaceholderAttachmentForURL:(id)arg1 completionBlock:(id)arg2;
+ (void)placeholderAttachmentForData:(id)arg1 fileName:(id)arg2 mimeType:(id)arg3 contentID:(id)arg4 completionBlock:(id)arg5;
+ (void)placeholderAttachmentForFileName:(id)arg1 fileSize:(long long)arg2 mimeType:(id)arg3 contentID:(id)arg4 completionBlock:(id)arg5;
+ (void)placeholderAttachmentForURL:(id)arg1 mimeType:(id)arg2 contentID:(id)arg3 completionBlock:(id)arg4;
...
+ (void)securityScopeForPlaceholderURL:(id)arg1 completionBlock:(id)arg2;
