...
- (void)p_drawShadowedContentIntoContext:(struct CGContext { }*)arg1 size:(struct CGSize { float x1; float x2; })arg2 contentsScale:(float)arg3 preset:(id)arg4;
- (void)p_drawUnshadowedContentIntoContext:(struct CGContext { }*)arg1 size:(struct CGSize { float x1; float x2; })arg2 contentsScale:(float)arg3 preset:(id)arg4;
