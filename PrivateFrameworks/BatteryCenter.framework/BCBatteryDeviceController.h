...
- (void)_queue_addDeviceChangeHandler:(id)arg1 withIdentifier:(id)arg2;
...
- (void)connectedDevicesIncludingMissingPartsWithResult:(id)arg1;
- (void)connectedDevicesWithResult:(id)arg1;
- (void)dealloc;
- (id)init;
