...
- (void).cxx_destruct;
- (void)_electDeviceForAccountDestination:(id)arg1 completionHandler:(id)arg2;
...
- (void)_handleNotificationResponseForMessage:(id)arg1 responsePayload:(id)arg2 responseError:(id)arg3 responseHandler:(id)arg4;
...
- (void)_openSecureSessionToDevice:(id)arg1 completionHandler:(id)arg2;
- (void)_pingDevice:(id)arg1 completionHandler:(id)arg2;
- (id)_preferredTransportForMessage:(id)arg1;
- (void)_reallyOpenSecureSessionToDevice:(id)arg1 completionHandler:(id)arg2;
- (void)_sendPingToDevice:(id)arg1 timeout:(double)arg2 restriction:(unsigned long long)arg3 responseHandler:(id)arg4;
- (void)_sendSecureMessage:(id)arg1 completionHandler:(id)arg2;
...
- (id)deviceMonitor;
- (void)electDeviceForUser:(id)arg1 destination:(id)arg2 deviceCapabilities:(id)arg3 responseTimeout:(double)arg4 responseQueue:(id)arg5 responseHandler:(id)arg6;
- (id)identityRegistry;
...
- (void)openSecureSessionToDevice:(id)arg1 completionHandler:(id)arg2;
