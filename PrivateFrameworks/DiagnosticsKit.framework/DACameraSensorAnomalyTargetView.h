...
@property (nonatomic) struct CGSize { float x1; float x2; } shutterButtonIntrinsicContentSize;
...
- (id)delegate;
- (id)initWithFrame:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1 color:(id)arg2 thickness:(float)arg3 instructionText:(id)arg4;
- (void)setCancelButton:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)setShutterButton:(id)arg1;
- (void)setShutterButtonIntrinsicContentSize:(struct CGSize { float x1; float x2; })arg1;
...
- (id)shutterButton;
- (struct CGSize { float x1; float x2; })shutterButtonIntrinsicContentSize;
