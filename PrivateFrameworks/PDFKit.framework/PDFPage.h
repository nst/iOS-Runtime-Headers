...
- (struct CGImage { }*)_newCGImageWithBox:(int)arg1 bitmapSize:(struct CGSize { double x1; double x2; })arg2 scale:(float)arg3 offset:(struct CGPoint { double x1; double x2; })arg4 fillBackground:(bool)arg5 withRotation:(bool)arg6 withAntialiasing:(bool)arg7 withAnnotations:(bool)arg8 withDelegate:(id)arg9;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })characterBoundsAtIndex:(int)arg1;
- (int)characterIndexAtPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })getDrawingTransformForBox:(int)arg1;
- (BOOL)hasArtBox;
- (BOOL)hasBleedBox;
- (BOOL)hasCropBox;
...
- (BOOL)hasTrimBox;
- (id)image;
- (id)imageOfSize:(struct CGSize { double x1; double x2; })arg1 forBox:(int)arg2 withRotation:(bool)arg3 withAntialiasing:(bool)arg4;
- (id)imageOfSize:(struct CGSize { double x1; double x2; })arg1 forBox:(int)arg2 withRotation:(bool)arg3 withAntialiasing:(bool)arg4 withAnnotations:(bool)arg5;
- (id)imageOfSize:(struct CGSize { double x1; double x2; })arg1 forBox:(int)arg2 withRotation:(bool)arg3 withAntialiasing:(bool)arg4 withAnnotations:(bool)arg5 withDelegate:(id)arg6;
- (id)init;
...
- (void)loadTextChars;
- (id)noFillthumbnailOfSize:(struct CGSize { double x1; double x2; })arg1 forBox:(int)arg2;
...
- (void)setBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 forBox:(int)arg2;
...
- (id)string;
- (id)thumbnailOfSize:(struct CGSize { double x1; double x2; })arg1 forBox:(int)arg2;
- (void)transformContext:(struct CGContext { }*)arg1 forBox:(int)arg2;
- (void)transformContextForBox:(int)arg1;
- (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })transformForBox:(int)arg1;
