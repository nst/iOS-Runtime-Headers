...
- (int)saliencyDetection:(struct __CVBuffer { }*)arg1 withTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2 salientRegions:(id)arg3 cancel:(id)arg4;
