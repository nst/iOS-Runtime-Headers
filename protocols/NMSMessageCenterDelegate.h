...
- (void)messageCenter:(void *)arg1 activeDeviceChanged:(void *)arg2 acknowledgement:(void *)arg3; // needs 3 arg types, found 7: NMSMessageCenter *, IDSDevice *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
