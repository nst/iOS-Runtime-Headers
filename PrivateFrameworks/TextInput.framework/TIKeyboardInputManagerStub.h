...
- (void)adjustPhraseBoundaryInForwardDirection:(bool)arg1 granularity:(int)arg2 keyboardState:(id)arg3 completionHandler:(id)arg4;
...
- (void)handleAcceptedCandidate:(id)arg1 keyboardState:(id)arg2 completionHandlerWithKeyboardOutput:(id)arg3;
