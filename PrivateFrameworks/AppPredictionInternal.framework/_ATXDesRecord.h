...
@interface _ATXDESRecord : NSObject <NSSecureCoding> {
    ...
    struct { double x1[69]; double x2; } * _predictionItems;
    long long  _version;
}
...
@property (nonatomic, readonly) struct { double x1[69]; double x2; }*predictionItems;
...
- (id)initWithScores:(struct { char *x1; double x2[69]; double x3; }*)arg1 count:(unsigned long long)arg2 version:(long long)arg3 launchBundle:(id)arg4;
- (bool)isEqual:(id)arg1;
- (bool)isEqualToRecord:(id)arg1;
- (id)launchBundle;
- (unsigned long long)predictionCount;
- (struct { double x1[69]; double x2; }*)predictionItems;
- (long long)version;
