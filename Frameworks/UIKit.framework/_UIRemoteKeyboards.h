...
- (void)_performOnDistributedControllersExceptSelf:(id)arg1;
...
- (double)iavHeight;
- (void)ignoreLayoutNotifications:(id)arg1;
- (id)init;
...
- (void)performOnDistributedControllers:(id)arg1;
...
- (id)proxy;
- (void)queue_applicationLostFocusWithCompletion:(id)arg1;
- (void)queue_failedConnection:(id)arg1;
- (void)queue_getDebugInfoWithCompletion:(id)arg1;
- (void)queue_keyboardChanged:(id)arg1 onComplete:(id)arg2;
- (void)queue_keyboardChangedWithCompletion:(id)arg1;
- (void)queue_keyboardSuppressed:(bool)arg1 withCompletion:(id)arg2;
- (void)queue_keyboardTransition:(id)arg1 event:(unsigned long long)arg2 withInfo:(id)arg3 onComplete:(id)arg4;
...
- (bool)updatingHeight;
- (void)userSelectedApp:(id)arg1 onCompletion:(id)arg2;
