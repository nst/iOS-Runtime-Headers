...
- (void).cxx_destruct;
- (void)_handleDidUpdateSettings:(id)arg1 withDiff:(id)arg2 transitionContext:(id)arg3 completion:(id)arg4;
- (void)_handleInvalidationWithTransitionContext:(id)arg1 completion:(id)arg2;
- (id)_workspaceQueue;
- (void)_workspaceQueue_dispatchClientBlockIfNecessary:(id)arg1 success:(bool)arg2;
- (bool)_workspaceQueue_handledInitialSettingsDiff;
- (bool)_workspaceQueue_hasSentCreationEvent;
- (void)_workspaceQueue_invalidate;
- (void)_workspaceQueue_invalidateSceneAgentWithEvent:(id)arg1 completion:(id)arg2;
...
- (void)agent:(id)arg1 registerMessageHandler:(id)arg2;
- (void)agent:(id)arg1 sendMessage:(id)arg2 withResponse:(id)arg3;
- (id)callOutQueue;
- (id)clientProcess;
...
- (void)sceneDidReceiveMessage:(id)arg1 withCompletion:(id)arg2;
