...
@interface WebCoreScriptDebugger : NSObject 
{
  ...
  /* Error parsing encoded ivar type info: ^{WebCoreScriptDebuggerImp=^^?^{DebuggerImp}{HashMap<KJS::JSGlobalObject*,KJS::ProtectedPtr<KJS::JSValue>,WTF::PtrHash<KJS::JSGlobalObject*>,WTF::HashTraits<KJS::JSGlobalObject*>,WTF::HashTraits<KJS::ProtectedPtr<KJS::JSValue> > >="m_impl"{HashTable<int,std::pair<int, KJS::ProtectedPtr<KJS::JSValue> >,WTF::PairFirstExtractor<std::pair<int, KJS::ProtectedPtr<KJS::JSValue> > >,WTF::IntHash<int32_t>,WTF::PairHashTraits<WTF::HashTraits<int32_t>, WTF::HashTraits<KJS::ProtectedPtr<KJS::JSValue> > >,WTF::HashTraits<int32_t> >="m_table"^{pair<int,KJS::ProtectedPtr<KJS::JSValue> >}"m_tableSize"i"m_tableSizeMask"i"m_keyCount"i"m_deletedCount"i}}@"WebCoreScriptDebugger"B@"WebCoreScriptCallFrame"} */
