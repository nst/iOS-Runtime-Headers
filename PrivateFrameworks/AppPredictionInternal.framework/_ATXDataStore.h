...
- (void)_enumerateAppInfoAppIntentsExecutingBlock:(id /* block */)arg1;
...
- (void)addAppIntentLaunchForAppIntent:(id)arg1 date:(id)arg2;
...
- (void)enumerateAppInfoAppIntentsExecutingBlock:(id /* block */)arg1;
...
- (void)removeInfoForAppIntent:(id)arg1;
...
- (bool)updateOrInsertTimestamp:(long long)arg1 forAppIntent:(id)arg2;
