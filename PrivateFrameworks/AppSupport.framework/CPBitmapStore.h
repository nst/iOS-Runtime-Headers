...
- (struct CGImage { }*)_copyAndStoreImageForKey:(id)arg1 inGroup:(id)arg2 withSize:(struct CGSize { double x1; double x2; })arg3 format:(unsigned char)arg4 scale:(double)arg5 fillMem:(id)arg6 alternateCompletion:(id)arg7;
- (id)_versionPath;
- (id)allGroups;
