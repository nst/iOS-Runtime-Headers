...
+ (id)runningPropertyAnimatorWithDuration:(double)arg1 delay:(double)arg2 options:(unsigned long long)arg3 animations:(id)arg4 completion:(id)arg5;
...
- (void)_setupWithDuration:(double)arg1 timingParameters:(id)arg2 animations:(id)arg3;
...
- (void)addAnimations:(id)arg1 delayFactor:(double)arg2;
- (void)addAnimations:(id)arg1 delayFactor:(double)arg2 durationFactor:(double)arg3;
...
- (id)init;
- (id)initWithDuration:(double)arg1 controlPoint1:(struct CGPoint { double x1; double x2; })arg2 controlPoint2:(struct CGPoint { double x1; double x2; })arg3 animations:(id)arg4;
- (id)initWithDuration:(double)arg1 curve:(long long)arg2 animations:(id)arg3;
- (id)initWithDuration:(double)arg1 dampingRatio:(double)arg2 animations:(id)arg3;
- (id)initWithDuration:(double)arg1 timingParameters:(id)arg2;
- (id)initWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3 initialVelocity:(struct CGVector { double x1; double x2; })arg4 animations:(id)arg5;
