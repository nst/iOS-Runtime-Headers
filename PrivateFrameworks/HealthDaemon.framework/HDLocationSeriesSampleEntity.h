...
- (bool)enumerateLocationDataFromTimestamp:(double)arg1 toTimestamp:(double)arg2 database:(id)arg3 error:(id*)arg4 handler:(id)arg5;
- (bool)enumerateLocationDataInDatabase:(id)arg1 error:(id*)arg2 handler:(id)arg3;
