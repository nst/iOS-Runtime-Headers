...
@class NSInvocation, MFComposeHeaderView, _MFComposeRecipientView, UINavigationItem, UIPickerView, MFComposeBodyField, MFComposeScrollView, <MFMailPopoverManagerDelegate>, MFComposeFromView, MFContactsSearchManager, UITableView, NSNumber, <MFMailComposeViewDelegate>, UITextContentView, UIBarButtonItem, MFFromAddressViewController, UIToolbar, UIKeyboard, UIResponder, MFComposeSubjectView, MFContactsSearchResultsModel, ABPeoplePickerNavigationController, UIView;
