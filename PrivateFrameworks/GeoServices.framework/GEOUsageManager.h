...
- (void)_captureNetworUsageLogMessageForRequester:(id)arg1 service:(int)arg2 requestType:(int)arg3 requestErrorDomain:(id)arg4 requestErrorCode:(int)arg5 requestErrorDescription:(id)arg6 traits:(id)arg7 fromLogFrameworkAdaptor:(BOOL)arg8;
- (void)_captureNetworUsageLogMessageForService:(int)arg1 requestType:(int)arg2 requestErrorDomain:(id)arg3 requestErrorCode:(int)arg4 requestErrorDescription:(id)arg5 requestDataSize:(int)arg6 responseDataSize:(int)arg7 responseTime:(int)arg8 traits:(id)arg9 fromLogFrameworkAdaptor:(BOOL)arg10;
...
- (void)captureLogFrameworkEventForMetricType:(int)arg1 metricState:(int)arg2 messageCount:(int)arg3 messageSize:(int)arg4 retryCount:(int)arg5 traits:(id)arg6;
...
- (void)captureNetworkEventForRequester:(id)arg1 networkService:(int)arg2 requestType:(int)arg3 requestErrorDomain:(id)arg4 requestErrorCode:(int)arg5 requestErrorDescription:(id)arg6 traits:(id)arg7 fromLogFrameworkAdaptor:(BOOL)arg8;
- (void)captureNetworkEventForService:(int)arg1 requestType:(int)arg2 requestErrorDomain:(id)arg3 requestErrorCode:(int)arg4 requestErrorDescription:(id)arg5 requestDataSize:(int)arg6 responseDataSize:(int)arg7 responseTime:(int)arg8 traits:(id)arg9 fromLogFrameworkAdaptor:(BOOL)arg10;
- (void)captureNetworkMetricWithState:(int)arg1 messageCount:(int)arg2 messageSize:(int)arg3 retryCount:(int)arg4 fromLogFrameworkAdaptor:(BOOL)arg5;
...
- (void)captureNetworkUsageForRequest:(id)arg1 service:(int)arg2 requestErrorDomain:(id)arg3 requestErrorCode:(int)arg4 requestErrorDescription:(id)arg5;
- (void)captureNetworkUsageForRequest:(id)arg1 service:(int)arg2 requestErrorDomain:(id)arg3 requestErrorCode:(int)arg4 requestErrorDescription:(id)arg5 fromLogFrameworkAdaptor:(BOOL)arg6;
- (void)captureNetworkUsageForRequest:(id)arg1 service:(int)arg2 requestType:(int)arg3 requestErrorDomain:(id)arg4 requestErrorCode:(int)arg5 requestErrorDescription:(id)arg6 traits:(id)arg7;
...
- (void)captureNetworkUsageForRequestToService:(int)arg1 requestErrorDomain:(id)arg2 requestErrorCode:(int)arg3 requestErrorDescription:(id)arg4 responseSize:(unsigned int)arg5 responseTime:(unsigned int)arg6;
- (void)captureNetworkUsageForTiles:(id)arg1;
- (void)capturePlaceCardUserActionAsString:(id)arg1 onTarget:(int)arg2 eventValue:(id)arg3 mapItem:(id)arg4 timestamp:(double)arg5 resultIndex:(int)arg6 targetID:(unsigned int)arg7 providerID:(id)arg8 animationID:(unsigned int)arg9 actionURL:(id)arg10 photoID:(id)arg11 traits:(id)arg12 placeCardType:(int)arg13 localizedMapItemCategory:(id)arg14 availableActions:(id)arg15 unactionableUIElements:(id)arg16;
...
- (void)captureTransitPlaceCardUserActionAsString:(id)arg1 onTarget:(int)arg2 eventValue:(id)arg3 mapItem:(id)arg4 timestamp:(double)arg5 resultIndex:(int)arg6 targetID:(unsigned int)arg7 providerID:(id)arg8 animationID:(unsigned int)arg9 transitCardCategory:(int)arg10 transitSystem:(id)arg11 transitDepartureSequence:(id)arg12 transitIncident:(id)arg13 traits:(id)arg14;
