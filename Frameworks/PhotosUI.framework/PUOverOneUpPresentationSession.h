...
- (bool)_dismissAvalancheReviewController:(id)arg1 animated:(bool)arg2 completionHandler:(id)arg3;
- (bool)_dismissEditViewController:(id)arg1 animated:(bool)arg2 completionHandler:(id)arg3;
- (bool)_dismissPhotoMarkupViewController:(id)arg1 animated:(bool)arg2 completionHandler:(id)arg3;
- (bool)_dismissPhotosSharingViewController:(id)arg1 animated:(bool)arg2 completionHandler:(id)arg3;
- (bool)_dismissSlideshowViewController:(id)arg1 animated:(bool)arg2 completionHandler:(id)arg3;
...
- (void)_performNavigationRequestForAssetDisplayDescriptor:(id)arg1 completionHandler:(id)arg2;
- (id)_photoMarkupViewController;
- (void)_prepareForSharingViewControllerDismiss:(id)arg1 withAsset:(id)arg2 completionHandler:(id)arg3;
...
- (id)delegate;
- (void)dismissViewController:(id)arg1 animated:(bool)arg2 completionHandler:(id)arg3;
...
- (void)ppt_tapNextButton:(id)arg1;
