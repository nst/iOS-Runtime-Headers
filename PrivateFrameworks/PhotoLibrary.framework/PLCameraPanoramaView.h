...
@class CADisplayLink, CALayer, CAShapeLayer, CMMotionManager, NSOperationQueue, PLCameraLevelView, PLCameraOverlayTextLabelView, PLCameraPanoramaProgressView, UIImageView, UIView;
