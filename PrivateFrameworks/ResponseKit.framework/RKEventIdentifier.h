...
- (id)_identifyStrings:(id)arg1 otherDateCount:(unsigned int)arg2 otherDates:(struct RKEventIdentifierRange { unsigned int x1; struct _NSRange { unsigned int x_2_1_1; unsigned int x_2_1_2; } x2; }*)arg3;
- (void)dealloc;
