...
- (void)_enqueueEnableEventCompletionHandler:(id)arg1 queue:(id)arg2 forCharacteristic:(id)arg3;
- (void)_enqueueOperation:(long long)arg1 identifier:(id)arg2 publicKey:(id)arg3 admin:(bool)arg4 queue:(id)arg5 completion:(id)arg6;
...
- (void)_readCharacteristicValues:(id)arg1 completionQueue:(id)arg2 completionHandler:(id)arg3;
- (void)_readValueForCharacteristic:(id)arg1 completionQueue:(id)arg2 completionHandler:(id)arg3;
