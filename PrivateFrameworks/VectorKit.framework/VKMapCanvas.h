...
@class <VKInteractiveMapDelegate>, <VKRouteMatchedAnnotationPresentation>, <VKRoutePreloadSession>, <VKTrackableAnnotation>, GEOMapRegion, NSArray, VKAnchorWrapper, VKCamera, VKMapCameraController, VKMapModel, VKPolylineOverlayPainter, VKStylesheet;
