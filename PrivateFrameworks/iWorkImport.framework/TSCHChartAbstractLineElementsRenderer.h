...
- (void)p_clipOutSymbolsInContext:(struct CGContext { }*)arg1 withTransformArray:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; }*)arg2 withCount:(unsigned int)arg3 forSeries:(id)arg4;
