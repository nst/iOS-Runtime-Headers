...
- (void)service:(void *)arg1 didSwitchActivePairedDevice:(void *)arg2 acknowledgementBlock:(void *)arg3; // needs 3 arg types, found 7: IDSService *, IDSDevice *, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, void*
