...
- (void)appendArraySection:(id)arg1 withName:(id)arg2 multilinePrefix:(id)arg3 skipIfEmpty:(bool)arg4 objectTransformer:(id)arg5;
- (void)appendArraySection:(id)arg1 withName:(id)arg2 skipIfEmpty:(bool)arg3;
- (void)appendArraySection:(id)arg1 withName:(id)arg2 skipIfEmpty:(bool)arg3 objectTransformer:(id)arg4;
- (void)appendBodySectionWithName:(id)arg1 multilinePrefix:(id)arg2 block:(id)arg3;
...
- (void)appendDictionarySection:(id)arg1 withName:(id)arg2 multilinePrefix:(id)arg3 skipIfEmpty:(bool)arg4 objectTransformer:(id)arg5;
...
- (id)modifyBody:(id)arg1;
- (id)modifyProem:(id)arg1;
