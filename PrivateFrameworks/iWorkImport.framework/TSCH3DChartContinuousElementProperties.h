...
@interface TSCH3DChartContinuousElementProperties : TSCH3DChartBasicElementProperties {
    double  mDepthGapFactor;
    double  mDepthLimitFactor;
    unsigned int  mMaxLimitingSeries;
    double  mShadowCameraDepthLimitAdjustmentFactor;
}

@property (nonatomic, readonly) double depthLimitFactor;
@property (nonatomic, readonly) double p_sageInterSetDepthGapProperty;
@property (nonatomic, readonly) int seriesCount;
@property (nonatomic, readonly) double shadowCameraDepthLimitAdjustmentFactor;
