...
- (void).cxx_destruct;
- (void)_asyncFetchCloudSharedVideoComplement:(id)arg1 options:(id)arg2 resultHandler:(id)arg3;
- (id)_domain;
- (int)_requestAVAssetForAsset:(id)arg1 options:(id)arg2 resultHandler:(id)arg3;
- (id)_requestAsynchronousVideoURLForAsset:(id)arg1 chainedToMasterRequest:(id)arg2 options:(id)arg3 resultHandler:(id)arg4;
