...
+ (id)array:(id)arg1 filter:(id)arg2;
+ (id)array:(id)arg1 map:(id)arg2;
+ (id)array:(id)arg1 reduce:(id)arg2 withInitialValue:(id)arg3;
...
+ (void)mutableArray:(id)arg1 replaceObjectsAtIndexes:(id)arg2 withObjectFromBlock:(id)arg3;
