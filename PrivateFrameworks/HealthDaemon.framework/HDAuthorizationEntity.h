...
+ (BOOL)_insertAuthorizationWithSourceIdentifier:(int)arg1 dataTypeCode:(int)arg2 authorizationStatus:(int)arg3 authorizationRequest:(int)arg4 modificationDate:(double)arg5 syncProvenance:(int)arg6 objectAnchor:(int)arg7 database:(id)arg8 error:(id*)arg9;
+ (BOOL)_insertCodableAuthorizations:(id)arg1 sourceEntity:(id)arg2 syncProvenance:(int)arg3 objectAnchor:(unsigned int)arg4 database:(id)arg5 error:(id*)arg6;
...
+ (BOOL)_setAuthorizationStatuses:(id)arg1 authorizationRequests:(id)arg2 sourceEntity:(id)arg3 dateModified:(id)arg4 syncProvenance:(int)arg5 objectAnchor:(int)arg6 database:(id)arg7 error:(id*)arg8;
