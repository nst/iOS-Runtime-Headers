...
- (void)lockFocusAtLensPosition:(float)arg1 completionBlock:(id)arg2;
...
- (void)queryTimelapseDimensionsWithCompletionBlock:(id)arg1;
- (void)queryVideoDimensionsWithCompletionBlock:(id)arg1;
- (id)recoveryDelegate;
