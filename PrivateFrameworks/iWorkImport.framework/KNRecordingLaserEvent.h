...
@property(readonly) struct CGPoint { float x1; float x2; } unscaledLocation;
...
- (id)initWithStartTime:(double)arg1 unscaledLocation:(struct CGPoint { float x1; float x2; })arg2;
...
- (struct CGPoint { float x1; float x2; })unscaledLocation;
