...
- (void)assistantConnection:(void *)arg1 speechRecordingPerformTwoShotPromptWithType:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 10: AFConnection *, long long, id, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id, double, double, NSError *, void*
