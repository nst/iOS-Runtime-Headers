...
@interface SKAction : NSObject <NSCoding, NSCopying> {
    struct SKCAction { int (**x1)(); unsigned int x2; float x3; id x4; id x5; double x6; double x7; float x8; float x9; double x10; bool x11; bool x12; id x13; long long x14; float x15; float x16; float x17; float x18; } * _caction;
}
...
- (struct SKCAction { int (**x1)(); unsigned int x2; float x3; id x4; id x5; double x6; double x7; float x8; float x9; double x10; bool x11; bool x12; id x13; long long x14; float x15; float x16; float x17; float x18; }*)caction;
- (void)commonInit;
- (id)copy;
