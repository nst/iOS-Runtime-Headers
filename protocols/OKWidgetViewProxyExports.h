...
- (void)dynamicsSnapToPoint:(struct CGPoint { double x1; double x2; })arg1 withDamping:(float)arg2;
...
- (void)dynamicsSnapToPoint:(struct CGPoint { double x1; double x2; })arg1 withDamping:(float)arg2 __JS_EXPORT_AS__dynamicsSnapToPoint:(id)arg3;
