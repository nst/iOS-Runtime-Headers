...
- (void)getWellnessEntriesAfterDate:(id)arg1 limit:(unsigned int)arg2 handler:(id /* block */)arg3;
- (void)getWellnessEntriesBeforeDate:(id)arg1 limit:(unsigned int)arg2 handler:(id /* block */)arg3;
- (id)init;
