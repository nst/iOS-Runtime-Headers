...
- (struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })rectByScalingRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1 factor:(struct CGSize { float x1; float x2; })arg2;
- (float)scale;
- (void)setScale:(float)arg1;
- (id)shapeByScalingShape:(id)arg1 factor:(struct CGSize { float x1; float x2; })arg2;
- (id)shapesByCenteringShapes:(id)arg1 insideRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg2;
