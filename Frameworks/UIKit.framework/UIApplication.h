...
@interface UIApplication : UIResponder <DebugHierarchyEntryPoint_Fallback, DebugHierarchyObject_Fallback, FBSDisplayLayoutObserver, FBSUIApplicationSystemServiceDelegate, FBSUIApplicationWorkspaceDelegate, UIActivityContinuationManagerApplicationContext, UIApplicationSnapshotPreparing, UIStatusBarStyleDelegate_SpringBoardOnly, UNRemoteNotificationRegistrarDelegate> {
