...
- (void)_enqueueIncomingStartSessionRequest:(id)arg1 withCompletion:(id)arg2;
- (void)_handleEndSession:(id)arg1 completion:(id)arg2;
- (bool)_handleEndSessionResponse:(id)arg1 error:(id*)arg2;
- (void)_handleError:(id)arg1;
- (void)_handleResetRequest:(id)arg1 completion:(id)arg2;
- (bool)_handleResetResponse:(id)arg1 error:(id*)arg2;
- (void)_handleRestartSession:(id)arg1 completion:(id)arg2;
- (bool)_handleRestartSessionResponse:(id)arg1 error:(id*)arg2;
- (void)_handleStartSession:(id)arg1 completion:(id)arg2;
- (bool)_handleStartSessionResponse:(id)arg1 error:(id*)arg2;
- (void)_handleSyncBatch:(id)arg1 completion:(id)arg2;
- (bool)_handleSyncBatchResponse:(id)arg1 error:(id*)arg2;
- (void)_ifDelegateImplements:(SEL)arg1 do:(id)arg2 then:(id)arg3;
...
- (void)_peerRejectedVersion:(id)arg1 completion:(id)arg2;
...
- (bool)_request:(id)arg1 hasValidSessionIDForSession:(id)arg2 response:(id)arg3 completion:(id)arg4;
...
- (void)_v1_handleBatchSyncChunk:(id)arg1 completion:(id)arg2;
- (void)_v1_handleBatchSyncEnd:(id)arg1 completion:(id)arg2;
- (void)_v1_handleBatchSyncStart:(id)arg1 completion:(id)arg2;
- (void)_v1_handleChangeMessage:(id)arg1 completion:(id)arg2;
- (void)_v1_handleFullSyncRequest:(id)arg1 completion:(id)arg2;
- (bool)_v1_handleFullSyncRequestAck:(id)arg1 error:(id*)arg2;
- (void)_v1_handleSyncAllObjects:(id)arg1 completion:(id)arg2;
- (void)_vectorClockUpdated;
- (void)_whenSessionEnds:(id)arg1;
- (void)_wrapUpCurrentSession:(id)arg1;
- (id)aggdKeys;
- (void)currentDeviceProximityChanged:(bool)arg1;
- (id)currentSession;
- (id)customIDSOptions;
- (void)dataStreamWithMetadata:(id)arg1 options:(struct NSDictionary { Class x1; }*)arg2 completion:(id)arg3;
...
- (id)generationID;
- (void)handleFileTransfer:(id)arg1 metadata:(id)arg2 completion:(id)arg3;
- (void)handleOutOfBandData:(id)arg1 completion:(id)arg2;
- (void)handleSyncError:(id)arg1 forMessageWithIdentifier:(id)arg2;
- (void)handleSyncRequest:(id)arg1 ofType:(unsigned short)arg2 response:(id)arg3;
- (void)handleSyncResponse:(id)arg1 ofType:(unsigned short)arg2 completion:(id)arg3;
...
- (id)queue;
- (bool)resume:(id*)arg1;
- (void)sendData:(id)arg1 options:(struct NSDictionary { Class x1; }*)arg2 completion:(id)arg3;
...
- (void)serializeForIncomingSession:(id)arg1;
- (id)serviceActivity;
