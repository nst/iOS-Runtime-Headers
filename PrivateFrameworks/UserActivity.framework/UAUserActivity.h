...
+ (bool)determineIfUserActivityIsCurrent:(id)arg1 completionHandler:(id)arg2;
+ (void)fetchUserActivityWithUUID:(id)arg1 completionHandler:(id)arg2;
+ (id)fetchUserActivityWithUUID:(id)arg1 intervalToWaitForDocumentSynchronizationToComplete:(double)arg2 completionHandler:(id)arg3;
+ (void)initialize;
...
- (void).cxx_destruct;
- (bool)_encodeIntoUserActivityDataWithSave:(bool)arg1 completionHandler:(id)arg2;
- (bool)_encodeIntoUserActivityStringWithSave:(bool)arg1 completionHandler:(id)arg2;
- (void)_resignCurrent;
...
- (bool)archiveURL:(id)arg1 completionHandler:(id)arg2;
...
- (id)copyWithNewUUID;
- (bool)createUserActivityDataWithSaving:(bool)arg1 options:(id)arg2 completionHandler:(id)arg3;
- (bool)createUserActivityStringsWithSaving:(bool)arg1 options:(id)arg2 completionHandler:(id)arg3;
...
- (bool)encodeUserInfo:(id)arg1 completionHandler:(id)arg2;
...
- (id)payloadObjects;
- (id)payloadUpdateBlockForIdentifier:(id)arg1;
- (id)payloadUpdateBlocks;
- (void)pinUserActivityWithCompletionHandler:(id)arg1;
- (void)prepareUserActivityForLaunchingWithOptions:(id)arg1 completionHandler:(id)arg2;
- (long long)priority;
...
- (void)setPayloadIdentifier:(id)arg1 object:(id)arg2 withBlock:(id)arg3;
