...
- (BOOL)accessibilityScroll:(NSInteger)arg1;
...
- (BOOL)_accessibilityHandlePublicScroll:(NSInteger)arg1;
...
- (void)accessibilityPostNotification:(NSUInteger)arg1 withObject:(id)arg2 afterDelay:(double)arg3;
...
- (id)valueForSelector:(SEL)arg1 forThreadKey:(id)arg2 waitTime:(double)arg3 withObjects:(id)arg4;
- (double)performSelector:(SEL)arg1 withThreadKey:(id)arg2 count:(unsigned long)arg3 objects:(id)arg4;
- (double)performSelector:(SEL)arg1 withThreadKey:(id)arg2 waitTime:(double)arg3 cancelMask:(unsigned long)arg4 count:(unsigned long)arg5 objects:(id)arg6;
