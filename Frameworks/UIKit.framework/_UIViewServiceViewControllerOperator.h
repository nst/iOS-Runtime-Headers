...
- (void)__hostViewWillTransitionToSize:(struct CGSize { float x1; float x2; })arg1 withContextDescription:(id)arg2 statusBarHeight:(float)arg3 underlapsStatusBar:(BOOL)arg4 whenDone:(id /* block */)arg5;
