...
- (void)setColorResolveTexture:(id)arg1 slice:(unsigned int)arg2 depthPlane:(unsigned int)arg3 level:(unsigned int)arg4 atIndex:(unsigned int)arg5 yInvert:(BOOL)arg6;
