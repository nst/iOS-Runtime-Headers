...
- (void)_accessTokensForConsentTokens:(id)arg1 user:(id)arg2 completionHandler:(id)arg3;
...
- (void)addUserToRelayAccessories:(id)arg1 consentTokens:(id)arg2 completionQueue:(id)arg3 completionHandler:(id)arg4;
- (id)clientQueue;
