...
- (void)handleUploadBatchesFromEvent:(id)arg1 insertedPhotoCount:(unsigned int*)arg2 insertedVideoCount:(unsigned int*)arg3 totalSizeOfUnpushedOriginals:(unsigned long long*)arg4;
