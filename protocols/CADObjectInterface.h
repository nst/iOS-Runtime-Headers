...
- (void)CADObject:(void *)arg1 getDataPropertyWithName:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 9: struct { int x1; int x2; }, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSData *, void*
- (void)CADObject:(void *)arg1 getDatePropertyWithName:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 9: struct { int x1; int x2; }, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSDate *, void*
- (void)CADObject:(void *)arg1 getNumberPropertyWithName:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 9: struct { int x1; int x2; }, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSNumber *, void*
- (void)CADObject:(void *)arg1 getPropertiesWithNames:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 9: struct { int x1; int x2; }, NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSDictionary *, void*
- (void)CADObject:(void *)arg1 getPropertyWithName:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 9: struct { int x1; int x2; }, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSObject<NSSecureCoding> *, void*
- (void)CADObject:(void *)arg1 getRelatedObjectWithRelationName:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 9: struct { int x1; int x2; }, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, struct { int x1; int x2; }, void*
