...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)_querySignificantElevationChangeFromDate:(id)arg1 toDate:(id)arg2 withHandler:(id)arg3;
- (void)_startElevationUpdatesWithHandler:(id)arg1;
- (void)_startSignificantElevationUpdatesWithHandler:(id)arg1;
