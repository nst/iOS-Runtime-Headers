...
@property (nonatomic) double quickSpeakSpeakingRate;
@property (nonatomic) BOOL quickSpeakUnderlineSentence;
@property (nonatomic) double quickSpeakVolume;
...
@property (nonatomic) double reduceWhitePointLevel;
...
@property double voiceOverSpeakingRate;
...
@property double voiceOverVolume;
