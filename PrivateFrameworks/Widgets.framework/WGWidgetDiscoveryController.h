...
@property (nonatomic) long long columnModes;
...
+ (id)generatorForWidgetViewControllerWithBundleID:(id)arg1 containingBundleID:(id)arg2 timeout:(unsigned long long)arg3;
...
- (void)_requestUnlockWithCompletion:(id)arg1;
...
- (id)_widgetViewControllerWithBundleID:(id)arg1 containingBundleID:(id)arg2 didConnect:(id)arg3 canTearDown:(id)arg4;
- (void)addDiscoveryObserver:(id)arg1;
- (void)beginDiscovery;
- (long long)columnModes;
- (void)debugWidgetWithBundleID:(id)arg1 options:(id)arg2 completion:(id)arg3;
- (id)debuggingHandler;
- (id)delegate;
- (id)disabledInterfaceItemIdentifiersForWidgetListEditViewController:(id)arg1;
- (id)disabledWidgetIdentifiers;
- (void)dismissWidgetListEditViewController:(id)arg1 animated:(bool)arg2 withCompletion:(id)arg3;
- (void)dismissWidgetListEditViewControllerAnimated:(bool)arg1 completion:(id)arg2;
...
- (void)presentWidgetListEditViewControllerFromViewController:(id)arg1 animated:(bool)arg2 completion:(id)arg3;
