...
- (void).cxx_destruct;
- (id)description;
- (id)initWithKey:(const struct VKTileKey { unsigned int x1; int x2; int x3; unsigned int x4; }*)arg1 modelTile:(id)arg2 tileType:(unsigned char)arg3 labelManager:(const struct shared_ptr<md::LabelManager> { }*)arg4;
