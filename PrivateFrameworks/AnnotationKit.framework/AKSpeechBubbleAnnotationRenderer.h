...
+ (void)basePointsOfPointyBit:(id)arg1 withUpdatedProperties:(id)arg2 firstPoint:(struct CGPoint { float x1; float x2; }*)arg3 secondPoint:(struct CGPoint { float x1; float x2; }*)arg4;
+ (float)pointyBitPointWidthAngleGivenControlBasePoint:(struct CGPoint { float x1; float x2; })arg1 forAnnotation:(id)arg2;
