...
@property (nonatomic, copy) id testHandler;
...
- (long long)_countOfObjectsWithSQLQuery:(id)arg1 database:(id)arg2 error:(id*)arg3 bindingHandler:(id)arg4;
- (long long)_deletedRowCountWithDatabase:(id)arg1 error:(id*)arg2;
- (bool)_enumerateAppleStandHoursFromDate:(id)arg1 toDate:(id)arg2 error:(id*)arg3 handler:(id)arg4;
...
- (id)_newActivitySummaryQueryHelperWithFilter:(id)arg1 initialResultsHandler:(id)arg2;
