...
@class NSSet, SUScriptWindowContext, <SUWebViewManagerDelegate>, NSMapTable, NSLock, SUClientInterface, UIWebView, ISURLRequestPerformance, SSAuthenticationContext;
