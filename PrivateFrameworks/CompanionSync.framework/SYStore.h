...
- (void).cxx_destruct;
- (void)_enqueueDeltaSessionWithChanges:(id)arg1 contextInfo:(id)arg2 idsOptions:(id)arg3 blockUntilSent:(bool)arg4 reportError:(id)arg5;
...
- (void)service:(id)arg1 incomingData:(id)arg2 identifier:(id)arg3 completion:(id)arg4;
- (void)service:(id)arg1 incomingStream:(id)arg2 metadata:(id)arg3 identifier:(id)arg4 completion:(id)arg5;
