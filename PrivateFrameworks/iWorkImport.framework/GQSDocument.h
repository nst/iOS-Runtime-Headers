...
@class <GQUOutputBundle>, <GQWrapPointGenerator>, GQDRoot, GQDSStylesheet, GQPProcessor, GQSTable, NSString, SFUZipArchive;

@interface GQSDocument : NSObject <GQWrapPointGenerator> {
    bool_doCalculateThumbnailSize;
    boolmDoExternalTextWrap;
    boolmGeneratingThumbnail;
    boolmGeneratorBeginWasCalled;
    boolmIsReadingStorageAttachments;
    boolmMustRegisterDrawables;
    boolmShouldStreamTables;
    boolmThumbnailGenerationDone;
