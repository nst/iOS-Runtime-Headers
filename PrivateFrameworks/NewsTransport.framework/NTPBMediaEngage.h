...
@interface NTPBMediaEngage : PBCodable <NSCopying> {
    ...
    int  _mediaPausePosition;
    int  _mediaPlayLocation;
    int  _mediaPlayMethod;
    int  _mediaResumeMethod;
    int  _mediaResumePosition;
    int  _mediaResumeTimePlayed;
...
@property (nonatomic) int mediaPausePosition;
@property (nonatomic) int mediaPlayLocation;
@property (nonatomic) int mediaPlayMethod;
@property (nonatomic) int mediaResumeMethod;
@property (nonatomic) int mediaResumePosition;
@property (nonatomic) int mediaResumeTimePlayed;
...
- (int)mediaPausePosition;
- (int)mediaPlayLocation;
- (int)mediaPlayMethod;
- (int)mediaResumeMethod;
- (int)mediaResumePosition;
- (int)mediaResumeTimePlayed;
- (int)mediaTimePlayed;
- (int)mediaType;
...
- (void)setMediaPausePosition:(int)arg1;
- (void)setMediaPlayLocation:(int)arg1;
- (void)setMediaPlayMethod:(int)arg1;
- (void)setMediaResumeMethod:(int)arg1;
- (void)setMediaResumePosition:(int)arg1;
- (void)setMediaResumeTimePlayed:(int)arg1;
