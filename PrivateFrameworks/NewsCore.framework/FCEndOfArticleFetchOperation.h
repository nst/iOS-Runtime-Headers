...
- (void).cxx_destruct;
- (void)_fetchThumbnailsForHeadlines:(id)arg1 callbackQueue:(id)arg2 withCompletion:(id)arg3;
- (void)_filterHeadlines:(id)arg1 completion:(id)arg2;
- (void)_streamingHeadlinesForArticleIDs:(id)arg1 callbackQueue:(id)arg2 minimumResultCount:(unsigned long long)arg3 completion:(id)arg4;
