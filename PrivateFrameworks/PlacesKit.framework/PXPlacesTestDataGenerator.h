...
- (void)generateTestImages:(unsigned long long)arg1 fromLocation:(struct CLLocationCoordinate2D { double x1; double x2; })arg2 toLocation:(struct CLLocationCoordinate2D { double x1; double x2; })arg3 atEnd:(id)arg4;
- (id)init;
