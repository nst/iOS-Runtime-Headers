...
@interface ISReuseQueue : NSObject {
    ...
    id  _objectBecomeReusableHandler;
    bool  _reuseEnabled;
}
...
@property (nonatomic, copy) id objectBecomeReusableHandler;
...
- (void)registerObjectCreationBlock:(id)arg1 withReuseIdentifier:(id)arg2;
