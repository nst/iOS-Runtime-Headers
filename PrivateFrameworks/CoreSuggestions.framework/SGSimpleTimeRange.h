...
- (id)initWithStart:(struct SGUnixTimestamp_ { double x1; })arg1 startUTCOffsetSeconds:(int)arg2 end:(struct SGUnixTimestamp_ { double x1; })arg3 endUTCOffsetSeconds:(int)arg4;
