...
@property (copy) id dateNameBlock;
...
- (void)draw;
- (long long)format;
- (id)initWithCalendar:(id)arg1 dayNumber:(id)arg2 dateNameBlock:(id)arg3 dateNameFormatType:(long long)arg4 canvasSize:(struct CGSize { double x1; double x2; })arg5 format:(long long)arg6;
