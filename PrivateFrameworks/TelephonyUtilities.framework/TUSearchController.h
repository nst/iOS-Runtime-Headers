...
- (id)_searchModuleCompletionWithModules:(id)arg1 searchTerm:(id)arg2 resultsClass:(Class)arg3 completion:(id)arg4;
- (id)contactStore;
- (id)init;
- (id)recentsModuleCompletionWithCompletion:(id)arg1;
- (id)recentsModules;
- (void)recentsWithCompletion:(id)arg1;
- (void)searchForString:(id)arg1 completion:(id)arg2;
- (id)searchModuleCompletionWithSearchTerm:(id)arg1 completion:(id)arg2;
- (id)searchModules;
- (id)searchQueue;
