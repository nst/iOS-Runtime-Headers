...
@interface CLGpsPosition : NSObject <NSSecureCoding> {
    ...
    struct time_point<std::__1::chrono::steady_clock, std::__1::chrono::duration<int, std::__1::ratio<1, 1000000000> > > { 
    ...
    double  _horzUncSemiMaj;
    double  _horzUncSemiMajAz;
    double  _horzUncSemiMin;
...
@property (nonatomic) double horzUncSemiMaj;
@property (nonatomic) double horzUncSemiMajAz;
@property (nonatomic) double horzUncSemiMin;
...
- (struct time_point<std::__1::chrono::steady_clock, std::__1::chrono::duration<int, std::__1::ratio<1, 1000000000> > > { struct duration<int, std::__1::ratio<1, 1000000000> > { int x_1_1_1; } x1; })expiry;
...
- (id)initWithLocation:(const struct { int x1; struct { double x_2_1_1; double x_2_1_2; } x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; int x11; double x12; int x13; struct { double x_14_1_1; double x_14_1_2; } x14; double x15; int x16; unsigned int x17; int x18; }*)arg1 andPrivateLocation:(const struct { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; bool x9; int x10; struct { double x_11_1_1; double x_11_1_2; } x11; double x12; int x13; int x14; bool x15; struct { double x_16_1_1; double x_16_1_2; } x16; double x17; struct { double x_18_1_1; double x_18_1_2; } x18; double x19; double x20; int x21; }*)arg2;
- (BOOL)isStaleFix:(struct time_point<std::__1::chrono::steady_clock, std::__1::chrono::duration<int, std::__1::ratio<1, 1000000000> > > { struct duration<int, std::__1::ratio<1, 1000000000> > { int x_1_1_1; } x1; })arg1;
