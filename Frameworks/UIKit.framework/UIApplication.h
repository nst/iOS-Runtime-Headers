...
@class <UIApplicationDelegate>, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSTimer, UIAlertView, UIColor, UIEvent, UIMoveEvent, UIPhysicalButtonsEvent, UIPhysicalKeyboardEvent, UIStatusBar, UIStatusBarWindow, UIWheelEvent, UIWindow;
